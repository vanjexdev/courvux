...
`,Ue=!1;function Be(){if(Ue||typeof document>"u")return;Ue=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=xt,document.head.appendChild(e)}var qe=!1;function wt(){if(qe||typeof document>"u")return;qe=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function kt(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(c=>{(c.name.startsWith("on")||c.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(c.name)})}),t.body.innerHTML}async function oe(e,t,o){var y,E,x,L,C,k,W,$,M,D,F,I,T,d,a,h,A;const c=Array.from(e.childNodes);let l=0;for(;l<c.length;){const S=c[l];if(S.nodeType===3){const i=S.textContent||"",r=i.match(/\{\{([\s\S]+?)\}\}/g);if(r){const s=i,u=()=>{let m=s;r.forEach(p=>{const b=p.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(p,H(b,t)??"")}),S.textContent=m};r.forEach(m=>{K(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,u)}),u()}l++;continue}if(S.nodeType!==1){l++;continue}const n=S,f=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),l++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await oe(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),l++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const i=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const r=document.querySelector(i)??document.body,s=document.createComment(`cv-teleport: ${i}`);n.replaceWith(s),await oe(n,t,o),r.appendChild(n),l++;continue}if(n.hasAttribute("cv-memo")){const i=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const r=()=>i.split(",").map(b=>H(b.trim(),t));let s=r();const u=[],m=b=>(u.push(b),()=>{const v=u.indexOf(b);v>-1&&u.splice(v,1)});await oe(n,t,{...o,subscribe:(b,v)=>m(v),storeSubscribeOverride:(b,v,w)=>m(w)});const p=K(i,o,()=>{const b=r();b.some((v,w)=>v!==s[w])&&(s=b,[...u].forEach(v=>v()))});(y=o.registerCleanup)==null||y.call(o,()=>p()),l++;continue}if(n.hasAttribute("cv-data")){const i=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let r={},s={};if(i.startsWith("{")){const u=H(i,t)??{};Object.entries(u).forEach(([m,p])=>{typeof p=="function"?s[m]=p:r[m]=p})}else if(i){const u=(E=o.components)==null?void 0:E[i];if(u){const m=typeof u.data=="function"?u.data():u.data??{};m instanceof Promise||Object.assign(r,m),Object.assign(s,u.methods??{})}}if(o.createChildScope){const u=o.createChildScope(r,s);(x=o.registerCleanup)==null||x.call(o,u.cleanup),await oe(n,u.state,{...o,subscribe:u.subscribe})}else await oe(n,{...t,...r,...s},o);l++;continue}if(n.hasAttribute("cv-for")){const i=n.getAttribute("cv-for");n.removeAttribute("cv-for");const r=i.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(r){const[,s,u,m]=r,p=n.getAttribute(":key")??null;p&&n.removeAttribute(":key");const b=n.getAttribute("cv-transition")??null;b&&n.removeAttribute("cv-transition");const v=document.createComment(`cv-for: ${m}`);n.replaceWith(v);let w=[],P=[];const O=new Map,U=async()=>{var G;const N=H(m,t),R=N?typeof N=="number"?Array.from({length:N},(z,q)=>[q+1,q]):Array.isArray(N)?N.map((z,q)=>[z,q]):Object.entries(N).map(([z,q])=>[q,z]):[];if(p){const z=[],q=new Map,Q=new Set;for(const[Y,X]of R){const re=H(p,Ne(t,Y,s,X,u));Q.has(re)&&console.warn(`[courvux] cv-for: duplicate :key "${re}" in "${m}"`),Q.add(re),z.push(re),q.set(re,[Y,X])}const V=[];for(const[Y,{el:X,destroy:re}]of O)q.has(Y)||(b?(X.classList.add(`${b}-leave`),V.push(ie(X).then(()=>{var ae;X.classList.remove(`${b}-leave`),re(),(ae=X.parentNode)==null||ae.removeChild(X),O.delete(Y)}))):(re(),(G=X.parentNode)==null||G.removeChild(X),O.delete(Y)));V.length&&await Promise.all(V);const B=v.parentNode,te=[];for(const Y of z){const[X,re]=q.get(Y);if(O.has(Y)){const ae=O.get(Y);ae.itemRef!==X&&(ae.reactive[s]=X,ae.itemRef=X),u&&(ae.reactive[u]=re)}else{const ae=n.cloneNode(!0),Se=[],{subscribe:ht,createReactiveState:ft}=Pe(),Ee=ft({[s]:X,...u?{[u]:re}:{}}),vt=new Proxy({},{has(se,ee){return!0},get(se,ee){return typeof ee!="string"?t[ee]:ee===s||u&&ee===u?Ee[ee]:t[ee]},set(se,ee,ce){return ee===s||u&&ee===u?(Ee[ee]=ce,!0):(t[ee]=ce,!0)}}),gt={...o,subscribe:(se,ee)=>{const ce=se.split(".")[0];let de;return ce===s||u&&ce===u?de=ht(ce,ee):de=o.subscribe(se,ee),Se.push(de),de},storeSubscribeOverride:(se,ee,ce)=>{const de=ve(se,ee,ce);return Se.push(de),de}},_e=document.createDocumentFragment();_e.appendChild(ae),await oe(_e,vt,gt);const Te=_e.firstChild??ae;b&&Te.classList.add(`${b}-enter`),O.set(Y,{el:Te,reactive:Ee,itemRef:X,destroy:()=>Se.forEach(se=>se())}),b&&te.push(Te)}}let J=v.nextSibling,pe=0;for(const Y of z){const{el:X}=O.get(Y);X!==J?pe++:J=X.nextSibling}if(pe>0)if(pe>z.length>>1){const Y=document.createDocumentFragment();for(const X of z)Y.appendChild(O.get(X).el);B.insertBefore(Y,v.nextSibling)}else{J=v.nextSibling;for(const Y of z){const{el:X}=O.get(Y);X!==J?B.insertBefore(X,J):J=X.nextSibling}}w=z.map(Y=>O.get(Y).el),te.length&&Promise.all(te.map(Y=>ie(Y).then(()=>Y.classList.remove(`${b}-enter`))))}else{if(P.forEach(V=>V()),P=[],w.forEach(V=>{var B;return(B=V.parentNode)==null?void 0:B.removeChild(V)}),w=[],!R.length)return;const z=v.parentNode,q=v.nextSibling,Q={...o,subscribe:(V,B)=>{const te=o.subscribe(V,B);return P.push(te),te},storeSubscribeOverride:(V,B,te)=>{const J=ve(V,B,te);return P.push(J),J}};for(const[V,B]of R){const te=n.cloneNode(!0),J=document.createDocumentFragment();J.appendChild(te),await oe(J,Ne(t,V,s,B,u),Q);const pe=J.firstChild??te;z.insertBefore(J,q),w.push(pe)}}};(L=o.registerCleanup)==null||L.call(o,()=>{O.forEach(({el:N,destroy:R})=>{var G;R(),(G=N.parentNode)==null||G.removeChild(N)}),O.clear(),P.forEach(N=>N()),w.forEach(N=>{var R;return(R=N.parentNode)==null?void 0:R.removeChild(N)}),w=[]}),K(m,o,U),await U()}l++;continue}if(n.hasAttribute("cv-if")){const i=[],r=n.getAttribute("cv-if");n.removeAttribute("cv-if");const s=document.createComment("cv-if");n.replaceWith(s),i.push({condition:r,template:n,anchor:s});let u=l+1;for(;u<c.length;){const w=c[u];if(w.nodeType===3&&(((C=w.textContent)==null?void 0:C.trim())??"")===""){u++;continue}if(w.nodeType!==1)break;const P=w;if(P.hasAttribute("cv-else-if")){const O=P.getAttribute("cv-else-if");P.removeAttribute("cv-else-if");const U=document.createComment("cv-else-if");P.replaceWith(U),i.push({condition:O,template:P,anchor:U}),u++;continue}if(P.hasAttribute("cv-else")){P.removeAttribute("cv-else");const O=document.createComment("cv-else");P.replaceWith(O),i.push({condition:null,template:P,anchor:O}),u++;break}break}l=u;let m=null,p=!1,b=!1;const v=async()=>{var w,P;if(p){b=!0;return}p=!0;try{do{b=!1,m&&((w=m.parentNode)==null||w.removeChild(m),m=null);for(const O of i)if(O.condition===null||H(O.condition,t)){const U=O.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(U),await oe(N,t,o);const R=N.firstChild??U;(P=O.anchor.parentNode)==null||P.insertBefore(N,O.anchor.nextSibling),m=R;break}}while(b)}finally{p=!1}};i.filter(w=>w.condition).forEach(w=>{K(w.condition,o,v)}),await v();continue}if(n.hasAttribute("cv-show")){const i=n.getAttribute("cv-show");n.removeAttribute("cv-show");const r=Array.from(n.attributes).filter(s=>s.name==="cv-transition"||s.name.startsWith("cv-transition:")||s.name.startsWith("cv-transition."));if(r.length>0){const s=R=>(n.getAttribute(R)??"").split(" ").filter(Boolean),u=s("cv-transition:enter"),m=s("cv-transition:enter-start"),p=s("cv-transition:enter-end"),b=s("cv-transition:leave"),v=s("cv-transition:leave-start"),w=s("cv-transition:leave-end"),P=n.getAttribute("cv-transition")??"",O=new Set(P.split(".").slice(1)),U=[...O].find(R=>/^\d+$/.test(R)),N=U?parseInt(U):200;if(u.length||m.length||b.length||v.length){r.forEach(V=>n.removeAttribute(V.name));const R=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!H(i,t),z=!1,q=null;const Q=async V=>{if(z){q=V;return}z=!0;try{V?(n.style.display="",n.classList.add(...u,...m),await R(),n.classList.remove(...m),n.classList.add(...p),await ie(n),n.classList.remove(...u,...p)):(n.classList.add(...b,...v),await R(),n.classList.remove(...v),n.classList.add(...w),await ie(n),n.classList.remove(...b,...w),n.style.display="none"),G=V}finally{if(z=!1,q!==null&&q!==G){const B=q;q=null,Q(B)}else q=null}};G||(n.style.display="none"),K(i,o,()=>{const V=!!H(i,t);V!==G&&Q(V)})}else{const R=[...O].find(B=>B==="scale"||/^scale$/.test(B)),G=(()=>{const B=[...O].find(te=>/^\d+$/.test(te)&&te!==U);return B?parseInt(B)/100:.9})(),z=[];(!O.has("scale")||O.has("opacity"))&&z.push(`opacity ${N}ms ease`),R&&z.push(`transform ${N}ms ease`),z.length||z.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+z.join(", "),r.forEach(B=>n.removeAttribute(B.name));let q=!!H(i,t);const Q=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B()))),V=async B=>{B?(n.style.display="",n.style.opacity="0",R&&(n.style.transform=`scale(${G})`),await Q(),n.style.opacity="",R&&(n.style.transform=""),await ie(n)):(n.style.opacity="0",R&&(n.style.transform=`scale(${G})`),await ie(n),n.style.display="none",n.style.opacity="",R&&(n.style.transform="")),q=B};q||(n.style.display="none"),K(i,o,()=>{const B=!!H(i,t);B!==q&&V(B)})}}else{const s=n.getAttribute("cv-show-transition"),u=n.getAttribute(":transition");s&&n.removeAttribute("cv-show-transition"),u&&n.removeAttribute(":transition");const m=s??(u?String(H(u,t)):null);if(m){Be();let p=!!H(i,t);p||(n.style.display="none");let b=!1,v=null;const w=async P=>{if(b){v=P;return}b=!0;try{P?(n.style.display="",n.classList.add(`${m}-enter`),await ie(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ie(n),n.classList.remove(`${m}-leave`),n.style.display="none"),p=P}finally{if(b=!1,v!==null&&v!==p){const O=v;v=null,w(O)}else v=null}};K(i,o,()=>{const P=!!H(i,t);P!==p&&w(P)})}else{const p=()=>{n.style.display=H(i,t)?"":"none"};K(i,o,p),p()}}}if(n.hasAttribute("cv-focus")){const i=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!i)Promise.resolve().then(()=>n.focus());else{const r=()=>{H(i,t)&&Promise.resolve().then(()=>n.focus())};K(i,o,r),r()}}{const i=Array.from(n.attributes).filter(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect:")||r.name.startsWith("cv-intersect."));if(i.length&&typeof IntersectionObserver<"u"){const r=i.find(R=>R.name==="cv-intersect"||R.name==="cv-intersect:enter"||R.name.startsWith("cv-intersect.")),s=i.find(R=>R.name==="cv-intersect:leave"),u=(r==null?void 0:r.value)??"",m=(s==null?void 0:s.value)??"",p=((r==null?void 0:r.name)??"cv-intersect").split("."),b=new Set(p.slice(1)),v=b.has("once");let w=0;if(b.has("half"))w=.5;else if(b.has("full"))w=1;else{const R=[...b].find(G=>G.startsWith("threshold-"));R&&(w=parseInt(R.replace("threshold-",""))/100)}const P=[...b].find(R=>R.startsWith("margin-")),O=P?`${P.replace("margin-","")}px`:void 0;i.forEach(R=>n.removeAttribute(R.name));const U=R=>{if(R)try{new Function("$data",`with($data){${R}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${R}":`,G)}},N=new IntersectionObserver(R=>{R.forEach(G=>{G.isIntersecting?(U(u),v&&N.disconnect()):U(m)})},{threshold:w,...O?{rootMargin:O}:{}});N.observe(n),(k=o.registerCleanup)==null||k.call(o,()=>N.disconnect())}}{const i=Array.from(n.attributes).find(r=>r.name==="cv-html"||r.name.startsWith("cv-html."));if(i){const r=i.value;n.removeAttribute(i.name);const s=i.name.split(".").slice(1).includes("sanitize"),u=()=>{const m=String(H(r,t)??"");n.innerHTML=s?kt(m):m};K(r,o,u),u(),l++;continue}}if(n.hasAttribute("cv-ref")&&!((W=o.components)!=null&&W[f])){const i=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[i]=n)}const g=!!(($=o.components)!=null&&$[f]),_=Array.from(n.attributes).find(i=>i.name==="cv-model"||i.name.startsWith("cv-model."));if(_&&!g){const i=_.value;n.removeAttribute(_.name);const r=new Set(_.name.split(".").slice(1)),s=n,u=(M=s.type)==null?void 0:M.toLowerCase(),m=p=>{if(r.has("number")){const b=parseFloat(p);return isNaN(b)?p:b}return r.has("trim")?p.trim():p};if(u==="checkbox"){const p=()=>{const b=H(i,t);s.checked=Array.isArray(b)?b.includes(s.value):!!b};ue(i,o,p),p(),s.addEventListener("change",()=>{const b=H(i,t);if(Array.isArray(b)){const v=[...b];if(s.checked)v.includes(s.value)||v.push(s.value);else{const w=v.indexOf(s.value);w>-1&&v.splice(w,1)}le(i,t,v)}else le(i,t,s.checked)})}else if(u==="radio"){const p=()=>{s.checked=H(i,t)===s.value};ue(i,o,p),p(),s.addEventListener("change",()=>{s.checked&&le(i,t,m(s.value))})}else if(n.hasAttribute("contenteditable")){const p=n,b=()=>{const v=String(H(i,t)??"");p.innerText!==v&&(p.innerText=v)};if(ue(i,o,b),b(),r.has("debounce")){const v=[...r].find(O=>/^\d+$/.test(O)),w=v?parseInt(v):300;let P;p.addEventListener("input",()=>{clearTimeout(P),P=setTimeout(()=>le(i,t,m(p.innerText)),w)})}else{const v=r.has("lazy")?"blur":"input";p.addEventListener(v,()=>le(i,t,m(p.innerText)))}}else{const p=()=>{s.value=H(i,t)??""};if(ue(i,o,p),p(),r.has("debounce")){const b=[...r].find(P=>/^\d+$/.test(P)),v=b?parseInt(b):300;let w;s.addEventListener("input",()=>{clearTimeout(w),w=setTimeout(()=>le(i,t,m(s.value)),v)})}else{const b=f==="select"||r.has("lazy")?"change":"input";s.addEventListener(b,()=>le(i,t,m(s.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(i=>{var U,N;if(!i.name.startsWith("cv-"))return;const r=i.name.slice(3).split("."),s=r[0],u=r.slice(1),m=s.indexOf(":"),p=m>=0?s.slice(0,m):s,b=m>=0?s.slice(m+1):void 0,v=o.directives[p];if(!v)return;const w=i.value;n.removeAttribute(i.name);const P=typeof v=="function"?{onMount:v}:v,O={value:w?H(w,t):void 0,arg:b,modifiers:Object.fromEntries(u.map(R=>[R,!0]))};(U=P.onMount)==null||U.call(P,n,O),P.onUpdate&&w&&K(w,o,()=>{O.value=H(w,t),P.onUpdate(n,O)}),P.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>P.onDestroy(n,O)))}),f==="slot"){const i=n.getAttribute("name")??"default",r=(D=o.slots)==null?void 0:D[i];if(r){const s={};Array.from(n.attributes).forEach(p=>{p.name.startsWith(":")&&(s[p.name.slice(1)]=H(p.value,t))});const u=await r(s),m=document.createDocumentFragment();u.forEach(p=>m.appendChild(p)),n.replaceWith(m)}else{const s=document.createDocumentFragment();for(;n.firstChild;)s.appendChild(n.firstChild);await oe(s,t,o),n.replaceWith(s)}l++;continue}if(f==="cv-transition"){Be();const i=n.getAttribute("name")??"fade",r=n.getAttribute(":show")??null;n.removeAttribute("name"),r&&n.removeAttribute(":show");const s=document.createElement("div");for(s.className="cv-t-wrap";n.firstChild;)s.appendChild(n.firstChild);if(n.replaceWith(s),await oe(s,t,o),r){let u=!!H(r,t),m=!1,p=null;u||(s.style.display="none");const b=async v=>{if(m){p=v;return}m=!0;try{v?(s.style.display="",s.classList.add(`${i}-enter`),await ie(s),s.classList.remove(`${i}-enter`)):(s.classList.add(`${i}-leave`),await ie(s),s.classList.remove(`${i}-leave`),s.style.display="none"),u=v}finally{if(m=!1,p!==null&&p!==u){const w=p;p=null,b(w)}else p=null}};K(r,o,()=>{const v=!!H(r,t);v!==u&&b(v)})}l++;continue}if(f==="router-view"&&o.mountRouterView){const i=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,i),l++;continue}if(f==="router-link"){const i=n.getAttribute(":to"),r=n.getAttribute("to"),s=()=>i?String(H(i,t)??"/"):r||"/",u=document.createElement("a");u.innerHTML=n.innerHTML,Array.from(n.attributes).forEach(w=>{w.name!=="to"&&w.name!==":to"&&u.setAttribute(w.name,w.value)});const m=((F=o.router)==null?void 0:F.base)??"",p=w=>m?w===m?"/":w.startsWith(m+"/")?w.slice(m.length)||"/":w||"/":w||"/",b=()=>{var w;return((w=o.router)==null?void 0:w.mode)==="history"?p(window.location.pathname):window.location.hash.slice(1)||"/"},v=()=>{var O;const w=s(),P=b()===w;((O=o.router)==null?void 0:O.mode)==="history"?u.href=`${m}${w}`:u.href=`#${w}`,P?(u.setAttribute("aria-current","page"),u.classList.add("active")):(u.removeAttribute("aria-current"),u.classList.remove("active"))};((I=o.router)==null?void 0:I.mode)==="history"?(u.addEventListener("click",w=>{w.preventDefault(),o.router.navigate(s())}),window.addEventListener("popstate",v)):window.addEventListener("hashchange",v),i&&ue(i,o,v),v(),n.replaceWith(u),await oe(u,t,o),l++;continue}if(f==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const i=n.getAttribute(":is");n.removeAttribute(":is");const r=document.createComment("component:is");n.replaceWith(r),await o.mountDynamic(r,i,n,t,o),l++;continue}if((T=o.components)!=null&&T[f]&&o.mountElement){await o.mountElement(n,f,t,o),l++;continue}{const i=Array.from(n.attributes).find(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect."));if(i&&typeof IntersectionObserver<"u"){const r=new Set(i.name.split(".").slice(1));n.removeAttribute(i.name);const s=H(i.value,t);let u,m=0,p="0px",b=r.has("once");if(typeof s=="function"?u=v=>s.call(t,v):s&&typeof s=="object"&&(typeof s.handler=="function"&&(u=v=>s.handler.call(t,v)),s.threshold!==void 0&&(m=s.threshold),s.margin&&(p=s.margin),s.once&&(b=!0)),u){const v=new IntersectionObserver(w=>{const P=w[0];u(P),b&&P.isIntersecting&&v.disconnect()},{threshold:m,rootMargin:p});v.observe(n),(d=o.registerCleanup)==null||d.call(o,()=>v.disconnect())}}}if(n.hasAttribute("cv-resize")){const i=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const r=H(i,t);let s,u="content-box";if(typeof r=="function"?s=m=>r.call(t,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(s=m=>r.handler.call(t,m)),r.box&&(u=r.box)),s){const m=new ResizeObserver(p=>{p[0]&&s(p[0])});m.observe(n,{box:u}),(a=o.registerCleanup)==null||a.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const i=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const r=H(i,t);let s,u=0;if(typeof r=="function"?s=m=>r.call(t,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(s=m=>r.handler.call(t,m)),r.throttle&&(u=r.throttle)),s){let m=0;const p=()=>{const b=Date.now();u>0&&b-m<u||(m=b,s({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",p,{passive:!0}),(h=o.registerCleanup)==null||h.call(o,()=>n.removeEventListener("scroll",p))}}if(n.hasAttribute("cv-clickoutside")){const i=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const r=s=>{n.contains(s.target)||(typeof t[i]=="function"?t[i].call(t,s):We(i,t,s))};document.addEventListener("click",r,!0),(A=o.registerCleanup)==null||A.call(o,()=>document.removeEventListener("click",r,!0))}if(n.hasAttribute("cv-bind")){const i=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const r=n.getAttribute("class")??"",s=n.getAttribute("style")??"";let u=[];const m=()=>{const p=H(i,t)??{},b=Object.keys(p);for(const v of u)v in p||(v==="class"?n.className=r:v==="style"?n.style.cssText=s:n.removeAttribute(v));for(const[v,w]of Object.entries(p))v==="class"?n.className=[r,De(w)].filter(Boolean).join(" "):v==="style"?He(n,w,s):w==null||w===!1?n.removeAttribute(v):n.setAttribute(v,w===!0?"":String(w));u=b};K(i,o,m),m()}const j={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(i=>{if(i.name.startsWith("@")||i.name.startsWith("cv:on:")){const r=(i.name.startsWith("@")?i.name.substring(1):i.name.substring(6)).split("."),s=r[0],u=new Set(r.slice(1)),m=[...u].find(w=>w in j),p=i.value,b=w=>{u.has("prevent")&&w.preventDefault(),u.has("stop")&&w.stopPropagation(),!(u.has("self")&&w.target!==w.currentTarget)&&(m&&w.key!==j[m]||(typeof t[p]=="function"?t[p].call(t,w):We(p,t,w)))},v={};u.has("once")&&(v.once=!0),u.has("passive")&&(v.passive=!0),u.has("capture")&&(v.capture=!0),n.addEventListener(s,b,Object.keys(v).length?v:void 0)}else if(i.name.startsWith(":")){const r=i.name.slice(1),s=i.value;if(r==="class"){const u=n.getAttribute("class")??"",m=()=>{n.className=[u,De(H(s,t))].filter(Boolean).join(" ")};K(s,o,m),m()}else if(r==="style"){const u=n.getAttribute("style")??"",m=()=>He(n,H(s,t),u);K(s,o,m),m()}else if(r.includes("-")){const u=()=>{const m=H(s,t);m==null||m===!1?n.removeAttribute(r):n.setAttribute(r,m===!0?"":String(m))};K(s,o,u),u()}else{const u=()=>{n[r]=H(s,t)??""};K(s,o,u),u()}}}),S.hasChildNodes()&&await oe(S,t,o),l++}}var At=`
...
`;function St(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=At,document.head.appendChild(e)}async function ge(e,t,o){e.classList.add(`${t}-${o}`);const c=getComputedStyle(e),l=Math.max(parseFloat(c.animationDuration)||0,parseFloat(c.transitionDuration)||0)*1e3;l>0&&await new Promise(y=>{const E=()=>y();e.addEventListener("animationend",E,{once:!0}),e.addEventListener("transitionend",E,{once:!0}),setTimeout(E,l+50)}),e.classList.remove(`${t}-${o}`)}var we=new Map;async function Et(e){if(typeof e!="function")return e;if(we.has(e))return we.get(e);const t=await e();return we.set(e,t.default),t.default}function Ve(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ge(e,t){if(e==="*")return{};const o=[],c=e.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=t.match(new RegExp(`^${c}$`));return l?Object.fromEntries(o.map((y,E)=>[y,l[E+1]])):null}function _t(e,t){if(e==="/")return{params:{},remaining:t};const o=[],c=e.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=t.match(new RegExp(`^${c}(/.+)?$`));return l?{params:Object.fromEntries(o.map((y,E)=>[y,l[E+1]])),remaining:l[o.length+1]||"/"}:null}function ut(e,t=""){return e.map(o=>{var l;if(o.path==="*")return o;const c=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(l=o.children)!=null&&l.length?{...o,path:c,children:ut(o.children,c==="/"?"":c)}:{...o,path:c}})}var me=(e,t)=>new Promise(o=>e(t,o)),Xe=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Tt(e,t={}){const o=t.mode??"hash",c=$t(t.base??"");return{routes:ut(e),mode:o,base:c,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(l,y){const E=Ye(l,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=E},replace(l,y){const E=Ye(l,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${E}`)}},back(){history.back()},forward(){history.forward()}}}function $t(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function Ct(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Ye(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function Ze(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((c,l)=>{o[l]=c}),o}function Je(e,t,o,c="default",l){const y=t.base??"",E=()=>t.mode==="history"?Ct(window.location.pathname,y):(window.location.hash.slice(1)||"/").split("?")[0]||"/",x=()=>{if(t.mode==="history")return Ze(window.location.search);const a=window.location.hash.slice(1)||"/",h=a.indexOf("?");return h>=0?Ze(a.slice(h+1)):{}};t.transition&&St();let L=null,C=null,k=null,W=null,$=!1;const M=()=>{$||($=!0,l==null||l())},D=new Map,F=a=>{var h;if(a!=null&&a.keepAlive&&k){(h=k.deactivate)==null||h.call(k);const A=document.createDocumentFragment();for(;e.firstChild;)A.appendChild(e.firstChild);D.set(L.path,{fragment:A,activation:k}),k=null}else k==null||k.destroy(),k=null,e.innerHTML=""},I=async(a,h,A,S,n)=>{const f=typeof h=="function"&&!we.has(h),g=f?h.__asyncOptions:void 0,_=a.loadingTemplate??(g==null?void 0:g.loadingTemplate);f&&_&&(e.innerHTML=_);let j;try{j=await Et(h)}catch(i){const r=g==null?void 0:g.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw i}return f&&_&&(e.innerHTML=""),o(e,j,A,S,n)},T=async()=>{var A,S,n,f,g,_,j,i;const a=E(),h=x();for(const r of t.routes){if((A=r.children)!=null&&A.length){const u=_t(r.path,a);if(u!==null)for(const m of r.children){const p=Ge(m.path,a);if(p!==null){const b={params:u.params,query:h,path:a,meta:r.meta};if(m.redirect){const O={params:p,query:h,path:a,meta:m.meta},U=typeof m.redirect=="function"?m.redirect(O):m.redirect;t.navigate(U);return}if(t.beforeEach){const O=await me(t.beforeEach,b);if(O){t.navigate(O);return}}if(r.beforeEnter){const O=await me(r.beforeEnter,b);if(O){t.navigate(O);return}}if(m.beforeEnter){const O={params:p,query:h,path:a,meta:m.meta},U=await me(m.beforeEnter,O);if(U){t.navigate(U);return}}const v=`${r.path}::${JSON.stringify(u.params)}`;if(W!==v){const O=await Xe(k,b);if(O){t.navigate(O);return}const U=r.transition??t.transition;U&&e.hasChildNodes()&&await ge(e,U,"leave"),F(C);const N=Ve(r,c);if(N){const R={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(G,z)=>t.navigate(G,z),replace:(G,z)=>t.replace(G,z),back:()=>t.back(),forward:()=>t.forward()};k=await I(r,N,b,c==="default"?r.layout:void 0,c==="default"?R:void 0),(S=k.enter)==null||S.call(k,L)}else e.innerHTML="";W=v,U&&await ge(e,U,"enter")}const w={params:{...u.params,...p},query:h,path:a,meta:m.meta??r.meta};(n=t.afterEach)==null||n.call(t,w,L);const P=(f=t.scrollBehavior)==null?void 0:f.call(t,w,L);P&&window.scrollTo(P.x??0,P.y??0),L=w,C=r,M();return}}}const s=Ge(r.path,a);if(s!==null){W=null;const u={params:s,query:h,path:a,meta:r.meta};if(r.redirect){const w=typeof r.redirect=="function"?r.redirect(u):r.redirect;t.navigate(w);return}if(t.beforeEach){const w=await me(t.beforeEach,u);if(w){t.navigate(w);return}}if(r.beforeEnter){const w=await me(r.beforeEnter,u);if(w){t.navigate(w);return}}const m=await Xe(k,u);if(m){t.navigate(m);return}const p=r.transition??t.transition;p&&e.hasChildNodes()&&await ge(e,p,"leave"),F(C);const b=Ve(r,c);if(b){const w=u.path;if(r.keepAlive&&D.has(w)){const P=D.get(w);e.appendChild(P.fragment),k=P.activation,(g=k.activate)==null||g.call(k),D.delete(w)}else{const P=L;k=await I(r,b,u,c==="default"?r.layout:void 0),(_=k.enter)==null||_.call(k,P)}}else e.innerHTML="",k=null;p&&await ge(e,p,"enter"),(j=t.afterEach)==null||j.call(t,u,L);const v=(i=t.scrollBehavior)==null?void 0:i.call(t,u,L);v&&window.scrollTo(v.x??0,v.y??0),L=u,C=r,M();return}}W=null,F(C),C=null,M()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,T),T(),()=>{window.removeEventListener(d,T),k==null||k.destroy(),k=null,D.forEach(({activation:a})=>a.destroy()),D.clear()}}function Ft(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,c){return e.has(o)||e.set(o,new Set),e.get(o).add(c),()=>{var l;return(l=e.get(o))==null?void 0:l.delete(c)}},_emit(o,c){var l;(l=e.get(o))==null||l.forEach(y=>{try{y(c)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const c=this.instances.findIndex(l=>l.id===o);if(c!==-1){const l=this.instances[c];this.instances.splice(c,1),this._emit("destroy",l)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Ot=0;function jt(){return++Ot}var Lt=`
...
`;function Pt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Lt,document.head.appendChild(e)}function be(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function Ke(e){try{return JSON.parse(e)}catch{return e}}function Dt(e){if(typeof document>"u")return;Pt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,c="components",l=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(y);const E=document.createElement("div");E.id="cvd-panel",E.style.display="none",t.appendChild(E),E.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const x=E.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",E.style.display="flex",W()}),E.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,E.style.display="none",y.style.display=""}),E.querySelectorAll(".cvd-tab").forEach($=>{$.addEventListener("click",()=>{c=$.dataset.tab,E.querySelectorAll(".cvd-tab").forEach(M=>M.classList.remove("active")),$.classList.add("active"),W()})});const L=E.querySelector("#cvd-head");L.addEventListener("pointerdown",$=>{if($.target.closest("button"))return;L.setPointerCapture($.pointerId);const M=$.clientX,D=$.clientY,F=t.offsetLeft,I=t.offsetTop,T=a=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${F+(a.clientX-M)}px`,t.style.top=`${I+(a.clientY-D)}px`},d=a=>{L.releasePointerCapture(a.pointerId),L.removeEventListener("pointermove",T),L.removeEventListener("pointerup",d),L.removeEventListener("pointercancel",d)};L.addEventListener("pointermove",T),L.addEventListener("pointerup",d),L.addEventListener("pointercancel",d)});function C(){const $=e.instances;if(!$.length){x.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}x.innerHTML=$.map(M=>{const D=M.getState(),F=Object.keys(D);return`
            ...
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(M=>{M.addEventListener("click",()=>{const D=M.closest(".cvd-inst"),F=parseInt(D.dataset.id);l.has(F)?l.delete(F):l.add(F),D.classList.toggle("open")})}),x.querySelectorAll(".cvd-val").forEach(M=>{M.addEventListener("click",D=>{D.stopPropagation();const F=M;if(F.querySelector("input"))return;const I=parseInt(F.dataset.inst),T=F.dataset.key,d=e.instances.find(S=>S.id===I);if(!d)return;const a=be(d.getState()[T]);F.classList.add("editing"),F.innerHTML=`<input class="cvd-edit" value='${a.replace(/'/g,"&#39;")}'>`;const h=F.querySelector("input");h.focus(),h.select();const A=()=>{d.setState(T,Ke(h.value)),F.classList.remove("editing")};h.addEventListener("blur",A),h.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),A()),S.key==="Escape"&&(F.classList.remove("editing"),W())})})})}function k(){if(!e.stores.length){x.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}x.innerHTML=e.stores.map(($,M)=>{const D=$.getState(),F=Object.keys(D);return`
            ...
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach($=>{$.addEventListener("click",()=>$.closest(".cvd-inst").classList.toggle("open"))}),x.querySelectorAll("[data-store][data-key]").forEach($=>{$.addEventListener("click",M=>{M.stopPropagation();const D=$;if(D.querySelector("input"))return;const F=parseInt(D.dataset.store),I=D.dataset.key,T=e.stores[F];if(!T)return;const d=be(T.getState()[I]);D.classList.add("editing"),D.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const a=D.querySelector("input");a.focus(),a.select();const h=()=>{T.setState(I,Ke(a.value)),D.classList.remove("editing")};a.addEventListener("blur",h),a.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),h()),A.key==="Escape"&&(D.classList.remove("editing"),W())})})})}function W(){o&&(c==="components"?C():k())}e.on("mount",()=>W()),e.on("update",()=>W()),e.on("destroy",()=>W()),e.on("store-update",()=>W())}var Mt="__COURVUX_HEAD_COLLECTOR__";function It(){return globalThis[Mt]??null}var Rt=(e,t)=>{Object.entries(t).forEach(([o,c])=>{o!=="innerHTML"&&(c==null||c===!1||e.setAttribute(o,c===!0?"":String(c)))})},zt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Nt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,c])=>e.setAttribute(o,c))},Qe=(e,t,o,c)=>{let l=o?document.head.querySelector(o):null;l?(c.push({el:l,prevAttrs:zt(l),created:!1}),Array.from(l.attributes).forEach(y=>l.removeAttribute(y.name))):(l=document.createElement(e),document.head.appendChild(l),c.push({el:l,created:!0})),Rt(l,t)};function Ht(e){var E,x,L;const t=It();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let c;const l={},y={};if(e.title!==void 0){c=document.title;const C=e.titleTemplate,k=typeof C=="function"?C(e.title):typeof C=="string"?C.replace("%s",e.title):e.title;document.title=k}return(E=e.meta)==null||E.forEach(C=>{Qe("meta",C,C.name?`meta[name="${CSS.escape(C.name)}"]`:C.property?`meta[property="${CSS.escape(C.property)}"]`:C["http-equiv"]?`meta[http-equiv="${CSS.escape(C["http-equiv"])}"]`:null,o)}),(x=e.link)==null||x.forEach(C=>{Qe("link",C,C.rel==="canonical"?'link[rel="canonical"]':C.rel&&C.href?`link[rel="${CSS.escape(C.rel)}"][href="${CSS.escape(C.href)}"]`:null,o)}),(L=e.script)==null||L.forEach(C=>{const k=document.createElement("script");Object.entries(C).forEach(([W,$])=>{W==="innerHTML"?k.textContent=String($):$!=null&&$!==!1&&k.setAttribute(W,$===!0?"":String($))}),document.head.appendChild(k),o.push({el:k,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([C,k])=>{l[C]=document.documentElement.getAttribute(C),document.documentElement.setAttribute(C,k)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([C,k])=>{y[C]=document.body.getAttribute(C),document.body.setAttribute(C,k)}),function(){c!==void 0&&(document.title=c),o.forEach(({el:C,prevAttrs:k,created:W})=>{var $;W?($=C.parentNode)==null||$.removeChild(C):k&&Nt(C,k)}),Object.entries(l).forEach(([C,k])=>{k===null?document.documentElement.removeAttribute(C):document.documentElement.setAttribute(C,k)}),Object.entries(y).forEach(([C,k])=>{k===null?document.body.removeAttribute(C):document.body.setAttribute(C,k)})}}var Fe="data-courvux-ssr",Wt=e=>e?Promise.resolve().then(e):Promise.resolve();function et(e,t){const o=e.trim();if(o.startsWith("{")){const c=o.replace(/[{}]/g,"").split(",").map(l=>l.trim()).filter(Boolean);return Object.fromEntries(c.map(l=>[l,t[l]]))}return{[o]:t}}var ye=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var A,S,n;const c={},{subscribe:l,createReactiveState:y,registerSetInterceptor:E,notifyAll:x}=Pe();let L;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),L=await t.data()):L=t.data??{},t.templateUrl){const f=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,g=await fetch(f);if(!g.ok)throw new Error(`Failed to load template: ${f} (${g.status})`);e.innerHTML=await g.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Fe),(A=e.querySelector(`[${Fe}]`))==null||A.removeAttribute(Fe);const C={};if(t.inject&&o.provided){const f=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(g=>[g,g])):t.inject;Object.entries(f).forEach(([g,_])=>{o.provided&&_ in o.provided&&(C[g]=o.provided[_])})}const k=y({...o.globalProperties??{},...L,...C,...t.methods,$refs:c,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(f=>[f,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});k.$watch=(f,g,_)=>{const j=(_==null?void 0:_.deep)??!1,i=(_==null?void 0:_.immediate)??!1;let r=j?ye(k[f]):k[f];const s=l(f,()=>{const u=k[f];g.call(k,u,r),r=j?ye(u):u});return i&&g.call(k,k[f],void 0),s},k.$batch=yt,k.$nextTick=f=>Wt(f),k.$dispatch=(f,g,_)=>{e.dispatchEvent(new CustomEvent(f,{bubbles:!0,composed:!0,..._??{},detail:g}))},o.magics&&Object.entries(o.magics).forEach(([f,g])=>{k[f]=g(k)}),k.$forceUpdate=()=>x();const W=[];k.$watchEffect=f=>{let g=[];const _=()=>{g.forEach(s=>s()),g=[];const i=Ie(()=>{try{f()}catch{}}),r=new Map;for(const{sub:s,key:u}of i)r.has(s)||r.set(s,new Set),!r.get(s).has(u)&&(r.get(s).add(u),g.push(s(u,_)))};_();const j=()=>{g.forEach(r=>r()),g=[];const i=W.indexOf(j);i>-1&&W.splice(i,1)};return W.push(j),j};const $=[];t.computed&&Object.entries(t.computed).forEach(([f,g])=>{const _=typeof g=="function"?g:g.get,j=typeof g!="function"?g.set:void 0;let i=[];const r=()=>{i.forEach(p=>p()),i=[];let s;const u=Ie(()=>{try{s=_.call(k)}catch(p){(t.debug??o.debug)&&console.warn("[courvux] computed error:",p)}});k[f]=s;const m=new Map;for(const{sub:p,key:b}of u)m.has(p)||m.set(p,new Set),!m.get(p).has(b)&&(m.get(p).add(b),i.push(p(b,r)))};r(),$.push(()=>i.forEach(s=>s())),j&&E(f,s=>j.call(k,s))});const M=[];t.watch&&Object.entries(t.watch).forEach(([f,g])=>{const _=typeof g=="object"&&g!==null&&"handler"in g,j=_?g.handler:g,i=_?g.immediate??!1:!1,r=_?g.deep??!1:!1;let s=r?ye(k[f]):k[f];const u=l(f,()=>{const m=k[f];j.call(k,m,s),s=r?ye(m):m});M.push(u),i&&j.call(k,k[f],void 0)});const D={...o.provided??{}};if(t.provide){const f=typeof t.provide=="function"?t.provide.call(k):t.provide;Object.assign(D,f)}const F={...o,provided:D,components:{...o.components,...t.components}};F.mountElement=Ae(F),F.createChildScope=(f,g)=>{const _=new Set(Object.keys(f)),j=new Set(Object.keys(g)),{subscribe:i,createReactiveState:r}=Pe(),s=r(f);let u;return u=new Proxy({},{get(m,p){return typeof p!="string"?k[p]:_.has(p)?s[p]:j.has(p)?g[p].bind(u):k[p]},set(m,p,b){return typeof p!="string"?!1:_.has(p)?(s[p]=b,!0):(k[p]=b,!0)},has(m,p){return _.has(p)||j.has(p)||p in k},ownKeys(){return[..._,...j,...Object.keys(k)]},getOwnPropertyDescriptor(m,p){return _.has(p)||j.has(p)||p in k?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:u,subscribe:(m,p)=>_.has(m)?i(m,p):d(m,p),cleanup:()=>{}}},F.mountDynamic=async(f,g,_,j,i)=>{let r=null,s=null;const u=_.getAttribute("loading-template")??"",m=async()=>{var N,R,G;s==null||s(),s=null,r!=null&&r.parentNode&&(r.parentNode.removeChild(r),r=null);const p=H(g,j);if(!p)return;let b;if(typeof p=="function"){if(u){const z=document.createElement("div");z.innerHTML=u,(N=f.parentNode)==null||N.insertBefore(z,f.nextSibling),r=z}b=(await p()).default,r!=null&&r.parentNode&&(r.parentNode.removeChild(r),r=null)}else typeof p=="string"?b=(R=F.components)==null?void 0:R[p]:p&&typeof p=="object"&&(b=p);if(!b)return;const v=document.createElement("div");Array.from(_.attributes).forEach(z=>v.setAttribute(z.name,z.value)),v.innerHTML=_.innerHTML;const w={},P={};Array.from(_.attributes).forEach(z=>{if(z.name.startsWith(":"))w[z.name.slice(1)]=H(z.value,j);else if(z.name.startsWith("@")||z.name.startsWith("cv:on:")){const q=z.value,Q=z.name.startsWith("@")?z.name.slice(1):z.name.slice(6);P[Q]=(...V)=>{typeof j[q]=="function"&&j[q].call(j,...V)}}});const O={...b,data:{...b.data,...w},methods:{...b.methods,$emit(z,...q){var Q;pt(b,z,q),(Q=P[z])==null||Q.call(P,...q)}}},U={...F,components:{...F.components,...b.components}};U.mountElement=Ae(U),s=(await ne(v,O,U)).destroy,(G=f.parentNode)==null||G.insertBefore(v,f.nextSibling),r=v};K(g,i,m),await m()};const I=[];k.$addCleanup=f=>{I.push(f)};let T=!1;const d=(f,g)=>!t.onBeforeUpdate&&!t.onUpdated?l(f,g):l(f,()=>{var _;T||(T=!0,(_=t.onBeforeUpdate)==null||_.call(k),Promise.resolve().then(()=>{var j;T=!1,(j=t.onUpdated)==null||j.call(k)})),g()});try{(S=t.onBeforeMount)==null||S.call(k),await oe(e,k,{subscribe:d,refs:c,...F,registerCleanup:f=>I.push(f)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(k)}catch(f){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(k,f);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(f,k,t.name??e.tagName.toLowerCase());else throw f}const a=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,h=a?jt():0;if(a){const f=k,g=new Set,_={id:h,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const j={};for(const i of Object.keys(f))if(!(i.startsWith("$")||typeof f[i]=="function"))try{j[i]=f[i]}catch{}return j},setState:(j,i)=>{f[j]=i},subscribe:j=>(g.add(j),()=>g.delete(j)),children:[]};Object.keys(f).filter(j=>!j.startsWith("$")&&typeof f[j]!="function").forEach(j=>{l(j,()=>{a._emit("update",_),g.forEach(i=>i())})}),a._registerInstance(_),I.push(()=>a._unregisterInstance(h))}return{state:k,destroy:()=>{var f,g;(f=t.onBeforeUnmount)==null||f.call(k),$.forEach(_=>_()),M.forEach(_=>_()),W.forEach(_=>_()),I.forEach(_=>_()),(g=t.onDestroy)==null||g.call(k)},activate:()=>{var f;(f=t.onActivated)==null||f.call(k)},deactivate:()=>{var f;(f=t.onDeactivated)==null||f.call(k)},beforeLeave:t.onBeforeRouteLeave?(f,g)=>t.onBeforeRouteLeave.call(k,f,g):void 0,enter:t.onBeforeRouteEnter?f=>t.onBeforeRouteEnter.call(k,f):void 0}}function pt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const c=e.emits[t];typeof c=="function"&&!c(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ae(e){return async(t,o,c,l)=>{const y=e.components[o],E=t.getAttribute("cv-ref");E&&t.removeAttribute("cv-ref");const x={},L=[],C={};Array.from(t.attributes).filter(T=>T.name==="cv-model"||T.name.startsWith("cv-model.")||T.name.startsWith("cv-model:")).forEach(T=>{t.removeAttribute(T.name);const d=T.value,a=T.name.indexOf(":"),h=a>=0?T.name.slice(a+1).split(".")[0]:"modelValue",A=h==="modelValue"?"update:modelValue":`update:${h}`;x[h]=$e(H(d,c)),L.push({propName:h,expr:d}),C[A]=S=>{le(d,c,S)}});const k={};Array.from(t.attributes).forEach(T=>{const d=T.name.startsWith(":"),a=T.name.startsWith("@")||T.name.startsWith("cv:on:"),h=T.name==="cv-model"||T.name.startsWith("cv-model.")||T.name.startsWith("cv-model:"),A=T.name.startsWith("v-slot"),S=T.name==="slot";!d&&!a&&!h&&!A&&!S&&(k[T.name]=T.value)}),y.inheritAttrs===!1&&Object.keys(k).forEach(T=>t.removeAttribute(T)),Array.from(t.attributes).forEach(T=>{if(T.name.startsWith(":")){const d=T.name.slice(1),a=T.value;x[d]=$e(H(a,c)),L.push({propName:d,expr:a})}else if(T.name.startsWith("@")||T.name.startsWith("cv:on:")){const d=T.name.startsWith("@")?T.name.slice(1):T.name.slice(6),a=T.value;C[d]=(...h)=>{typeof c[a]=="function"&&c[a].call(c,...h)}}});const W=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");W&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const $=new Map,M=[];Array.from(t.childNodes).forEach(T=>{const d=T.nodeType===1?T.getAttribute("slot"):null;if(d){if(!$.has(d)){const a=t.getAttribute(`v-slot:${d}`)??null;a&&t.removeAttribute(`v-slot:${d}`),$.set(d,{nodes:[],vSlot:a})}$.get(d).nodes.push(T.cloneNode(!0))}else M.push(T.cloneNode(!0))});const D={};M.some(T=>{var d;return T.nodeType===1||T.nodeType===3&&(((d=T.textContent)==null?void 0:d.trim())??"")!==""})&&(D.default=async T=>{const d=W?{...c,...et(W,T)}:c,a=document.createDocumentFragment();return M.forEach(h=>a.appendChild(h.cloneNode(!0))),await oe(a,d,l),Array.from(a.childNodes)});for(const[T,{nodes:d,vSlot:a}]of $)D[T]=async h=>{const A=a?{...c,...et(a,h)}:c,S=document.createDocumentFragment();return d.forEach(n=>S.appendChild(n.cloneNode(!0))),await oe(S,A,l),Array.from(S.childNodes)};const F={...e,components:{...e.components,...y.components},slots:D};F.mountElement=Ae(F);const{state:I}=await ne(t,{...y,data:{...y.data,...x,$attrs:k,$parent:c},methods:{...y.methods,$emit(T,...d){var a;pt(y,T,d),(a=C[T])==null||a.call(C,...d)}}},F);I&&(L.forEach(({propName:T,expr:d})=>{ue(d,{...l,subscribe:l.subscribe},()=>{I[T]=$e(H(d,c))})}),E&&l.refs&&(l.refs[E]=I))}}function Ut(e){wt();const t=typeof window<"u"?Ft():void 0,o=[],c={...e.directives},l={...e.components??{}},y=[],E=new Map,x={},L=new Map;if(e.debug&&t&&Dt(t),t&&e.store){const $=e.store,M=Object.keys($).filter(D=>typeof $[D]!="function");t._registerStore({getState(){const D={};return M.forEach(F=>{try{D[F]=$[F]}catch{}}),D},setState(D,F){$[D]=F},subscribe(D){const F=M.map(I=>{try{return ve($,I,D)}catch{return()=>{}}});return()=>F.forEach(I=>I())}})}const C={router:e.router,use($){return o.includes($)||(o.push($),$.install(C)),C},directive($,M){return c[$]=M,C},component($,M){return l[$]=M,C},provide($,M){return typeof $=="string"?x[$]=M:Object.assign(x,$),C},magic($,M){return L.set(`$${$}`,M),C},mount:async $=>(await W($),C),mountAll:async($="[data-courvux]")=>{const M=Array.from(document.querySelectorAll($));return await Promise.all(M.map(D=>k(D))),C},mountEl:async $=>k($),unmount($){if(!$)y.forEach(M=>M()),y.length=0,E.clear();else{const M=document.querySelector($);if(M){const D=E.get(M);if(D){D(),E.delete(M);const F=y.indexOf(D);F>-1&&y.splice(F,1)}}}return C},destroy(){y.forEach($=>$()),y.length=0,E.clear()}},k=async $=>{const M=new URL(".",document.baseURI).href,D={components:l,router:e.router,store:e.store,directives:c,baseUrl:M,provided:{...x},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:L.size?Object.fromEntries(L):void 0};if(D.mountElement=Ae(D),e.router){const I=e.router;D.mountRouterView=async(T,d)=>{await new Promise(a=>{Je(T,I,async(h,A,S,n,f)=>{const g={...D,currentRoute:S};if(f){let _=null;const j={...g,mountRouterView:async(i,r)=>{_=Je(i,f,async(s,u,m,p)=>{const b={...g,currentRoute:m};if(p){let v=null;const w={...b,mountRouterView:async(O,U)=>{v=await ne(O,u,b)}},{destroy:P}=await ne(s,{template:p},w);return{destroy:()=>{v==null||v.destroy(),P()},activate:()=>v==null?void 0:v.activate(),deactivate:()=>v==null?void 0:v.deactivate()}}else return await ne(s,u,b)},r)}};if(n){let i=null;const r={...j,mountRouterView:async(u,m)=>{i=await ne(u,A,j)}},{destroy:s}=await ne(h,{template:n},r);return{destroy:()=>{_==null||_(),i==null||i.destroy(),s()},activate:()=>i==null?void 0:i.activate(),deactivate:()=>i==null?void 0:i.deactivate()}}else{const i=await ne(h,A,j);return{destroy:()=>{_==null||_(),i.destroy()},activate:()=>i.activate(),deactivate:()=>i.deactivate()}}}else if(n){let _=null;const j={...g,mountRouterView:async(r,s)=>{_=await ne(r,A,g)}},{destroy:i}=await ne(h,{template:n},j);return{destroy:()=>{_==null||_.destroy(),i()},activate:()=>_==null?void 0:_.activate(),deactivate:()=>_==null?void 0:_.deactivate()}}else return await ne(h,A,g)},d,a)})}}const F=await ne($,e,D);return y.push(F.destroy),E.set($,F.destroy),F.state},W=async $=>{const M=document.querySelector($);if(M)return k(M)};return C}var tt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Bt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Oe={exports:{}},ot;function qt(){return ot||(ot=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
pnpm add github:vanjexdev/courvux#v0.4.2`,s2:`<script type="importmap">
{
  "imports": {
