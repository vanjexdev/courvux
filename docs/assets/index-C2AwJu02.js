(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const p of s)if(p.type==="childList")for(const k of p.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&i(k)}).observe(document,{childList:!0,subtree:!0});function o(s){const p={};return s.integrity&&(p.integrity=s.integrity),s.referrerPolicy&&(p.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?p.credentials="include":s.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function i(s){if(s.ep)return;s.ep=!0;const p=o(s);fetch(s.href,p)}})();var Ct=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),ft=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,Me=new WeakSet,Te=Symbol("raw"),Pe=e=>e===null||typeof e!="object"?e:e[Te]??e,Ae=0,Re=new Map,be=null;function Ue(e){const t=[],o=be;be=t;try{e()}finally{be=o}return t}function Tt(e){Ae++;try{e()}finally{if(Ae--,Ae===0){const t=[...Re.values()];Re.clear(),t.forEach(o=>o())}}}function gt(e,t){return e===null||typeof e!="object"||Me.has(e)||ft(e)?e:new Proxy(e,{get(o,i){if(i===Te)return o[Te]??o;if(typeof i=="string"&&Array.isArray(o)&&Ct.has(i))return(...p)=>{const k=Array.prototype[i].apply(o,p);return t(),k};const s=o[i];return s!==null&&typeof s=="object"&&!Me.has(s)?gt(s,t):s},set(o,i,s){return o[i]=s,t(),!0}})}function ze(){const e={},t=Math.random().toString(36).slice(2),o=(p,k)=>(e[p]||(e[p]=new Set),e[p].add(k),()=>{var g;(g=e[p])==null||g.delete(k)}),i=p=>{Ae>0?Re.set(`${t}:${p}`,()=>{(e[p]?[...e[p]]:[]).forEach(k=>k())}):(e[p]?[...e[p]]:[]).forEach(k=>k())},s={};return{subscribe:o,createReactiveState:p=>new Proxy(p,{get(k,g){if(g===Te)return p;typeof g=="string"&&!g.startsWith("$")&&be&&be.push({sub:o,key:g});const P=k[g];return typeof g=="string"&&!g.startsWith("$")&&P!==null&&typeof P=="object"&&!Me.has(P)&&!ft(P)?gt(P,()=>i(g)):P},set(k,g,P){if(s[g])return s[g](P),!0;const $=k[g];return k[g]=P,($!==P||P!==null&&typeof P=="object")&&i(g),!0}}),registerSetInterceptor:(p,k)=>{s[p]=k},notifyAll:()=>{Object.keys(e).forEach(p=>i(p))}}}var De=new WeakMap;function ye(e,t,o){var s,p;const i=t.indexOf(".");if(i>=0){const k=t.slice(0,i),g=t.slice(i+1),P=e[k];return P&&De.has(P)?ye(P,g,o):((s=De.get(e))==null?void 0:s(k,o))??(()=>{})}return((p=De.get(e))==null?void 0:p(t,o))??(()=>{})}var vt=(e,t)=>e.split(".").reduce((o,i)=>o==null?void 0:o[i],t),Be=!1,xe=!1,We=()=>{if(Be)return xe;Be=!0;try{new Function("return 1")(),xe=!0}catch{console.warn("[courvux] CSP blocks eval. Falling back to a limited evaluator that handles property access and literals only. Add `vite-plugin-courvux-precompile` to your build for full template support under strict CSP."),xe=!1}return xe},Ve=new Map,Ge=new Map,he=new WeakMap,Et=(e,t)=>{const o=he.get(e);o?Object.assign(o,t):he.set(e,{...t})},_e=(e,t)=>{const o=he.get(t);o&&he.set(e,o)},bt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!bt(o.slice(1).trim(),t):vt(o,t)},W=(e,t)=>{var i;const o=(i=he.get(t))==null?void 0:i[e];if(o)try{return o(t)}catch{}if(!We())return bt(e,t);try{let s=Ve.get(e);return s||(s=new Function("$data",`with($data) { return (${e}) }`),Ve.set(e,s)),s(t)}catch{return vt(e,t)}},yt=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):ye(t.store,e.slice(7),o):t.subscribe(e,o),Z=(e,t,o)=>{const i=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),s=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],p=[...new Set(s.map(g=>g.startsWith("$store.")?g:g.split(".")[0]).filter(g=>!i.has(g)))];if(p.length===0)return()=>{};const k=p.map(g=>yt(g,t,o));return()=>k.forEach(g=>g())},Ye=new Map,$t=e=>{const t=Ye.get(e);if(t)return t;const o=e.trim();let i=0,s=-1,p=null;for(let g=0;g<o.length;g++){const P=o[g];P==="["?(i===0&&(s=g,p="bracket"),i++):P==="]"?i--:P==="."&&i===0&&(s=g,p="dot")}let k;if(s<0)k={parent:"",keyExpr:JSON.stringify(o)};else if(p==="dot")k={parent:o.slice(0,s),keyExpr:JSON.stringify(o.slice(s+1))};else{const g=o.lastIndexOf("]");k=g>s?{parent:o.slice(0,s),keyExpr:o.slice(s+1,g)}:{parent:"",keyExpr:JSON.stringify(o)}}return Ye.set(e,k),k},pe=(e,t,o)=>{if(We())try{const{parent:s,keyExpr:p}=$t(e),k=s?W(s,t):t,g=W(p,t);if(k==null)return;k[g]=o;return}catch(s){console.warn(`[courvux] setStateValue: write failed for "${e}":`,s);return}const i=e.split(".");if(i.length===1)t[i[0]]=o;else{const s=i.slice(0,-1).reduce((p,k)=>p==null?void 0:p[k],t);s&&(s[i[i.length-1]]=o)}},Xe=(e,t,o,i,s)=>{const p={};return Object.keys(e).forEach(k=>p[k]=e[k]),p[o]=t,s&&(p[s]=i),_e(p,e),p},He=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(He).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Je=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([i,s])=>{e.style[i]=s??""}))},Ze=(e,t,o)=>{var s;const i=(s=he.get(t))==null?void 0:s[e];if(i)try{i(new Proxy(t,{get(p,k){return k==="$event"?o:p[k]},set(p,k,g){return p[k]=g,!0},has(p,k){return!0}}));return}catch(p){console.warn(`[courvux] handler error "${e}":`,p);return}if(We())try{let p=Ge.get(e);p||(p=new Function("__p__",`with(__p__){${e}}`),Ge.set(e,p));const k=new Proxy({},{has:()=>!0,get:(g,P)=>P==="$event"?o:P in t?t[P]:globalThis[P],set:(g,P,$)=>(t[P]=$,!0)});p(k)}catch(p){console.warn(`[courvux] handler error "${e}":`,p)}},ce=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(i=>{const s=()=>i();e.addEventListener("animationend",s,{once:!0}),e.addEventListener("transitionend",s,{once:!0}),setTimeout(s,o+50)})},jt=`
...
`,Ke=!1;function Qe(){if(Ke||typeof document>"u")return;Ke=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=jt,document.head.appendChild(e)}var et=!1;function Ot(){if(et||typeof document>"u")return;et=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function Ft(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(i=>{(i.name.startsWith("on")||i.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(i.name)})}),t.body.innerHTML}async function te(e,t,o){var p,k,g,P,$,_,L,E,M,z,j,R,C,c,d,m,w;const i=Array.from(e.childNodes);let s=0;for(;s<i.length;){const S=i[s];if(S.nodeType===3){const a=S.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,f=()=>{let h=r;l.forEach(u=>{const v=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");h=h.replace(u,W(v,t)??"")}),S.textContent=h};l.forEach(h=>{Z(h.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,f)}),f()}s++;continue}if(S.nodeType!==1){s++;continue}const n=S,y=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),s++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await te(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),s++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await te(n,t,o),l.appendChild(n),s++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(v=>W(v.trim(),t));let r=l();const f=[],h=v=>(f.push(v),()=>{const b=f.indexOf(v);b>-1&&f.splice(b,1)});await te(n,t,{...o,subscribe:(v,b)=>h(b),storeSubscribeOverride:(v,b,T)=>h(T)});const u=Z(a,o,()=>{const v=l();v.some((b,T)=>b!==r[T])&&(r=v,[...f].forEach(b=>b()))});(p=o.registerCleanup)==null||p.call(o,()=>u()),s++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const f=W(a,t)??{};Object.entries(f).forEach(([h,u])=>{typeof u=="function"?r[h]=u:l[h]=u})}else if(a){const f=(k=o.components)==null?void 0:k[a];if(f){const h=typeof f.data=="function"?f.data():f.data??{};h instanceof Promise||Object.assign(l,h),Object.assign(r,f.methods??{})}}if(o.createChildScope){const f=o.createChildScope(l,r);(g=o.registerCleanup)==null||g.call(o,f.cleanup),_e(f.state,t),await te(n,f.state,{...o,subscribe:f.subscribe})}else{const f={...t,...l,...r};_e(f,t),await te(n,f,o)}s++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,f,h]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const v=n.getAttribute("cv-transition")??null;v&&n.removeAttribute("cv-transition");const b=document.createComment(`cv-for: ${h}`);n.replaceWith(b);let T=[],O=[];const F=new Map;let q=!1,N=!1;const I=async()=>{var K;const U=W(h,t),H=U?typeof U=="number"?Array.from({length:U},(V,B)=>[B+1,B]):Array.isArray(U)?U.map((V,B)=>[V,B]):Object.entries(U).map(([V,B])=>[B,V]):[];if(u){const V=[],B=new Map,de=new Set;for(const[J,Y]of H){const ae=W(u,Xe(t,J,r,Y,f));de.has(ae)&&console.warn(`[courvux] cv-for: duplicate :key "${ae}" in "${h}"`),de.add(ae),V.push(ae),B.set(ae,[J,Y])}const Q=[];for(const[J,{el:Y,destroy:ae}]of F)B.has(J)||(v?(Y.classList.add(`${v}-leave`),Q.push(ce(Y).then(()=>{var ie;Y.classList.remove(`${v}-leave`),ae(),(ie=Y.parentNode)==null||ie.removeChild(Y),F.delete(J)}))):(ae(),(K=Y.parentNode)==null||K.removeChild(Y),F.delete(J)));Q.length&&await Promise.all(Q);const re=b.parentNode,se=[];for(const J of V){const[Y,ae]=B.get(J);if(F.has(J)){const ie=F.get(J);ie.itemRef!==Y&&(ie.reactive[r]=Y,ie.itemRef=Y),f&&(ie.reactive[f]=ae)}else{const ie=n.cloneNode(!0),$e=[],{subscribe:St,createReactiveState:At}=ze(),je=At({[r]:Y,...f?{[f]:ae}:{}}),qe=new Proxy({},{has(le,ee){return!0},get(le,ee){return typeof ee!="string"?t[ee]:ee===r||f&&ee===f?je[ee]:t[ee]},set(le,ee,ue){return ee===r||f&&ee===f?(je[ee]=ue,!0):(t[ee]=ue,!0)}});_e(qe,t);const _t={...o,subscribe:(le,ee)=>{const ue=le.split(".")[0];let me;return ue===r||f&&ue===f?me=St(ue,ee):me=o.subscribe(le,ee),$e.push(me),me},storeSubscribeOverride:(le,ee,ue)=>{const me=ye(le,ee,ue);return $e.push(me),me}},Oe=document.createDocumentFragment();Oe.appendChild(ie),await te(Oe,qe,_t);const Fe=Oe.firstChild??ie;v&&Fe.classList.add(`${v}-enter`),F.set(J,{el:Fe,reactive:je,itemRef:Y,destroy:()=>$e.forEach(le=>le())}),v&&se.push(Fe)}}let oe=b.nextSibling,fe=0;for(const J of V){const{el:Y}=F.get(J);Y!==oe?fe++:oe=Y.nextSibling}if(fe>0)if(fe>V.length>>1){const J=document.createDocumentFragment();for(const Y of V)J.appendChild(F.get(Y).el);re.insertBefore(J,b.nextSibling)}else{oe=b.nextSibling;for(const J of V){const{el:Y}=F.get(J);Y!==oe?re.insertBefore(Y,oe):oe=Y.nextSibling}}T=V.map(J=>F.get(J).el),se.length&&Promise.all(se.map(J=>ce(J).then(()=>J.classList.remove(`${v}-enter`))))}else{if(O.forEach(Q=>Q()),O=[],T.forEach(Q=>{var re;return(re=Q.parentNode)==null?void 0:re.removeChild(Q)}),T=[],!H.length)return;const V=b.parentNode,B=b.nextSibling,de={...o,subscribe:(Q,re)=>{const se=o.subscribe(Q,re);return O.push(se),se},storeSubscribeOverride:(Q,re,se)=>{const oe=ye(Q,re,se);return O.push(oe),oe}};for(const[Q,re]of H){const se=n.cloneNode(!0),oe=document.createDocumentFragment();oe.appendChild(se),await te(oe,Xe(t,Q,r,re,f),de);const fe=oe.firstChild??se;V.insertBefore(oe,B),T.push(fe)}}},G=async()=>{if(q){N=!0;return}q=!0;try{for(await I();N;)N=!1,await I()}finally{q=!1}};(P=o.registerCleanup)==null||P.call(o,()=>{F.forEach(({el:U,destroy:H})=>{var K;H(),(K=U.parentNode)==null||K.removeChild(U)}),F.clear(),O.forEach(U=>U()),T.forEach(U=>{var H;return(H=U.parentNode)==null?void 0:H.removeChild(U)}),T=[]}),Z(h,o,G),await G()}s++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let f=s+1;for(;f<i.length;){const T=i[f];if(T.nodeType===3&&((($=T.textContent)==null?void 0:$.trim())??"")===""){f++;continue}if(T.nodeType!==1)break;const O=T;if(O.hasAttribute("cv-else-if")){const F=O.getAttribute("cv-else-if");O.removeAttribute("cv-else-if");const q=document.createComment("cv-else-if");O.replaceWith(q),a.push({condition:F,template:O,anchor:q}),f++;continue}if(O.hasAttribute("cv-else")){O.removeAttribute("cv-else");const F=document.createComment("cv-else");O.replaceWith(F),a.push({condition:null,template:O,anchor:F}),f++;break}break}s=f;let h=null,u=!1,v=!1;const b=async()=>{var T,O;if(u){v=!0;return}u=!0;try{do{v=!1,h&&((T=h.parentNode)==null||T.removeChild(h),h=null);for(const F of a)if(F.condition===null||W(F.condition,t)){const q=F.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(q),await te(N,t,o);const I=N.firstChild??q;(O=F.anchor.parentNode)==null||O.insertBefore(N,F.anchor.nextSibling),h=I;break}}while(v)}finally{u=!1}};a.filter(T=>T.condition).forEach(T=>{Z(T.condition,o,b)}),await b();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=I=>(n.getAttribute(I)??"").split(" ").filter(Boolean),f=r("cv-transition:enter"),h=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),v=r("cv-transition:leave"),b=r("cv-transition:leave-start"),T=r("cv-transition:leave-end"),O=n.getAttribute("cv-transition")??"",F=new Set(O.split(".").slice(1)),q=[...F].find(I=>/^\d+$/.test(I)),N=q?parseInt(q):200;if(f.length||h.length||v.length||b.length){l.forEach(V=>n.removeAttribute(V.name));const I=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!W(a,t),U=!1,H=null;const K=async V=>{if(U){H=V;return}U=!0;try{V?(n.style.display="",n.classList.add(...f,...h),await I(),n.classList.remove(...h),n.classList.add(...u),await ce(n),n.classList.remove(...f,...u)):(n.classList.add(...v,...b),await I(),n.classList.remove(...b),n.classList.add(...T),await ce(n),n.classList.remove(...v,...T),n.style.display="none"),G=V}finally{if(U=!1,H!==null&&H!==G){const B=H;H=null,K(B)}else H=null}};G||(n.style.display="none"),Z(a,o,()=>{const V=!!W(a,t);V!==G&&K(V)})}else{const I=[...F].find(B=>B==="scale"||/^scale$/.test(B)),G=(()=>{const B=[...F].find(de=>/^\d+$/.test(de)&&de!==q);return B?parseInt(B)/100:.9})(),U=[];(!F.has("scale")||F.has("opacity"))&&U.push(`opacity ${N}ms ease`),I&&U.push(`transform ${N}ms ease`),U.length||U.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+U.join(", "),l.forEach(B=>n.removeAttribute(B.name));let H=!!W(a,t);const K=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B()))),V=async B=>{B?(n.style.display="",n.style.opacity="0",I&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",I&&(n.style.transform=""),await ce(n)):(n.style.opacity="0",I&&(n.style.transform=`scale(${G})`),await ce(n),n.style.display="none",n.style.opacity="",I&&(n.style.transform="")),H=B};H||(n.style.display="none"),Z(a,o,()=>{const B=!!W(a,t);B!==H&&V(B)})}}else{const r=n.getAttribute("cv-show-transition"),f=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),f&&n.removeAttribute(":transition");const h=r??(f?String(W(f,t)):null);if(h){Qe();let u=!!W(a,t);u||(n.style.display="none");let v=!1,b=null;const T=async O=>{if(v){b=O;return}v=!0;try{O?(n.style.display="",n.classList.add(`${h}-enter`),await ce(n),n.classList.remove(`${h}-enter`)):(n.classList.add(`${h}-leave`),await ce(n),n.classList.remove(`${h}-leave`),n.style.display="none"),u=O}finally{if(v=!1,b!==null&&b!==u){const F=b;b=null,T(F)}else b=null}};Z(a,o,()=>{const O=!!W(a,t);O!==u&&T(O)})}else{const u=()=>{n.style.display=W(a,t)?"":"none"};Z(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{W(a,t)&&Promise.resolve().then(()=>n.focus())};Z(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(I=>I.name==="cv-intersect"||I.name==="cv-intersect:enter"||I.name.startsWith("cv-intersect.")),r=a.find(I=>I.name==="cv-intersect:leave"),f=(l==null?void 0:l.value)??"",h=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),v=new Set(u.slice(1)),b=v.has("once");let T=0;if(v.has("half"))T=.5;else if(v.has("full"))T=1;else{const I=[...v].find(G=>G.startsWith("threshold-"));I&&(T=parseInt(I.replace("threshold-",""))/100)}const O=[...v].find(I=>I.startsWith("margin-")),F=O?`${O.replace("margin-","")}px`:void 0;a.forEach(I=>n.removeAttribute(I.name));const q=I=>{if(I)try{new Function("$data",`with($data){${I}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${I}":`,G)}},N=new IntersectionObserver(I=>{I.forEach(G=>{G.isIntersecting?(q(f),b&&N.disconnect()):q(h)})},{threshold:T,...F?{rootMargin:F}:{}});N.observe(n),(_=o.registerCleanup)==null||_.call(o,()=>N.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=!a.name.split(".").slice(1).includes("raw"),f=()=>{const h=String(W(l,t)??"");n.innerHTML=r?Ft(h):h};Z(l,o,f),f(),s++;continue}}if(n.hasAttribute("cv-ref")&&!((L=o.components)!=null&&L[y])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const x=!!((E=o.components)!=null&&E[y]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!x){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,f=(M=r.type)==null?void 0:M.toLowerCase(),h=u=>{if(l.has("number")){const v=parseFloat(u);return isNaN(v)?u:v}return l.has("trim")?u.trim():u};if(f==="checkbox"){const u=()=>{const v=W(a,t);r.checked=Array.isArray(v)?v.includes(r.value):!!v};Z(a,o,u),u(),r.addEventListener("change",()=>{const v=W(a,t);if(Array.isArray(v)){const b=[...v];if(r.checked)b.includes(r.value)||b.push(r.value);else{const T=b.indexOf(r.value);T>-1&&b.splice(T,1)}pe(a,t,b)}else pe(a,t,r.checked)})}else if(f==="radio"){const u=()=>{r.checked=W(a,t)===r.value};Z(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&pe(a,t,h(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,v=()=>{const b=String(W(a,t)??"");u.innerText!==b&&(u.innerText=b)};if(Z(a,o,v),v(),l.has("debounce")){const b=[...l].find(F=>/^\d+$/.test(F)),T=b?parseInt(b):300;let O;u.addEventListener("input",()=>{clearTimeout(O),O=setTimeout(()=>pe(a,t,h(u.innerText)),T)})}else{const b=l.has("lazy")?"blur":"input";u.addEventListener(b,()=>pe(a,t,h(u.innerText)))}}else{const u=()=>{r.value=W(a,t)??""};if(Z(a,o,u),u(),l.has("debounce")){const v=[...l].find(O=>/^\d+$/.test(O)),b=v?parseInt(v):300;let T;r.addEventListener("input",()=>{clearTimeout(T),T=setTimeout(()=>pe(a,t,h(r.value)),b)})}else{const v=y==="select"||l.has("lazy")?"change":"input";r.addEventListener(v,()=>pe(a,t,h(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var q,N;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],f=l.slice(1),h=r.indexOf(":"),u=h>=0?r.slice(0,h):r,v=h>=0?r.slice(h+1):void 0,b=o.directives[u];if(!b)return;const T=a.value;n.removeAttribute(a.name);const O=typeof b=="function"?{onMount:b}:b,F={value:T?W(T,t):void 0,arg:v,modifiers:Object.fromEntries(f.map(I=>[I,!0]))};(q=O.onMount)==null||q.call(O,n,F),O.onUpdate&&T&&Z(T,o,()=>{F.value=W(T,t),O.onUpdate(n,F)}),O.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>O.onDestroy(n,F)))}),y==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=W(u.value,t))});const f=await l(r),h=document.createDocumentFragment();f.forEach(u=>h.appendChild(u)),n.replaceWith(h)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await te(r,t,o),n.replaceWith(r)}s++;continue}if(y==="cv-transition"){Qe();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await te(r,t,o),l){let f=!!W(l,t),h=!1,u=null;f||(r.style.display="none");const v=async b=>{if(h){u=b;return}h=!0;try{b?(r.style.display="",r.classList.add(`${a}-enter`),await ce(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ce(r),r.classList.remove(`${a}-leave`),r.style.display="none"),f=b}finally{if(h=!1,u!==null&&u!==f){const T=u;u=null,v(T)}else u=null}};Z(l,o,()=>{const b=!!W(l,t);b!==f&&v(b)})}s++;continue}if(y==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),s++;continue}if(y==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(W(a,t)??"/"):l||"/",f=I=>String(I).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let h="";Array.from(n.attributes).forEach(I=>{I.name==="to"||I.name===":to"||(h+=` ${I.name}="${f(I.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${h}></a>`;const v=u.firstElementChild;for(;n.firstChild;)v.appendChild(n.firstChild);const b=((j=o.router)==null?void 0:j.base)??"",T=I=>b?I===b?"/":I.startsWith(b+"/")?I.slice(b.length)||"/":I||"/":I||"/",O=()=>{var I;return((I=o.router)==null?void 0:I.mode)==="history"?T(window.location.pathname):window.location.hash.slice(1)||"/"},F=()=>{var U;const I=r(),G=O()===I;((U=o.router)==null?void 0:U.mode)==="history"?v.href=`${b}${I}`:v.href=`#${I}`,G?(v.setAttribute("aria-current","page"),v.classList.add("active")):(v.removeAttribute("aria-current"),v.classList.remove("active"))};((R=o.router)==null?void 0:R.mode)==="history"?(v.addEventListener("click",I=>{I.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",F)):window.addEventListener("hashchange",F),a&&Z(a,o,F),F();const q=document.createDocumentFragment();q.appendChild(v),await te(q,t,o);const N=q.firstChild??v;n.replaceWith(N),s++;continue}if(y==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),s++;continue}if((C=o.components)!=null&&C[y]&&o.mountElement){await o.mountElement(n,y,t,o),s++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=W(a.value,t);let f,h=0,u="0px",v=l.has("once");if(typeof r=="function"?f=b=>r.call(t,b):r&&typeof r=="object"&&(typeof r.handler=="function"&&(f=b=>r.handler.call(t,b)),r.threshold!==void 0&&(h=r.threshold),r.margin&&(u=r.margin),r.once&&(v=!0)),f){const b=new IntersectionObserver(T=>{const O=T[0];f(O),v&&O.isIntersecting&&b.disconnect()},{threshold:h,rootMargin:u});b.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>b.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=W(a,t);let r,f="content-box";if(typeof l=="function"?r=h=>l.call(t,h):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=h=>l.handler.call(t,h)),l.box&&(f=l.box)),r){const h=new ResizeObserver(u=>{u[0]&&r(u[0])});h.observe(n,{box:f}),(d=o.registerCleanup)==null||d.call(o,()=>h.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=W(a,t);let r,f=0;if(typeof l=="function"?r=h=>l.call(t,h):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=h=>l.handler.call(t,h)),l.throttle&&(f=l.throttle)),r){let h=0;const u=()=>{const v=Date.now();f>0&&v-h<f||(h=v,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(m=o.registerCleanup)==null||m.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):Ze(a,t,r))};document.addEventListener("click",l,!0),(w=o.registerCleanup)==null||w.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let f=[];const h=()=>{const u=W(a,t)??{},v=Object.keys(u);for(const b of f)b in u||(b==="class"?n.className=l:b==="style"?n.style.cssText=r:n.removeAttribute(b));for(const[b,T]of Object.entries(u))if(b==="class")n.className=[l,He(T)].filter(Boolean).join(" ");else if(b==="style")Je(n,T,r);else if(T==null||T===!1)try{n.removeAttribute(b)}catch{}else try{n.setAttribute(b,T===!0?"":String(T))}catch(O){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${b}":`,O)}f=v};Z(a,o,h),h()}const D={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],f=new Set(l.slice(1)),h=[...f].find(T=>T in D),u=a.value,v=T=>{f.has("prevent")&&T.preventDefault(),f.has("stop")&&T.stopPropagation(),!(f.has("self")&&T.target!==T.currentTarget)&&(h&&T.key!==D[h]||(typeof t[u]=="function"?t[u].call(t,T):Ze(u,t,T)))},b={};f.has("once")&&(b.once=!0),f.has("passive")&&(b.passive=!0),f.has("capture")&&(b.capture=!0),n.addEventListener(r,v,Object.keys(b).length?b:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const f=n.getAttribute("class")??"",h=()=>{n.className=[f,He(W(r,t))].filter(Boolean).join(" ")};Z(r,o,h),h()}else if(l==="style"){const f=n.getAttribute("style")??"",h=()=>Je(n,W(r,t),f);Z(r,o,h),h()}else if(l.includes("-")){const f=()=>{const h=W(r,t);h==null||h===!1?n.removeAttribute(l):n.setAttribute(l,h===!0?"":String(h))};Z(r,o,f),f()}else{const f=()=>{n[l]=W(r,t)??""};Z(r,o,f),f()}}}),S.hasChildNodes()&&await te(S,t,o),s++}}var Pt=`
...
`;function Dt(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=Pt,document.head.appendChild(e)}async function we(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(p=>{const k=()=>p();e.addEventListener("animationend",k,{once:!0}),e.addEventListener("transitionend",k,{once:!0}),setTimeout(k,s+50)}),e.classList.remove(`${t}-${o}`)}var Ce=new Map;async function It(e){if(typeof e!="function")return e;if(Ce.has(e))return Ce.get(e);const t=await e();return Ce.set(e,t.default),t.default}function tt(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function ot(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((p,k)=>[p,s[k+1]])):null}function Lt(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((p,k)=>[p,s[k+1]])),remaining:s[o.length+1]||"/"}:null}function xt(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:xt(o.children,i==="/"?"":i)}:{...o,path:i}})}var ge=(e,t)=>new Promise(o=>e(t,o)),nt=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Mt(e,t={}){const o=t.mode??"hash",i=Rt(t.base??"");return{routes:xt(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,p){const k=rt(s,p==null?void 0:p.query);o==="history"?(history.pushState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=k},replace(s,p){const k=rt(s,p==null?void 0:p.query);if(o==="history")history.replaceState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const g=window.location.href.split("#")[0];window.location.replace(`${g}#${k}`)}},back(){history.back()},forward(){history.forward()}}}function Rt(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function zt(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function rt(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function st(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function at(e,t,o,i="default",s){const p=t.base??"",k=m=>m.length>1&&m.endsWith("/")?m.slice(0,-1):m,g=()=>t.mode==="history"?k(zt(window.location.pathname,p)):k((window.location.hash.slice(1)||"/").split("?")[0]||"/"),P=()=>{if(t.mode==="history")return st(window.location.search);const m=window.location.hash.slice(1)||"/",w=m.indexOf("?");return w>=0?st(m.slice(w+1)):{}};t.transition&&Dt();let $=null,_=null,L=null,E=null,M=!1;const z=()=>{M||(M=!0,s==null||s())},j=new Map,R=m=>{var w;if(m!=null&&m.keepAlive&&L){(w=L.deactivate)==null||w.call(L);const S=document.createDocumentFragment();for(;e.firstChild;)S.appendChild(e.firstChild);j.set($.path,{fragment:S,activation:L}),L=null}else L==null||L.destroy(),L=null,e.innerHTML=""},C=async(m,w,S,n,y)=>{const x=typeof w=="function"&&!Ce.has(w),A=x?w.__asyncOptions:void 0,D=m.loadingTemplate??(A==null?void 0:A.loadingTemplate);x&&D&&(e.innerHTML=D);let a;try{a=await It(w)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return x&&D&&(e.innerHTML=""),o(e,a,S,n,y)},c=async()=>{var S,n,y,x,A,D,a,l;const m=g(),w=P();for(const r of t.routes){if((S=r.children)!=null&&S.length){const h=Lt(r.path,m);if(h!==null)for(const u of r.children){const v=ot(u.path,m);if(v!==null){const b={params:h.params,query:w,path:m,meta:r.meta};if(u.redirect){const q={params:v,query:w,path:m,meta:u.meta},N=typeof u.redirect=="function"?u.redirect(q):u.redirect;t.navigate(N);return}if(t.beforeEach){const q=await ge(t.beforeEach,b);if(q){t.navigate(q);return}}if(r.beforeEnter){const q=await ge(r.beforeEnter,b);if(q){t.navigate(q);return}}if(u.beforeEnter){const q={params:v,query:w,path:m,meta:u.meta},N=await ge(u.beforeEnter,q);if(N){t.navigate(N);return}}const T=`${r.path}::${JSON.stringify(h.params)}`;if(E!==T){const q=await nt(L,b);if(q){t.navigate(q);return}const N=r.transition??t.transition;N&&e.hasChildNodes()&&await we(e,N,"leave"),R(_);const I=tt(r,i);if(I){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(U,H)=>t.navigate(U,H),replace:(U,H)=>t.replace(U,H),back:()=>t.back(),forward:()=>t.forward()};L=await C(r,I,b,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=L.enter)==null||n.call(L,$)}else e.innerHTML="";E=T,N&&await we(e,N,"enter")}const O={params:{...h.params,...v},query:w,path:m,meta:u.meta??r.meta};(y=t.afterEach)==null||y.call(t,O,$);const F=(x=t.scrollBehavior)==null?void 0:x.call(t,O,$);F&&window.scrollTo(F.x??0,F.y??0),$=O,_=r,z();return}}}const f=ot(r.path,m);if(f!==null){E=null;const h={params:f,query:w,path:m,meta:r.meta};if(r.redirect){const O=typeof r.redirect=="function"?r.redirect(h):r.redirect;t.navigate(O);return}if(t.beforeEach){const O=await ge(t.beforeEach,h);if(O){t.navigate(O);return}}if(r.beforeEnter){const O=await ge(r.beforeEnter,h);if(O){t.navigate(O);return}}const u=await nt(L,h);if(u){t.navigate(u);return}const v=r.transition??t.transition;v&&e.hasChildNodes()&&await we(e,v,"leave"),R(_);const b=tt(r,i);if(b){const O=h.path;if(r.keepAlive&&j.has(O)){const F=j.get(O);e.appendChild(F.fragment),L=F.activation,(A=L.activate)==null||A.call(L),j.delete(O)}else{const F=$;L=await C(r,b,h,i==="default"?r.layout:void 0),(D=L.enter)==null||D.call(L,F)}}else e.innerHTML="",L=null;v&&await we(e,v,"enter"),(a=t.afterEach)==null||a.call(t,h,$);const T=(l=t.scrollBehavior)==null?void 0:l.call(t,h,$);T&&window.scrollTo(T.x??0,T.y??0),$=h,_=r,z();return}}E=null,R(_),_=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),L==null||L.destroy(),L=null,j.forEach(({activation:m})=>m.destroy()),j.clear()}}function Ht(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(p=>{try{p(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Nt=0;function Wt(){return++Nt}var qt=`
...
`;function Ut(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=qt,document.head.appendChild(e)}function ke(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function it(e){try{return JSON.parse(e)}catch{return e}}function Bt(e){if(typeof document>"u")return;Ut();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,i="components",s=new Set;const p=document.createElement("div");p.id="cvd-badge",p.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(p);const k=document.createElement("div");k.id="cvd-panel",k.style.display="none",t.appendChild(k),k.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const g=k.querySelector("#cvd-body");p.addEventListener("click",()=>{o=!0,p.style.display="none",k.style.display="flex",L()}),k.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,k.style.display="none",p.style.display=""}),k.querySelectorAll(".cvd-tab").forEach(E=>{E.addEventListener("click",()=>{i=E.dataset.tab,k.querySelectorAll(".cvd-tab").forEach(M=>M.classList.remove("active")),E.classList.add("active"),L()})});const P=k.querySelector("#cvd-head");P.addEventListener("pointerdown",E=>{if(E.target.closest("button"))return;P.setPointerCapture(E.pointerId);const M=E.clientX,z=E.clientY,j=t.offsetLeft,R=t.offsetTop,C=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${j+(d.clientX-M)}px`,t.style.top=`${R+(d.clientY-z)}px`},c=d=>{P.releasePointerCapture(d.pointerId),P.removeEventListener("pointermove",C),P.removeEventListener("pointerup",c),P.removeEventListener("pointercancel",c)};P.addEventListener("pointermove",C),P.addEventListener("pointerup",c),P.addEventListener("pointercancel",c)});function $(){const E=e.instances;if(!E.length){g.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}g.innerHTML=E.map(M=>{const z=M.getState(),j=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${j.length?j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-inst="${M.id}" data-key="${R}" title="click to edit">${ke(z[R])}</span>
                            </div>
                        `).join(""):'<span style="color:#555">— sin datos reactivos —</span>'}
                    </div>
                </div>
            `}).join(""),g.querySelectorAll(".cvd-inst-head").forEach(M=>{M.addEventListener("click",()=>{const z=M.closest(".cvd-inst"),j=parseInt(z.dataset.id);s.has(j)?s.delete(j):s.add(j),z.classList.toggle("open")})}),g.querySelectorAll(".cvd-val").forEach(M=>{M.addEventListener("click",z=>{z.stopPropagation();const j=M;if(j.querySelector("input"))return;const R=parseInt(j.dataset.inst),C=j.dataset.key,c=e.instances.find(S=>S.id===R);if(!c)return;const d=ke(c.getState()[C]);j.classList.add("editing"),j.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const m=j.querySelector("input");m.focus(),m.select();const w=()=>{c.setState(C,it(m.value)),j.classList.remove("editing")};m.addEventListener("blur",w),m.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),w()),S.key==="Escape"&&(j.classList.remove("editing"),L())})})})}function _(){if(!e.stores.length){g.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}g.innerHTML=e.stores.map((E,M)=>{const z=E.getState(),j=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${M}" data-key="${R}" title="click to edit">${ke(z[R])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),g.querySelectorAll(".cvd-inst-head").forEach(E=>{E.addEventListener("click",()=>E.closest(".cvd-inst").classList.toggle("open"))}),g.querySelectorAll("[data-store][data-key]").forEach(E=>{E.addEventListener("click",M=>{M.stopPropagation();const z=E;if(z.querySelector("input"))return;const j=parseInt(z.dataset.store),R=z.dataset.key,C=e.stores[j];if(!C)return;const c=ke(C.getState()[R]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const m=()=>{C.setState(R,it(d.value)),z.classList.remove("editing")};d.addEventListener("blur",m),d.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),m()),w.key==="Escape"&&(z.classList.remove("editing"),L())})})})}function L(){o&&(i==="components"?$():_())}e.on("mount",()=>L()),e.on("update",()=>L()),e.on("destroy",()=>L()),e.on("store-update",()=>L())}var Vt="__COURVUX_HEAD_COLLECTOR__";function Gt(){return globalThis[Vt]??null}var Yt=(e,t)=>{Object.entries(t).forEach(([o,i])=>{o!=="innerHTML"&&(i==null||i===!1||e.setAttribute(o,i===!0?"":String(i)))})},Xt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Jt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,i])=>e.setAttribute(o,i))},ct=(e,t,o,i)=>{let s=o?document.head.querySelector(o):null;s?(i.push({el:s,prevAttrs:Xt(s),created:!1}),Array.from(s.attributes).forEach(p=>s.removeAttribute(p.name))):(s=document.createElement(e),document.head.appendChild(s),i.push({el:s,created:!0})),Yt(s,t)};function Zt(e){var k,g,P;const t=Gt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let i;const s={},p={};if(e.title!==void 0){i=document.title;const $=e.titleTemplate,_=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=_}return(k=e.meta)==null||k.forEach($=>{ct("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(g=e.link)==null||g.forEach($=>{ct("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(P=e.script)==null||P.forEach($=>{const _=document.createElement("script");Object.entries($).forEach(([L,E])=>{L==="innerHTML"?_.textContent=String(E):E!=null&&E!==!1&&_.setAttribute(L,E===!0?"":String(E))}),document.head.appendChild(_),o.push({el:_,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,_])=>{s[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,_)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,_])=>{p[$]=document.body.getAttribute($),document.body.setAttribute($,_)}),function(){i!==void 0&&(document.title=i),o.forEach(({el:$,prevAttrs:_,created:L})=>{var E;L?(E=$.parentNode)==null||E.removeChild($):_&&Jt($,_)}),Object.entries(s).forEach(([$,_])=>{_===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,_)}),Object.entries(p).forEach(([$,_])=>{_===null?document.body.removeAttribute($):document.body.setAttribute($,_)})}}var Ie="data-courvux-ssr",Kt=e=>e?Promise.resolve().then(e):Promise.resolve();function dt(e,t){const o=e.trim();if(o.startsWith("{")){const i=o.replace(/[{}]/g,"").split(",").map(s=>s.trim()).filter(Boolean);return Object.fromEntries(i.map(s=>[s,t[s]]))}return{[o]:t}}var Se=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var w,S,n;const i={},{subscribe:s,createReactiveState:p,registerSetInterceptor:k,notifyAll:g}=ze();let P;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),P=await t.data()):P=t.data??{},t.templateUrl){const y=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,x=await fetch(y);if(!x.ok)throw new Error(`Failed to load template: ${y} (${x.status})`);e.innerHTML=await x.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Ie),(w=e.querySelector(`[${Ie}]`))==null||w.removeAttribute(Ie);const $={};if(t.inject&&o.provided){const y=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(x=>[x,x])):t.inject;Object.entries(y).forEach(([x,A])=>{o.provided&&A in o.provided&&($[x]=o.provided[A])})}const _=p({...o.globalProperties??{},...P,...$,...t.methods,$refs:i,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(y=>[y,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});t.exprs&&typeof t.exprs=="object"&&Et(_,t.exprs),_.$watch=(y,x,A)=>{const D=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=D?Se(_[y]):_[y];const r=s(y,()=>{const f=_[y];x.call(_,f,l),l=D?Se(f):f});return a&&x.call(_,_[y],void 0),r},_.$batch=Tt,_.$nextTick=y=>Kt(y),_.$dispatch=(y,x,A)=>{e.dispatchEvent(new CustomEvent(y,{bubbles:!0,composed:!0,...A??{},detail:x}))},o.magics&&Object.entries(o.magics).forEach(([y,x])=>{_[y]=x(_)}),_.$forceUpdate=()=>g();const L=[];_.$watchEffect=y=>{let x=[];const A=()=>{x.forEach(r=>r()),x=[];const a=Ue(()=>{try{y()}catch{}}),l=new Map;for(const{sub:r,key:f}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(f)&&(l.get(r).add(f),x.push(r(f,A)))};A();const D=()=>{x.forEach(l=>l()),x=[];const a=L.indexOf(D);a>-1&&L.splice(a,1)};return L.push(D),D};const E=[];t.computed&&Object.entries(t.computed).forEach(([y,x])=>{const A=typeof x=="function"?x:x.get,D=typeof x!="function"?x.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const f=Ue(()=>{try{r=A.call(_)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});_[y]=r;const h=new Map;for(const{sub:u,key:v}of f)h.has(u)||h.set(u,new Set),!h.get(u).has(v)&&(h.get(u).add(v),a.push(u(v,l)))};l(),E.push(()=>a.forEach(r=>r())),D&&k(y,r=>D.call(_,r))});const M=[];t.watch&&Object.entries(t.watch).forEach(([y,x])=>{const A=typeof x=="object"&&x!==null&&"handler"in x,D=A?x.handler:x,a=A?x.immediate??!1:!1,l=A?x.deep??!1:!1;let r=l?Se(_[y]):_[y];const f=s(y,()=>{const h=_[y];D.call(_,h,r),r=l?Se(h):h});M.push(f),a&&D.call(_,_[y],void 0)});const z={...o.provided??{}};if(t.provide){const y=typeof t.provide=="function"?t.provide.call(_):t.provide;Object.assign(z,y)}const j={...o,provided:z,components:{...o.components,...t.components}};j.mountElement=Ee(j),j.createChildScope=(y,x)=>{const A=new Set(Object.keys(y)),D=new Set(Object.keys(x)),{subscribe:a,createReactiveState:l}=ze(),r=l(y);let f;return f=new Proxy({},{get(h,u){return typeof u!="string"?_[u]:A.has(u)?r[u]:D.has(u)?x[u].bind(f):_[u]},set(h,u,v){return typeof u!="string"?!1:A.has(u)?(r[u]=v,!0):(_[u]=v,!0)},has(h,u){return A.has(u)||D.has(u)||u in _},ownKeys(){return[...A,...D,...Object.keys(_)]},getOwnPropertyDescriptor(h,u){return A.has(u)||D.has(u)||u in _?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:f,subscribe:(h,u)=>A.has(h)?a(h,u):c(h,u),cleanup:()=>{}}},j.mountDynamic=async(y,x,A,D,a)=>{let l=null,r=null;const f=A.getAttribute("loading-template")??"",h=async()=>{var I,G,U;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=W(x,D);if(!u)return;let v;if(typeof u=="function"){if(f){const H=document.createElement("div");H.innerHTML=f,(I=y.parentNode)==null||I.insertBefore(H,y.nextSibling),l=H}v=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?v=(G=j.components)==null?void 0:G[u]:u&&typeof u=="object"&&(v=u);if(!v)return;const b=document.createElement("div"),T=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{T(H.name)||b.setAttribute(H.name,H.value)}),b.innerHTML=A.innerHTML;const O={},F={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))O[H.name.slice(1)]=W(H.value,D);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);F[V]=(...B)=>{typeof D[K]=="function"&&D[K].call(D,...B)}}});const q={...v,data:{...v.data,...O},methods:{...v.methods,$emit(H,...K){var V;wt(v,H,K),(V=F[H])==null||V.call(F,...K)}}},N={...j,components:{...j.components,...v.components}};N.mountElement=Ee(N),r=(await ne(b,q,N)).destroy,(U=y.parentNode)==null||U.insertBefore(b,y.nextSibling),l=b};Z(x,a,h),await h()};const R=[];_.$addCleanup=y=>{R.push(y)};let C=!1;const c=(y,x)=>!t.onBeforeUpdate&&!t.onUpdated?s(y,x):s(y,()=>{var A;C||(C=!0,(A=t.onBeforeUpdate)==null||A.call(_),Promise.resolve().then(()=>{var D;C=!1,(D=t.onUpdated)==null||D.call(_)})),x()});try{(S=t.onBeforeMount)==null||S.call(_),await te(e,_,{subscribe:c,refs:i,...j,registerCleanup:y=>R.push(y)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(_)}catch(y){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(_,y);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(y,_,t.name??e.tagName.toLowerCase());else throw y}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,m=d?Wt():0;if(d){const y=_,x=new Set,A={id:m,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const D={};for(const a of Object.keys(y))if(!(a.startsWith("$")||typeof y[a]=="function"))try{D[a]=y[a]}catch{}return D},setState:(D,a)=>{y[D]=a},subscribe:D=>(x.add(D),()=>x.delete(D)),children:[]};Object.keys(y).filter(D=>!D.startsWith("$")&&typeof y[D]!="function").forEach(D=>{s(D,()=>{d._emit("update",A),x.forEach(a=>a())})}),d._registerInstance(A),R.push(()=>d._unregisterInstance(m))}return{state:_,destroy:()=>{var y,x;(y=t.onBeforeUnmount)==null||y.call(_),E.forEach(A=>A()),M.forEach(A=>A()),L.forEach(A=>A()),R.forEach(A=>A()),(x=t.onDestroy)==null||x.call(_)},activate:()=>{var y;(y=t.onActivated)==null||y.call(_)},deactivate:()=>{var y;(y=t.onDeactivated)==null||y.call(_)},beforeLeave:t.onBeforeRouteLeave?(y,x)=>t.onBeforeRouteLeave.call(_,y,x):void 0,enter:t.onBeforeRouteEnter?y=>t.onBeforeRouteEnter.call(_,y):void 0}}function wt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const i=e.emits[t];typeof i=="function"&&!i(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ee(e){return async(t,o,i,s)=>{const p=e.components[o],k=t.getAttribute("cv-ref");k&&t.removeAttribute("cv-ref");const g={},P=[],$={};Array.from(t.attributes).filter(C=>C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:")).forEach(C=>{t.removeAttribute(C.name);const c=C.value,d=C.name.indexOf(":"),m=d>=0?C.name.slice(d+1).split(".")[0]:"modelValue",w=m==="modelValue"?"update:modelValue":`update:${m}`;g[m]=Pe(W(c,i)),P.push({propName:m,expr:c}),$[w]=S=>{pe(c,i,S)}});const _={};Array.from(t.attributes).forEach(C=>{const c=C.name.startsWith(":"),d=C.name.startsWith("@")||C.name.startsWith("cv:on:"),m=C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:"),w=C.name.startsWith("v-slot"),S=C.name==="slot";!c&&!d&&!m&&!w&&!S&&(_[C.name]=C.value)}),p.inheritAttrs===!1&&Object.keys(_).forEach(C=>t.removeAttribute(C)),Array.from(t.attributes).forEach(C=>{if(C.name.startsWith(":")){const c=C.name.slice(1),d=C.value;g[c]=Pe(W(d,i)),P.push({propName:c,expr:d})}else if(C.name.startsWith("@")||C.name.startsWith("cv:on:")){const c=C.name.startsWith("@")?C.name.slice(1):C.name.slice(6),d=C.value;$[c]=(...m)=>{typeof i[d]=="function"&&i[d].call(i,...m)}}});const L=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");L&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const E=new Map,M=[];Array.from(t.childNodes).forEach(C=>{const c=C.nodeType===1?C.getAttribute("slot"):null;if(c){if(!E.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),E.set(c,{nodes:[],vSlot:d})}E.get(c).nodes.push(C.cloneNode(!0))}else M.push(C.cloneNode(!0))});const z={};M.some(C=>{var c;return C.nodeType===1||C.nodeType===3&&(((c=C.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async C=>{const c=L?{...i,...dt(L,C)}:i,d=document.createDocumentFragment();return M.forEach(m=>d.appendChild(m.cloneNode(!0))),await te(d,c,s),Array.from(d.childNodes)});for(const[C,{nodes:c,vSlot:d}]of E)z[C]=async m=>{const w=d?{...i,...dt(d,m)}:i,S=document.createDocumentFragment();return c.forEach(n=>S.appendChild(n.cloneNode(!0))),await te(S,w,s),Array.from(S.childNodes)};const j={...e,components:{...e.components,...p.components},slots:z};j.mountElement=Ee(j);const{state:R}=await ne(t,{...p,data:{...p.data,...g,$attrs:_,$parent:i},methods:{...p.methods,$emit(C,...c){var d;wt(p,C,c),(d=$[C])==null||d.call($,...c)}}},j);R&&(P.forEach(({propName:C,expr:c})=>{yt(c,{...s,subscribe:s.subscribe},()=>{R[C]=Pe(W(c,i))})}),k&&s.refs&&(s.refs[k]=R))}}function Qt(e){Ot();const t=typeof window<"u"?Ht():void 0,o=[],i={...e.directives},s={...e.components??{}},p=[],k=new Map,g={},P=new Map;if(e.debug&&t&&Bt(t),t&&e.store){const E=e.store,M=Object.keys(E).filter(z=>typeof E[z]!="function");t._registerStore({getState(){const z={};return M.forEach(j=>{try{z[j]=E[j]}catch{}}),z},setState(z,j){E[z]=j},subscribe(z){const j=M.map(R=>{try{return ye(E,R,z)}catch{return()=>{}}});return()=>j.forEach(R=>R())}})}const $={router:e.router,use(E){return o.includes(E)||(o.push(E),E.install($)),$},directive(E,M){return i[E]=M,$},component(E,M){return s[E]=M,$},provide(E,M){return typeof E=="string"?g[E]=M:Object.assign(g,E),$},magic(E,M){return P.set(`$${E}`,M),$},mount:async E=>(await L(E),$),mountAll:async(E="[data-courvux]")=>{const M=Array.from(document.querySelectorAll(E));return await Promise.all(M.map(z=>_(z))),$},mountEl:async E=>_(E),unmount(E){if(!E)p.forEach(M=>M()),p.length=0,k.clear();else{const M=document.querySelector(E);if(M){const z=k.get(M);if(z){z(),k.delete(M);const j=p.indexOf(z);j>-1&&p.splice(j,1)}}}return $},destroy(){p.forEach(E=>E()),p.length=0,k.clear()}},_=async E=>{const M=new URL(".",document.baseURI).href,z={components:s,router:e.router,store:e.store,directives:i,baseUrl:M,provided:{...g},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:P.size?Object.fromEntries(P):void 0};if(z.mountElement=Ee(z),e.router){const R=e.router;z.mountRouterView=async(C,c)=>{await new Promise(d=>{at(C,R,async(m,w,S,n,y)=>{const x={...z,currentRoute:S};if(y){let A=null;const D={...x,mountRouterView:async(a,l)=>{A=at(a,y,async(r,f,h,u)=>{const v={...x,currentRoute:h};if(u){let b=null;const T={...v,mountRouterView:async(F,q)=>{b=await ne(F,f,v)}},{destroy:O}=await ne(r,{template:u},T);return{destroy:()=>{b==null||b.destroy(),O()},activate:()=>b==null?void 0:b.activate(),deactivate:()=>b==null?void 0:b.deactivate()}}else return await ne(r,f,v)},l)}};if(n){let a=null;const l={...D,mountRouterView:async(f,h)=>{a=await ne(f,w,D)}},{destroy:r}=await ne(m,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(m,w,D);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const D={...x,mountRouterView:async(l,r)=>{A=await ne(l,w,x)}},{destroy:a}=await ne(m,{template:n},D);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(m,w,x)},c,d)})}}const j=await ne(E,e,z);return p.push(j.destroy),k.set(E,j.destroy),j.state},L=async E=>{const M=document.querySelector(E);if(M)return _(M)};return $}var lt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function eo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Le={exports:{}},ut;function to(){return ut||(ut=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
`)}const io={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,exprs:{"label || langLabel":(e=>e.label||e.langLabel),"copied ? '✓ Copied' : 'Copy'":(e=>e.copied?"â Copied":"Copy"),"copy()":(e=>e.copy()),"'language-' + lang":(e=>"language-"+e.lang)},computed:{langLabel(){return so[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=ao(this.code),e.textContent=this._cleanCode,no.highlightElement(e))}},ve="Courvux",co="https://vanjexdev.github.io/courvux";function X({title:e,description:t,slug:o="/"}){const i=e?`${e} — ${ve}`:`${ve} — Lightweight reactive UI framework`,s=co+o;return Zt({title:e??`${ve} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${ve}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:i},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:s},{property:"og:site_name",content:ve},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:i},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:s}]})}const lo={data:{install:`# From GitHub — pin a tag for stable installs
pnpm add github:vanjexdev/courvux#v0.7.0
...
createApp({
    ...
    `,exprs:{"'bash'":(e=>"bash"),install:(e=>e.install),"'terminal'":(e=>"terminal"),"'js'":(e=>"js"),counter:(e=>e.counter),"'main.js'":(e=>"main.js")},onMount(){X({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~20 KB gzip with everything (router, store, devtools, composables, useHead, SSR).",slug:"/"})}},uo={data:{s1:`# Latest commit on main (rolling)
pnpm add github:vanjexdev/courvux

# Pin to a tagged release (recommended for production)
pnpm add github:vanjexdev/courvux#v0.7.0`,s2:`<script type="importmap">
{
  "imports": {
...
{
  "imports": {
    "courvux": "https://cdn.jsdelivr.net/gh/vanjexdev/courvux@v0.7.0/dist/index.js"
  }
}
<\/script>
...
<\/script>`},onMount(){X({title:"Installation",description:"Install Courvux from GitHub or via import map / CDN. Vite plugin for templateUrl inlining and jsDelivr CDN setup.",slug:"/installation"});const e=this.$refs.pen;if(!e)return;const t=document.createElement("iframe");t.src="https://codepen.io/jesusuzcategui-the-bold/embed/VYmZNgZ?default-tab=html%2Cresult&theme-id=dark",t.height="420",t.style.cssText="width:100%; border:0; border-radius:8px; display:block; margin-bottom:1rem;",t.scrolling="no",t.setAttribute("frameborder","no"),t.setAttribute("allowtransparency","true"),t.allowFullscreen=!0,t.title="Courvux CDN demo on CodePen",e.replaceWith(t)},template:`
        <div class="prose">
            <h1>Installation</h1>
    ...
    `,exprs:{"'html'":(e=>"html"),sCdn:(e=>e.sCdn),"'index.html'":(e=>"index.html"),sCdnMap:(e=>e.sCdnMap),"'bash'":(e=>"bash"),s1:(e=>e.s1),"'terminal'":(e=>"terminal"),s2:(e=>e.s2),"'js'":(e=>"js"),s3:(e=>e.s3),"'main.js'":(e=>"main.js"),s4:(e=>e.s4),"'vite.config.js'":(e=>"vite.config.js"),"'json'":(e=>"json"),s5:(e=>e.s5),"'tsconfig.json'":(e=>"tsconfig.json")}},po={data:{s1:`import { createApp } from 'courvux';
...
createApp({ store, router, template: '<router-view />' }).mount('#app');`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),"'main.js'":(e=>"main.js"),s2:(e=>e.s2),s3:(e=>e.s3),s4:(e=>e.s4)},onMount(){X({title:"Quick Start",description:"Build your first reactive Courvux app — counter example, methods, computed properties.",slug:"/quick-start"})}},mo={data:{s_interp:`<!-- Text interpolation -->
<p>{{ count }}</p>
<p>{{ price * qty }}</p>
<p>{{ active ? 'On' : 'Off' }}</p>
...
<div id="app" cv-cloak></div>`},template:`
    ...
    `,exprs:{"'html'":(e=>"html"),s_interp:(e=>e.s_interp),s_bind:(e=>e.s_bind),s_events:(e=>e.s_events),s_cvfor:(e=>e.s_cvfor),s_cvif:(e=>e.s_cvif),s_cvshow:(e=>e.s_cvshow),s_cvmodel:(e=>e.s_cvmodel),s_cvhtml:(e=>e.s_cvhtml),s_cvdata:(e=>e.s_cvdata),s_misc:(e=>e.s_misc)},onMount(){X({title:"Template Syntax",description:"Courvux directives and bindings: cv-if, cv-for, cv-model, cv-show, :class, :style, @event.",slug:"/template"})}},ho={data:{s_define:`createApp({
    components: {
        'user-card': {
...
<editor cv-model:title="docTitle" cv-model:body="docBody" />`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_define:(e=>e.s_define),s_props:(e=>e.s_props),s_emit:(e=>e.s_emit),s_dispatch:(e=>e.s_dispatch),"'html'":(e=>"html"),s_slots:(e=>e.s_slots),s_dynamic:(e=>e.s_dynamic),s_refs:(e=>e.s_refs),s_model:(e=>e.s_model)},onMount(){X({title:"Components",description:"Define, register, and compose Courvux components with props, slots, emits, and scoped slots.",slug:"/components"})}},fo={data:{s_computed:`{
    data: { price: 10, qty: 3 },
    computed: {
...
}`,s3:`// Error boundary — catches errors from descendant onMount
{
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),s2:(e=>e.s2),s3:(e=>e.s3)},onMount(){X({title:"Lifecycle Hooks",description:"onMount, onBeforeUnmount, onDestroy, error boundaries, and async data in Courvux.",slug:"/lifecycle"})}},vo={data:{s_storage:`import { cvStorage } from 'courvux';
...
export const useCounter = defineComposable((initial = 0) => useComposables(
    ...
    `,exprs:{"'js'":(e=>"js"),s_define:(e=>e.s_define),s_useMany:(e=>e.s_useMany),s_nested:(e=>e.s_nested),s_storage:(e=>e.s_storage),s_fetch:(e=>e.s_fetch),s_fetch_opts:(e=>e.s_fetch_opts),s_debounce:(e=>e.s_debounce),s_throttle:(e=>e.s_throttle),s_media:(e=>e.s_media),s_listener:(e=>e.s_listener)},onMount(){X({title:"Composables",description:"Author and reuse logic in Courvux with defineComposable + useComposables, plus the built-in cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener helpers.",slug:"/composables"})}},bo={data:{s_basic:`import { createEventBus } from 'courvux';
...
bus.emit('toast:show', 'Saved again');  // handler does NOT run`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_basic:(e=>e.s_basic),"'ts'":(e=>"ts"),s_typed:(e=>e.s_typed),s_once:(e=>e.s_once),s_provide:(e=>e.s_provide),s_inject:(e=>e.s_inject)},onMount(){X({title:"Event Bus",description:"Typed cross-component event bus in Courvux: on, off, emit, once, clear, and provide/inject patterns.",slug:"/event-bus"})}},yo={data:{s_setup:`import { createApp, createRouter } from 'courvux';
...
methods: {
    ...
    `,exprs:{"'js'":(e=>"js"),s_setup:(e=>e.s_setup),s_route:(e=>e.s_route),s_params:(e=>e.s_params),s_lazy:(e=>e.s_lazy),s_navigate:(e=>e.s_navigate),s_nested:(e=>e.s_nested)},onMount(){X({title:"Router",description:"SPA routing in Courvux: dynamic params, nested routes, navigation guards, transitions.",slug:"/router"})}},xo={data:{s1:`import { createStore } from 'courvux';
...
{ inject: { localTheme: 'theme', endpoint: 'apiUrl' } }`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),"'html'":(e=>"html"),s2:(e=>e.s2),s3:(e=>e.s3),s4:(e=>e.s4),s5:(e=>e.s5),s6:(e=>e.s6)},onMount(){X({title:"Store",description:"Global reactive state in Courvux with createStore, modules, and namespaced actions.",slug:"/store"})}},wo={data:{s_basic:`import { useHead } from 'courvux';
...
// → embed headHtml in your shell, then html in the mount root`},template:`
    ...
    mode: 'history',
    base: '/courvux',
});`)},onMount(){X({title:"Static Site Generation",description:"Pre-render every route to static HTML at build time with the courvux/plugin/ssg Vite plugin.",slug:"/ssg"})}},So={data:{s_setup:`import { createApp, setupDevTools, mountDevOverlay } from 'courvux';
...
inst.setState('filter', 'completed');`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_setup:(e=>e.s_setup),s_external:(e=>e.s_external),"'ts'":(e=>"ts"),s_hook:(e=>e.s_hook)},onMount(){X({title:"DevTools",description:"In-app DevTools overlay for Courvux: live component state inspection and inline editing, no browser extension needed.",slug:"/devtools"})}},Ao={data:{s_basic:`import { mount } from 'courvux/test-utils';
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,exprs:{"'js'":(e=>"js"),s_config:(e=>e.s_config),s_basic:(e=>e.s_basic),s_state:(e=>e.s_state),s_global:(e=>e.s_global),s_async:(e=>e.s_async)},onMount(){X({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},_o={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
<button cv-if="pwa.installable && !pwa.installed" @click="pwa.prompt()">
    ...
    `,exprs:{"'json'":(e=>"json"),s_manifest:(e=>e.s_manifest),"'html'":(e=>"html"),s_link:(e=>e.s_link),"'js'":(e=>"js"),s_workbox:(e=>e.s_workbox),"'ts'":(e=>"ts"),s_pwa:(e=>e.s_pwa),s_use:(e=>e.s_use),s_template:(e=>e.s_template)},onMount(){X({title:"Progressive Web App",description:"Make any Courvux app installable and offline-capable: manifest, vite-plugin-pwa, install prompt utility.",slug:"/pwa"})}},Co={data:{s_install:"pnpm add courvux-precompiler@github:vanjexdev/courvux-precompiler",s_vite:`// vite.config.js
import { defineConfig } from 'vite';
...
[courvux-precompile] processed 25 file(s), 258 expression(s) precompiled, 0 template(s) fell back to runtime new Function.`,s_skip:"[courvux-precompile] templates not precompiled (CSP `unsafe-eval` required for these):\n  - src/pages/Dynamic.js:42 — `template` value is Identifier, not a static literal\n  - src/pages/Cards.js:12  — `template` value is ConditionalExpression, not a static literal"},template:`
    ...
    `,exprs:{"count + 1":(e=>e.count+1),loading:(e=>e.loading),"todos.push(draft)":(e=>e.todos.push(e.draft)),"form.email":(e=>e.form.email),"'bash'":(e=>"bash"),s_install:(e=>e.s_install),"'js'":(e=>"js"),s_vite:(e=>e.s_vite),"'html'":(e=>"html"),s_csp:(e=>e.s_csp),s_inline:(e=>e.s_inline),s_html:(e=>e.s_html),"'text'":(e=>"text"),s_skip:(e=>e.s_skip),s_report:(e=>e.s_report)},onMount(){X({title:"Strict CSP & the precompiler",description:"Drop `script-src 'unsafe-eval'` from your CSP by precompiling Courvux template expressions at build time with the Rust → WASM precompiler and its Vite plugin.",slug:"/csp"})}},To={data:{s_dir:`// Full definition
app.directive('focus', {
...
autoInit({
    ...
    `,exprs:{"'js'":(e=>"js"),s_dir:(e=>e.s_dir),"'html'":(e=>"html"),s_dir_use:(e=>e.s_dir_use),s_transition:(e=>e.s_transition),s_intersect:(e=>e.s_intersect),s_plugins:(e=>e.s_plugins),s_magic:(e=>e.s_magic),s_autoinit:(e=>e.s_autoinit)},onMount(){X({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},Eo={template:`
        <div class="prose">
...
this.cards.splice(idx, 1);`},template:`
    ...
    `,exprs:{"'html'":(e=>"html"),s_keyed:(e=>e.s_keyed),"item.id":(e=>e.item.id),"'js'":(e=>"js"),s_csp:(e=>e.s_csp),"'ts'":(e=>"ts"),s_ts:(e=>e.s_ts),s_lazy:(e=>e.s_lazy),s_vite:(e=>e.s_vite),s_tauri:(e=>e.s_tauri),s_test:(e=>e.s_test),s_proxyId_faq:(e=>e.s_proxyId_faq)},onMount(){X({title:"FAQ",description:"Frequently asked questions and troubleshooting for Courvux: cv-for keys, strict CSP, TypeScript, lazy loading, Vite/Tauri integration, testing, migration.",slug:"/faq"})}},jo={data:{s_component_vue:`// Vue 3 — Options API
export default {
    data() { return { count: 0 } },
...
// Used in HTML: $store.cart.count`},template:`
    ...
    `,exprs:{"{ open: false }":(e=>({open:!1})),open:(e=>e.open),items:(e=>e.items),"'foo_'+id":(e=>"foo_"+e.id),"'html'":(e=>"html"),s_xdata:(e=>e.s_xdata),s_init:(e=>e.s_init),"'js'":(e=>"js"),s_components:(e=>e.s_components),counter:(e=>e.counter),s_store:(e=>e.s_store)},onMount(){X({title:"Migrating from Alpine",description:"Mapping table from Alpine.js to Courvux: x-data → cv-data, directives, named components, stores. Mostly identical syntax with a prefix swap.",slug:"/migrating-from-alpine"})}},kt="courvux-demo-todos",Fo=`const STORAGE_KEY = 'courvux-demo-todos';
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function Do(){try{return JSON.parse(localStorage.getItem(kt))||[]}catch{return[]}}function Io(e){localStorage.setItem(kt,JSON.stringify(e))}const Lo={data:{todos:Do(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:Fo,srcHtml:Po,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(e=>!e.done):this.filter==="completed"?this.todos.filter(e=>e.done):this.todos},remaining(){return this.todos.filter(e=>!e.done).length},allDone(){return this.todos.length>0&&this.todos.every(e=>e.done)}},watch:{todos:{deep:!0,handler(e){Io(e)}}},methods:{add(){const e=this.newTodo.trim();e&&(this.todos=[...this.todos,{id:this._nextId++,text:e,done:!1}],this.newTodo="")},toggle(e){this.todos=this.todos.map(t=>t.id===e?{...t,done:!t.done}:t)},remove(e){this.todos=this.todos.filter(t=>t.id!==e)},clearCompleted(){this.todos=this.todos.filter(e=>!e.done)},toggleAll(){const e=this.allDone;this.todos=this.todos.map(t=>({...t,done:!e}))},startEdit(e){this.editingId=e.id,this.editText=e.text,this.$nextTick(()=>{var t;return(t=this.$refs["edit_"+e.id])==null?void 0:t.focus()})},commitEdit(e){const t=this.editText.trim();t?this.todos=this.todos.map(o=>o.id===e?{...o,text:t}:o):this.remove(e),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(e){this.filter=e}},template:`
    ...
    `,exprs:{"goBack()":(e=>e.goBack()),"$event.currentTarget.style.background='#f5f5f5'":(e=>e.$event.currentTarget.style.background="#f5f5f5"),"$event.currentTarget.style.background='#fff'":(e=>e.$event.currentTarget.style.background="#fff"),"$event.currentTarget.style.opacity='0.85'":(e=>e.$event.currentTarget.style.opacity="0.85"),"$event.currentTarget.style.opacity='1'":(e=>e.$event.currentTarget.style.opacity="1")},onMount(){X({title:"404 — Page not found",description:"The page you are looking for does not exist on Courvux docs.",slug:"/404"})}};let Ne=null;function zo(e){Ne=e}const Ho=Mt([...Mo,{path:"*",component:Ro}],{mode:"history",base:"/courvux",afterEach(){Ne&&Ne()},scrollBehavior:()=>{var e;return(e=document.querySelector("main"))==null||e.scrollTo({top:0,behavior:"instant"}),{x:0,y:0}}}),ht=[{key:"start",label:"Getting Started",items:[{to:"/",label:"Introduction"},{to:"/installation",label:"Installation"},{to:"/quick-start",label:"Quick Start"}]},{key:"template",label:"Template Syntax",items:[{to:"/template",label:"Directives & Bindings"}]},{key:"components",label:"Components",items:[{to:"/components",label:"Components"},{to:"/reactivity",label:"Reactivity"},{to:"/lifecycle",label:"Lifecycle"},{to:"/composables",label:"Composables"},{to:"/event-bus",label:"Event Bus"}]},{key:"router",label:"Router & Store",items:[{to:"/router",label:"Router"},{to:"/store",label:"Store"}]},{key:"seo",label:"SEO & SSG",items:[{to:"/head",label:"useHead"},{to:"/ssg",label:"Static Generation"}]},{key:"tooling",label:"Tooling",items:[{to:"/devtools",label:"DevTools"},{to:"/testing",label:"Testing"},{to:"/pwa",label:"PWA"},{to:"/csp",label:"Strict CSP"}]},{key:"advanced",label:"Advanced",items:[{to:"/advanced",label:"Directives & Plugins"}]},{key:"reference",label:"Reference",items:[{to:"/design-decisions",label:"Design Decisions"},{to:"/faq",label:"FAQ & Troubleshooting"},{to:"/migrating-from-vue",label:"Migrating from Vue"},{to:"/migrating-from-alpine",label:"Migrating from Alpine"}]},{key:"demo",label:"Demo",items:[{to:"/demo",label:"⚡ TODO App"}]}];Qt({router:Ho,components:{"code-block":io},data:{nav:ht,open:ht.reduce((e,t)=>(e[t.key]=!0,e),{}),sidebarOpen:!1},methods:{toggle(e){this.open={...this.open,[e]:!this.open[e]}},toggleSidebar(){if(this.sidebarOpen=!this.sidebarOpen,this.sidebarOpen)document.body.style.overflow="hidden",this.$nextTick(()=>{const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(0)")});else{document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(-100%)")}},closeSidebar(){if(window.innerWidth<=1024){this.sidebarOpen=!1,document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(-100%)")}}},onMount(){zo(()=>{this.closeSidebar()})},onBeforeMount(){typeof window<"u"&&window.addEventListener("resize",()=>{if(window.innerWidth>1024&&this.sidebarOpen){this.sidebarOpen=!1,document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="")}})},template:`
