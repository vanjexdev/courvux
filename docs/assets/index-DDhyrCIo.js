(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const y of s)if(y.type==="childList")for(const S of y.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&i(S)}).observe(document,{childList:!0,subtree:!0});function o(s){const y={};return s.integrity&&(y.integrity=s.integrity),s.referrerPolicy&&(y.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?y.credentials="include":s.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function i(s){if(s.ep)return;s.ep=!0;const y=o(s);fetch(s.href,y)}})();var xt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),ct=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,De=new WeakSet,Ae=Symbol("raw"),Oe=e=>e===null||typeof e!="object"?e:e[Ae]??e,ke=0,Ie=new Map,ve=null;function ze(e){const t=[],o=ve;ve=t;try{e()}finally{ve=o}return t}function kt(e){ke++;try{e()}finally{if(ke--,ke===0){const t=[...Ie.values()];Ie.clear(),t.forEach(o=>o())}}}function dt(e,t){return e===null||typeof e!="object"||De.has(e)||ct(e)?e:new Proxy(e,{get(o,i){if(i===Ae)return o[Ae]??o;if(typeof i=="string"&&Array.isArray(o)&&xt.has(i))return(...y)=>{const S=Array.prototype[i].apply(o,y);return t(),S};const s=o[i];return s!==null&&typeof s=="object"&&!De.has(s)?dt(s,t):s},set(o,i,s){return o[i]=s,t(),!0}})}function Me(){const e={},t=Math.random().toString(36).slice(2),o=(y,S)=>(e[y]||(e[y]=new Set),e[y].add(S),()=>{var w;(w=e[y])==null||w.delete(S)}),i=y=>{ke>0?Ie.set(`${t}:${y}`,()=>{(e[y]?[...e[y]]:[]).forEach(S=>S())}):(e[y]?[...e[y]]:[]).forEach(S=>S())},s={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(S,w){if(w===Ae)return y;typeof w=="string"&&!w.startsWith("$")&&ve&&ve.push({sub:o,key:w});const R=S[w];return typeof w=="string"&&!w.startsWith("$")&&R!==null&&typeof R=="object"&&!De.has(R)&&!ct(R)?dt(R,()=>i(w)):R},set(S,w,R){if(s[w])return s[w](R),!0;const $=S[w];return S[w]=R,($!==R||R!==null&&typeof R=="object")&&i(w),!0}}),registerSetInterceptor:(y,S)=>{s[y]=S},notifyAll:()=>{Object.keys(e).forEach(y=>i(y))}}}var Fe=new WeakMap;function be(e,t,o){var s,y;const i=t.indexOf(".");if(i>=0){const S=t.slice(0,i),w=t.slice(i+1),R=e[S];return R&&Fe.has(R)?be(R,w,o):((s=Fe.get(e))==null?void 0:s(S,o))??(()=>{})}return((y=Fe.get(e))==null?void 0:y(t,o))??(()=>{})}var lt=(e,t)=>e.split(".").reduce((o,i)=>o==null?void 0:o[i],t),ut=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),He=new Map,Ne=new Map,pt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!pt(o.slice(1).trim(),t):lt(o,t)},U=(e,t)=>{if(!ut)return pt(e,t);try{let o=He.get(e);return o||(o=new Function("$data",`with($data) { return (${e}) }`),He.set(e,o)),o(t)}catch{return lt(e,t)}},mt=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):be(t.store,e.slice(7),o):t.subscribe(e,o),Z=(e,t,o)=>{const i=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),s=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(s.map(w=>w.startsWith("$store.")?w:w.split(".")[0]).filter(w=>!i.has(w)))];if(y.length===0)return()=>{};const S=y.map(w=>mt(w,t,o));return()=>S.forEach(w=>w())},pe=(e,t,o)=>{const i=e.split(".");if(i.length===1)t[i[0]]=o;else{const s=i.slice(0,-1).reduce((y,S)=>y==null?void 0:y[S],t);s&&(s[i[i.length-1]]=o)}},We=(e,t,o,i,s)=>{const y={};return Object.keys(e).forEach(S=>y[S]=e[S]),y[o]=t,s&&(y[s]=i),y},Le=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(Le).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Ue=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([i,s])=>{e.style[i]=s??""}))},qe=(e,t,o)=>{if(ut)try{let i=Ne.get(e);i||(i=new Function("__p__",`with(__p__){${e}}`),Ne.set(e,i));const s=new Proxy({},{has:()=>!0,get:(y,S)=>S==="$event"?o:S in t?t[S]:globalThis[S],set:(y,S,w)=>(t[S]=w,!0)});i(s)}catch(i){console.warn(`[courvux] handler error "${e}":`,i)}},ce=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(i=>{const s=()=>i();e.addEventListener("animationend",s,{once:!0}),e.addEventListener("transitionend",s,{once:!0}),setTimeout(s,o+50)})},St=`
...
`,Be=!1;function Ve(){if(Be||typeof document>"u")return;Be=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=St,document.head.appendChild(e)}var Ge=!1;function At(){if(Ge||typeof document>"u")return;Ge=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function Ct(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(i=>{(i.name.startsWith("on")||i.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(i.name)})}),t.body.innerHTML}async function te(e,t,o){var y,S,w,R,$,C,I,_,M,z,O,L,E,c,d,p,x;const i=Array.from(e.childNodes);let s=0;for(;s<i.length;){const k=i[s];if(k.nodeType===3){const a=k.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,f=()=>{let m=r;l.forEach(u=>{const h=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(u,U(h,t)??"")}),k.textContent=m};l.forEach(m=>{Z(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,f)}),f()}s++;continue}if(k.nodeType!==1){s++;continue}const n=k,v=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),s++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await te(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),s++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await te(n,t,o),l.appendChild(n),s++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(h=>U(h.trim(),t));let r=l();const f=[],m=h=>(f.push(h),()=>{const g=f.indexOf(h);g>-1&&f.splice(g,1)});await te(n,t,{...o,subscribe:(h,g)=>m(g),storeSubscribeOverride:(h,g,T)=>m(T)});const u=Z(a,o,()=>{const h=l();h.some((g,T)=>g!==r[T])&&(r=h,[...f].forEach(g=>g()))});(y=o.registerCleanup)==null||y.call(o,()=>u()),s++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const f=U(a,t)??{};Object.entries(f).forEach(([m,u])=>{typeof u=="function"?r[m]=u:l[m]=u})}else if(a){const f=(S=o.components)==null?void 0:S[a];if(f){const m=typeof f.data=="function"?f.data():f.data??{};m instanceof Promise||Object.assign(l,m),Object.assign(r,f.methods??{})}}if(o.createChildScope){const f=o.createChildScope(l,r);(w=o.registerCleanup)==null||w.call(o,f.cleanup),await te(n,f.state,{...o,subscribe:f.subscribe})}else await te(n,{...t,...l,...r},o);s++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,f,m]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const h=n.getAttribute("cv-transition")??null;h&&n.removeAttribute("cv-transition");const g=document.createComment(`cv-for: ${m}`);n.replaceWith(g);let T=[],F=[];const j=new Map;let W=!1,N=!1;const D=async()=>{var K;const q=U(m,t),H=q?typeof q=="number"?Array.from({length:q},(V,B)=>[B+1,B]):Array.isArray(q)?q.map((V,B)=>[V,B]):Object.entries(q).map(([V,B])=>[B,V]):[];if(u){const V=[],B=new Map,de=new Set;for(const[X,Y]of H){const ie=U(u,We(t,X,r,Y,f));de.has(ie)&&console.warn(`[courvux] cv-for: duplicate :key "${ie}" in "${m}"`),de.add(ie),V.push(ie),B.set(ie,[X,Y])}const Q=[];for(const[X,{el:Y,destroy:ie}]of j)B.has(X)||(h?(Y.classList.add(`${h}-leave`),Q.push(ce(Y).then(()=>{var se;Y.classList.remove(`${h}-leave`),ie(),(se=Y.parentNode)==null||se.removeChild(Y),j.delete(X)}))):(ie(),(K=Y.parentNode)==null||K.removeChild(Y),j.delete(X)));Q.length&&await Promise.all(Q);const re=g.parentNode,ae=[];for(const X of V){const[Y,ie]=B.get(X);if(j.has(X)){const se=j.get(X);se.itemRef!==Y&&(se.reactive[r]=Y,se.itemRef=Y),f&&(se.reactive[f]=ie)}else{const se=n.cloneNode(!0),Ee=[],{subscribe:vt,createReactiveState:bt}=Me(),Te=bt({[r]:Y,...f?{[f]:ie}:{}}),yt=new Proxy({},{has(le,ee){return!0},get(le,ee){return typeof ee!="string"?t[ee]:ee===r||f&&ee===f?Te[ee]:t[ee]},set(le,ee,ue){return ee===r||f&&ee===f?(Te[ee]=ue,!0):(t[ee]=ue,!0)}}),wt={...o,subscribe:(le,ee)=>{const ue=le.split(".")[0];let me;return ue===r||f&&ue===f?me=vt(ue,ee):me=o.subscribe(le,ee),Ee.push(me),me},storeSubscribeOverride:(le,ee,ue)=>{const me=be(le,ee,ue);return Ee.push(me),me}},_e=document.createDocumentFragment();_e.appendChild(se),await te(_e,yt,wt);const $e=_e.firstChild??se;h&&$e.classList.add(`${h}-enter`),j.set(X,{el:$e,reactive:Te,itemRef:Y,destroy:()=>Ee.forEach(le=>le())}),h&&ae.push($e)}}let oe=g.nextSibling,he=0;for(const X of V){const{el:Y}=j.get(X);Y!==oe?he++:oe=Y.nextSibling}if(he>0)if(he>V.length>>1){const X=document.createDocumentFragment();for(const Y of V)X.appendChild(j.get(Y).el);re.insertBefore(X,g.nextSibling)}else{oe=g.nextSibling;for(const X of V){const{el:Y}=j.get(X);Y!==oe?re.insertBefore(Y,oe):oe=Y.nextSibling}}T=V.map(X=>j.get(X).el),ae.length&&Promise.all(ae.map(X=>ce(X).then(()=>X.classList.remove(`${h}-enter`))))}else{if(F.forEach(Q=>Q()),F=[],T.forEach(Q=>{var re;return(re=Q.parentNode)==null?void 0:re.removeChild(Q)}),T=[],!H.length)return;const V=g.parentNode,B=g.nextSibling,de={...o,subscribe:(Q,re)=>{const ae=o.subscribe(Q,re);return F.push(ae),ae},storeSubscribeOverride:(Q,re,ae)=>{const oe=be(Q,re,ae);return F.push(oe),oe}};for(const[Q,re]of H){const ae=n.cloneNode(!0),oe=document.createDocumentFragment();oe.appendChild(ae),await te(oe,We(t,Q,r,re,f),de);const he=oe.firstChild??ae;V.insertBefore(oe,B),T.push(he)}}},G=async()=>{if(W){N=!0;return}W=!0;try{for(await D();N;)N=!1,await D()}finally{W=!1}};(R=o.registerCleanup)==null||R.call(o,()=>{j.forEach(({el:q,destroy:H})=>{var K;H(),(K=q.parentNode)==null||K.removeChild(q)}),j.clear(),F.forEach(q=>q()),T.forEach(q=>{var H;return(H=q.parentNode)==null?void 0:H.removeChild(q)}),T=[]}),Z(m,o,G),await G()}s++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let f=s+1;for(;f<i.length;){const T=i[f];if(T.nodeType===3&&((($=T.textContent)==null?void 0:$.trim())??"")===""){f++;continue}if(T.nodeType!==1)break;const F=T;if(F.hasAttribute("cv-else-if")){const j=F.getAttribute("cv-else-if");F.removeAttribute("cv-else-if");const W=document.createComment("cv-else-if");F.replaceWith(W),a.push({condition:j,template:F,anchor:W}),f++;continue}if(F.hasAttribute("cv-else")){F.removeAttribute("cv-else");const j=document.createComment("cv-else");F.replaceWith(j),a.push({condition:null,template:F,anchor:j}),f++;break}break}s=f;let m=null,u=!1,h=!1;const g=async()=>{var T,F;if(u){h=!0;return}u=!0;try{do{h=!1,m&&((T=m.parentNode)==null||T.removeChild(m),m=null);for(const j of a)if(j.condition===null||U(j.condition,t)){const W=j.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(W),await te(N,t,o);const D=N.firstChild??W;(F=j.anchor.parentNode)==null||F.insertBefore(N,j.anchor.nextSibling),m=D;break}}while(h)}finally{u=!1}};a.filter(T=>T.condition).forEach(T=>{Z(T.condition,o,g)}),await g();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=D=>(n.getAttribute(D)??"").split(" ").filter(Boolean),f=r("cv-transition:enter"),m=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),h=r("cv-transition:leave"),g=r("cv-transition:leave-start"),T=r("cv-transition:leave-end"),F=n.getAttribute("cv-transition")??"",j=new Set(F.split(".").slice(1)),W=[...j].find(D=>/^\d+$/.test(D)),N=W?parseInt(W):200;if(f.length||m.length||h.length||g.length){l.forEach(V=>n.removeAttribute(V.name));const D=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!U(a,t),q=!1,H=null;const K=async V=>{if(q){H=V;return}q=!0;try{V?(n.style.display="",n.classList.add(...f,...m),await D(),n.classList.remove(...m),n.classList.add(...u),await ce(n),n.classList.remove(...f,...u)):(n.classList.add(...h,...g),await D(),n.classList.remove(...g),n.classList.add(...T),await ce(n),n.classList.remove(...h,...T),n.style.display="none"),G=V}finally{if(q=!1,H!==null&&H!==G){const B=H;H=null,K(B)}else H=null}};G||(n.style.display="none"),Z(a,o,()=>{const V=!!U(a,t);V!==G&&K(V)})}else{const D=[...j].find(B=>B==="scale"||/^scale$/.test(B)),G=(()=>{const B=[...j].find(de=>/^\d+$/.test(de)&&de!==W);return B?parseInt(B)/100:.9})(),q=[];(!j.has("scale")||j.has("opacity"))&&q.push(`opacity ${N}ms ease`),D&&q.push(`transform ${N}ms ease`),q.length||q.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+q.join(", "),l.forEach(B=>n.removeAttribute(B.name));let H=!!U(a,t);const K=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B()))),V=async B=>{B?(n.style.display="",n.style.opacity="0",D&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",D&&(n.style.transform=""),await ce(n)):(n.style.opacity="0",D&&(n.style.transform=`scale(${G})`),await ce(n),n.style.display="none",n.style.opacity="",D&&(n.style.transform="")),H=B};H||(n.style.display="none"),Z(a,o,()=>{const B=!!U(a,t);B!==H&&V(B)})}}else{const r=n.getAttribute("cv-show-transition"),f=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),f&&n.removeAttribute(":transition");const m=r??(f?String(U(f,t)):null);if(m){Ve();let u=!!U(a,t);u||(n.style.display="none");let h=!1,g=null;const T=async F=>{if(h){g=F;return}h=!0;try{F?(n.style.display="",n.classList.add(`${m}-enter`),await ce(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ce(n),n.classList.remove(`${m}-leave`),n.style.display="none"),u=F}finally{if(h=!1,g!==null&&g!==u){const j=g;g=null,T(j)}else g=null}};Z(a,o,()=>{const F=!!U(a,t);F!==u&&T(F)})}else{const u=()=>{n.style.display=U(a,t)?"":"none"};Z(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{U(a,t)&&Promise.resolve().then(()=>n.focus())};Z(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(D=>D.name==="cv-intersect"||D.name==="cv-intersect:enter"||D.name.startsWith("cv-intersect.")),r=a.find(D=>D.name==="cv-intersect:leave"),f=(l==null?void 0:l.value)??"",m=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),h=new Set(u.slice(1)),g=h.has("once");let T=0;if(h.has("half"))T=.5;else if(h.has("full"))T=1;else{const D=[...h].find(G=>G.startsWith("threshold-"));D&&(T=parseInt(D.replace("threshold-",""))/100)}const F=[...h].find(D=>D.startsWith("margin-")),j=F?`${F.replace("margin-","")}px`:void 0;a.forEach(D=>n.removeAttribute(D.name));const W=D=>{if(D)try{new Function("$data",`with($data){${D}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${D}":`,G)}},N=new IntersectionObserver(D=>{D.forEach(G=>{G.isIntersecting?(W(f),g&&N.disconnect()):W(m)})},{threshold:T,...j?{rootMargin:j}:{}});N.observe(n),(C=o.registerCleanup)==null||C.call(o,()=>N.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=a.name.split(".").slice(1).includes("sanitize"),f=()=>{const m=String(U(l,t)??"");n.innerHTML=r?Ct(m):m};Z(l,o,f),f(),s++;continue}}if(n.hasAttribute("cv-ref")&&!((I=o.components)!=null&&I[v])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const b=!!((_=o.components)!=null&&_[v]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!b){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,f=(M=r.type)==null?void 0:M.toLowerCase(),m=u=>{if(l.has("number")){const h=parseFloat(u);return isNaN(h)?u:h}return l.has("trim")?u.trim():u};if(f==="checkbox"){const u=()=>{const h=U(a,t);r.checked=Array.isArray(h)?h.includes(r.value):!!h};Z(a,o,u),u(),r.addEventListener("change",()=>{const h=U(a,t);if(Array.isArray(h)){const g=[...h];if(r.checked)g.includes(r.value)||g.push(r.value);else{const T=g.indexOf(r.value);T>-1&&g.splice(T,1)}pe(a,t,g)}else pe(a,t,r.checked)})}else if(f==="radio"){const u=()=>{r.checked=U(a,t)===r.value};Z(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&pe(a,t,m(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,h=()=>{const g=String(U(a,t)??"");u.innerText!==g&&(u.innerText=g)};if(Z(a,o,h),h(),l.has("debounce")){const g=[...l].find(j=>/^\d+$/.test(j)),T=g?parseInt(g):300;let F;u.addEventListener("input",()=>{clearTimeout(F),F=setTimeout(()=>pe(a,t,m(u.innerText)),T)})}else{const g=l.has("lazy")?"blur":"input";u.addEventListener(g,()=>pe(a,t,m(u.innerText)))}}else{const u=()=>{r.value=U(a,t)??""};if(Z(a,o,u),u(),l.has("debounce")){const h=[...l].find(F=>/^\d+$/.test(F)),g=h?parseInt(h):300;let T;r.addEventListener("input",()=>{clearTimeout(T),T=setTimeout(()=>pe(a,t,m(r.value)),g)})}else{const h=v==="select"||l.has("lazy")?"change":"input";r.addEventListener(h,()=>pe(a,t,m(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var W,N;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],f=l.slice(1),m=r.indexOf(":"),u=m>=0?r.slice(0,m):r,h=m>=0?r.slice(m+1):void 0,g=o.directives[u];if(!g)return;const T=a.value;n.removeAttribute(a.name);const F=typeof g=="function"?{onMount:g}:g,j={value:T?U(T,t):void 0,arg:h,modifiers:Object.fromEntries(f.map(D=>[D,!0]))};(W=F.onMount)==null||W.call(F,n,j),F.onUpdate&&T&&Z(T,o,()=>{j.value=U(T,t),F.onUpdate(n,j)}),F.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>F.onDestroy(n,j)))}),v==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=U(u.value,t))});const f=await l(r),m=document.createDocumentFragment();f.forEach(u=>m.appendChild(u)),n.replaceWith(m)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await te(r,t,o),n.replaceWith(r)}s++;continue}if(v==="cv-transition"){Ve();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await te(r,t,o),l){let f=!!U(l,t),m=!1,u=null;f||(r.style.display="none");const h=async g=>{if(m){u=g;return}m=!0;try{g?(r.style.display="",r.classList.add(`${a}-enter`),await ce(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ce(r),r.classList.remove(`${a}-leave`),r.style.display="none"),f=g}finally{if(m=!1,u!==null&&u!==f){const T=u;u=null,h(T)}else u=null}};Z(l,o,()=>{const g=!!U(l,t);g!==f&&h(g)})}s++;continue}if(v==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),s++;continue}if(v==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(U(a,t)??"/"):l||"/",f=D=>String(D).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let m="";Array.from(n.attributes).forEach(D=>{D.name==="to"||D.name===":to"||(m+=` ${D.name}="${f(D.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${m}></a>`;const h=u.firstElementChild;for(;n.firstChild;)h.appendChild(n.firstChild);const g=((O=o.router)==null?void 0:O.base)??"",T=D=>g?D===g?"/":D.startsWith(g+"/")?D.slice(g.length)||"/":D||"/":D||"/",F=()=>{var D;return((D=o.router)==null?void 0:D.mode)==="history"?T(window.location.pathname):window.location.hash.slice(1)||"/"},j=()=>{var q;const D=r(),G=F()===D;((q=o.router)==null?void 0:q.mode)==="history"?h.href=`${g}${D}`:h.href=`#${D}`,G?(h.setAttribute("aria-current","page"),h.classList.add("active")):(h.removeAttribute("aria-current"),h.classList.remove("active"))};((L=o.router)==null?void 0:L.mode)==="history"?(h.addEventListener("click",D=>{D.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",j)):window.addEventListener("hashchange",j),a&&Z(a,o,j),j();const W=document.createDocumentFragment();W.appendChild(h),await te(W,t,o);const N=W.firstChild??h;n.replaceWith(N),s++;continue}if(v==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),s++;continue}if((E=o.components)!=null&&E[v]&&o.mountElement){await o.mountElement(n,v,t,o),s++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=U(a.value,t);let f,m=0,u="0px",h=l.has("once");if(typeof r=="function"?f=g=>r.call(t,g):r&&typeof r=="object"&&(typeof r.handler=="function"&&(f=g=>r.handler.call(t,g)),r.threshold!==void 0&&(m=r.threshold),r.margin&&(u=r.margin),r.once&&(h=!0)),f){const g=new IntersectionObserver(T=>{const F=T[0];f(F),h&&F.isIntersecting&&g.disconnect()},{threshold:m,rootMargin:u});g.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>g.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=U(a,t);let r,f="content-box";if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.box&&(f=l.box)),r){const m=new ResizeObserver(u=>{u[0]&&r(u[0])});m.observe(n,{box:f}),(d=o.registerCleanup)==null||d.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=U(a,t);let r,f=0;if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.throttle&&(f=l.throttle)),r){let m=0;const u=()=>{const h=Date.now();f>0&&h-m<f||(m=h,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(p=o.registerCleanup)==null||p.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):qe(a,t,r))};document.addEventListener("click",l,!0),(x=o.registerCleanup)==null||x.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let f=[];const m=()=>{const u=U(a,t)??{},h=Object.keys(u);for(const g of f)g in u||(g==="class"?n.className=l:g==="style"?n.style.cssText=r:n.removeAttribute(g));for(const[g,T]of Object.entries(u))if(g==="class")n.className=[l,Le(T)].filter(Boolean).join(" ");else if(g==="style")Ue(n,T,r);else if(T==null||T===!1)try{n.removeAttribute(g)}catch{}else try{n.setAttribute(g,T===!0?"":String(T))}catch(F){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${g}":`,F)}f=h};Z(a,o,m),m()}const P={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],f=new Set(l.slice(1)),m=[...f].find(T=>T in P),u=a.value,h=T=>{f.has("prevent")&&T.preventDefault(),f.has("stop")&&T.stopPropagation(),!(f.has("self")&&T.target!==T.currentTarget)&&(m&&T.key!==P[m]||(typeof t[u]=="function"?t[u].call(t,T):qe(u,t,T)))},g={};f.has("once")&&(g.once=!0),f.has("passive")&&(g.passive=!0),f.has("capture")&&(g.capture=!0),n.addEventListener(r,h,Object.keys(g).length?g:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const f=n.getAttribute("class")??"",m=()=>{n.className=[f,Le(U(r,t))].filter(Boolean).join(" ")};Z(r,o,m),m()}else if(l==="style"){const f=n.getAttribute("style")??"",m=()=>Ue(n,U(r,t),f);Z(r,o,m),m()}else if(l.includes("-")){const f=()=>{const m=U(r,t);m==null||m===!1?n.removeAttribute(l):n.setAttribute(l,m===!0?"":String(m))};Z(r,o,f),f()}else{const f=()=>{n[l]=U(r,t)??""};Z(r,o,f),f()}}}),k.hasChildNodes()&&await te(k,t,o),s++}}var Et=`
...
`;function Tt(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=Et,document.head.appendChild(e)}async function ye(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(y=>{const S=()=>y();e.addEventListener("animationend",S,{once:!0}),e.addEventListener("transitionend",S,{once:!0}),setTimeout(S,s+50)}),e.classList.remove(`${t}-${o}`)}var Se=new Map;async function _t(e){if(typeof e!="function")return e;if(Se.has(e))return Se.get(e);const t=await e();return Se.set(e,t.default),t.default}function Ye(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Xe(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((y,S)=>[y,s[S+1]])):null}function $t(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((y,S)=>[y,s[S+1]])),remaining:s[o.length+1]||"/"}:null}function ht(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:ht(o.children,i==="/"?"":i)}:{...o,path:i}})}var fe=(e,t)=>new Promise(o=>e(t,o)),Ze=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Ot(e,t={}){const o=t.mode??"hash",i=Ft(t.base??"");return{routes:ht(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,y){const S=Je(s,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=S},replace(s,y){const S=Je(s,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const w=window.location.href.split("#")[0];window.location.replace(`${w}#${S}`)}},back(){history.back()},forward(){history.forward()}}}function Ft(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function jt(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Je(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function Ke(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function Qe(e,t,o,i="default",s){const y=t.base??"",S=p=>p.length>1&&p.endsWith("/")?p.slice(0,-1):p,w=()=>t.mode==="history"?S(jt(window.location.pathname,y)):S((window.location.hash.slice(1)||"/").split("?")[0]||"/"),R=()=>{if(t.mode==="history")return Ke(window.location.search);const p=window.location.hash.slice(1)||"/",x=p.indexOf("?");return x>=0?Ke(p.slice(x+1)):{}};t.transition&&Tt();let $=null,C=null,I=null,_=null,M=!1;const z=()=>{M||(M=!0,s==null||s())},O=new Map,L=p=>{var x;if(p!=null&&p.keepAlive&&I){(x=I.deactivate)==null||x.call(I);const k=document.createDocumentFragment();for(;e.firstChild;)k.appendChild(e.firstChild);O.set($.path,{fragment:k,activation:I}),I=null}else I==null||I.destroy(),I=null,e.innerHTML=""},E=async(p,x,k,n,v)=>{const b=typeof x=="function"&&!Se.has(x),A=b?x.__asyncOptions:void 0,P=p.loadingTemplate??(A==null?void 0:A.loadingTemplate);b&&P&&(e.innerHTML=P);let a;try{a=await _t(x)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return b&&P&&(e.innerHTML=""),o(e,a,k,n,v)},c=async()=>{var k,n,v,b,A,P,a,l;const p=w(),x=R();for(const r of t.routes){if((k=r.children)!=null&&k.length){const m=$t(r.path,p);if(m!==null)for(const u of r.children){const h=Xe(u.path,p);if(h!==null){const g={params:m.params,query:x,path:p,meta:r.meta};if(u.redirect){const W={params:h,query:x,path:p,meta:u.meta},N=typeof u.redirect=="function"?u.redirect(W):u.redirect;t.navigate(N);return}if(t.beforeEach){const W=await fe(t.beforeEach,g);if(W){t.navigate(W);return}}if(r.beforeEnter){const W=await fe(r.beforeEnter,g);if(W){t.navigate(W);return}}if(u.beforeEnter){const W={params:h,query:x,path:p,meta:u.meta},N=await fe(u.beforeEnter,W);if(N){t.navigate(N);return}}const T=`${r.path}::${JSON.stringify(m.params)}`;if(_!==T){const W=await Ze(I,g);if(W){t.navigate(W);return}const N=r.transition??t.transition;N&&e.hasChildNodes()&&await ye(e,N,"leave"),L(C);const D=Ye(r,i);if(D){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(q,H)=>t.navigate(q,H),replace:(q,H)=>t.replace(q,H),back:()=>t.back(),forward:()=>t.forward()};I=await E(r,D,g,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=I.enter)==null||n.call(I,$)}else e.innerHTML="";_=T,N&&await ye(e,N,"enter")}const F={params:{...m.params,...h},query:x,path:p,meta:u.meta??r.meta};(v=t.afterEach)==null||v.call(t,F,$);const j=(b=t.scrollBehavior)==null?void 0:b.call(t,F,$);j&&window.scrollTo(j.x??0,j.y??0),$=F,C=r,z();return}}}const f=Xe(r.path,p);if(f!==null){_=null;const m={params:f,query:x,path:p,meta:r.meta};if(r.redirect){const F=typeof r.redirect=="function"?r.redirect(m):r.redirect;t.navigate(F);return}if(t.beforeEach){const F=await fe(t.beforeEach,m);if(F){t.navigate(F);return}}if(r.beforeEnter){const F=await fe(r.beforeEnter,m);if(F){t.navigate(F);return}}const u=await Ze(I,m);if(u){t.navigate(u);return}const h=r.transition??t.transition;h&&e.hasChildNodes()&&await ye(e,h,"leave"),L(C);const g=Ye(r,i);if(g){const F=m.path;if(r.keepAlive&&O.has(F)){const j=O.get(F);e.appendChild(j.fragment),I=j.activation,(A=I.activate)==null||A.call(I),O.delete(F)}else{const j=$;I=await E(r,g,m,i==="default"?r.layout:void 0),(P=I.enter)==null||P.call(I,j)}}else e.innerHTML="",I=null;h&&await ye(e,h,"enter"),(a=t.afterEach)==null||a.call(t,m,$);const T=(l=t.scrollBehavior)==null?void 0:l.call(t,m,$);T&&window.scrollTo(T.x??0,T.y??0),$=m,C=r,z();return}}_=null,L(C),C=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),I==null||I.destroy(),I=null,O.forEach(({activation:p})=>p.destroy()),O.clear()}}function Pt(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(y=>{try{y(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Dt=0;function It(){return++Dt}var Mt=`
...
`;function Lt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Mt,document.head.appendChild(e)}function we(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function et(e){try{return JSON.parse(e)}catch{return e}}function Rt(e){if(typeof document>"u")return;Lt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,i="components",s=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(y);const S=document.createElement("div");S.id="cvd-panel",S.style.display="none",t.appendChild(S),S.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const w=S.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",S.style.display="flex",I()}),S.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,S.style.display="none",y.style.display=""}),S.querySelectorAll(".cvd-tab").forEach(_=>{_.addEventListener("click",()=>{i=_.dataset.tab,S.querySelectorAll(".cvd-tab").forEach(M=>M.classList.remove("active")),_.classList.add("active"),I()})});const R=S.querySelector("#cvd-head");R.addEventListener("pointerdown",_=>{if(_.target.closest("button"))return;R.setPointerCapture(_.pointerId);const M=_.clientX,z=_.clientY,O=t.offsetLeft,L=t.offsetTop,E=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${O+(d.clientX-M)}px`,t.style.top=`${L+(d.clientY-z)}px`},c=d=>{R.releasePointerCapture(d.pointerId),R.removeEventListener("pointermove",E),R.removeEventListener("pointerup",c),R.removeEventListener("pointercancel",c)};R.addEventListener("pointermove",E),R.addEventListener("pointerup",c),R.addEventListener("pointercancel",c)});function $(){const _=e.instances;if(!_.length){w.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}w.innerHTML=_.map(M=>{const z=M.getState(),O=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${O.map(L=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${M}" data-key="${L}" title="click to edit">${we(z[L])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),w.querySelectorAll(".cvd-inst-head").forEach(_=>{_.addEventListener("click",()=>_.closest(".cvd-inst").classList.toggle("open"))}),w.querySelectorAll("[data-store][data-key]").forEach(_=>{_.addEventListener("click",M=>{M.stopPropagation();const z=_;if(z.querySelector("input"))return;const O=parseInt(z.dataset.store),L=z.dataset.key,E=e.stores[O];if(!E)return;const c=we(E.getState()[L]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const p=()=>{E.setState(L,et(d.value)),z.classList.remove("editing")};d.addEventListener("blur",p),d.addEventListener("keydown",x=>{x.key==="Enter"&&(x.preventDefault(),p()),x.key==="Escape"&&(z.classList.remove("editing"),I())})})})}function I(){o&&(i==="components"?$():C())}e.on("mount",()=>I()),e.on("update",()=>I()),e.on("destroy",()=>I()),e.on("store-update",()=>I())}var zt="__COURVUX_HEAD_COLLECTOR__";function Ht(){return globalThis[zt]??null}var Nt=(e,t)=>{Object.entries(t).forEach(([o,i])=>{o!=="innerHTML"&&(i==null||i===!1||e.setAttribute(o,i===!0?"":String(i)))})},Wt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Ut=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,i])=>e.setAttribute(o,i))},tt=(e,t,o,i)=>{let s=o?document.head.querySelector(o):null;s?(i.push({el:s,prevAttrs:Wt(s),created:!1}),Array.from(s.attributes).forEach(y=>s.removeAttribute(y.name))):(s=document.createElement(e),document.head.appendChild(s),i.push({el:s,created:!0})),Nt(s,t)};function qt(e){var S,w,R;const t=Ht();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let i;const s={},y={};if(e.title!==void 0){i=document.title;const $=e.titleTemplate,C=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=C}return(S=e.meta)==null||S.forEach($=>{tt("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(w=e.link)==null||w.forEach($=>{tt("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(R=e.script)==null||R.forEach($=>{const C=document.createElement("script");Object.entries($).forEach(([I,_])=>{I==="innerHTML"?C.textContent=String(_):_!=null&&_!==!1&&C.setAttribute(I,_===!0?"":String(_))}),document.head.appendChild(C),o.push({el:C,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,C])=>{s[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,C)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,C])=>{y[$]=document.body.getAttribute($),document.body.setAttribute($,C)}),function(){i!==void 0&&(document.title=i),o.forEach(({el:$,prevAttrs:C,created:I})=>{var _;I?(_=$.parentNode)==null||_.removeChild($):C&&Ut($,C)}),Object.entries(s).forEach(([$,C])=>{C===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,C)}),Object.entries(y).forEach(([$,C])=>{C===null?document.body.removeAttribute($):document.body.setAttribute($,C)})}}var je="data-courvux-ssr",Bt=e=>e?Promise.resolve().then(e):Promise.resolve();function ot(e,t){const o=e.trim();if(o.startsWith("{")){const i=o.replace(/[{}]/g,"").split(",").map(s=>s.trim()).filter(Boolean);return Object.fromEntries(i.map(s=>[s,t[s]]))}return{[o]:t}}var xe=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var x,k,n;const i={},{subscribe:s,createReactiveState:y,registerSetInterceptor:S,notifyAll:w}=Me();let R;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),R=await t.data()):R=t.data??{},t.templateUrl){const v=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,b=await fetch(v);if(!b.ok)throw new Error(`Failed to load template: ${v} (${b.status})`);e.innerHTML=await b.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(je),(x=e.querySelector(`[${je}]`))==null||x.removeAttribute(je);const $={};if(t.inject&&o.provided){const v=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(b=>[b,b])):t.inject;Object.entries(v).forEach(([b,A])=>{o.provided&&A in o.provided&&($[b]=o.provided[A])})}const C=y({...o.globalProperties??{},...R,...$,...t.methods,$refs:i,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(v=>[v,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});C.$watch=(v,b,A)=>{const P=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=P?xe(C[v]):C[v];const r=s(v,()=>{const f=C[v];b.call(C,f,l),l=P?xe(f):f});return a&&b.call(C,C[v],void 0),r},C.$batch=kt,C.$nextTick=v=>Bt(v),C.$dispatch=(v,b,A)=>{e.dispatchEvent(new CustomEvent(v,{bubbles:!0,composed:!0,...A??{},detail:b}))},o.magics&&Object.entries(o.magics).forEach(([v,b])=>{C[v]=b(C)}),C.$forceUpdate=()=>w();const I=[];C.$watchEffect=v=>{let b=[];const A=()=>{b.forEach(r=>r()),b=[];const a=ze(()=>{try{v()}catch{}}),l=new Map;for(const{sub:r,key:f}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(f)&&(l.get(r).add(f),b.push(r(f,A)))};A();const P=()=>{b.forEach(l=>l()),b=[];const a=I.indexOf(P);a>-1&&I.splice(a,1)};return I.push(P),P};const _=[];t.computed&&Object.entries(t.computed).forEach(([v,b])=>{const A=typeof b=="function"?b:b.get,P=typeof b!="function"?b.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const f=ze(()=>{try{r=A.call(C)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});C[v]=r;const m=new Map;for(const{sub:u,key:h}of f)m.has(u)||m.set(u,new Set),!m.get(u).has(h)&&(m.get(u).add(h),a.push(u(h,l)))};l(),_.push(()=>a.forEach(r=>r())),P&&S(v,r=>P.call(C,r))});const M=[];t.watch&&Object.entries(t.watch).forEach(([v,b])=>{const A=typeof b=="object"&&b!==null&&"handler"in b,P=A?b.handler:b,a=A?b.immediate??!1:!1,l=A?b.deep??!1:!1;let r=l?xe(C[v]):C[v];const f=s(v,()=>{const m=C[v];P.call(C,m,r),r=l?xe(m):m});M.push(f),a&&P.call(C,C[v],void 0)});const z={...o.provided??{}};if(t.provide){const v=typeof t.provide=="function"?t.provide.call(C):t.provide;Object.assign(z,v)}const O={...o,provided:z,components:{...o.components,...t.components}};O.mountElement=Ce(O),O.createChildScope=(v,b)=>{const A=new Set(Object.keys(v)),P=new Set(Object.keys(b)),{subscribe:a,createReactiveState:l}=Me(),r=l(v);let f;return f=new Proxy({},{get(m,u){return typeof u!="string"?C[u]:A.has(u)?r[u]:P.has(u)?b[u].bind(f):C[u]},set(m,u,h){return typeof u!="string"?!1:A.has(u)?(r[u]=h,!0):(C[u]=h,!0)},has(m,u){return A.has(u)||P.has(u)||u in C},ownKeys(){return[...A,...P,...Object.keys(C)]},getOwnPropertyDescriptor(m,u){return A.has(u)||P.has(u)||u in C?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:f,subscribe:(m,u)=>A.has(m)?a(m,u):c(m,u),cleanup:()=>{}}},O.mountDynamic=async(v,b,A,P,a)=>{let l=null,r=null;const f=A.getAttribute("loading-template")??"",m=async()=>{var D,G,q;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=U(b,P);if(!u)return;let h;if(typeof u=="function"){if(f){const H=document.createElement("div");H.innerHTML=f,(D=v.parentNode)==null||D.insertBefore(H,v.nextSibling),l=H}h=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?h=(G=O.components)==null?void 0:G[u]:u&&typeof u=="object"&&(h=u);if(!h)return;const g=document.createElement("div"),T=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{T(H.name)||g.setAttribute(H.name,H.value)}),g.innerHTML=A.innerHTML;const F={},j={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))F[H.name.slice(1)]=U(H.value,P);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);j[V]=(...B)=>{typeof P[K]=="function"&&P[K].call(P,...B)}}});const W={...h,data:{...h.data,...F},methods:{...h.methods,$emit(H,...K){var V;ft(h,H,K),(V=j[H])==null||V.call(j,...K)}}},N={...O,components:{...O.components,...h.components}};N.mountElement=Ce(N),r=(await ne(g,W,N)).destroy,(q=v.parentNode)==null||q.insertBefore(g,v.nextSibling),l=g};Z(b,a,m),await m()};const L=[];C.$addCleanup=v=>{L.push(v)};let E=!1;const c=(v,b)=>!t.onBeforeUpdate&&!t.onUpdated?s(v,b):s(v,()=>{var A;E||(E=!0,(A=t.onBeforeUpdate)==null||A.call(C),Promise.resolve().then(()=>{var P;E=!1,(P=t.onUpdated)==null||P.call(C)})),b()});try{(k=t.onBeforeMount)==null||k.call(C),await te(e,C,{subscribe:c,refs:i,...O,registerCleanup:v=>L.push(v)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(C)}catch(v){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(C,v);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(v,C,t.name??e.tagName.toLowerCase());else throw v}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,p=d?It():0;if(d){const v=C,b=new Set,A={id:p,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const P={};for(const a of Object.keys(v))if(!(a.startsWith("$")||typeof v[a]=="function"))try{P[a]=v[a]}catch{}return P},setState:(P,a)=>{v[P]=a},subscribe:P=>(b.add(P),()=>b.delete(P)),children:[]};Object.keys(v).filter(P=>!P.startsWith("$")&&typeof v[P]!="function").forEach(P=>{s(P,()=>{d._emit("update",A),b.forEach(a=>a())})}),d._registerInstance(A),L.push(()=>d._unregisterInstance(p))}return{state:C,destroy:()=>{var v,b;(v=t.onBeforeUnmount)==null||v.call(C),_.forEach(A=>A()),M.forEach(A=>A()),I.forEach(A=>A()),L.forEach(A=>A()),(b=t.onDestroy)==null||b.call(C)},activate:()=>{var v;(v=t.onActivated)==null||v.call(C)},deactivate:()=>{var v;(v=t.onDeactivated)==null||v.call(C)},beforeLeave:t.onBeforeRouteLeave?(v,b)=>t.onBeforeRouteLeave.call(C,v,b):void 0,enter:t.onBeforeRouteEnter?v=>t.onBeforeRouteEnter.call(C,v):void 0}}function ft(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const i=e.emits[t];typeof i=="function"&&!i(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ce(e){return async(t,o,i,s)=>{const y=e.components[o],S=t.getAttribute("cv-ref");S&&t.removeAttribute("cv-ref");const w={},R=[],$={};Array.from(t.attributes).filter(E=>E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:")).forEach(E=>{t.removeAttribute(E.name);const c=E.value,d=E.name.indexOf(":"),p=d>=0?E.name.slice(d+1).split(".")[0]:"modelValue",x=p==="modelValue"?"update:modelValue":`update:${p}`;w[p]=Oe(U(c,i)),R.push({propName:p,expr:c}),$[x]=k=>{pe(c,i,k)}});const C={};Array.from(t.attributes).forEach(E=>{const c=E.name.startsWith(":"),d=E.name.startsWith("@")||E.name.startsWith("cv:on:"),p=E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:"),x=E.name.startsWith("v-slot"),k=E.name==="slot";!c&&!d&&!p&&!x&&!k&&(C[E.name]=E.value)}),y.inheritAttrs===!1&&Object.keys(C).forEach(E=>t.removeAttribute(E)),Array.from(t.attributes).forEach(E=>{if(E.name.startsWith(":")){const c=E.name.slice(1),d=E.value;w[c]=Oe(U(d,i)),R.push({propName:c,expr:d})}else if(E.name.startsWith("@")||E.name.startsWith("cv:on:")){const c=E.name.startsWith("@")?E.name.slice(1):E.name.slice(6),d=E.value;$[c]=(...p)=>{typeof i[d]=="function"&&i[d].call(i,...p)}}});const I=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");I&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const _=new Map,M=[];Array.from(t.childNodes).forEach(E=>{const c=E.nodeType===1?E.getAttribute("slot"):null;if(c){if(!_.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),_.set(c,{nodes:[],vSlot:d})}_.get(c).nodes.push(E.cloneNode(!0))}else M.push(E.cloneNode(!0))});const z={};M.some(E=>{var c;return E.nodeType===1||E.nodeType===3&&(((c=E.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async E=>{const c=I?{...i,...ot(I,E)}:i,d=document.createDocumentFragment();return M.forEach(p=>d.appendChild(p.cloneNode(!0))),await te(d,c,s),Array.from(d.childNodes)});for(const[E,{nodes:c,vSlot:d}]of _)z[E]=async p=>{const x=d?{...i,...ot(d,p)}:i,k=document.createDocumentFragment();return c.forEach(n=>k.appendChild(n.cloneNode(!0))),await te(k,x,s),Array.from(k.childNodes)};const O={...e,components:{...e.components,...y.components},slots:z};O.mountElement=Ce(O);const{state:L}=await ne(t,{...y,data:{...y.data,...w,$attrs:C,$parent:i},methods:{...y.methods,$emit(E,...c){var d;ft(y,E,c),(d=$[E])==null||d.call($,...c)}}},O);L&&(R.forEach(({propName:E,expr:c})=>{mt(c,{...s,subscribe:s.subscribe},()=>{L[E]=Oe(U(c,i))})}),S&&s.refs&&(s.refs[S]=L))}}function Vt(e){At();const t=typeof window<"u"?Pt():void 0,o=[],i={...e.directives},s={...e.components??{}},y=[],S=new Map,w={},R=new Map;if(e.debug&&t&&Rt(t),t&&e.store){const _=e.store,M=Object.keys(_).filter(z=>typeof _[z]!="function");t._registerStore({getState(){const z={};return M.forEach(O=>{try{z[O]=_[O]}catch{}}),z},setState(z,O){_[z]=O},subscribe(z){const O=M.map(L=>{try{return be(_,L,z)}catch{return()=>{}}});return()=>O.forEach(L=>L())}})}const $={router:e.router,use(_){return o.includes(_)||(o.push(_),_.install($)),$},directive(_,M){return i[_]=M,$},component(_,M){return s[_]=M,$},provide(_,M){return typeof _=="string"?w[_]=M:Object.assign(w,_),$},magic(_,M){return R.set(`$${_}`,M),$},mount:async _=>(await I(_),$),mountAll:async(_="[data-courvux]")=>{const M=Array.from(document.querySelectorAll(_));return await Promise.all(M.map(z=>C(z))),$},mountEl:async _=>C(_),unmount(_){if(!_)y.forEach(M=>M()),y.length=0,S.clear();else{const M=document.querySelector(_);if(M){const z=S.get(M);if(z){z(),S.delete(M);const O=y.indexOf(z);O>-1&&y.splice(O,1)}}}return $},destroy(){y.forEach(_=>_()),y.length=0,S.clear()}},C=async _=>{const M=new URL(".",document.baseURI).href,z={components:s,router:e.router,store:e.store,directives:i,baseUrl:M,provided:{...w},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:R.size?Object.fromEntries(R):void 0};if(z.mountElement=Ce(z),e.router){const L=e.router;z.mountRouterView=async(E,c)=>{await new Promise(d=>{Qe(E,L,async(p,x,k,n,v)=>{const b={...z,currentRoute:k};if(v){let A=null;const P={...b,mountRouterView:async(a,l)=>{A=Qe(a,v,async(r,f,m,u)=>{const h={...b,currentRoute:m};if(u){let g=null;const T={...h,mountRouterView:async(j,W)=>{g=await ne(j,f,h)}},{destroy:F}=await ne(r,{template:u},T);return{destroy:()=>{g==null||g.destroy(),F()},activate:()=>g==null?void 0:g.activate(),deactivate:()=>g==null?void 0:g.deactivate()}}else return await ne(r,f,h)},l)}};if(n){let a=null;const l={...P,mountRouterView:async(f,m)=>{a=await ne(f,x,P)}},{destroy:r}=await ne(p,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(p,x,P);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const P={...b,mountRouterView:async(l,r)=>{A=await ne(l,x,b)}},{destroy:a}=await ne(p,{template:n},P);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(p,x,b)},c,d)})}}const O=await ne(_,e,z);return y.push(O.destroy),S.set(_,O.destroy),O.state},I=async _=>{const M=document.querySelector(_);if(M)return C(M)};return $}var nt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Gt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Pe={exports:{}},rt;function Yt(){return rt||(rt=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
`)}const eo={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Kt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=Qt(this.code),e.textContent=this._cleanCode,Zt.highlightElement(e))}},ge="Courvux",to="https://vanjexdev.github.io/courvux";function J({title:e,description:t,slug:o="/"}){const i=e?`${e} — ${ge}`:`${ge} — Lightweight reactive UI framework`,s=to+o;return qt({title:e??`${ge} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${ge}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:i},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:s},{property:"og:site_name",content:ge},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:i},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:s}]})}const oo={data:{install:`# From GitHub — pin a tag for stable installs
pnpm add github:vanjexdev/courvux#v0.5.1
...
createApp({
    ...
    `,onMount(){J({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~20 KB gzip with everything (router, store, devtools, composables, useHead, SSR).",slug:"/"})}},no={data:{s1:`# Latest commit on main (rolling)
pnpm add github:vanjexdev/courvux

# Pin to a tagged release (recommended for production)
pnpm add github:vanjexdev/courvux#v0.5.1`,s2:`<script type="importmap">
{
  "imports": {
...
{
  "imports": {
    "courvux": "https://cdn.jsdelivr.net/gh/vanjexdev/courvux@v0.5.1/dist/index.js"
  }
}
<\/script>
...
<\/script>`},onMount(){J({title:"Installation",description:"Install Courvux from GitHub or via import map / CDN. Vite plugin for templateUrl inlining and jsDelivr CDN setup.",slug:"/installation"});const e=this.$refs.pen;if(!e)return;const t=document.createElement("iframe");t.src="https://codepen.io/jesusuzcategui-the-bold/embed/VYmZNgZ?default-tab=html%2Cresult&theme-id=dark",t.height="420",t.style.cssText="width:100%; border:0; border-radius:8px; display:block; margin-bottom:1rem;",t.scrolling="no",t.setAttribute("frameborder","no"),t.setAttribute("allowtransparency","true"),t.allowFullscreen=!0,t.title="Courvux CDN demo on CodePen",e.replaceWith(t)},template:`
    ...
    `},ro={data:{s1:`import { createApp } from 'courvux';
...
createApp({ store, router, template: '<router-view />' }).mount('#app');`},template:`
    ...
    `,onMount(){J({title:"Quick Start",description:"Build your first reactive Courvux app — counter example, methods, computed properties.",slug:"/quick-start"})}},ao={data:{s_interp:`<!-- Text interpolation -->
<p>{{ count }}</p>
<p>{{ price * qty }}</p>
<p>{{ active ? 'On' : 'Off' }}</p>
...
<div id="app" cv-cloak></div>`},template:`
    ...
    `,onMount(){J({title:"Template Syntax",description:"Courvux directives and bindings: cv-if, cv-for, cv-model, cv-show, :class, :style, @event.",slug:"/template"})}},io={data:{s_define:`createApp({
    components: {
        'user-card': {
...
<editor cv-model:title="docTitle" cv-model:body="docBody" />`},template:`
    ...
    `,onMount(){J({title:"Components",description:"Define, register, and compose Courvux components with props, slots, emits, and scoped slots.",slug:"/components"})}},so={data:{s_computed:`{
    data: { price: 10, qty: 3 },
    computed: {
...
this.$batch(() => {
    ...
    `,onMount(){J({title:"Reactivity",description:"Proxy-based reactive state, computed properties, watchers, and refs in Courvux.",slug:"/reactivity"})}},co={data:{s1:`{
    data: { ticks: 0 },
...
}`,s3:`// Error boundary — catches errors from descendant onMount
{
    ...
    `,onMount(){J({title:"Lifecycle Hooks",description:"onMount, onBeforeUnmount, onDestroy, error boundaries, and async data in Courvux.",slug:"/lifecycle"})}},lo={data:{s_storage:`import { cvStorage } from 'courvux';
...
export const useCounter = defineComposable((initial = 0) => useComposables(
    ...
    `,onMount(){J({title:"Composables",description:"Author and reuse logic in Courvux with defineComposable + useComposables, plus the built-in cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener helpers.",slug:"/composables"})}},uo={data:{s_basic:`import { createEventBus } from 'courvux';
...
bus.emit('toast:show', 'Saved again');  // handler does NOT run`},template:`
    ...
    `,onMount(){J({title:"Event Bus",description:"Typed cross-component event bus in Courvux: on, off, emit, once, clear, and provide/inject patterns.",slug:"/event-bus"})}},po={data:{s_setup:`import { createApp, createRouter } from 'courvux';
...
methods: {
    ...
    `,onMount(){J({title:"Router",description:"SPA routing in Courvux: dynamic params, nested routes, navigation guards, transitions.",slug:"/router"})}},mo={data:{s1:`import { createStore } from 'courvux';
...
{ inject: { localTheme: 'theme', endpoint: 'apiUrl' } }`},template:`
    ...
    `,onMount(){J({title:"Store",description:"Global reactive state in Courvux with createStore, modules, and namespaced actions.",slug:"/store"})}},ho={data:{s_basic:`import { useHead } from 'courvux';
...
// → <title>Install | site</title>`},template:`
    ...
    `,onMount(){J({title:"useHead — SEO and metadata",description:"Per-component head management with useHead in Courvux: title, meta tags, Open Graph, JSON-LD, htmlAttrs.",slug:"/head"})}},fo={data:{s_vite:`// vite.config.js
import { defineConfig } from 'vite';
...
// → embed headHtml in your shell, then html in the mount root`},template:`
    ...
    `,onMount(){J({title:"Static Site Generation",description:"Pre-render every route to static HTML at build time with the courvux/plugin/ssg Vite plugin.",slug:"/ssg"})}},go={data:{s_setup:`import { createApp, setupDevTools, mountDevOverlay } from 'courvux';
...
inst.setState('filter', 'completed');`},template:`
    ...
    `,onMount(){J({title:"DevTools",description:"In-app DevTools overlay for Courvux: live component state inspection and inline editing, no browser extension needed.",slug:"/devtools"})}},vo={data:{s_basic:`import { mount } from 'courvux/test-utils';
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,onMount(){J({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},bo={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
<button cv-if="pwa.installable && !pwa.installed" @click="pwa.prompt()">
    ...
    `,onMount(){J({title:"Progressive Web App",description:"Make any Courvux app installable and offline-capable: manifest, vite-plugin-pwa, install prompt utility.",slug:"/pwa"})}},yo={data:{s_dir:`// Full definition
app.directive('focus', {
...
autoInit({
    ...
    `,onMount(){J({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},wo={template:`
        <div class="prose">
    ...
    `,onMount(){J({title:"Design decisions",description:"Why Courvux uses Proxy over signals, Options API over Composition, no Virtual DOM, embedded DevTools, cv- prefix, and SSG over per-request SSR. Trade-offs documented.",slug:"/design-decisions"})}},xo={data:{s_keyed:`<!-- Without :key, every state change rebuilds the whole list -->
...
this.cards.splice(idx, 1);`},template:`
    ...
    `,onMount(){J({title:"FAQ",description:"Frequently asked questions and troubleshooting for Courvux: cv-for keys, strict CSP, TypeScript, lazy loading, Vite/Tauri integration, testing, migration.",slug:"/faq"})}},ko={data:{s_component_vue:`// Vue 3 — Options API
export default {
    data() { return { count: 0 } },
...
this.$store.addToCart(product);`},template:`
    ...
    `,onMount(){J({title:"Migrating from Vue",description:"Mapping table from Vue 3 Options API to Courvux: directives, lifecycle hooks, props, emits, router, Pinia store. Surgical migration, mostly identical syntax.",slug:"/migrating-from-vue"})}},So={data:{s_xdata:`<!-- Alpine -->
...
// Used in HTML: $store.cart.count`},template:`
    ...
    `,onMount(){J({title:"Migrating from Alpine",description:"Mapping table from Alpine.js to Courvux: x-data → cv-data, directives, named components, stores. Mostly identical syntax with a prefix swap.",slug:"/migrating-from-alpine"})}},gt="courvux-demo-todos",Ao=`const STORAGE_KEY = 'courvux-demo-todos';
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function Eo(){try{return JSON.parse(localStorage.getItem(gt))||[]}catch{return[]}}function To(e){localStorage.setItem(gt,JSON.stringify(e))}const _o={data:{todos:Eo(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:Ao,srcHtml:Co,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(e=>!e.done):this.filter==="completed"?this.todos.filter(e=>e.done):this.todos},remaining(){return this.todos.filter(e=>!e.done).length},allDone(){return this.todos.length>0&&this.todos.every(e=>e.done)}},watch:{todos:{deep:!0,handler(e){To(e)}}},methods:{add(){const e=this.newTodo.trim();e&&(this.todos=[...this.todos,{id:this._nextId++,text:e,done:!1}],this.newTodo="")},toggle(e){this.todos=this.todos.map(t=>t.id===e?{...t,done:!t.done}:t)},remove(e){this.todos=this.todos.filter(t=>t.id!==e)},clearCompleted(){this.todos=this.todos.filter(e=>!e.done)},toggleAll(){const e=this.allDone;this.todos=this.todos.map(t=>({...t,done:!e}))},startEdit(e){this.editingId=e.id,this.editText=e.text,this.$nextTick(()=>{var t;return(t=this.$refs["edit_"+e.id])==null?void 0:t.focus()})},commitEdit(e){const t=this.editText.trim();t?this.todos=this.todos.map(o=>o.id===e?{...o,text:t}:o):this.remove(e),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(e){this.filter=e}},template:`
    ...
    `,onMount(){J({title:"Demo — TODO App",description:"Interactive TODO app built with Courvux. Live demo with full source code (JS + HTML).",slug:"/demo"})}},$o=[{path:"/",component:oo},{path:"/installation",component:no},{path:"/quick-start",component:ro},{path:"/template",component:ao},{path:"/components",component:io},{path:"/reactivity",component:so},{path:"/lifecycle",component:co},{path:"/composables",component:lo},{path:"/event-bus",component:uo},{path:"/router",component:po},{path:"/store",component:mo},{path:"/head",component:ho},{path:"/ssg",component:fo},{path:"/devtools",component:go},{path:"/testing",component:vo},{path:"/pwa",component:bo},{path:"/advanced",component:yo},{path:"/design-decisions",component:wo},{path:"/faq",component:xo},{path:"/migrating-from-vue",component:ko},{path:"/migrating-from-alpine",component:So},{path:"/demo",component:_o}],Oo={methods:{goBack(){window.history.back()}},template:`
        ...
        <div style="display:flex; min-height:100vh; position:relative;">
            ...
            ">
                ...
                <div style="padding: 20px 16px 12px; border-bottom: 1px solid #f0f0f0;">
                    <router-link to="/" @click="closeSidebar()" style="text-decoration:none; display:flex; align-items:center; gap:8px;" aria-label="Courvux v0.5.1 home">
                        <span style="font-size:1.3rem;" aria-hidden="true">⚡</span>
                        <span style="font-weight:700; font-size:15px; color:#111;">Courvux</span>
                        <span style="font-size:10px; color:#666; margin-left:2px;">v0.5.1</span>
                    </router-link>
                </div>
