...
`;function At(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=St,document.head.appendChild(e)}async function ve(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(y=>{const S=()=>y();e.addEventListener("animationend",S,{once:!0}),e.addEventListener("transitionend",S,{once:!0}),setTimeout(S,s+50)}),e.classList.remove(`${t}-${o}`)}var xe=new Map;async function Et(e){if(typeof e!="function")return e;if(xe.has(e))return xe.get(e);const t=await e();return xe.set(e,t.default),t.default}function Be(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ve(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((y,S)=>[y,s[S+1]])):null}function Ct(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((y,S)=>[y,s[S+1]])),remaining:s[o.length+1]||"/"}:null}function ut(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:ut(o.children,i==="/"?"":i)}:{...o,path:i}})}var pe=(e,t)=>new Promise(o=>e(t,o)),Ge=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Tt(e,t={}){const o=t.mode??"hash",i=_t(t.base??"");return{routes:ut(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,y){const S=Ye(s,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=S},replace(s,y){const S=Ye(s,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${S}`)}},back(){history.back()},forward(){history.forward()}}}function _t(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function $t(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Ye(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function Xe(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function Je(e,t,o,i="default",s){const y=t.base??"",S=p=>p.length>1&&p.endsWith("/")?p.slice(0,-1):p,x=()=>t.mode==="history"?S($t(window.location.pathname,y)):S((window.location.hash.slice(1)||"/").split("?")[0]||"/"),R=()=>{if(t.mode==="history")return Xe(window.location.search);const p=window.location.hash.slice(1)||"/",w=p.indexOf("?");return w>=0?Xe(p.slice(w+1)):{}};t.transition&&At();let $=null,E=null,M=null,_=null,I=!1;const z=()=>{I||(I=!0,s==null||s())},O=new Map,L=p=>{var w;if(p!=null&&p.keepAlive&&M){(w=M.deactivate)==null||w.call(M);const k=document.createDocumentFragment();for(;e.firstChild;)k.appendChild(e.firstChild);O.set($.path,{fragment:k,activation:M}),M=null}else M==null||M.destroy(),M=null,e.innerHTML=""},C=async(p,w,k,n,g)=>{const b=typeof w=="function"&&!xe.has(w),A=b?w.__asyncOptions:void 0,D=p.loadingTemplate??(A==null?void 0:A.loadingTemplate);b&&D&&(e.innerHTML=D);let a;try{a=await Et(w)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return b&&D&&(e.innerHTML=""),o(e,a,k,n,g)},c=async()=>{var k,n,g,b,A,D,a,l;const p=x(),w=R();for(const r of t.routes){if((k=r.children)!=null&&k.length){const m=Ct(r.path,p);if(m!==null)for(const u of r.children){const h=Ve(u.path,p);if(h!==null){const v={params:m.params,query:w,path:p,meta:r.meta};if(u.redirect){const N={params:h,query:w,path:p,meta:u.meta},W=typeof u.redirect=="function"?u.redirect(N):u.redirect;t.navigate(W);return}if(t.beforeEach){const N=await pe(t.beforeEach,v);if(N){t.navigate(N);return}}if(r.beforeEnter){const N=await pe(r.beforeEnter,v);if(N){t.navigate(N);return}}if(u.beforeEnter){const N={params:h,query:w,path:p,meta:u.meta},W=await pe(u.beforeEnter,N);if(W){t.navigate(W);return}}const T=`${r.path}::${JSON.stringify(m.params)}`;if(_!==T){const N=await Ge(M,v);if(N){t.navigate(N);return}const W=r.transition??t.transition;W&&e.hasChildNodes()&&await ve(e,W,"leave"),L(E);const j=Be(r,i);if(j){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(q,H)=>t.navigate(q,H),replace:(q,H)=>t.replace(q,H),back:()=>t.back(),forward:()=>t.forward()};M=await C(r,j,v,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=M.enter)==null||n.call(M,$)}else e.innerHTML="";_=T,W&&await ve(e,W,"enter")}const F={params:{...m.params,...h},query:w,path:p,meta:u.meta??r.meta};(g=t.afterEach)==null||g.call(t,F,$);const P=(b=t.scrollBehavior)==null?void 0:b.call(t,F,$);P&&window.scrollTo(P.x??0,P.y??0),$=F,E=r,z();return}}}const f=Ve(r.path,p);if(f!==null){_=null;const m={params:f,query:w,path:p,meta:r.meta};if(r.redirect){const F=typeof r.redirect=="function"?r.redirect(m):r.redirect;t.navigate(F);return}if(t.beforeEach){const F=await pe(t.beforeEach,m);if(F){t.navigate(F);return}}if(r.beforeEnter){const F=await pe(r.beforeEnter,m);if(F){t.navigate(F);return}}const u=await Ge(M,m);if(u){t.navigate(u);return}const h=r.transition??t.transition;h&&e.hasChildNodes()&&await ve(e,h,"leave"),L(E);const v=Be(r,i);if(v){const F=m.path;if(r.keepAlive&&O.has(F)){const P=O.get(F);e.appendChild(P.fragment),M=P.activation,(A=M.activate)==null||A.call(M),O.delete(F)}else{const P=$;M=await C(r,v,m,i==="default"?r.layout:void 0),(D=M.enter)==null||D.call(M,P)}}else e.innerHTML="",M=null;h&&await ve(e,h,"enter"),(a=t.afterEach)==null||a.call(t,m,$);const T=(l=t.scrollBehavior)==null?void 0:l.call(t,m,$);T&&window.scrollTo(T.x??0,T.y??0),$=m,E=r,z();return}}_=null,L(E),E=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),M==null||M.destroy(),M=null,O.forEach(({activation:p})=>p.destroy()),O.clear()}}function Ot(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(y=>{try{y(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var jt=0;function Ft(){return++jt}var Pt=`
...
`)}const Zt={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Xt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=Jt(this.code),e.textContent=this._cleanCode,Gt.highlightElement(e))}},me="Courvux",Kt="https://vanjexdev.github.io/courvux";function Z({title:e,description:t,slug:o="/"}){const i=e?`${e} — ${me}`:`${me} — Lightweight reactive UI framework`,s=Kt+o;return Wt({title:e??`${me} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${me}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:i},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:s},{property:"og:site_name",content:me},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:i},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:s}]})}const Qt={data:{install:`# From GitHub — pin a tag for stable installs
...
autoInit({
    ...
    `,onMount(){Z({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},go={template:`
        <div class="prose">
    ...
    `,onMount(){Z({title:"Design decisions",description:"Why Courvux uses Proxy over signals, Options API over Composition, no Virtual DOM, embedded DevTools, cv- prefix, and SSG over per-request SSR. Trade-offs documented.",slug:"/design-decisions"})}},bo={data:{s_keyed:`<!-- Without :key, every state change rebuilds the whole list -->
...
it('counter increments on click', async () => {
    ...
    `,onMount(){Z({title:"FAQ",description:"Frequently asked questions and troubleshooting for Courvux: cv-for keys, strict CSP, TypeScript, lazy loading, Vite/Tauri integration, testing, migration.",slug:"/faq"})}},yo={data:{s_component_vue:`// Vue 3 — Options API
export default {
    data() { return { count: 0 } },
...
this.$store.addToCart(product);`},template:`
    ...
    `,onMount(){Z({title:"Migrating from Vue",description:"Mapping table from Vue 3 Options API to Courvux: directives, lifecycle hooks, props, emits, router, Pinia store. Surgical migration, mostly identical syntax.",slug:"/migrating-from-vue"})}},xo={data:{s_xdata:`<!-- Alpine -->
...
// Used in HTML: $store.cart.count`},template:`
    ...
    `,onMount(){Z({title:"Migrating from Alpine",description:"Mapping table from Alpine.js to Courvux: x-data → cv-data, directives, named components, stores. Mostly identical syntax with a prefix swap.",slug:"/migrating-from-alpine"})}},mt="courvux-demo-todos",wo=`const STORAGE_KEY = 'courvux-demo-todos';
