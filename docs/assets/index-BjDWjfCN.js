(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))c(l);new MutationObserver(l=>{for(const y of l)if(y.type==="childList")for(const E of y.addedNodes)E.tagName==="LINK"&&E.rel==="modulepreload"&&c(E)}).observe(document,{childList:!0,subtree:!0});function o(l){const y={};return l.integrity&&(y.integrity=l.integrity),l.referrerPolicy&&(y.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?y.credentials="include":l.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function c(l){if(l.ep)return;l.ep=!0;const y=o(l);fetch(l.href,y)}})();var gt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),at=t=>t instanceof Date||t instanceof RegExp||t instanceof Map||t instanceof Set||t instanceof WeakMap||t instanceof WeakSet||ArrayBuffer.isView(t)||t instanceof ArrayBuffer,Le=new WeakSet,xe=Symbol("raw"),$e=t=>t===null||typeof t!="object"?t:t[xe]??t,ke=0,je=new Map,fe=null;function Me(t){const e=[],o=fe;fe=e;try{t()}finally{fe=o}return e}function bt(t){ke++;try{t()}finally{if(ke--,ke===0){const e=[...je.values()];je.clear(),e.forEach(o=>o())}}}function st(t,e){return t===null||typeof t!="object"||Le.has(t)||at(t)?t:new Proxy(t,{get(o,c){if(c===xe)return o[xe]??o;if(typeof c=="string"&&Array.isArray(o)&&gt.has(c))return(...y)=>{const E=Array.prototype[c].apply(o,y);return e(),E};const l=o[c];return l!==null&&typeof l=="object"&&!Le.has(l)?st(l,e):l},set(o,c,l){return o[c]=l,e(),!0}})}function Pe(){const t={},e=Math.random().toString(36).slice(2),o=(y,E)=>(t[y]||(t[y]=new Set),t[y].add(E),()=>{var x;(x=t[y])==null||x.delete(E)}),c=y=>{ke>0?je.set(`${e}:${y}`,()=>{(t[y]?[...t[y]]:[]).forEach(E=>E())}):(t[y]?[...t[y]]:[]).forEach(E=>E())},l={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(E,x){if(x===xe)return y;typeof x=="string"&&!x.startsWith("$")&&fe&&fe.push({sub:o,key:x});const D=E[x];return typeof x=="string"&&!x.startsWith("$")&&D!==null&&typeof D=="object"&&!Le.has(D)&&!at(D)?st(D,()=>c(x)):D},set(E,x,D){if(l[x])return l[x](D),!0;const $=E[x];return E[x]=D,($!==D||D!==null&&typeof D=="object")&&c(x),!0}}),registerSetInterceptor:(y,E)=>{l[y]=E},notifyAll:()=>{Object.keys(t).forEach(y=>c(y))}}}var Ce=new WeakMap;function ve(t,e,o){var l,y;const c=e.indexOf(".");if(c>=0){const E=e.slice(0,c),x=e.slice(c+1),D=t[E];return D&&Ce.has(D)?ve(D,x,o):((l=Ce.get(t))==null?void 0:l(E,o))??(()=>{})}return((y=Ce.get(t))==null?void 0:y(e,o))??(()=>{})}var it=(t,e)=>t.split(".").reduce((o,c)=>o==null?void 0:o[c],e),ct=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),Ie=new Map,Re=new Map,lt=(t,e)=>{const o=t.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!lt(o.slice(1).trim(),e):it(o,e)},N=(t,e)=>{if(!ct)return lt(t,e);try{let o=Ie.get(t);return o||(o=new Function("$data",`with($data) { return (${t}) }`),Ie.set(t,o)),o(e)}catch{return it(t,e)}},ue=(t,e,o)=>t.startsWith("$store.")&&e.store?e.storeSubscribeOverride?e.storeSubscribeOverride(e.store,t.slice(7),o):ve(e.store,t.slice(7),o):e.subscribe(t,o),J=(t,e,o)=>{const c=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),l=t.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(l.filter(x=>!c.has(x.split(".")[0])))];if(y.length===0)return()=>{};const E=y.map(x=>ue(x,e,o));return()=>E.forEach(x=>x())},le=(t,e,o)=>{const c=t.split(".");if(c.length===1)e[c[0]]=o;else{const l=c.slice(0,-1).reduce((y,E)=>y==null?void 0:y[E],e);l&&(l[c[c.length-1]]=o)}},ze=(t,e,o,c,l)=>{const y={};return Object.keys(t).forEach(E=>y[E]=t[E]),y[o]=e,l&&(y[l]=c),y},De=t=>t?typeof t=="string"?t:Array.isArray(t)?t.map(De).filter(Boolean).join(" "):typeof t=="object"?Object.entries(t).filter(([,e])=>!!e).map(([e])=>e).join(" "):"":"",He=(t,e,o)=>{if(!e){t.style.cssText=o;return}typeof e=="string"?t.style.cssText=o?`${o};${e}`:e:typeof e=="object"&&(o&&(t.style.cssText=o),Object.entries(e).forEach(([c,l])=>{t.style[c]=l??""}))},Ne=(t,e,o)=>{if(ct)try{let c=Re.get(t);c||(c=new Function("__p__",`with(__p__){${t}}`),Re.set(t,c));const l=new Proxy({},{has:()=>!0,get:(y,E)=>E==="$event"?o:E in e?e[E]:globalThis[E],set:(y,E,x)=>(e[E]=x,!0)});c(l)}catch(c){console.warn(`[courvux] handler error "${t}":`,c)}},se=t=>{const e=getComputedStyle(t),o=Math.max(parseFloat(e.animationDuration)||0,parseFloat(e.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(c=>{const l=()=>c();t.addEventListener("animationend",l,{once:!0}),t.addEventListener("transitionend",l,{once:!0}),setTimeout(l,o+50)})},yt=`
...
`,We=!1;function Ue(){if(We||typeof document>"u")return;We=!0;const t=document.createElement("style");t.id="cv-transitions-el",t.textContent=yt,document.head.appendChild(t)}var Be=!1;function kt(){if(Be||typeof document>"u")return;Be=!0;const t=document.createElement("style");t.id="cv-cloak-style",t.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(t)}function wt(t){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(t,{sanitizer:new window.Sanitizer}),o.innerHTML}const e=new DOMParser().parseFromString(t,"text/html");return e.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),e.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(c=>{(c.name.startsWith("on")||c.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(c.name)})}),e.body.innerHTML}async function oe(t,e,o){var y,E,x,D,$,w,V,j,H,R,C,P,_,d,a,v,S;const c=Array.from(t.childNodes);let l=0;for(;l<c.length;){const A=c[l];if(A.nodeType===3){const s=A.textContent||"",r=s.match(/\{\{([\s\S]+?)\}\}/g);if(r){const i=s,u=()=>{let m=i;r.forEach(p=>{const b=p.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(p,N(b,e)??"")}),A.textContent=m};r.forEach(m=>{J(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,u)}),u()}l++;continue}if(A.nodeType!==1){l++;continue}const n=A,h=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),l++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await oe(n,e,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),l++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const s=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const r=document.querySelector(s)??document.body,i=document.createComment(`cv-teleport: ${s}`);n.replaceWith(i),await oe(n,e,o),r.appendChild(n),l++;continue}if(n.hasAttribute("cv-memo")){const s=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const r=()=>s.split(",").map(b=>N(b.trim(),e));let i=r();const u=[],m=b=>(u.push(b),()=>{const g=u.indexOf(b);g>-1&&u.splice(g,1)});await oe(n,e,{...o,subscribe:(b,g)=>m(g),storeSubscribeOverride:(b,g,k)=>m(k)});const p=J(s,o,()=>{const b=r();b.some((g,k)=>g!==i[k])&&(i=b,[...u].forEach(g=>g()))});(y=o.registerCleanup)==null||y.call(o,()=>p()),l++;continue}if(n.hasAttribute("cv-data")){const s=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let r={},i={};if(s.startsWith("{")){const u=N(s,e)??{};Object.entries(u).forEach(([m,p])=>{typeof p=="function"?i[m]=p:r[m]=p})}else if(s){const u=(E=o.components)==null?void 0:E[s];if(u){const m=typeof u.data=="function"?u.data():u.data??{};m instanceof Promise||Object.assign(r,m),Object.assign(i,u.methods??{})}}if(o.createChildScope){const u=o.createChildScope(r,i);(x=o.registerCleanup)==null||x.call(o,u.cleanup),await oe(n,u.state,{...o,subscribe:u.subscribe})}else await oe(n,{...e,...r,...i},o);l++;continue}if(n.hasAttribute("cv-for")){const s=n.getAttribute("cv-for");n.removeAttribute("cv-for");const r=s.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(r){const[,i,u,m]=r,p=n.getAttribute(":key")??null;p&&n.removeAttribute(":key");const b=n.getAttribute("cv-transition")??null;b&&n.removeAttribute("cv-transition");const g=document.createComment(`cv-for: ${m}`);n.replaceWith(g);let k=[],L=[];const F=new Map,W=async()=>{var G;const z=N(m,e),M=z?typeof z=="number"?Array.from({length:z},(I,B)=>[B+1,B]):Array.isArray(z)?z.map((I,B)=>[I,B]):Object.entries(z).map(([I,B])=>[B,I]):[];if(p){const I=[],B=new Map,Q=new Set;for(const[X,Y]of M){const re=N(p,ze(e,X,i,Y,u));Q.has(re)&&console.warn(`[courvux] cv-for: duplicate :key "${re}" in "${m}"`),Q.add(re),I.push(re),B.set(re,[X,Y])}const q=[];for(const[X,{el:Y,destroy:re}]of F)B.has(X)||(b?(Y.classList.add(`${b}-leave`),q.push(se(Y).then(()=>{var ae;Y.classList.remove(`${b}-leave`),re(),(ae=Y.parentNode)==null||ae.removeChild(Y),F.delete(X)}))):(re(),(G=Y.parentNode)==null||G.removeChild(Y),F.delete(X)));q.length&&await Promise.all(q);const U=g.parentNode,te=[];for(const X of I){const[Y,re]=B.get(X);if(F.has(X)){const ae=F.get(X);ae.itemRef!==Y&&(ae.reactive[i]=Y,ae.itemRef=Y),u&&(ae.reactive[u]=re)}else{const ae=n.cloneNode(!0),Se=[],{subscribe:mt,createReactiveState:ht}=Pe(),Ee=ht({[i]:Y,...u?{[u]:re}:{}}),ft=new Proxy({},{has(ie,ee){return!0},get(ie,ee){return typeof ee!="string"?e[ee]:ee===i||u&&ee===u?Ee[ee]:e[ee]},set(ie,ee,ce){return ee===i||u&&ee===u?(Ee[ee]=ce,!0):(e[ee]=ce,!0)}}),vt={...o,subscribe:(ie,ee)=>{const ce=ie.split(".")[0];let de;return ce===i||u&&ce===u?de=mt(ce,ee):de=o.subscribe(ie,ee),Se.push(de),de},storeSubscribeOverride:(ie,ee,ce)=>{const de=ve(ie,ee,ce);return Se.push(de),de}},_e=document.createDocumentFragment();_e.appendChild(ae),await oe(_e,ft,vt);const Te=_e.firstChild??ae;b&&Te.classList.add(`${b}-enter`),F.set(X,{el:Te,reactive:Ee,itemRef:Y,destroy:()=>Se.forEach(ie=>ie())}),b&&te.push(Te)}}let Z=g.nextSibling,pe=0;for(const X of I){const{el:Y}=F.get(X);Y!==Z?pe++:Z=Y.nextSibling}if(pe>0)if(pe>I.length>>1){const X=document.createDocumentFragment();for(const Y of I)X.appendChild(F.get(Y).el);U.insertBefore(X,g.nextSibling)}else{Z=g.nextSibling;for(const X of I){const{el:Y}=F.get(X);Y!==Z?U.insertBefore(Y,Z):Z=Y.nextSibling}}k=I.map(X=>F.get(X).el),te.length&&Promise.all(te.map(X=>se(X).then(()=>X.classList.remove(`${b}-enter`))))}else{if(L.forEach(q=>q()),L=[],k.forEach(q=>{var U;return(U=q.parentNode)==null?void 0:U.removeChild(q)}),k=[],!M.length)return;const I=g.parentNode,B=g.nextSibling,Q={...o,subscribe:(q,U)=>{const te=o.subscribe(q,U);return L.push(te),te},storeSubscribeOverride:(q,U,te)=>{const Z=ve(q,U,te);return L.push(Z),Z}};for(const[q,U]of M){const te=n.cloneNode(!0),Z=document.createDocumentFragment();Z.appendChild(te),await oe(Z,ze(e,q,i,U,u),Q);const pe=Z.firstChild??te;I.insertBefore(Z,B),k.push(pe)}}};(D=o.registerCleanup)==null||D.call(o,()=>{F.forEach(({el:z,destroy:M})=>{var G;M(),(G=z.parentNode)==null||G.removeChild(z)}),F.clear(),L.forEach(z=>z()),k.forEach(z=>{var M;return(M=z.parentNode)==null?void 0:M.removeChild(z)}),k=[]}),J(m,o,W),await W()}l++;continue}if(n.hasAttribute("cv-if")){const s=[],r=n.getAttribute("cv-if");n.removeAttribute("cv-if");const i=document.createComment("cv-if");n.replaceWith(i),s.push({condition:r,template:n,anchor:i});let u=l+1;for(;u<c.length;){const k=c[u];if(k.nodeType===3&&((($=k.textContent)==null?void 0:$.trim())??"")===""){u++;continue}if(k.nodeType!==1)break;const L=k;if(L.hasAttribute("cv-else-if")){const F=L.getAttribute("cv-else-if");L.removeAttribute("cv-else-if");const W=document.createComment("cv-else-if");L.replaceWith(W),s.push({condition:F,template:L,anchor:W}),u++;continue}if(L.hasAttribute("cv-else")){L.removeAttribute("cv-else");const F=document.createComment("cv-else");L.replaceWith(F),s.push({condition:null,template:L,anchor:F}),u++;break}break}l=u;let m=null,p=!1,b=!1;const g=async()=>{var k,L;if(p){b=!0;return}p=!0;try{do{b=!1,m&&((k=m.parentNode)==null||k.removeChild(m),m=null);for(const F of s)if(F.condition===null||N(F.condition,e)){const W=F.template.cloneNode(!0),z=document.createDocumentFragment();z.appendChild(W),await oe(z,e,o);const M=z.firstChild??W;(L=F.anchor.parentNode)==null||L.insertBefore(z,F.anchor.nextSibling),m=M;break}}while(b)}finally{p=!1}};s.filter(k=>k.condition).forEach(k=>{J(k.condition,o,g)}),await g();continue}if(n.hasAttribute("cv-show")){const s=n.getAttribute("cv-show");n.removeAttribute("cv-show");const r=Array.from(n.attributes).filter(i=>i.name==="cv-transition"||i.name.startsWith("cv-transition:")||i.name.startsWith("cv-transition."));if(r.length>0){const i=M=>(n.getAttribute(M)??"").split(" ").filter(Boolean),u=i("cv-transition:enter"),m=i("cv-transition:enter-start"),p=i("cv-transition:enter-end"),b=i("cv-transition:leave"),g=i("cv-transition:leave-start"),k=i("cv-transition:leave-end"),L=n.getAttribute("cv-transition")??"",F=new Set(L.split(".").slice(1)),W=[...F].find(M=>/^\d+$/.test(M)),z=W?parseInt(W):200;if(u.length||m.length||b.length||g.length){r.forEach(q=>n.removeAttribute(q.name));const M=()=>new Promise(q=>requestAnimationFrame(()=>requestAnimationFrame(()=>q())));let G=!!N(s,e),I=!1,B=null;const Q=async q=>{if(I){B=q;return}I=!0;try{q?(n.style.display="",n.classList.add(...u,...m),await M(),n.classList.remove(...m),n.classList.add(...p),await se(n),n.classList.remove(...u,...p)):(n.classList.add(...b,...g),await M(),n.classList.remove(...g),n.classList.add(...k),await se(n),n.classList.remove(...b,...k),n.style.display="none"),G=q}finally{if(I=!1,B!==null&&B!==G){const U=B;B=null,Q(U)}else B=null}};G||(n.style.display="none"),J(s,o,()=>{const q=!!N(s,e);q!==G&&Q(q)})}else{const M=[...F].find(U=>U==="scale"||/^scale$/.test(U)),G=(()=>{const U=[...F].find(te=>/^\d+$/.test(te)&&te!==W);return U?parseInt(U)/100:.9})(),I=[];(!F.has("scale")||F.has("opacity"))&&I.push(`opacity ${z}ms ease`),M&&I.push(`transform ${z}ms ease`),I.length||I.push(`opacity ${z}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+I.join(", "),r.forEach(U=>n.removeAttribute(U.name));let B=!!N(s,e);const Q=()=>new Promise(U=>requestAnimationFrame(()=>requestAnimationFrame(()=>U()))),q=async U=>{U?(n.style.display="",n.style.opacity="0",M&&(n.style.transform=`scale(${G})`),await Q(),n.style.opacity="",M&&(n.style.transform=""),await se(n)):(n.style.opacity="0",M&&(n.style.transform=`scale(${G})`),await se(n),n.style.display="none",n.style.opacity="",M&&(n.style.transform="")),B=U};B||(n.style.display="none"),J(s,o,()=>{const U=!!N(s,e);U!==B&&q(U)})}}else{const i=n.getAttribute("cv-show-transition"),u=n.getAttribute(":transition");i&&n.removeAttribute("cv-show-transition"),u&&n.removeAttribute(":transition");const m=i??(u?String(N(u,e)):null);if(m){Ue();let p=!!N(s,e);p||(n.style.display="none");let b=!1,g=null;const k=async L=>{if(b){g=L;return}b=!0;try{L?(n.style.display="",n.classList.add(`${m}-enter`),await se(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await se(n),n.classList.remove(`${m}-leave`),n.style.display="none"),p=L}finally{if(b=!1,g!==null&&g!==p){const F=g;g=null,k(F)}else g=null}};J(s,o,()=>{const L=!!N(s,e);L!==p&&k(L)})}else{const p=()=>{n.style.display=N(s,e)?"":"none"};J(s,o,p),p()}}}if(n.hasAttribute("cv-focus")){const s=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!s)Promise.resolve().then(()=>n.focus());else{const r=()=>{N(s,e)&&Promise.resolve().then(()=>n.focus())};J(s,o,r),r()}}{const s=Array.from(n.attributes).filter(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect:")||r.name.startsWith("cv-intersect."));if(s.length&&typeof IntersectionObserver<"u"){const r=s.find(M=>M.name==="cv-intersect"||M.name==="cv-intersect:enter"||M.name.startsWith("cv-intersect.")),i=s.find(M=>M.name==="cv-intersect:leave"),u=(r==null?void 0:r.value)??"",m=(i==null?void 0:i.value)??"",p=((r==null?void 0:r.name)??"cv-intersect").split("."),b=new Set(p.slice(1)),g=b.has("once");let k=0;if(b.has("half"))k=.5;else if(b.has("full"))k=1;else{const M=[...b].find(G=>G.startsWith("threshold-"));M&&(k=parseInt(M.replace("threshold-",""))/100)}const L=[...b].find(M=>M.startsWith("margin-")),F=L?`${L.replace("margin-","")}px`:void 0;s.forEach(M=>n.removeAttribute(M.name));const W=M=>{if(M)try{new Function("$data",`with($data){${M}}`)(e)}catch(G){console.warn(`[courvux] cv-intersect error "${M}":`,G)}},z=new IntersectionObserver(M=>{M.forEach(G=>{G.isIntersecting?(W(u),g&&z.disconnect()):W(m)})},{threshold:k,...F?{rootMargin:F}:{}});z.observe(n),(w=o.registerCleanup)==null||w.call(o,()=>z.disconnect())}}{const s=Array.from(n.attributes).find(r=>r.name==="cv-html"||r.name.startsWith("cv-html."));if(s){const r=s.value;n.removeAttribute(s.name);const i=s.name.split(".").slice(1).includes("sanitize"),u=()=>{const m=String(N(r,e)??"");n.innerHTML=i?wt(m):m};J(r,o,u),u(),l++;continue}}if(n.hasAttribute("cv-ref")&&!((V=o.components)!=null&&V[h])){const s=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[s]=n)}const f=!!((j=o.components)!=null&&j[h]),T=Array.from(n.attributes).find(s=>s.name==="cv-model"||s.name.startsWith("cv-model."));if(T&&!f){const s=T.value;n.removeAttribute(T.name);const r=new Set(T.name.split(".").slice(1)),i=n,u=(H=i.type)==null?void 0:H.toLowerCase(),m=p=>{if(r.has("number")){const b=parseFloat(p);return isNaN(b)?p:b}return r.has("trim")?p.trim():p};if(u==="checkbox"){const p=()=>{const b=N(s,e);i.checked=Array.isArray(b)?b.includes(i.value):!!b};ue(s,o,p),p(),i.addEventListener("change",()=>{const b=N(s,e);if(Array.isArray(b)){const g=[...b];if(i.checked)g.includes(i.value)||g.push(i.value);else{const k=g.indexOf(i.value);k>-1&&g.splice(k,1)}le(s,e,g)}else le(s,e,i.checked)})}else if(u==="radio"){const p=()=>{i.checked=N(s,e)===i.value};ue(s,o,p),p(),i.addEventListener("change",()=>{i.checked&&le(s,e,m(i.value))})}else if(n.hasAttribute("contenteditable")){const p=n,b=()=>{const g=String(N(s,e)??"");p.innerText!==g&&(p.innerText=g)};if(ue(s,o,b),b(),r.has("debounce")){const g=[...r].find(F=>/^\d+$/.test(F)),k=g?parseInt(g):300;let L;p.addEventListener("input",()=>{clearTimeout(L),L=setTimeout(()=>le(s,e,m(p.innerText)),k)})}else{const g=r.has("lazy")?"blur":"input";p.addEventListener(g,()=>le(s,e,m(p.innerText)))}}else{const p=()=>{i.value=N(s,e)??""};if(ue(s,o,p),p(),r.has("debounce")){const b=[...r].find(L=>/^\d+$/.test(L)),g=b?parseInt(b):300;let k;i.addEventListener("input",()=>{clearTimeout(k),k=setTimeout(()=>le(s,e,m(i.value)),g)})}else{const b=h==="select"||r.has("lazy")?"change":"input";i.addEventListener(b,()=>le(s,e,m(i.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(s=>{var W,z;if(!s.name.startsWith("cv-"))return;const r=s.name.slice(3).split("."),i=r[0],u=r.slice(1),m=i.indexOf(":"),p=m>=0?i.slice(0,m):i,b=m>=0?i.slice(m+1):void 0,g=o.directives[p];if(!g)return;const k=s.value;n.removeAttribute(s.name);const L=typeof g=="function"?{onMount:g}:g,F={value:k?N(k,e):void 0,arg:b,modifiers:Object.fromEntries(u.map(M=>[M,!0]))};(W=L.onMount)==null||W.call(L,n,F),L.onUpdate&&k&&J(k,o,()=>{F.value=N(k,e),L.onUpdate(n,F)}),L.onDestroy&&((z=o.registerCleanup)==null||z.call(o,()=>L.onDestroy(n,F)))}),h==="slot"){const s=n.getAttribute("name")??"default",r=(R=o.slots)==null?void 0:R[s];if(r){const i={};Array.from(n.attributes).forEach(p=>{p.name.startsWith(":")&&(i[p.name.slice(1)]=N(p.value,e))});const u=await r(i),m=document.createDocumentFragment();u.forEach(p=>m.appendChild(p)),n.replaceWith(m)}else{const i=document.createDocumentFragment();for(;n.firstChild;)i.appendChild(n.firstChild);await oe(i,e,o),n.replaceWith(i)}l++;continue}if(h==="cv-transition"){Ue();const s=n.getAttribute("name")??"fade",r=n.getAttribute(":show")??null;n.removeAttribute("name"),r&&n.removeAttribute(":show");const i=document.createElement("div");for(i.className="cv-t-wrap";n.firstChild;)i.appendChild(n.firstChild);if(n.replaceWith(i),await oe(i,e,o),r){let u=!!N(r,e),m=!1,p=null;u||(i.style.display="none");const b=async g=>{if(m){p=g;return}m=!0;try{g?(i.style.display="",i.classList.add(`${s}-enter`),await se(i),i.classList.remove(`${s}-enter`)):(i.classList.add(`${s}-leave`),await se(i),i.classList.remove(`${s}-leave`),i.style.display="none"),u=g}finally{if(m=!1,p!==null&&p!==u){const k=p;p=null,b(k)}else p=null}};J(r,o,()=>{const g=!!N(r,e);g!==u&&b(g)})}l++;continue}if(h==="router-view"&&o.mountRouterView){const s=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,s),l++;continue}if(h==="router-link"){const s=n.getAttribute(":to"),r=n.getAttribute("to"),i=()=>s?String(N(s,e)??"/"):r||"/",u=document.createElement("a");u.innerHTML=n.innerHTML,Array.from(n.attributes).forEach(k=>{k.name!=="to"&&k.name!==":to"&&u.setAttribute(k.name,k.value)});const m=((C=o.router)==null?void 0:C.base)??"",p=k=>m?k===m?"/":k.startsWith(m+"/")?k.slice(m.length)||"/":k||"/":k||"/",b=()=>{var k;return((k=o.router)==null?void 0:k.mode)==="history"?p(window.location.pathname):window.location.hash.slice(1)||"/"},g=()=>{var F;const k=i(),L=b()===k;((F=o.router)==null?void 0:F.mode)==="history"?u.href=`${m}${k}`:u.href=`#${k}`,L?(u.setAttribute("aria-current","page"),u.classList.add("active")):(u.removeAttribute("aria-current"),u.classList.remove("active"))};((P=o.router)==null?void 0:P.mode)==="history"?(u.addEventListener("click",k=>{k.preventDefault(),o.router.navigate(i())}),window.addEventListener("popstate",g)):window.addEventListener("hashchange",g),s&&ue(s,o,g),g(),n.replaceWith(u),await oe(u,e,o),l++;continue}if(h==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const s=n.getAttribute(":is");n.removeAttribute(":is");const r=document.createComment("component:is");n.replaceWith(r),await o.mountDynamic(r,s,n,e,o),l++;continue}if((_=o.components)!=null&&_[h]&&o.mountElement){await o.mountElement(n,h,e,o),l++;continue}{const s=Array.from(n.attributes).find(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect."));if(s&&typeof IntersectionObserver<"u"){const r=new Set(s.name.split(".").slice(1));n.removeAttribute(s.name);const i=N(s.value,e);let u,m=0,p="0px",b=r.has("once");if(typeof i=="function"?u=g=>i.call(e,g):i&&typeof i=="object"&&(typeof i.handler=="function"&&(u=g=>i.handler.call(e,g)),i.threshold!==void 0&&(m=i.threshold),i.margin&&(p=i.margin),i.once&&(b=!0)),u){const g=new IntersectionObserver(k=>{const L=k[0];u(L),b&&L.isIntersecting&&g.disconnect()},{threshold:m,rootMargin:p});g.observe(n),(d=o.registerCleanup)==null||d.call(o,()=>g.disconnect())}}}if(n.hasAttribute("cv-resize")){const s=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const r=N(s,e);let i,u="content-box";if(typeof r=="function"?i=m=>r.call(e,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(i=m=>r.handler.call(e,m)),r.box&&(u=r.box)),i){const m=new ResizeObserver(p=>{p[0]&&i(p[0])});m.observe(n,{box:u}),(a=o.registerCleanup)==null||a.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const s=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const r=N(s,e);let i,u=0;if(typeof r=="function"?i=m=>r.call(e,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(i=m=>r.handler.call(e,m)),r.throttle&&(u=r.throttle)),i){let m=0;const p=()=>{const b=Date.now();u>0&&b-m<u||(m=b,i({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",p,{passive:!0}),(v=o.registerCleanup)==null||v.call(o,()=>n.removeEventListener("scroll",p))}}if(n.hasAttribute("cv-clickoutside")){const s=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const r=i=>{n.contains(i.target)||(typeof e[s]=="function"?e[s].call(e,i):Ne(s,e,i))};document.addEventListener("click",r,!0),(S=o.registerCleanup)==null||S.call(o,()=>document.removeEventListener("click",r,!0))}if(n.hasAttribute("cv-bind")){const s=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const r=n.getAttribute("class")??"",i=n.getAttribute("style")??"";let u=[];const m=()=>{const p=N(s,e)??{},b=Object.keys(p);for(const g of u)g in p||(g==="class"?n.className=r:g==="style"?n.style.cssText=i:n.removeAttribute(g));for(const[g,k]of Object.entries(p))g==="class"?n.className=[r,De(k)].filter(Boolean).join(" "):g==="style"?He(n,k,i):k==null||k===!1?n.removeAttribute(g):n.setAttribute(g,k===!0?"":String(k));u=b};J(s,o,m),m()}const O={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(s=>{if(s.name.startsWith("@")||s.name.startsWith("cv:on:")){const r=(s.name.startsWith("@")?s.name.substring(1):s.name.substring(6)).split("."),i=r[0],u=new Set(r.slice(1)),m=[...u].find(k=>k in O),p=s.value,b=k=>{u.has("prevent")&&k.preventDefault(),u.has("stop")&&k.stopPropagation(),!(u.has("self")&&k.target!==k.currentTarget)&&(m&&k.key!==O[m]||(typeof e[p]=="function"?e[p].call(e,k):Ne(p,e,k)))},g={};u.has("once")&&(g.once=!0),u.has("passive")&&(g.passive=!0),u.has("capture")&&(g.capture=!0),n.addEventListener(i,b,Object.keys(g).length?g:void 0)}else if(s.name.startsWith(":")){const r=s.name.slice(1),i=s.value;if(r==="class"){const u=n.getAttribute("class")??"",m=()=>{n.className=[u,De(N(i,e))].filter(Boolean).join(" ")};J(i,o,m),m()}else if(r==="style"){const u=n.getAttribute("style")??"",m=()=>He(n,N(i,e),u);J(i,o,m),m()}else if(r.includes("-")){const u=()=>{const m=N(i,e);m==null||m===!1?n.removeAttribute(r):n.setAttribute(r,m===!0?"":String(m))};J(i,o,u),u()}else{const u=()=>{n[r]=N(i,e)??""};J(i,o,u),u()}}}),A.hasChildNodes()&&await oe(A,e,o),l++}}var xt=`
...
`;function At(){if(document.getElementById("cv-transitions"))return;const t=document.createElement("style");t.id="cv-transitions",t.textContent=xt,document.head.appendChild(t)}async function ge(t,e,o){t.classList.add(`${e}-${o}`);const c=getComputedStyle(t),l=Math.max(parseFloat(c.animationDuration)||0,parseFloat(c.transitionDuration)||0)*1e3;l>0&&await new Promise(y=>{const E=()=>y();t.addEventListener("animationend",E,{once:!0}),t.addEventListener("transitionend",E,{once:!0}),setTimeout(E,l+50)}),t.classList.remove(`${e}-${o}`)}var we=new Map;async function St(t){if(typeof t!="function")return t;if(we.has(t))return we.get(t);const e=await t();return we.set(t,e.default),e.default}function qe(t,e){if(t.components)return t.components[e];if(e==="default")return t.component}function Ve(t,e){if(t==="*")return{};const o=[],c=t.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=e.match(new RegExp(`^${c}$`));return l?Object.fromEntries(o.map((y,E)=>[y,l[E+1]])):null}function Et(t,e){if(t==="/")return{params:{},remaining:e};const o=[],c=t.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=e.match(new RegExp(`^${c}(/.+)?$`));return l?{params:Object.fromEntries(o.map((y,E)=>[y,l[E+1]])),remaining:l[o.length+1]||"/"}:null}function dt(t,e=""){return t.map(o=>{var l;if(o.path==="*")return o;const c=((e.endsWith("/")?e.slice(0,-1):e)+o.path).replace(/\/+/g,"/")||"/";return(l=o.children)!=null&&l.length?{...o,path:c,children:dt(o.children,c==="/"?"":c)}:{...o,path:c}})}var me=(t,e)=>new Promise(o=>t(e,o)),Ge=(t,e)=>t!=null&&t.beforeLeave?new Promise(o=>t.beforeLeave(e,o)):Promise.resolve(void 0);function _t(t,e={}){const o=e.mode??"hash",c=Tt(e.base??"");return{routes:dt(t),mode:o,base:c,transition:e.transition,beforeEach:e.beforeEach,afterEach:e.afterEach,scrollBehavior:e.scrollBehavior,navigate(l,y){const E=Ye(l,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=E},replace(l,y){const E=Ye(l,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${E}`)}},back(){history.back()},forward(){history.forward()}}}function Tt(t){if(!t||t==="/")return"";let e=t.startsWith("/")?t:`/${t}`;return e.endsWith("/")&&(e=e.slice(0,-1)),e}function $t(t,e){return e?t===e?"/":t.startsWith(e+"/")?t.slice(e.length)||"/":t||"/":t||"/"}function Ye(t,e){return!e||!Object.keys(e).length?t:`${t}?${new URLSearchParams(e).toString()}`}function Xe(t){if(!t)return{};const e=new URLSearchParams(t.startsWith("?")?t.slice(1):t),o={};return e.forEach((c,l)=>{o[l]=c}),o}function Ze(t,e,o,c="default",l){const y=e.base??"",E=()=>e.mode==="history"?$t(window.location.pathname,y):(window.location.hash.slice(1)||"/").split("?")[0]||"/",x=()=>{if(e.mode==="history")return Xe(window.location.search);const a=window.location.hash.slice(1)||"/",v=a.indexOf("?");return v>=0?Xe(a.slice(v+1)):{}};e.transition&&At();let D=null,$=null,w=null,V=null,j=!1;const H=()=>{j||(j=!0,l==null||l())},R=new Map,C=a=>{var v;if(a!=null&&a.keepAlive&&w){(v=w.deactivate)==null||v.call(w);const S=document.createDocumentFragment();for(;t.firstChild;)S.appendChild(t.firstChild);R.set(D.path,{fragment:S,activation:w}),w=null}else w==null||w.destroy(),w=null,t.innerHTML=""},P=async(a,v,S,A,n)=>{const h=typeof v=="function"&&!we.has(v),f=h?v.__asyncOptions:void 0,T=a.loadingTemplate??(f==null?void 0:f.loadingTemplate);h&&T&&(t.innerHTML=T);let O;try{O=await St(v)}catch(s){const r=f==null?void 0:f.errorTemplate;if(r)return t.innerHTML=r,{destroy:()=>{t.innerHTML=""}};throw s}return h&&T&&(t.innerHTML=""),o(t,O,S,A,n)},_=async()=>{var S,A,n,h,f,T,O,s;const a=E(),v=x();for(const r of e.routes){if((S=r.children)!=null&&S.length){const u=Et(r.path,a);if(u!==null)for(const m of r.children){const p=Ve(m.path,a);if(p!==null){const b={params:u.params,query:v,path:a,meta:r.meta};if(m.redirect){const F={params:p,query:v,path:a,meta:m.meta},W=typeof m.redirect=="function"?m.redirect(F):m.redirect;e.navigate(W);return}if(e.beforeEach){const F=await me(e.beforeEach,b);if(F){e.navigate(F);return}}if(r.beforeEnter){const F=await me(r.beforeEnter,b);if(F){e.navigate(F);return}}if(m.beforeEnter){const F={params:p,query:v,path:a,meta:m.meta},W=await me(m.beforeEnter,F);if(W){e.navigate(W);return}}const g=`${r.path}::${JSON.stringify(u.params)}`;if(V!==g){const F=await Ge(w,b);if(F){e.navigate(F);return}const W=r.transition??e.transition;W&&t.hasChildNodes()&&await ge(t,W,"leave"),C($);const z=qe(r,c);if(z){const M={routes:r.children,mode:e.mode,base:e.base,transition:r.transition??e.transition,beforeEach:e.beforeEach,afterEach:e.afterEach,scrollBehavior:e.scrollBehavior,navigate:(G,I)=>e.navigate(G,I),replace:(G,I)=>e.replace(G,I),back:()=>e.back(),forward:()=>e.forward()};w=await P(r,z,b,c==="default"?r.layout:void 0,c==="default"?M:void 0),(A=w.enter)==null||A.call(w,D)}else t.innerHTML="";V=g,W&&await ge(t,W,"enter")}const k={params:{...u.params,...p},query:v,path:a,meta:m.meta??r.meta};(n=e.afterEach)==null||n.call(e,k,D);const L=(h=e.scrollBehavior)==null?void 0:h.call(e,k,D);L&&window.scrollTo(L.x??0,L.y??0),D=k,$=r,H();return}}}const i=Ve(r.path,a);if(i!==null){V=null;const u={params:i,query:v,path:a,meta:r.meta};if(r.redirect){const k=typeof r.redirect=="function"?r.redirect(u):r.redirect;e.navigate(k);return}if(e.beforeEach){const k=await me(e.beforeEach,u);if(k){e.navigate(k);return}}if(r.beforeEnter){const k=await me(r.beforeEnter,u);if(k){e.navigate(k);return}}const m=await Ge(w,u);if(m){e.navigate(m);return}const p=r.transition??e.transition;p&&t.hasChildNodes()&&await ge(t,p,"leave"),C($);const b=qe(r,c);if(b){const k=u.path;if(r.keepAlive&&R.has(k)){const L=R.get(k);t.appendChild(L.fragment),w=L.activation,(f=w.activate)==null||f.call(w),R.delete(k)}else{const L=D;w=await P(r,b,u,c==="default"?r.layout:void 0),(T=w.enter)==null||T.call(w,L)}}else t.innerHTML="",w=null;p&&await ge(t,p,"enter"),(O=e.afterEach)==null||O.call(e,u,D);const g=(s=e.scrollBehavior)==null?void 0:s.call(e,u,D);g&&window.scrollTo(g.x??0,g.y??0),D=u,$=r,H();return}}V=null,C($),$=null,H()},d=e.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,_),_(),()=>{window.removeEventListener(d,_),w==null||w.destroy(),w=null,R.forEach(({activation:a})=>a.destroy()),R.clear()}}function Ct(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const t=new Map,e={instances:[],stores:[],on(o,c){return t.has(o)||t.set(o,new Set),t.get(o).add(c),()=>{var l;return(l=t.get(o))==null?void 0:l.delete(c)}},_emit(o,c){var l;(l=t.get(o))==null||l.forEach(y=>{try{y(c)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const c=this.instances.findIndex(l=>l.id===o);if(c!==-1){const l=this.instances[c];this.instances.splice(c,1),this._emit("destroy",l)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=e,e}var Ft=0;function Ot(){return++Ft}var Lt=`
...
`;function jt(){if(document.getElementById("cvd-styles"))return;const t=document.createElement("style");t.id="cvd-styles",t.textContent=Lt,document.head.appendChild(t)}function be(t){return t===null?"null":t===void 0?"undefined":typeof t=="string"?`"${t}"`:typeof t=="object"?JSON.stringify(t):String(t)}function Je(t){try{return JSON.parse(t)}catch{return t}}function Pt(t){if(typeof document>"u")return;jt();const e=document.createElement("div");e.id="cvd",document.body.appendChild(e);let o=!1,c="components",l=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',e.appendChild(y);const E=document.createElement("div");E.id="cvd-panel",E.style.display="none",e.appendChild(E),E.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const x=E.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",E.style.display="flex",R()}),E.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,E.style.display="none",y.style.display=""}),E.querySelectorAll(".cvd-tab").forEach(C=>{C.addEventListener("click",()=>{c=C.dataset.tab,E.querySelectorAll(".cvd-tab").forEach(P=>P.classList.remove("active")),C.classList.add("active"),R()})});const D=E.querySelector("#cvd-head");let $=!1,w=0,V=0;D.addEventListener("mousedown",C=>{C.target.closest("button")||($=!0,w=C.clientX-e.getBoundingClientRect().left,V=C.clientY-e.getBoundingClientRect().top)}),document.addEventListener("mousemove",C=>{$&&(e.style.right="auto",e.style.bottom="auto",e.style.left=`${C.clientX-w}px`,e.style.top=`${C.clientY-V}px`)}),document.addEventListener("mouseup",()=>{$=!1});function j(){const C=t.instances;if(!C.length){x.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}x.innerHTML=C.map(P=>{const _=P.getState(),d=Object.keys(_);return`
            ...
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(P=>{P.addEventListener("click",()=>{const _=P.closest(".cvd-inst"),d=parseInt(_.dataset.id);l.has(d)?l.delete(d):l.add(d),_.classList.toggle("open")})}),x.querySelectorAll(".cvd-val").forEach(P=>{P.addEventListener("click",_=>{_.stopPropagation();const d=P;if(d.querySelector("input"))return;const a=parseInt(d.dataset.inst),v=d.dataset.key,S=t.instances.find(f=>f.id===a);if(!S)return;const A=be(S.getState()[v]);d.classList.add("editing"),d.innerHTML=`<input class="cvd-edit" value='${A.replace(/'/g,"&#39;")}'>`;const n=d.querySelector("input");n.focus(),n.select();const h=()=>{S.setState(v,Je(n.value)),d.classList.remove("editing")};n.addEventListener("blur",h),n.addEventListener("keydown",f=>{f.key==="Enter"&&(f.preventDefault(),h()),f.key==="Escape"&&(d.classList.remove("editing"),R())})})})}function H(){if(!t.stores.length){x.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}x.innerHTML=t.stores.map((C,P)=>{const _=C.getState(),d=Object.keys(_);return`
            ...
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(C=>{C.addEventListener("click",()=>C.closest(".cvd-inst").classList.toggle("open"))}),x.querySelectorAll("[data-store][data-key]").forEach(C=>{C.addEventListener("click",P=>{P.stopPropagation();const _=C;if(_.querySelector("input"))return;const d=parseInt(_.dataset.store),a=_.dataset.key,v=t.stores[d];if(!v)return;const S=be(v.getState()[a]);_.classList.add("editing"),_.innerHTML=`<input class="cvd-edit" value='${S.replace(/'/g,"&#39;")}'>`;const A=_.querySelector("input");A.focus(),A.select();const n=()=>{v.setState(a,Je(A.value)),_.classList.remove("editing")};A.addEventListener("blur",n),A.addEventListener("keydown",h=>{h.key==="Enter"&&(h.preventDefault(),n()),h.key==="Escape"&&(_.classList.remove("editing"),R())})})})}function R(){o&&(c==="components"?j():H())}t.on("mount",()=>R()),t.on("update",()=>R()),t.on("destroy",()=>R()),t.on("store-update",()=>R())}var Dt="__COURVUX_HEAD_COLLECTOR__";function Mt(){return globalThis[Dt]??null}var It=(t,e)=>{Object.entries(e).forEach(([o,c])=>{o!=="innerHTML"&&(c==null||c===!1||t.setAttribute(o,c===!0?"":String(c)))})},Rt=t=>{const e={};return Array.from(t.attributes).forEach(o=>{e[o.name]=o.value}),e},zt=(t,e)=>{Array.from(t.attributes).forEach(o=>t.removeAttribute(o.name)),Object.entries(e).forEach(([o,c])=>t.setAttribute(o,c))},Ke=(t,e,o,c)=>{let l=o?document.head.querySelector(o):null;l?(c.push({el:l,prevAttrs:Rt(l),created:!1}),Array.from(l.attributes).forEach(y=>l.removeAttribute(y.name))):(l=document.createElement(t),document.head.appendChild(l),c.push({el:l,created:!0})),It(l,e)};function Ht(t){var E,x,D;const e=Mt();if(e!==null)return e.push(t),()=>{};if(typeof document>"u")return()=>{};const o=[];let c;const l={},y={};if(t.title!==void 0){c=document.title;const $=t.titleTemplate,w=typeof $=="function"?$(t.title):typeof $=="string"?$.replace("%s",t.title):t.title;document.title=w}return(E=t.meta)==null||E.forEach($=>{Ke("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(x=t.link)==null||x.forEach($=>{Ke("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(D=t.script)==null||D.forEach($=>{const w=document.createElement("script");Object.entries($).forEach(([V,j])=>{V==="innerHTML"?w.textContent=String(j):j!=null&&j!==!1&&w.setAttribute(V,j===!0?"":String(j))}),document.head.appendChild(w),o.push({el:w,created:!0})}),t.htmlAttrs&&Object.entries(t.htmlAttrs).forEach(([$,w])=>{l[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,w)}),t.bodyAttrs&&Object.entries(t.bodyAttrs).forEach(([$,w])=>{y[$]=document.body.getAttribute($),document.body.setAttribute($,w)}),function(){c!==void 0&&(document.title=c),o.forEach(({el:$,prevAttrs:w,created:V})=>{var j;V?(j=$.parentNode)==null||j.removeChild($):w&&zt($,w)}),Object.entries(l).forEach(([$,w])=>{w===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,w)}),Object.entries(y).forEach(([$,w])=>{w===null?document.body.removeAttribute($):document.body.setAttribute($,w)})}}var Fe="data-courvux-ssr",Nt=t=>t?Promise.resolve().then(t):Promise.resolve();function Qe(t,e){const o=t.trim();if(o.startsWith("{")){const c=o.replace(/[{}]/g,"").split(",").map(l=>l.trim()).filter(Boolean);return Object.fromEntries(c.map(l=>[l,e[l]]))}return{[o]:e}}var ye=t=>{if(t===null||typeof t!="object")return t;try{return structuredClone(t)}catch{return t}};async function ne(t,e,o){var S,A,n;const c={},{subscribe:l,createReactiveState:y,registerSetInterceptor:E,notifyAll:x}=Pe();let D;if(typeof e.data=="function"?(e.loadingTemplate&&(t.innerHTML=e.loadingTemplate),D=await e.data()):D=e.data??{},e.templateUrl){const h=o.baseUrl?new URL(e.templateUrl,o.baseUrl).href:e.templateUrl,f=await fetch(h);if(!f.ok)throw new Error(`Failed to load template: ${h} (${f.status})`);t.innerHTML=await f.text()}else e.template&&(t.innerHTML=e.template);t.removeAttribute(Fe),(S=t.querySelector(`[${Fe}]`))==null||S.removeAttribute(Fe);const $={};if(e.inject&&o.provided){const h=Array.isArray(e.inject)?Object.fromEntries(e.inject.map(f=>[f,f])):e.inject;Object.entries(h).forEach(([f,T])=>{o.provided&&T in o.provided&&($[f]=o.provided[T])})}const w=y({...o.globalProperties??{},...D,...$,...e.methods,$refs:c,$el:t,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(h=>[h,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});w.$watch=(h,f,T)=>{const O=(T==null?void 0:T.deep)??!1,s=(T==null?void 0:T.immediate)??!1;let r=O?ye(w[h]):w[h];const i=l(h,()=>{const u=w[h];f.call(w,u,r),r=O?ye(u):u});return s&&f.call(w,w[h],void 0),i},w.$batch=bt,w.$nextTick=h=>Nt(h),w.$dispatch=(h,f,T)=>{t.dispatchEvent(new CustomEvent(h,{bubbles:!0,composed:!0,...T??{},detail:f}))},o.magics&&Object.entries(o.magics).forEach(([h,f])=>{w[h]=f(w)}),w.$forceUpdate=()=>x();const V=[];w.$watchEffect=h=>{let f=[];const T=()=>{f.forEach(i=>i()),f=[];const s=Me(()=>{try{h()}catch{}}),r=new Map;for(const{sub:i,key:u}of s)r.has(i)||r.set(i,new Set),!r.get(i).has(u)&&(r.get(i).add(u),f.push(i(u,T)))};T();const O=()=>{f.forEach(r=>r()),f=[];const s=V.indexOf(O);s>-1&&V.splice(s,1)};return V.push(O),O};const j=[];e.computed&&Object.entries(e.computed).forEach(([h,f])=>{const T=typeof f=="function"?f:f.get,O=typeof f!="function"?f.set:void 0;let s=[];const r=()=>{s.forEach(p=>p()),s=[];let i;const u=Me(()=>{try{i=T.call(w)}catch(p){(e.debug??o.debug)&&console.warn("[courvux] computed error:",p)}});w[h]=i;const m=new Map;for(const{sub:p,key:b}of u)m.has(p)||m.set(p,new Set),!m.get(p).has(b)&&(m.get(p).add(b),s.push(p(b,r)))};r(),j.push(()=>s.forEach(i=>i())),O&&E(h,i=>O.call(w,i))});const H=[];e.watch&&Object.entries(e.watch).forEach(([h,f])=>{const T=typeof f=="object"&&f!==null&&"handler"in f,O=T?f.handler:f,s=T?f.immediate??!1:!1,r=T?f.deep??!1:!1;let i=r?ye(w[h]):w[h];const u=l(h,()=>{const m=w[h];O.call(w,m,i),i=r?ye(m):m});H.push(u),s&&O.call(w,w[h],void 0)});const R={...o.provided??{}};if(e.provide){const h=typeof e.provide=="function"?e.provide.call(w):e.provide;Object.assign(R,h)}const C={...o,provided:R,components:{...o.components,...e.components}};C.mountElement=Ae(C),C.createChildScope=(h,f)=>{const T=new Set(Object.keys(h)),O=new Set(Object.keys(f)),{subscribe:s,createReactiveState:r}=Pe(),i=r(h);let u;return u=new Proxy({},{get(m,p){return typeof p!="string"?w[p]:T.has(p)?i[p]:O.has(p)?f[p].bind(u):w[p]},set(m,p,b){return typeof p!="string"?!1:T.has(p)?(i[p]=b,!0):(w[p]=b,!0)},has(m,p){return T.has(p)||O.has(p)||p in w},ownKeys(){return[...T,...O,...Object.keys(w)]},getOwnPropertyDescriptor(m,p){return T.has(p)||O.has(p)||p in w?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:u,subscribe:(m,p)=>T.has(m)?s(m,p):d(m,p),cleanup:()=>{}}},C.mountDynamic=async(h,f,T,O,s)=>{let r=null,i=null;const u=T.getAttribute("loading-template")??"",m=async()=>{var z,M,G;i==null||i(),i=null,r!=null&&r.parentNode&&(r.parentNode.removeChild(r),r=null);const p=N(f,O);if(!p)return;let b;if(typeof p=="function"){if(u){const I=document.createElement("div");I.innerHTML=u,(z=h.parentNode)==null||z.insertBefore(I,h.nextSibling),r=I}b=(await p()).default,r!=null&&r.parentNode&&(r.parentNode.removeChild(r),r=null)}else typeof p=="string"?b=(M=C.components)==null?void 0:M[p]:p&&typeof p=="object"&&(b=p);if(!b)return;const g=document.createElement("div");Array.from(T.attributes).forEach(I=>g.setAttribute(I.name,I.value)),g.innerHTML=T.innerHTML;const k={},L={};Array.from(T.attributes).forEach(I=>{if(I.name.startsWith(":"))k[I.name.slice(1)]=N(I.value,O);else if(I.name.startsWith("@")||I.name.startsWith("cv:on:")){const B=I.value,Q=I.name.startsWith("@")?I.name.slice(1):I.name.slice(6);L[Q]=(...q)=>{typeof O[B]=="function"&&O[B].call(O,...q)}}});const F={...b,data:{...b.data,...k},methods:{...b.methods,$emit(I,...B){var Q;ut(b,I,B),(Q=L[I])==null||Q.call(L,...B)}}},W={...C,components:{...C.components,...b.components}};W.mountElement=Ae(W),i=(await ne(g,F,W)).destroy,(G=h.parentNode)==null||G.insertBefore(g,h.nextSibling),r=g};J(f,s,m),await m()};const P=[];w.$addCleanup=h=>{P.push(h)};let _=!1;const d=(h,f)=>!e.onBeforeUpdate&&!e.onUpdated?l(h,f):l(h,()=>{var T;_||(_=!0,(T=e.onBeforeUpdate)==null||T.call(w),Promise.resolve().then(()=>{var O;_=!1,(O=e.onUpdated)==null||O.call(w)})),f()});try{(A=e.onBeforeMount)==null||A.call(w),await oe(t,w,{subscribe:d,refs:c,...C,registerCleanup:h=>P.push(h)}),t.removeAttribute("cv-cloak"),(n=e.onMount)==null||n.call(w)}catch(h){if(e.onError)t.removeAttribute("cv-cloak"),e.onError.call(w,h);else if(o.errorHandler)t.removeAttribute("cv-cloak"),o.errorHandler(h,w,e.name??t.tagName.toLowerCase());else throw h}const a=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,v=a?Ot():0;if(a){const h=w,f=new Set,T={id:v,name:e.name??t.tagName.toLowerCase(),el:t,getState:()=>{const O={};for(const s of Object.keys(h))if(!(s.startsWith("$")||typeof h[s]=="function"))try{O[s]=h[s]}catch{}return O},setState:(O,s)=>{h[O]=s},subscribe:O=>(f.add(O),()=>f.delete(O)),children:[]};Object.keys(h).filter(O=>!O.startsWith("$")&&typeof h[O]!="function").forEach(O=>{l(O,()=>{a._emit("update",T),f.forEach(s=>s())})}),a._registerInstance(T),P.push(()=>a._unregisterInstance(v))}return{state:w,destroy:()=>{var h,f;(h=e.onBeforeUnmount)==null||h.call(w),j.forEach(T=>T()),H.forEach(T=>T()),V.forEach(T=>T()),P.forEach(T=>T()),(f=e.onDestroy)==null||f.call(w)},activate:()=>{var h;(h=e.onActivated)==null||h.call(w)},deactivate:()=>{var h;(h=e.onDeactivated)==null||h.call(w)},beforeLeave:e.onBeforeRouteLeave?(h,f)=>e.onBeforeRouteLeave.call(w,h,f):void 0,enter:e.onBeforeRouteEnter?h=>e.onBeforeRouteEnter.call(w,h):void 0}}function ut(t,e,o){if(!t.emits||Array.isArray(t.emits))return;const c=t.emits[e];typeof c=="function"&&!c(...o)&&console.warn(`[courvux] emit "${e}": validator returned false`)}function Ae(t){return async(e,o,c,l)=>{const y=t.components[o],E=e.getAttribute("cv-ref");E&&e.removeAttribute("cv-ref");const x={},D=[],$={};Array.from(e.attributes).filter(_=>_.name==="cv-model"||_.name.startsWith("cv-model.")||_.name.startsWith("cv-model:")).forEach(_=>{e.removeAttribute(_.name);const d=_.value,a=_.name.indexOf(":"),v=a>=0?_.name.slice(a+1).split(".")[0]:"modelValue",S=v==="modelValue"?"update:modelValue":`update:${v}`;x[v]=$e(N(d,c)),D.push({propName:v,expr:d}),$[S]=A=>{le(d,c,A)}});const w={};Array.from(e.attributes).forEach(_=>{const d=_.name.startsWith(":"),a=_.name.startsWith("@")||_.name.startsWith("cv:on:"),v=_.name==="cv-model"||_.name.startsWith("cv-model.")||_.name.startsWith("cv-model:"),S=_.name.startsWith("v-slot"),A=_.name==="slot";!d&&!a&&!v&&!S&&!A&&(w[_.name]=_.value)}),y.inheritAttrs===!1&&Object.keys(w).forEach(_=>e.removeAttribute(_)),Array.from(e.attributes).forEach(_=>{if(_.name.startsWith(":")){const d=_.name.slice(1),a=_.value;x[d]=$e(N(a,c)),D.push({propName:d,expr:a})}else if(_.name.startsWith("@")||_.name.startsWith("cv:on:")){const d=_.name.startsWith("@")?_.name.slice(1):_.name.slice(6),a=_.value;$[d]=(...v)=>{typeof c[a]=="function"&&c[a].call(c,...v)}}});const V=e.getAttribute("v-slot")??e.getAttribute("v-slot:default");V&&(e.removeAttribute("v-slot"),e.removeAttribute("v-slot:default"));const j=new Map,H=[];Array.from(e.childNodes).forEach(_=>{const d=_.nodeType===1?_.getAttribute("slot"):null;if(d){if(!j.has(d)){const a=e.getAttribute(`v-slot:${d}`)??null;a&&e.removeAttribute(`v-slot:${d}`),j.set(d,{nodes:[],vSlot:a})}j.get(d).nodes.push(_.cloneNode(!0))}else H.push(_.cloneNode(!0))});const R={};H.some(_=>{var d;return _.nodeType===1||_.nodeType===3&&(((d=_.textContent)==null?void 0:d.trim())??"")!==""})&&(R.default=async _=>{const d=V?{...c,...Qe(V,_)}:c,a=document.createDocumentFragment();return H.forEach(v=>a.appendChild(v.cloneNode(!0))),await oe(a,d,l),Array.from(a.childNodes)});for(const[_,{nodes:d,vSlot:a}]of j)R[_]=async v=>{const S=a?{...c,...Qe(a,v)}:c,A=document.createDocumentFragment();return d.forEach(n=>A.appendChild(n.cloneNode(!0))),await oe(A,S,l),Array.from(A.childNodes)};const C={...t,components:{...t.components,...y.components},slots:R};C.mountElement=Ae(C);const{state:P}=await ne(e,{...y,data:{...y.data,...x,$attrs:w,$parent:c},methods:{...y.methods,$emit(_,...d){var a;ut(y,_,d),(a=$[_])==null||a.call($,...d)}}},C);P&&(D.forEach(({propName:_,expr:d})=>{ue(d,{...l,subscribe:l.subscribe},()=>{P[_]=$e(N(d,c))})}),E&&l.refs&&(l.refs[E]=P))}}function Wt(t){kt();const e=typeof window<"u"?Ct():void 0,o=[],c={...t.directives},l={...t.components??{}},y=[],E=new Map,x={},D=new Map;if(t.debug&&e&&Pt(e),e&&t.store){const j=t.store,H=Object.keys(j).filter(R=>typeof j[R]!="function");e._registerStore({getState(){const R={};return H.forEach(C=>{try{R[C]=j[C]}catch{}}),R},setState(R,C){j[R]=C},subscribe(R){const C=H.map(P=>{try{return ve(j,P,R)}catch{return()=>{}}});return()=>C.forEach(P=>P())}})}const $={router:t.router,use(j){return o.includes(j)||(o.push(j),j.install($)),$},directive(j,H){return c[j]=H,$},component(j,H){return l[j]=H,$},provide(j,H){return typeof j=="string"?x[j]=H:Object.assign(x,j),$},magic(j,H){return D.set(`$${j}`,H),$},mount:async j=>(await V(j),$),mountAll:async(j="[data-courvux]")=>{const H=Array.from(document.querySelectorAll(j));return await Promise.all(H.map(R=>w(R))),$},mountEl:async j=>w(j),unmount(j){if(!j)y.forEach(H=>H()),y.length=0,E.clear();else{const H=document.querySelector(j);if(H){const R=E.get(H);if(R){R(),E.delete(H);const C=y.indexOf(R);C>-1&&y.splice(C,1)}}}return $},destroy(){y.forEach(j=>j()),y.length=0,E.clear()}},w=async j=>{const H=new URL(".",document.baseURI).href,R={components:l,router:t.router,store:t.store,directives:c,baseUrl:H,provided:{...x},errorHandler:t.errorHandler,globalProperties:t.globalProperties,magics:D.size?Object.fromEntries(D):void 0};if(R.mountElement=Ae(R),t.router){const P=t.router;R.mountRouterView=async(_,d)=>{await new Promise(a=>{Ze(_,P,async(v,S,A,n,h)=>{const f={...R,currentRoute:A};if(h){let T=null;const O={...f,mountRouterView:async(s,r)=>{T=Ze(s,h,async(i,u,m,p)=>{const b={...f,currentRoute:m};if(p){let g=null;const k={...b,mountRouterView:async(F,W)=>{g=await ne(F,u,b)}},{destroy:L}=await ne(i,{template:p},k);return{destroy:()=>{g==null||g.destroy(),L()},activate:()=>g==null?void 0:g.activate(),deactivate:()=>g==null?void 0:g.deactivate()}}else return await ne(i,u,b)},r)}};if(n){let s=null;const r={...O,mountRouterView:async(u,m)=>{s=await ne(u,S,O)}},{destroy:i}=await ne(v,{template:n},r);return{destroy:()=>{T==null||T(),s==null||s.destroy(),i()},activate:()=>s==null?void 0:s.activate(),deactivate:()=>s==null?void 0:s.deactivate()}}else{const s=await ne(v,S,O);return{destroy:()=>{T==null||T(),s.destroy()},activate:()=>s.activate(),deactivate:()=>s.deactivate()}}}else if(n){let T=null;const O={...f,mountRouterView:async(r,i)=>{T=await ne(r,S,f)}},{destroy:s}=await ne(v,{template:n},O);return{destroy:()=>{T==null||T.destroy(),s()},activate:()=>T==null?void 0:T.activate(),deactivate:()=>T==null?void 0:T.deactivate()}}else return await ne(v,S,f)},d,a)})}}const C=await ne(j,t,R);return y.push(C.destroy),E.set(j,C.destroy),C.state},V=async j=>{const H=document.querySelector(j);if(H)return w(H)};return $}var et=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ut(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var Oe={exports:{}},tt;function Bt(){return tt||(tt=1,(function(t){var e=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
`)}const Zt={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Yt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var t;(t=navigator.clipboard)==null||t.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const t=this.$refs.el;t&&(this._cleanCode=Xt(this.code),t.textContent=this._cleanCode,Vt.highlightElement(t))}},he="Courvux",Jt="https://vanjexdev.github.io/courvux";function K({title:t,description:e,slug:o="/"}){const c=t?`${t} — ${he}`:`${he} — Lightweight reactive UI framework`,l=Jt+o;return Ht({title:t??`${he} — Lightweight reactive UI framework`,titleTemplate:t?`%s — ${he}`:void 0,meta:[{name:"description",content:e},{property:"og:title",content:c},{property:"og:description",content:e},{property:"og:type",content:"website"},{property:"og:url",content:l},{property:"og:site_name",content:he},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:c},{name:"twitter:description",content:e}],link:[{rel:"canonical",href:l}]})}const Kt={data:{install:`# From GitHub
...
createApp({
    ...
    `,onMount(){K({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~10 KB gzip.",slug:"/"})}},Qt={data:{s1:`npm install github:vanjexdev/courvux
# or
...
createApp({ store, router, template: '<router-view />' }).mount('#app');`},template:`
    ...
    `,onMount(){K({title:"Quick Start",description:"Build your first reactive Courvux app — counter example, methods, computed properties.",slug:"/quick-start"})}},to={data:{s_interp:`<!-- Text interpolation -->
<p>{{ count }}</p>
<p>{{ price * qty }}</p>
<p>{{ active ? 'On' : 'Off' }}</p>
...
<div id="app" cv-cloak></div>`},template:`
    ...
    `,onMount(){K({title:"Template Syntax",description:"Courvux directives and bindings: cv-if, cv-for, cv-model, cv-show, :class, :style, @event.",slug:"/template"})}},oo={data:{s_define:`createApp({
    components: {
        'user-card': {
...
<editor cv-model:title="docTitle" cv-model:body="docBody" />`},template:`
    ...
    `,onMount(){K({title:"Components",description:"Define, register, and compose Courvux components with props, slots, emits, and scoped slots.",slug:"/components"})}},no={data:{s_computed:`{
    data: { price: 10, qty: 3 },
    computed: {
...
provide() {
    ...
    `,onMount(){K({title:"Reactivity",description:"Proxy-based reactive state, computed properties, watchers, and refs in Courvux.",slug:"/reactivity"})}},ro={data:{s1:`{
    data: { ticks: 0 },
...
}`,s3:`// Error boundary — catches errors from descendant onMount
{
    ...
    `,onMount(){K({title:"Lifecycle Hooks",description:"onMount, onBeforeUnmount, onDestroy, error boundaries, and async data in Courvux.",slug:"/lifecycle"})}},ao={data:{s_storage:`import { cvStorage } from 'courvux';
...
onMount() {
    ...
    `,onMount(){K({title:"Composables",description:"Reactive composables in Courvux: cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener.",slug:"/composables"})}},so={data:{s_basic:`import { createEventBus } from 'courvux';
...
bus.emit('toast:show', 'Saved again');  // handler does NOT run`},template:`
    ...
    `,onMount(){K({title:"Event Bus",description:"Typed cross-component event bus in Courvux: on, off, emit, once, clear, and provide/inject patterns.",slug:"/event-bus"})}},io={data:{s_setup:`import { createApp, createRouter } from 'courvux';
...
methods: {
    ...
    `,onMount(){K({title:"Router",description:"SPA routing in Courvux: dynamic params, nested routes, navigation guards, transitions.",slug:"/router"})}},co={data:{s1:`import { createStore } from 'courvux';
...
{ inject: { localTheme: 'theme', endpoint: 'apiUrl' } }`},template:`
    ...
    `,onMount(){K({title:"Store",description:"Global reactive state in Courvux with createStore, modules, and namespaced actions.",slug:"/store"})}},lo={data:{s_basic:`import { useHead } from 'courvux';
...
// → <title>Install | site</title>`},template:`
    ...
    `,onMount(){K({title:"useHead — SEO and metadata",description:"Per-component head management with useHead in Courvux: title, meta tags, Open Graph, JSON-LD, htmlAttrs.",slug:"/head"})}},uo={data:{s_vite:`// vite.config.js
import { defineConfig } from 'vite';
...
// → embed headHtml in your shell, then html in the mount root`},template:`
    ...
    `,onMount(){K({title:"Static Site Generation",description:"Pre-render every route to static HTML at build time with the courvux/plugin/ssg Vite plugin.",slug:"/ssg"})}},po={data:{s_setup:`import { createApp, setupDevTools, mountDevOverlay } from 'courvux';
...
inst.setState('filter', 'completed');`},template:`
    ...
    `,onMount(){K({title:"DevTools",description:"In-app DevTools overlay for Courvux: live component state inspection and inline editing, no browser extension needed.",slug:"/devtools"})}},mo={data:{s_basic:`import { mount } from 'courvux/test-utils';
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,onMount(){K({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},ho={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
<button cv-if="pwa.installable && !pwa.installed" @click="pwa.prompt()">
    ...
    `,onMount(){K({title:"Progressive Web App",description:"Make any Courvux app installable and offline-capable: manifest, vite-plugin-pwa, install prompt utility.",slug:"/pwa"})}},fo={data:{s_dir:`// Full definition
app.directive('focus', {
...
autoInit({
    ...
    `,onMount(){K({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},pt="courvux-demo-todos",vo=`const STORAGE_KEY = 'courvux-demo-todos';
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function bo(){try{return JSON.parse(localStorage.getItem(pt))||[]}catch{return[]}}function yo(t){localStorage.setItem(pt,JSON.stringify(t))}const ko={data:{todos:bo(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:vo,srcHtml:go,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(t=>!t.done):this.filter==="completed"?this.todos.filter(t=>t.done):this.todos},remaining(){return this.todos.filter(t=>!t.done).length},allDone(){return this.todos.length>0&&this.todos.every(t=>t.done)}},watch:{todos:{deep:!0,handler(t){yo(t)}}},methods:{add(){const t=this.newTodo.trim();t&&(this.todos=[...this.todos,{id:this._nextId++,text:t,done:!1}],this.newTodo="")},toggle(t){this.todos=this.todos.map(e=>e.id===t?{...e,done:!e.done}:e)},remove(t){this.todos=this.todos.filter(e=>e.id!==t)},clearCompleted(){this.todos=this.todos.filter(t=>!t.done)},toggleAll(){const t=this.allDone;this.todos=this.todos.map(e=>({...e,done:!t}))},startEdit(t){this.editingId=t.id,this.editText=t.text,this.$nextTick(()=>{var e;return(e=this.$refs["edit_"+t.id])==null?void 0:e.focus()})},commitEdit(t){const e=this.editText.trim();e?this.todos=this.todos.map(o=>o.id===t?{...o,text:e}:o):this.remove(t),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(t){this.filter=t}},template:`
    ...
    `,onMount(){K({title:"Demo — TODO App",description:"Interactive TODO app built with Courvux. Live demo with full source code (JS + HTML).",slug:"/demo"})}},wo=[{path:"/",component:Kt},{path:"/installation",component:Qt},{path:"/quick-start",component:eo},{path:"/template",component:to},{path:"/components",component:oo},{path:"/reactivity",component:no},{path:"/lifecycle",component:ro},{path:"/composables",component:ao},{path:"/event-bus",component:so},{path:"/router",component:io},{path:"/store",component:co},{path:"/head",component:lo},{path:"/ssg",component:uo},{path:"/devtools",component:po},{path:"/testing",component:mo},{path:"/pwa",component:ho},{path:"/advanced",component:fo},{path:"/demo",component:ko}],xo={template:`
