(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const y of s)if(y.type==="childList")for(const S of y.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&i(S)}).observe(document,{childList:!0,subtree:!0});function o(s){const y={};return s.integrity&&(y.integrity=s.integrity),s.referrerPolicy&&(y.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?y.credentials="include":s.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function i(s){if(s.ep)return;s.ep=!0;const y=o(s);fetch(s.href,y)}})();var bt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),at=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,Oe=new WeakSet,we=Symbol("raw"),Te=e=>e===null||typeof e!="object"?e:e[we]??e,ye=0,Fe=new Map,he=null;function Ie(e){const t=[],o=he;he=t;try{e()}finally{he=o}return t}function yt(e){ye++;try{e()}finally{if(ye--,ye===0){const t=[...Fe.values()];Fe.clear(),t.forEach(o=>o())}}}function it(e,t){return e===null||typeof e!="object"||Oe.has(e)||at(e)?e:new Proxy(e,{get(o,i){if(i===we)return o[we]??o;if(typeof i=="string"&&Array.isArray(o)&&bt.has(i))return(...y)=>{const S=Array.prototype[i].apply(o,y);return t(),S};const s=o[i];return s!==null&&typeof s=="object"&&!Oe.has(s)?it(s,t):s},set(o,i,s){return o[i]=s,t(),!0}})}function Pe(){const e={},t=Math.random().toString(36).slice(2),o=(y,S)=>(e[y]||(e[y]=new Set),e[y].add(S),()=>{var x;(x=e[y])==null||x.delete(S)}),i=y=>{ye>0?Fe.set(`${t}:${y}`,()=>{(e[y]?[...e[y]]:[]).forEach(S=>S())}):(e[y]?[...e[y]]:[]).forEach(S=>S())},s={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(S,x){if(x===we)return y;typeof x=="string"&&!x.startsWith("$")&&he&&he.push({sub:o,key:x});const R=S[x];return typeof x=="string"&&!x.startsWith("$")&&R!==null&&typeof R=="object"&&!Oe.has(R)&&!at(R)?it(R,()=>i(x)):R},set(S,x,R){if(s[x])return s[x](R),!0;const $=S[x];return S[x]=R,($!==R||R!==null&&typeof R=="object")&&i(x),!0}}),registerSetInterceptor:(y,S)=>{s[y]=S},notifyAll:()=>{Object.keys(e).forEach(y=>i(y))}}}var _e=new WeakMap;function fe(e,t,o){var s,y;const i=t.indexOf(".");if(i>=0){const S=t.slice(0,i),x=t.slice(i+1),R=e[S];return R&&_e.has(R)?fe(R,x,o):((s=_e.get(e))==null?void 0:s(S,o))??(()=>{})}return((y=_e.get(e))==null?void 0:y(t,o))??(()=>{})}var st=(e,t)=>e.split(".").reduce((o,i)=>o==null?void 0:o[i],t),ct=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),Le=new Map,Re=new Map,dt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!dt(o.slice(1).trim(),t):st(o,t)},U=(e,t)=>{if(!ct)return dt(e,t);try{let o=Le.get(e);return o||(o=new Function("$data",`with($data) { return (${e}) }`),Le.set(e,o)),o(t)}catch{return st(e,t)}},lt=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):fe(t.store,e.slice(7),o):t.subscribe(e,o),Z=(e,t,o)=>{const i=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),s=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(s.map(x=>x.startsWith("$store.")?x:x.split(".")[0]).filter(x=>!i.has(x)))];if(y.length===0)return()=>{};const S=y.map(x=>lt(x,t,o));return()=>S.forEach(x=>x())},de=(e,t,o)=>{const i=e.split(".");if(i.length===1)t[i[0]]=o;else{const s=i.slice(0,-1).reduce((y,S)=>y==null?void 0:y[S],t);s&&(s[i[i.length-1]]=o)}},ze=(e,t,o,i,s)=>{const y={};return Object.keys(e).forEach(S=>y[S]=e[S]),y[o]=t,s&&(y[s]=i),y},Me=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(Me).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",He=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([i,s])=>{e.style[i]=s??""}))},Ne=(e,t,o)=>{if(ct)try{let i=Re.get(e);i||(i=new Function("__p__",`with(__p__){${e}}`),Re.set(e,i));const s=new Proxy({},{has:()=>!0,get:(y,S)=>S==="$event"?o:S in t?t[S]:globalThis[S],set:(y,S,x)=>(t[S]=x,!0)});i(s)}catch(i){console.warn(`[courvux] handler error "${e}":`,i)}},ie=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(i=>{const s=()=>i();e.addEventListener("animationend",s,{once:!0}),e.addEventListener("transitionend",s,{once:!0}),setTimeout(s,o+50)})},xt=`
...
`,We=!1;function Ue(){if(We||typeof document>"u")return;We=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=xt,document.head.appendChild(e)}var qe=!1;function wt(){if(qe||typeof document>"u")return;qe=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function kt(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(i=>{(i.name.startsWith("on")||i.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(i.name)})}),t.body.innerHTML}async function oe(e,t,o){var y,S,x,R,$,C,D,_,I,z,j,L,E,c,d,p,w;const i=Array.from(e.childNodes);let s=0;for(;s<i.length;){const k=i[s];if(k.nodeType===3){const a=k.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,f=()=>{let m=r;l.forEach(u=>{const h=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(u,U(h,t)??"")}),k.textContent=m};l.forEach(m=>{Z(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,f)}),f()}s++;continue}if(k.nodeType!==1){s++;continue}const n=k,v=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),s++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await oe(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),s++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await oe(n,t,o),l.appendChild(n),s++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(h=>U(h.trim(),t));let r=l();const f=[],m=h=>(f.push(h),()=>{const g=f.indexOf(h);g>-1&&f.splice(g,1)});await oe(n,t,{...o,subscribe:(h,g)=>m(g),storeSubscribeOverride:(h,g,T)=>m(T)});const u=Z(a,o,()=>{const h=l();h.some((g,T)=>g!==r[T])&&(r=h,[...f].forEach(g=>g()))});(y=o.registerCleanup)==null||y.call(o,()=>u()),s++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const f=U(a,t)??{};Object.entries(f).forEach(([m,u])=>{typeof u=="function"?r[m]=u:l[m]=u})}else if(a){const f=(S=o.components)==null?void 0:S[a];if(f){const m=typeof f.data=="function"?f.data():f.data??{};m instanceof Promise||Object.assign(l,m),Object.assign(r,f.methods??{})}}if(o.createChildScope){const f=o.createChildScope(l,r);(x=o.registerCleanup)==null||x.call(o,f.cleanup),await oe(n,f.state,{...o,subscribe:f.subscribe})}else await oe(n,{...t,...l,...r},o);s++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,f,m]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const h=n.getAttribute("cv-transition")??null;h&&n.removeAttribute("cv-transition");const g=document.createComment(`cv-for: ${m}`);n.replaceWith(g);let T=[],F=[];const P=new Map,W=async()=>{var G;const N=U(m,t),O=N?typeof N=="number"?Array.from({length:N},(q,H)=>[H+1,H]):Array.isArray(N)?N.map((q,H)=>[q,H]):Object.entries(N).map(([q,H])=>[H,q]):[];if(u){const q=[],H=new Map,K=new Set;for(const[X,Y]of O){const re=U(u,ze(t,X,r,Y,f));K.has(re)&&console.warn(`[courvux] cv-for: duplicate :key "${re}" in "${m}"`),K.add(re),q.push(re),H.set(re,[X,Y])}const B=[];for(const[X,{el:Y,destroy:re}]of P)H.has(X)||(h?(Y.classList.add(`${h}-leave`),B.push(ie(Y).then(()=>{var ae;Y.classList.remove(`${h}-leave`),re(),(ae=Y.parentNode)==null||ae.removeChild(Y),P.delete(X)}))):(re(),(G=Y.parentNode)==null||G.removeChild(Y),P.delete(X)));B.length&&await Promise.all(B);const V=g.parentNode,te=[];for(const X of q){const[Y,re]=H.get(X);if(P.has(X)){const ae=P.get(X);ae.itemRef!==Y&&(ae.reactive[r]=Y,ae.itemRef=Y),f&&(ae.reactive[f]=re)}else{const ae=n.cloneNode(!0),Se=[],{subscribe:ht,createReactiveState:ft}=Pe(),Ae=ft({[r]:Y,...f?{[f]:re}:{}}),gt=new Proxy({},{has(se,ee){return!0},get(se,ee){return typeof ee!="string"?t[ee]:ee===r||f&&ee===f?Ae[ee]:t[ee]},set(se,ee,ce){return ee===r||f&&ee===f?(Ae[ee]=ce,!0):(t[ee]=ce,!0)}}),vt={...o,subscribe:(se,ee)=>{const ce=se.split(".")[0];let le;return ce===r||f&&ce===f?le=ht(ce,ee):le=o.subscribe(se,ee),Se.push(le),le},storeSubscribeOverride:(se,ee,ce)=>{const le=fe(se,ee,ce);return Se.push(le),le}},Ce=document.createDocumentFragment();Ce.appendChild(ae),await oe(Ce,gt,vt);const Ee=Ce.firstChild??ae;h&&Ee.classList.add(`${h}-enter`),P.set(X,{el:Ee,reactive:Ae,itemRef:Y,destroy:()=>Se.forEach(se=>se())}),h&&te.push(Ee)}}let Q=g.nextSibling,ue=0;for(const X of q){const{el:Y}=P.get(X);Y!==Q?ue++:Q=Y.nextSibling}if(ue>0)if(ue>q.length>>1){const X=document.createDocumentFragment();for(const Y of q)X.appendChild(P.get(Y).el);V.insertBefore(X,g.nextSibling)}else{Q=g.nextSibling;for(const X of q){const{el:Y}=P.get(X);Y!==Q?V.insertBefore(Y,Q):Q=Y.nextSibling}}T=q.map(X=>P.get(X).el),te.length&&Promise.all(te.map(X=>ie(X).then(()=>X.classList.remove(`${h}-enter`))))}else{if(F.forEach(B=>B()),F=[],T.forEach(B=>{var V;return(V=B.parentNode)==null?void 0:V.removeChild(B)}),T=[],!O.length)return;const q=g.parentNode,H=g.nextSibling,K={...o,subscribe:(B,V)=>{const te=o.subscribe(B,V);return F.push(te),te},storeSubscribeOverride:(B,V,te)=>{const Q=fe(B,V,te);return F.push(Q),Q}};for(const[B,V]of O){const te=n.cloneNode(!0),Q=document.createDocumentFragment();Q.appendChild(te),await oe(Q,ze(t,B,r,V,f),K);const ue=Q.firstChild??te;q.insertBefore(Q,H),T.push(ue)}}};(R=o.registerCleanup)==null||R.call(o,()=>{P.forEach(({el:N,destroy:O})=>{var G;O(),(G=N.parentNode)==null||G.removeChild(N)}),P.clear(),F.forEach(N=>N()),T.forEach(N=>{var O;return(O=N.parentNode)==null?void 0:O.removeChild(N)}),T=[]}),Z(m,o,W),await W()}s++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let f=s+1;for(;f<i.length;){const T=i[f];if(T.nodeType===3&&((($=T.textContent)==null?void 0:$.trim())??"")===""){f++;continue}if(T.nodeType!==1)break;const F=T;if(F.hasAttribute("cv-else-if")){const P=F.getAttribute("cv-else-if");F.removeAttribute("cv-else-if");const W=document.createComment("cv-else-if");F.replaceWith(W),a.push({condition:P,template:F,anchor:W}),f++;continue}if(F.hasAttribute("cv-else")){F.removeAttribute("cv-else");const P=document.createComment("cv-else");F.replaceWith(P),a.push({condition:null,template:F,anchor:P}),f++;break}break}s=f;let m=null,u=!1,h=!1;const g=async()=>{var T,F;if(u){h=!0;return}u=!0;try{do{h=!1,m&&((T=m.parentNode)==null||T.removeChild(m),m=null);for(const P of a)if(P.condition===null||U(P.condition,t)){const W=P.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(W),await oe(N,t,o);const O=N.firstChild??W;(F=P.anchor.parentNode)==null||F.insertBefore(N,P.anchor.nextSibling),m=O;break}}while(h)}finally{u=!1}};a.filter(T=>T.condition).forEach(T=>{Z(T.condition,o,g)}),await g();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=O=>(n.getAttribute(O)??"").split(" ").filter(Boolean),f=r("cv-transition:enter"),m=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),h=r("cv-transition:leave"),g=r("cv-transition:leave-start"),T=r("cv-transition:leave-end"),F=n.getAttribute("cv-transition")??"",P=new Set(F.split(".").slice(1)),W=[...P].find(O=>/^\d+$/.test(O)),N=W?parseInt(W):200;if(f.length||m.length||h.length||g.length){l.forEach(B=>n.removeAttribute(B.name));const O=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B())));let G=!!U(a,t),q=!1,H=null;const K=async B=>{if(q){H=B;return}q=!0;try{B?(n.style.display="",n.classList.add(...f,...m),await O(),n.classList.remove(...m),n.classList.add(...u),await ie(n),n.classList.remove(...f,...u)):(n.classList.add(...h,...g),await O(),n.classList.remove(...g),n.classList.add(...T),await ie(n),n.classList.remove(...h,...T),n.style.display="none"),G=B}finally{if(q=!1,H!==null&&H!==G){const V=H;H=null,K(V)}else H=null}};G||(n.style.display="none"),Z(a,o,()=>{const B=!!U(a,t);B!==G&&K(B)})}else{const O=[...P].find(V=>V==="scale"||/^scale$/.test(V)),G=(()=>{const V=[...P].find(te=>/^\d+$/.test(te)&&te!==W);return V?parseInt(V)/100:.9})(),q=[];(!P.has("scale")||P.has("opacity"))&&q.push(`opacity ${N}ms ease`),O&&q.push(`transform ${N}ms ease`),q.length||q.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+q.join(", "),l.forEach(V=>n.removeAttribute(V.name));let H=!!U(a,t);const K=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V()))),B=async V=>{V?(n.style.display="",n.style.opacity="0",O&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",O&&(n.style.transform=""),await ie(n)):(n.style.opacity="0",O&&(n.style.transform=`scale(${G})`),await ie(n),n.style.display="none",n.style.opacity="",O&&(n.style.transform="")),H=V};H||(n.style.display="none"),Z(a,o,()=>{const V=!!U(a,t);V!==H&&B(V)})}}else{const r=n.getAttribute("cv-show-transition"),f=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),f&&n.removeAttribute(":transition");const m=r??(f?String(U(f,t)):null);if(m){Ue();let u=!!U(a,t);u||(n.style.display="none");let h=!1,g=null;const T=async F=>{if(h){g=F;return}h=!0;try{F?(n.style.display="",n.classList.add(`${m}-enter`),await ie(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ie(n),n.classList.remove(`${m}-leave`),n.style.display="none"),u=F}finally{if(h=!1,g!==null&&g!==u){const P=g;g=null,T(P)}else g=null}};Z(a,o,()=>{const F=!!U(a,t);F!==u&&T(F)})}else{const u=()=>{n.style.display=U(a,t)?"":"none"};Z(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{U(a,t)&&Promise.resolve().then(()=>n.focus())};Z(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(O=>O.name==="cv-intersect"||O.name==="cv-intersect:enter"||O.name.startsWith("cv-intersect.")),r=a.find(O=>O.name==="cv-intersect:leave"),f=(l==null?void 0:l.value)??"",m=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),h=new Set(u.slice(1)),g=h.has("once");let T=0;if(h.has("half"))T=.5;else if(h.has("full"))T=1;else{const O=[...h].find(G=>G.startsWith("threshold-"));O&&(T=parseInt(O.replace("threshold-",""))/100)}const F=[...h].find(O=>O.startsWith("margin-")),P=F?`${F.replace("margin-","")}px`:void 0;a.forEach(O=>n.removeAttribute(O.name));const W=O=>{if(O)try{new Function("$data",`with($data){${O}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${O}":`,G)}},N=new IntersectionObserver(O=>{O.forEach(G=>{G.isIntersecting?(W(f),g&&N.disconnect()):W(m)})},{threshold:T,...P?{rootMargin:P}:{}});N.observe(n),(C=o.registerCleanup)==null||C.call(o,()=>N.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=a.name.split(".").slice(1).includes("sanitize"),f=()=>{const m=String(U(l,t)??"");n.innerHTML=r?kt(m):m};Z(l,o,f),f(),s++;continue}}if(n.hasAttribute("cv-ref")&&!((D=o.components)!=null&&D[v])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const b=!!((_=o.components)!=null&&_[v]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!b){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,f=(I=r.type)==null?void 0:I.toLowerCase(),m=u=>{if(l.has("number")){const h=parseFloat(u);return isNaN(h)?u:h}return l.has("trim")?u.trim():u};if(f==="checkbox"){const u=()=>{const h=U(a,t);r.checked=Array.isArray(h)?h.includes(r.value):!!h};Z(a,o,u),u(),r.addEventListener("change",()=>{const h=U(a,t);if(Array.isArray(h)){const g=[...h];if(r.checked)g.includes(r.value)||g.push(r.value);else{const T=g.indexOf(r.value);T>-1&&g.splice(T,1)}de(a,t,g)}else de(a,t,r.checked)})}else if(f==="radio"){const u=()=>{r.checked=U(a,t)===r.value};Z(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&de(a,t,m(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,h=()=>{const g=String(U(a,t)??"");u.innerText!==g&&(u.innerText=g)};if(Z(a,o,h),h(),l.has("debounce")){const g=[...l].find(P=>/^\d+$/.test(P)),T=g?parseInt(g):300;let F;u.addEventListener("input",()=>{clearTimeout(F),F=setTimeout(()=>de(a,t,m(u.innerText)),T)})}else{const g=l.has("lazy")?"blur":"input";u.addEventListener(g,()=>de(a,t,m(u.innerText)))}}else{const u=()=>{r.value=U(a,t)??""};if(Z(a,o,u),u(),l.has("debounce")){const h=[...l].find(F=>/^\d+$/.test(F)),g=h?parseInt(h):300;let T;r.addEventListener("input",()=>{clearTimeout(T),T=setTimeout(()=>de(a,t,m(r.value)),g)})}else{const h=v==="select"||l.has("lazy")?"change":"input";r.addEventListener(h,()=>de(a,t,m(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var W,N;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],f=l.slice(1),m=r.indexOf(":"),u=m>=0?r.slice(0,m):r,h=m>=0?r.slice(m+1):void 0,g=o.directives[u];if(!g)return;const T=a.value;n.removeAttribute(a.name);const F=typeof g=="function"?{onMount:g}:g,P={value:T?U(T,t):void 0,arg:h,modifiers:Object.fromEntries(f.map(O=>[O,!0]))};(W=F.onMount)==null||W.call(F,n,P),F.onUpdate&&T&&Z(T,o,()=>{P.value=U(T,t),F.onUpdate(n,P)}),F.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>F.onDestroy(n,P)))}),v==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=U(u.value,t))});const f=await l(r),m=document.createDocumentFragment();f.forEach(u=>m.appendChild(u)),n.replaceWith(m)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await oe(r,t,o),n.replaceWith(r)}s++;continue}if(v==="cv-transition"){Ue();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await oe(r,t,o),l){let f=!!U(l,t),m=!1,u=null;f||(r.style.display="none");const h=async g=>{if(m){u=g;return}m=!0;try{g?(r.style.display="",r.classList.add(`${a}-enter`),await ie(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ie(r),r.classList.remove(`${a}-leave`),r.style.display="none"),f=g}finally{if(m=!1,u!==null&&u!==f){const T=u;u=null,h(T)}else u=null}};Z(l,o,()=>{const g=!!U(l,t);g!==f&&h(g)})}s++;continue}if(v==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),s++;continue}if(v==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(U(a,t)??"/"):l||"/",f=O=>String(O).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let m="";Array.from(n.attributes).forEach(O=>{O.name==="to"||O.name===":to"||(m+=` ${O.name}="${f(O.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${m}></a>`;const h=u.firstElementChild;for(;n.firstChild;)h.appendChild(n.firstChild);const g=((j=o.router)==null?void 0:j.base)??"",T=O=>g?O===g?"/":O.startsWith(g+"/")?O.slice(g.length)||"/":O||"/":O||"/",F=()=>{var O;return((O=o.router)==null?void 0:O.mode)==="history"?T(window.location.pathname):window.location.hash.slice(1)||"/"},P=()=>{var q;const O=r(),G=F()===O;((q=o.router)==null?void 0:q.mode)==="history"?h.href=`${g}${O}`:h.href=`#${O}`,G?(h.setAttribute("aria-current","page"),h.classList.add("active")):(h.removeAttribute("aria-current"),h.classList.remove("active"))};((L=o.router)==null?void 0:L.mode)==="history"?(h.addEventListener("click",O=>{O.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",P)):window.addEventListener("hashchange",P),a&&Z(a,o,P),P();const W=document.createDocumentFragment();W.appendChild(h),await oe(W,t,o);const N=W.firstChild??h;n.replaceWith(N),s++;continue}if(v==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),s++;continue}if((E=o.components)!=null&&E[v]&&o.mountElement){await o.mountElement(n,v,t,o),s++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=U(a.value,t);let f,m=0,u="0px",h=l.has("once");if(typeof r=="function"?f=g=>r.call(t,g):r&&typeof r=="object"&&(typeof r.handler=="function"&&(f=g=>r.handler.call(t,g)),r.threshold!==void 0&&(m=r.threshold),r.margin&&(u=r.margin),r.once&&(h=!0)),f){const g=new IntersectionObserver(T=>{const F=T[0];f(F),h&&F.isIntersecting&&g.disconnect()},{threshold:m,rootMargin:u});g.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>g.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=U(a,t);let r,f="content-box";if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.box&&(f=l.box)),r){const m=new ResizeObserver(u=>{u[0]&&r(u[0])});m.observe(n,{box:f}),(d=o.registerCleanup)==null||d.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=U(a,t);let r,f=0;if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.throttle&&(f=l.throttle)),r){let m=0;const u=()=>{const h=Date.now();f>0&&h-m<f||(m=h,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(p=o.registerCleanup)==null||p.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):Ne(a,t,r))};document.addEventListener("click",l,!0),(w=o.registerCleanup)==null||w.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let f=[];const m=()=>{const u=U(a,t)??{},h=Object.keys(u);for(const g of f)g in u||(g==="class"?n.className=l:g==="style"?n.style.cssText=r:n.removeAttribute(g));for(const[g,T]of Object.entries(u))if(g==="class")n.className=[l,Me(T)].filter(Boolean).join(" ");else if(g==="style")He(n,T,r);else if(T==null||T===!1)try{n.removeAttribute(g)}catch{}else try{n.setAttribute(g,T===!0?"":String(T))}catch(F){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${g}":`,F)}f=h};Z(a,o,m),m()}const M={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],f=new Set(l.slice(1)),m=[...f].find(T=>T in M),u=a.value,h=T=>{f.has("prevent")&&T.preventDefault(),f.has("stop")&&T.stopPropagation(),!(f.has("self")&&T.target!==T.currentTarget)&&(m&&T.key!==M[m]||(typeof t[u]=="function"?t[u].call(t,T):Ne(u,t,T)))},g={};f.has("once")&&(g.once=!0),f.has("passive")&&(g.passive=!0),f.has("capture")&&(g.capture=!0),n.addEventListener(r,h,Object.keys(g).length?g:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const f=n.getAttribute("class")??"",m=()=>{n.className=[f,Me(U(r,t))].filter(Boolean).join(" ")};Z(r,o,m),m()}else if(l==="style"){const f=n.getAttribute("style")??"",m=()=>He(n,U(r,t),f);Z(r,o,m),m()}else if(l.includes("-")){const f=()=>{const m=U(r,t);m==null||m===!1?n.removeAttribute(l):n.setAttribute(l,m===!0?"":String(m))};Z(r,o,f),f()}else{const f=()=>{n[l]=U(r,t)??""};Z(r,o,f),f()}}}),k.hasChildNodes()&&await oe(k,t,o),s++}}var St=`
...
`;function At(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=St,document.head.appendChild(e)}async function ge(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(y=>{const S=()=>y();e.addEventListener("animationend",S,{once:!0}),e.addEventListener("transitionend",S,{once:!0}),setTimeout(S,s+50)}),e.classList.remove(`${t}-${o}`)}var xe=new Map;async function Ct(e){if(typeof e!="function")return e;if(xe.has(e))return xe.get(e);const t=await e();return xe.set(e,t.default),t.default}function Be(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ve(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((y,S)=>[y,s[S+1]])):null}function Et(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((y,S)=>[y,s[S+1]])),remaining:s[o.length+1]||"/"}:null}function ut(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:ut(o.children,i==="/"?"":i)}:{...o,path:i}})}var pe=(e,t)=>new Promise(o=>e(t,o)),Ge=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Tt(e,t={}){const o=t.mode??"hash",i=_t(t.base??"");return{routes:ut(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,y){const S=Ye(s,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=S},replace(s,y){const S=Ye(s,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${i}${S}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${S}`)}},back(){history.back()},forward(){history.forward()}}}function _t(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function $t(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Ye(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function Xe(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function Ze(e,t,o,i="default",s){const y=t.base??"",S=p=>p.length>1&&p.endsWith("/")?p.slice(0,-1):p,x=()=>t.mode==="history"?S($t(window.location.pathname,y)):S((window.location.hash.slice(1)||"/").split("?")[0]||"/"),R=()=>{if(t.mode==="history")return Xe(window.location.search);const p=window.location.hash.slice(1)||"/",w=p.indexOf("?");return w>=0?Xe(p.slice(w+1)):{}};t.transition&&At();let $=null,C=null,D=null,_=null,I=!1;const z=()=>{I||(I=!0,s==null||s())},j=new Map,L=p=>{var w;if(p!=null&&p.keepAlive&&D){(w=D.deactivate)==null||w.call(D);const k=document.createDocumentFragment();for(;e.firstChild;)k.appendChild(e.firstChild);j.set($.path,{fragment:k,activation:D}),D=null}else D==null||D.destroy(),D=null,e.innerHTML=""},E=async(p,w,k,n,v)=>{const b=typeof w=="function"&&!xe.has(w),A=b?w.__asyncOptions:void 0,M=p.loadingTemplate??(A==null?void 0:A.loadingTemplate);b&&M&&(e.innerHTML=M);let a;try{a=await Ct(w)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return b&&M&&(e.innerHTML=""),o(e,a,k,n,v)},c=async()=>{var k,n,v,b,A,M,a,l;const p=x(),w=R();for(const r of t.routes){if((k=r.children)!=null&&k.length){const m=Et(r.path,p);if(m!==null)for(const u of r.children){const h=Ve(u.path,p);if(h!==null){const g={params:m.params,query:w,path:p,meta:r.meta};if(u.redirect){const W={params:h,query:w,path:p,meta:u.meta},N=typeof u.redirect=="function"?u.redirect(W):u.redirect;t.navigate(N);return}if(t.beforeEach){const W=await pe(t.beforeEach,g);if(W){t.navigate(W);return}}if(r.beforeEnter){const W=await pe(r.beforeEnter,g);if(W){t.navigate(W);return}}if(u.beforeEnter){const W={params:h,query:w,path:p,meta:u.meta},N=await pe(u.beforeEnter,W);if(N){t.navigate(N);return}}const T=`${r.path}::${JSON.stringify(m.params)}`;if(_!==T){const W=await Ge(D,g);if(W){t.navigate(W);return}const N=r.transition??t.transition;N&&e.hasChildNodes()&&await ge(e,N,"leave"),L(C);const O=Be(r,i);if(O){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(q,H)=>t.navigate(q,H),replace:(q,H)=>t.replace(q,H),back:()=>t.back(),forward:()=>t.forward()};D=await E(r,O,g,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=D.enter)==null||n.call(D,$)}else e.innerHTML="";_=T,N&&await ge(e,N,"enter")}const F={params:{...m.params,...h},query:w,path:p,meta:u.meta??r.meta};(v=t.afterEach)==null||v.call(t,F,$);const P=(b=t.scrollBehavior)==null?void 0:b.call(t,F,$);P&&window.scrollTo(P.x??0,P.y??0),$=F,C=r,z();return}}}const f=Ve(r.path,p);if(f!==null){_=null;const m={params:f,query:w,path:p,meta:r.meta};if(r.redirect){const F=typeof r.redirect=="function"?r.redirect(m):r.redirect;t.navigate(F);return}if(t.beforeEach){const F=await pe(t.beforeEach,m);if(F){t.navigate(F);return}}if(r.beforeEnter){const F=await pe(r.beforeEnter,m);if(F){t.navigate(F);return}}const u=await Ge(D,m);if(u){t.navigate(u);return}const h=r.transition??t.transition;h&&e.hasChildNodes()&&await ge(e,h,"leave"),L(C);const g=Be(r,i);if(g){const F=m.path;if(r.keepAlive&&j.has(F)){const P=j.get(F);e.appendChild(P.fragment),D=P.activation,(A=D.activate)==null||A.call(D),j.delete(F)}else{const P=$;D=await E(r,g,m,i==="default"?r.layout:void 0),(M=D.enter)==null||M.call(D,P)}}else e.innerHTML="",D=null;h&&await ge(e,h,"enter"),(a=t.afterEach)==null||a.call(t,m,$);const T=(l=t.scrollBehavior)==null?void 0:l.call(t,m,$);T&&window.scrollTo(T.x??0,T.y??0),$=m,C=r,z();return}}_=null,L(C),C=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),D==null||D.destroy(),D=null,j.forEach(({activation:p})=>p.destroy()),j.clear()}}function jt(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(y=>{try{y(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Ot=0;function Ft(){return++Ot}var Pt=`
...
`;function Mt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Pt,document.head.appendChild(e)}function ve(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function Je(e){try{return JSON.parse(e)}catch{return e}}function Dt(e){if(typeof document>"u")return;Mt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,i="components",s=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(y);const S=document.createElement("div");S.id="cvd-panel",S.style.display="none",t.appendChild(S),S.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const x=S.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",S.style.display="flex",D()}),S.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,S.style.display="none",y.style.display=""}),S.querySelectorAll(".cvd-tab").forEach(_=>{_.addEventListener("click",()=>{i=_.dataset.tab,S.querySelectorAll(".cvd-tab").forEach(I=>I.classList.remove("active")),_.classList.add("active"),D()})});const R=S.querySelector("#cvd-head");R.addEventListener("pointerdown",_=>{if(_.target.closest("button"))return;R.setPointerCapture(_.pointerId);const I=_.clientX,z=_.clientY,j=t.offsetLeft,L=t.offsetTop,E=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${j+(d.clientX-I)}px`,t.style.top=`${L+(d.clientY-z)}px`},c=d=>{R.releasePointerCapture(d.pointerId),R.removeEventListener("pointermove",E),R.removeEventListener("pointerup",c),R.removeEventListener("pointercancel",c)};R.addEventListener("pointermove",E),R.addEventListener("pointerup",c),R.addEventListener("pointercancel",c)});function $(){const _=e.instances;if(!_.length){x.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}x.innerHTML=_.map(I=>{const z=I.getState(),j=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${j.length?j.map(L=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-inst="${I.id}" data-key="${L}" title="click to edit">${ve(z[L])}</span>
                            </div>
                        `).join(""):'<span style="color:#555">— sin datos reactivos —</span>'}
                    </div>
                </div>
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(I=>{I.addEventListener("click",()=>{const z=I.closest(".cvd-inst"),j=parseInt(z.dataset.id);s.has(j)?s.delete(j):s.add(j),z.classList.toggle("open")})}),x.querySelectorAll(".cvd-val").forEach(I=>{I.addEventListener("click",z=>{z.stopPropagation();const j=I;if(j.querySelector("input"))return;const L=parseInt(j.dataset.inst),E=j.dataset.key,c=e.instances.find(k=>k.id===L);if(!c)return;const d=ve(c.getState()[E]);j.classList.add("editing"),j.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const p=j.querySelector("input");p.focus(),p.select();const w=()=>{c.setState(E,Je(p.value)),j.classList.remove("editing")};p.addEventListener("blur",w),p.addEventListener("keydown",k=>{k.key==="Enter"&&(k.preventDefault(),w()),k.key==="Escape"&&(j.classList.remove("editing"),D())})})})}function C(){if(!e.stores.length){x.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}x.innerHTML=e.stores.map((_,I)=>{const z=_.getState(),j=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${j.map(L=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${I}" data-key="${L}" title="click to edit">${ve(z[L])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(_=>{_.addEventListener("click",()=>_.closest(".cvd-inst").classList.toggle("open"))}),x.querySelectorAll("[data-store][data-key]").forEach(_=>{_.addEventListener("click",I=>{I.stopPropagation();const z=_;if(z.querySelector("input"))return;const j=parseInt(z.dataset.store),L=z.dataset.key,E=e.stores[j];if(!E)return;const c=ve(E.getState()[L]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const p=()=>{E.setState(L,Je(d.value)),z.classList.remove("editing")};d.addEventListener("blur",p),d.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),p()),w.key==="Escape"&&(z.classList.remove("editing"),D())})})})}function D(){o&&(i==="components"?$():C())}e.on("mount",()=>D()),e.on("update",()=>D()),e.on("destroy",()=>D()),e.on("store-update",()=>D())}var It="__COURVUX_HEAD_COLLECTOR__";function Lt(){return globalThis[It]??null}var Rt=(e,t)=>{Object.entries(t).forEach(([o,i])=>{o!=="innerHTML"&&(i==null||i===!1||e.setAttribute(o,i===!0?"":String(i)))})},zt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Ht=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,i])=>e.setAttribute(o,i))},Ke=(e,t,o,i)=>{let s=o?document.head.querySelector(o):null;s?(i.push({el:s,prevAttrs:zt(s),created:!1}),Array.from(s.attributes).forEach(y=>s.removeAttribute(y.name))):(s=document.createElement(e),document.head.appendChild(s),i.push({el:s,created:!0})),Rt(s,t)};function Nt(e){var S,x,R;const t=Lt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let i;const s={},y={};if(e.title!==void 0){i=document.title;const $=e.titleTemplate,C=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=C}return(S=e.meta)==null||S.forEach($=>{Ke("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(x=e.link)==null||x.forEach($=>{Ke("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(R=e.script)==null||R.forEach($=>{const C=document.createElement("script");Object.entries($).forEach(([D,_])=>{D==="innerHTML"?C.textContent=String(_):_!=null&&_!==!1&&C.setAttribute(D,_===!0?"":String(_))}),document.head.appendChild(C),o.push({el:C,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,C])=>{s[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,C)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,C])=>{y[$]=document.body.getAttribute($),document.body.setAttribute($,C)}),function(){i!==void 0&&(document.title=i),o.forEach(({el:$,prevAttrs:C,created:D})=>{var _;D?(_=$.parentNode)==null||_.removeChild($):C&&Ht($,C)}),Object.entries(s).forEach(([$,C])=>{C===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,C)}),Object.entries(y).forEach(([$,C])=>{C===null?document.body.removeAttribute($):document.body.setAttribute($,C)})}}var $e="data-courvux-ssr",Wt=e=>e?Promise.resolve().then(e):Promise.resolve();function Qe(e,t){const o=e.trim();if(o.startsWith("{")){const i=o.replace(/[{}]/g,"").split(",").map(s=>s.trim()).filter(Boolean);return Object.fromEntries(i.map(s=>[s,t[s]]))}return{[o]:t}}var be=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var w,k,n;const i={},{subscribe:s,createReactiveState:y,registerSetInterceptor:S,notifyAll:x}=Pe();let R;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),R=await t.data()):R=t.data??{},t.templateUrl){const v=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,b=await fetch(v);if(!b.ok)throw new Error(`Failed to load template: ${v} (${b.status})`);e.innerHTML=await b.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute($e),(w=e.querySelector(`[${$e}]`))==null||w.removeAttribute($e);const $={};if(t.inject&&o.provided){const v=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(b=>[b,b])):t.inject;Object.entries(v).forEach(([b,A])=>{o.provided&&A in o.provided&&($[b]=o.provided[A])})}const C=y({...o.globalProperties??{},...R,...$,...t.methods,$refs:i,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(v=>[v,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});C.$watch=(v,b,A)=>{const M=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=M?be(C[v]):C[v];const r=s(v,()=>{const f=C[v];b.call(C,f,l),l=M?be(f):f});return a&&b.call(C,C[v],void 0),r},C.$batch=yt,C.$nextTick=v=>Wt(v),C.$dispatch=(v,b,A)=>{e.dispatchEvent(new CustomEvent(v,{bubbles:!0,composed:!0,...A??{},detail:b}))},o.magics&&Object.entries(o.magics).forEach(([v,b])=>{C[v]=b(C)}),C.$forceUpdate=()=>x();const D=[];C.$watchEffect=v=>{let b=[];const A=()=>{b.forEach(r=>r()),b=[];const a=Ie(()=>{try{v()}catch{}}),l=new Map;for(const{sub:r,key:f}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(f)&&(l.get(r).add(f),b.push(r(f,A)))};A();const M=()=>{b.forEach(l=>l()),b=[];const a=D.indexOf(M);a>-1&&D.splice(a,1)};return D.push(M),M};const _=[];t.computed&&Object.entries(t.computed).forEach(([v,b])=>{const A=typeof b=="function"?b:b.get,M=typeof b!="function"?b.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const f=Ie(()=>{try{r=A.call(C)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});C[v]=r;const m=new Map;for(const{sub:u,key:h}of f)m.has(u)||m.set(u,new Set),!m.get(u).has(h)&&(m.get(u).add(h),a.push(u(h,l)))};l(),_.push(()=>a.forEach(r=>r())),M&&S(v,r=>M.call(C,r))});const I=[];t.watch&&Object.entries(t.watch).forEach(([v,b])=>{const A=typeof b=="object"&&b!==null&&"handler"in b,M=A?b.handler:b,a=A?b.immediate??!1:!1,l=A?b.deep??!1:!1;let r=l?be(C[v]):C[v];const f=s(v,()=>{const m=C[v];M.call(C,m,r),r=l?be(m):m});I.push(f),a&&M.call(C,C[v],void 0)});const z={...o.provided??{}};if(t.provide){const v=typeof t.provide=="function"?t.provide.call(C):t.provide;Object.assign(z,v)}const j={...o,provided:z,components:{...o.components,...t.components}};j.mountElement=ke(j),j.createChildScope=(v,b)=>{const A=new Set(Object.keys(v)),M=new Set(Object.keys(b)),{subscribe:a,createReactiveState:l}=Pe(),r=l(v);let f;return f=new Proxy({},{get(m,u){return typeof u!="string"?C[u]:A.has(u)?r[u]:M.has(u)?b[u].bind(f):C[u]},set(m,u,h){return typeof u!="string"?!1:A.has(u)?(r[u]=h,!0):(C[u]=h,!0)},has(m,u){return A.has(u)||M.has(u)||u in C},ownKeys(){return[...A,...M,...Object.keys(C)]},getOwnPropertyDescriptor(m,u){return A.has(u)||M.has(u)||u in C?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:f,subscribe:(m,u)=>A.has(m)?a(m,u):c(m,u),cleanup:()=>{}}},j.mountDynamic=async(v,b,A,M,a)=>{let l=null,r=null;const f=A.getAttribute("loading-template")??"",m=async()=>{var O,G,q;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=U(b,M);if(!u)return;let h;if(typeof u=="function"){if(f){const H=document.createElement("div");H.innerHTML=f,(O=v.parentNode)==null||O.insertBefore(H,v.nextSibling),l=H}h=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?h=(G=j.components)==null?void 0:G[u]:u&&typeof u=="object"&&(h=u);if(!h)return;const g=document.createElement("div"),T=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{T(H.name)||g.setAttribute(H.name,H.value)}),g.innerHTML=A.innerHTML;const F={},P={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))F[H.name.slice(1)]=U(H.value,M);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,B=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);P[B]=(...V)=>{typeof M[K]=="function"&&M[K].call(M,...V)}}});const W={...h,data:{...h.data,...F},methods:{...h.methods,$emit(H,...K){var B;pt(h,H,K),(B=P[H])==null||B.call(P,...K)}}},N={...j,components:{...j.components,...h.components}};N.mountElement=ke(N),r=(await ne(g,W,N)).destroy,(q=v.parentNode)==null||q.insertBefore(g,v.nextSibling),l=g};Z(b,a,m),await m()};const L=[];C.$addCleanup=v=>{L.push(v)};let E=!1;const c=(v,b)=>!t.onBeforeUpdate&&!t.onUpdated?s(v,b):s(v,()=>{var A;E||(E=!0,(A=t.onBeforeUpdate)==null||A.call(C),Promise.resolve().then(()=>{var M;E=!1,(M=t.onUpdated)==null||M.call(C)})),b()});try{(k=t.onBeforeMount)==null||k.call(C),await oe(e,C,{subscribe:c,refs:i,...j,registerCleanup:v=>L.push(v)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(C)}catch(v){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(C,v);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(v,C,t.name??e.tagName.toLowerCase());else throw v}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,p=d?Ft():0;if(d){const v=C,b=new Set,A={id:p,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const M={};for(const a of Object.keys(v))if(!(a.startsWith("$")||typeof v[a]=="function"))try{M[a]=v[a]}catch{}return M},setState:(M,a)=>{v[M]=a},subscribe:M=>(b.add(M),()=>b.delete(M)),children:[]};Object.keys(v).filter(M=>!M.startsWith("$")&&typeof v[M]!="function").forEach(M=>{s(M,()=>{d._emit("update",A),b.forEach(a=>a())})}),d._registerInstance(A),L.push(()=>d._unregisterInstance(p))}return{state:C,destroy:()=>{var v,b;(v=t.onBeforeUnmount)==null||v.call(C),_.forEach(A=>A()),I.forEach(A=>A()),D.forEach(A=>A()),L.forEach(A=>A()),(b=t.onDestroy)==null||b.call(C)},activate:()=>{var v;(v=t.onActivated)==null||v.call(C)},deactivate:()=>{var v;(v=t.onDeactivated)==null||v.call(C)},beforeLeave:t.onBeforeRouteLeave?(v,b)=>t.onBeforeRouteLeave.call(C,v,b):void 0,enter:t.onBeforeRouteEnter?v=>t.onBeforeRouteEnter.call(C,v):void 0}}function pt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const i=e.emits[t];typeof i=="function"&&!i(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function ke(e){return async(t,o,i,s)=>{const y=e.components[o],S=t.getAttribute("cv-ref");S&&t.removeAttribute("cv-ref");const x={},R=[],$={};Array.from(t.attributes).filter(E=>E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:")).forEach(E=>{t.removeAttribute(E.name);const c=E.value,d=E.name.indexOf(":"),p=d>=0?E.name.slice(d+1).split(".")[0]:"modelValue",w=p==="modelValue"?"update:modelValue":`update:${p}`;x[p]=Te(U(c,i)),R.push({propName:p,expr:c}),$[w]=k=>{de(c,i,k)}});const C={};Array.from(t.attributes).forEach(E=>{const c=E.name.startsWith(":"),d=E.name.startsWith("@")||E.name.startsWith("cv:on:"),p=E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:"),w=E.name.startsWith("v-slot"),k=E.name==="slot";!c&&!d&&!p&&!w&&!k&&(C[E.name]=E.value)}),y.inheritAttrs===!1&&Object.keys(C).forEach(E=>t.removeAttribute(E)),Array.from(t.attributes).forEach(E=>{if(E.name.startsWith(":")){const c=E.name.slice(1),d=E.value;x[c]=Te(U(d,i)),R.push({propName:c,expr:d})}else if(E.name.startsWith("@")||E.name.startsWith("cv:on:")){const c=E.name.startsWith("@")?E.name.slice(1):E.name.slice(6),d=E.value;$[c]=(...p)=>{typeof i[d]=="function"&&i[d].call(i,...p)}}});const D=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");D&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const _=new Map,I=[];Array.from(t.childNodes).forEach(E=>{const c=E.nodeType===1?E.getAttribute("slot"):null;if(c){if(!_.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),_.set(c,{nodes:[],vSlot:d})}_.get(c).nodes.push(E.cloneNode(!0))}else I.push(E.cloneNode(!0))});const z={};I.some(E=>{var c;return E.nodeType===1||E.nodeType===3&&(((c=E.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async E=>{const c=D?{...i,...Qe(D,E)}:i,d=document.createDocumentFragment();return I.forEach(p=>d.appendChild(p.cloneNode(!0))),await oe(d,c,s),Array.from(d.childNodes)});for(const[E,{nodes:c,vSlot:d}]of _)z[E]=async p=>{const w=d?{...i,...Qe(d,p)}:i,k=document.createDocumentFragment();return c.forEach(n=>k.appendChild(n.cloneNode(!0))),await oe(k,w,s),Array.from(k.childNodes)};const j={...e,components:{...e.components,...y.components},slots:z};j.mountElement=ke(j);const{state:L}=await ne(t,{...y,data:{...y.data,...x,$attrs:C,$parent:i},methods:{...y.methods,$emit(E,...c){var d;pt(y,E,c),(d=$[E])==null||d.call($,...c)}}},j);L&&(R.forEach(({propName:E,expr:c})=>{lt(c,{...s,subscribe:s.subscribe},()=>{L[E]=Te(U(c,i))})}),S&&s.refs&&(s.refs[S]=L))}}function Ut(e){wt();const t=typeof window<"u"?jt():void 0,o=[],i={...e.directives},s={...e.components??{}},y=[],S=new Map,x={},R=new Map;if(e.debug&&t&&Dt(t),t&&e.store){const _=e.store,I=Object.keys(_).filter(z=>typeof _[z]!="function");t._registerStore({getState(){const z={};return I.forEach(j=>{try{z[j]=_[j]}catch{}}),z},setState(z,j){_[z]=j},subscribe(z){const j=I.map(L=>{try{return fe(_,L,z)}catch{return()=>{}}});return()=>j.forEach(L=>L())}})}const $={router:e.router,use(_){return o.includes(_)||(o.push(_),_.install($)),$},directive(_,I){return i[_]=I,$},component(_,I){return s[_]=I,$},provide(_,I){return typeof _=="string"?x[_]=I:Object.assign(x,_),$},magic(_,I){return R.set(`$${_}`,I),$},mount:async _=>(await D(_),$),mountAll:async(_="[data-courvux]")=>{const I=Array.from(document.querySelectorAll(_));return await Promise.all(I.map(z=>C(z))),$},mountEl:async _=>C(_),unmount(_){if(!_)y.forEach(I=>I()),y.length=0,S.clear();else{const I=document.querySelector(_);if(I){const z=S.get(I);if(z){z(),S.delete(I);const j=y.indexOf(z);j>-1&&y.splice(j,1)}}}return $},destroy(){y.forEach(_=>_()),y.length=0,S.clear()}},C=async _=>{const I=new URL(".",document.baseURI).href,z={components:s,router:e.router,store:e.store,directives:i,baseUrl:I,provided:{...x},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:R.size?Object.fromEntries(R):void 0};if(z.mountElement=ke(z),e.router){const L=e.router;z.mountRouterView=async(E,c)=>{await new Promise(d=>{Ze(E,L,async(p,w,k,n,v)=>{const b={...z,currentRoute:k};if(v){let A=null;const M={...b,mountRouterView:async(a,l)=>{A=Ze(a,v,async(r,f,m,u)=>{const h={...b,currentRoute:m};if(u){let g=null;const T={...h,mountRouterView:async(P,W)=>{g=await ne(P,f,h)}},{destroy:F}=await ne(r,{template:u},T);return{destroy:()=>{g==null||g.destroy(),F()},activate:()=>g==null?void 0:g.activate(),deactivate:()=>g==null?void 0:g.deactivate()}}else return await ne(r,f,h)},l)}};if(n){let a=null;const l={...M,mountRouterView:async(f,m)=>{a=await ne(f,w,M)}},{destroy:r}=await ne(p,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(p,w,M);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const M={...b,mountRouterView:async(l,r)=>{A=await ne(l,w,b)}},{destroy:a}=await ne(p,{template:n},M);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(p,w,b)},c,d)})}}const j=await ne(_,e,z);return y.push(j.destroy),S.set(_,j.destroy),j.state},D=async _=>{const I=document.querySelector(_);if(I)return C(I)};return $}var et=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function qt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var je={exports:{}},tt;function Bt(){return tt||(tt=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
`)}const Jt={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Xt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=Zt(this.code),e.textContent=this._cleanCode,Gt.highlightElement(e))}},me="Courvux",Kt="https://vanjexdev.github.io/courvux";function J({title:e,description:t,slug:o="/"}){const i=e?`${e} — ${me}`:`${me} — Lightweight reactive UI framework`,s=Kt+o;return Nt({title:e??`${me} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${me}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:i},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:s},{property:"og:site_name",content:me},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:i},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:s}]})}const Qt={data:{install:`# From GitHub — pin a tag for stable installs
pnpm add github:vanjexdev/courvux#v0.5.0
...
pnpm add github:vanjexdev/courvux#v0.5.0`,s2:`<script type="importmap">
{
  "imports": {
...
{
  "imports": {
    "courvux": "https://cdn.jsdelivr.net/gh/vanjexdev/courvux@v0.5.0/dist/index.js"
  }
}
<\/script>
...
export const useCounter = defineComposable((initial = 0) => useComposables(
    ...
    `,onMount(){J({title:"Composables",description:"Author and reuse logic in Courvux with defineComposable + useComposables, plus the built-in cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener helpers.",slug:"/composables"})}},so={data:{s_basic:`import { createEventBus } from 'courvux';
...
<button cv-if="pwa.installable && !pwa.installed" @click="pwa.prompt()">
    ...
    `,onMount(){J({title:"Progressive Web App",description:"Make any Courvux app installable and offline-capable: manifest, vite-plugin-pwa, install prompt utility.",slug:"/pwa"})}},go={data:{s_dir:`// Full definition
app.directive('focus', {
...
autoInit({
    ...
    `,onMount(){J({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},vo={template:`
        <div class="prose">
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function So(){try{return JSON.parse(localStorage.getItem(mt))||[]}catch{return[]}}function Ao(e){localStorage.setItem(mt,JSON.stringify(e))}const Co={data:{todos:So(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:wo,srcHtml:ko,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(e=>!e.done):this.filter==="completed"?this.todos.filter(e=>e.done):this.todos},remaining(){return this.todos.filter(e=>!e.done).length},allDone(){return this.todos.length>0&&this.todos.every(e=>e.done)}},watch:{todos:{deep:!0,handler(e){Ao(e)}}},methods:{add(){const e=this.newTodo.trim();e&&(this.todos=[...this.todos,{id:this._nextId++,text:e,done:!1}],this.newTodo="")},toggle(e){this.todos=this.todos.map(t=>t.id===e?{...t,done:!t.done}:t)},remove(e){this.todos=this.todos.filter(t=>t.id!==e)},clearCompleted(){this.todos=this.todos.filter(e=>!e.done)},toggleAll(){const e=this.allDone;this.todos=this.todos.map(t=>({...t,done:!e}))},startEdit(e){this.editingId=e.id,this.editText=e.text,this.$nextTick(()=>{var t;return(t=this.$refs["edit_"+e.id])==null?void 0:t.focus()})},commitEdit(e){const t=this.editText.trim();t?this.todos=this.todos.map(o=>o.id===e?{...o,text:t}:o):this.remove(e),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(e){this.filter=e}},template:`
    ...
    `,onMount(){J({title:"Demo — TODO App",description:"Interactive TODO app built with Courvux. Live demo with full source code (JS + HTML).",slug:"/demo"})}},Eo=[{path:"/",component:Qt},{path:"/installation",component:eo},{path:"/quick-start",component:to},{path:"/template",component:oo},{path:"/components",component:no},{path:"/reactivity",component:ro},{path:"/lifecycle",component:ao},{path:"/composables",component:io},{path:"/event-bus",component:so},{path:"/router",component:co},{path:"/store",component:lo},{path:"/head",component:uo},{path:"/ssg",component:po},{path:"/devtools",component:mo},{path:"/testing",component:ho},{path:"/pwa",component:fo},{path:"/advanced",component:go},{path:"/design-decisions",component:vo},{path:"/faq",component:bo},{path:"/migrating-from-vue",component:yo},{path:"/migrating-from-alpine",component:xo},{path:"/demo",component:Co}],To={methods:{goBack(){window.history.back()}},template:`
        ...
        <div style="display:flex; min-height:100vh; position:relative;">
            ...
            ">
                ...
                <div style="padding: 20px 16px 12px; border-bottom: 1px solid #f0f0f0;">
                    <router-link to="/" @click="closeSidebar()" style="text-decoration:none; display:flex; align-items:center; gap:8px;" aria-label="Courvux v0.5.0 home">
                        <span style="font-size:1.3rem;" aria-hidden="true">⚡</span>
                        <span style="font-weight:700; font-size:15px; color:#111;">Courvux</span>
                        <span style="font-size:10px; color:#666; margin-left:2px;">v0.5.0</span>
                    </router-link>
                </div>
