(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))c(l);new MutationObserver(l=>{for(const y of l)if(y.type==="childList")for(const E of y.addedNodes)E.tagName==="LINK"&&E.rel==="modulepreload"&&c(E)}).observe(document,{childList:!0,subtree:!0});function o(l){const y={};return l.integrity&&(y.integrity=l.integrity),l.referrerPolicy&&(y.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?y.credentials="include":l.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function c(l){if(l.ep)return;l.ep=!0;const y=o(l);fetch(l.href,y)}})();var gt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),at=t=>t instanceof Date||t instanceof RegExp||t instanceof Map||t instanceof Set||t instanceof WeakMap||t instanceof WeakSet||ArrayBuffer.isView(t)||t instanceof ArrayBuffer,je=new WeakSet,xe=Symbol("raw"),$e=t=>t===null||typeof t!="object"?t:t[xe]??t,ke=0,Le=new Map,fe=null;function Me(t){const e=[],o=fe;fe=e;try{t()}finally{fe=o}return e}function bt(t){ke++;try{t()}finally{if(ke--,ke===0){const e=[...Le.values()];Le.clear(),e.forEach(o=>o())}}}function it(t,e){return t===null||typeof t!="object"||je.has(t)||at(t)?t:new Proxy(t,{get(o,c){if(c===xe)return o[xe]??o;if(typeof c=="string"&&Array.isArray(o)&&gt.has(c))return(...y)=>{const E=Array.prototype[c].apply(o,y);return e(),E};const l=o[c];return l!==null&&typeof l=="object"&&!je.has(l)?it(l,e):l},set(o,c,l){return o[c]=l,e(),!0}})}function Pe(){const t={},e=Math.random().toString(36).slice(2),o=(y,E)=>(t[y]||(t[y]=new Set),t[y].add(E),()=>{var x;(x=t[y])==null||x.delete(E)}),c=y=>{ke>0?Le.set(`${e}:${y}`,()=>{(t[y]?[...t[y]]:[]).forEach(E=>E())}):(t[y]?[...t[y]]:[]).forEach(E=>E())},l={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(E,x){if(x===xe)return y;typeof x=="string"&&!x.startsWith("$")&&fe&&fe.push({sub:o,key:x});const D=E[x];return typeof x=="string"&&!x.startsWith("$")&&D!==null&&typeof D=="object"&&!je.has(D)&&!at(D)?it(D,()=>c(x)):D},set(E,x,D){if(l[x])return l[x](D),!0;const $=E[x];return E[x]=D,($!==D||D!==null&&typeof D=="object")&&c(x),!0}}),registerSetInterceptor:(y,E)=>{l[y]=E},notifyAll:()=>{Object.keys(t).forEach(y=>c(y))}}}var Ce=new WeakMap;function ve(t,e,o){var l,y;const c=e.indexOf(".");if(c>=0){const E=e.slice(0,c),x=e.slice(c+1),D=t[E];return D&&Ce.has(D)?ve(D,x,o):((l=Ce.get(t))==null?void 0:l(E,o))??(()=>{})}return((y=Ce.get(t))==null?void 0:y(e,o))??(()=>{})}var st=(t,e)=>t.split(".").reduce((o,c)=>o==null?void 0:o[c],e),ct=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),Ie=new Map,Re=new Map,lt=(t,e)=>{const o=t.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!lt(o.slice(1).trim(),e):st(o,e)},N=(t,e)=>{if(!ct)return lt(t,e);try{let o=Ie.get(t);return o||(o=new Function("$data",`with($data) { return (${t}) }`),Ie.set(t,o)),o(e)}catch{return st(t,e)}},ue=(t,e,o)=>t.startsWith("$store.")&&e.store?e.storeSubscribeOverride?e.storeSubscribeOverride(e.store,t.slice(7),o):ve(e.store,t.slice(7),o):e.subscribe(t,o),K=(t,e,o)=>{const c=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),l=t.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(l.filter(x=>!c.has(x.split(".")[0])))];if(y.length===0)return()=>{};const E=y.map(x=>ue(x,e,o));return()=>E.forEach(x=>x())},le=(t,e,o)=>{const c=t.split(".");if(c.length===1)e[c[0]]=o;else{const l=c.slice(0,-1).reduce((y,E)=>y==null?void 0:y[E],e);l&&(l[c[c.length-1]]=o)}},ze=(t,e,o,c,l)=>{const y={};return Object.keys(t).forEach(E=>y[E]=t[E]),y[o]=e,l&&(y[l]=c),y},De=t=>t?typeof t=="string"?t:Array.isArray(t)?t.map(De).filter(Boolean).join(" "):typeof t=="object"?Object.entries(t).filter(([,e])=>!!e).map(([e])=>e).join(" "):"":"",He=(t,e,o)=>{if(!e){t.style.cssText=o;return}typeof e=="string"?t.style.cssText=o?`${o};${e}`:e:typeof e=="object"&&(o&&(t.style.cssText=o),Object.entries(e).forEach(([c,l])=>{t.style[c]=l??""}))},Ne=(t,e,o)=>{if(ct)try{let c=Re.get(t);c||(c=new Function("__p__",`with(__p__){${t}}`),Re.set(t,c));const l=new Proxy({},{has:()=>!0,get:(y,E)=>E==="$event"?o:E in e?e[E]:globalThis[E],set:(y,E,x)=>(e[E]=x,!0)});c(l)}catch(c){console.warn(`[courvux] handler error "${t}":`,c)}},ie=t=>{const e=getComputedStyle(t),o=Math.max(parseFloat(e.animationDuration)||0,parseFloat(e.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(c=>{const l=()=>c();t.addEventListener("animationend",l,{once:!0}),t.addEventListener("transitionend",l,{once:!0}),setTimeout(l,o+50)})},yt=`
...
`,Ue=!1;function We(){if(Ue||typeof document>"u")return;Ue=!0;const t=document.createElement("style");t.id="cv-transitions-el",t.textContent=yt,document.head.appendChild(t)}var Be=!1;function kt(){if(Be||typeof document>"u")return;Be=!0;const t=document.createElement("style");t.id="cv-cloak-style",t.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(t)}function wt(t){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(t,{sanitizer:new window.Sanitizer}),o.innerHTML}const e=new DOMParser().parseFromString(t,"text/html");return e.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),e.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(c=>{(c.name.startsWith("on")||c.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(c.name)})}),e.body.innerHTML}async function oe(t,e,o){var y,E,x,D,$,w,V,L,H,R,C,P,_,d,a,v,S;const c=Array.from(t.childNodes);let l=0;for(;l<c.length;){const A=c[l];if(A.nodeType===3){const i=A.textContent||"",r=i.match(/\{\{([\s\S]+?)\}\}/g);if(r){const s=i,u=()=>{let m=s;r.forEach(p=>{const b=p.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(p,N(b,e)??"")}),A.textContent=m};r.forEach(m=>{K(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,u)}),u()}l++;continue}if(A.nodeType!==1){l++;continue}const n=A,h=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),l++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await oe(n,e,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),l++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const i=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const r=document.querySelector(i)??document.body,s=document.createComment(`cv-teleport: ${i}`);n.replaceWith(s),await oe(n,e,o),r.appendChild(n),l++;continue}if(n.hasAttribute("cv-memo")){const i=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const r=()=>i.split(",").map(b=>N(b.trim(),e));let s=r();const u=[],m=b=>(u.push(b),()=>{const g=u.indexOf(b);g>-1&&u.splice(g,1)});await oe(n,e,{...o,subscribe:(b,g)=>m(g),storeSubscribeOverride:(b,g,k)=>m(k)});const p=K(i,o,()=>{const b=r();b.some((g,k)=>g!==s[k])&&(s=b,[...u].forEach(g=>g()))});(y=o.registerCleanup)==null||y.call(o,()=>p()),l++;continue}if(n.hasAttribute("cv-data")){const i=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let r={},s={};if(i.startsWith("{")){const u=N(i,e)??{};Object.entries(u).forEach(([m,p])=>{typeof p=="function"?s[m]=p:r[m]=p})}else if(i){const u=(E=o.components)==null?void 0:E[i];if(u){const m=typeof u.data=="function"?u.data():u.data??{};m instanceof Promise||Object.assign(r,m),Object.assign(s,u.methods??{})}}if(o.createChildScope){const u=o.createChildScope(r,s);(x=o.registerCleanup)==null||x.call(o,u.cleanup),await oe(n,u.state,{...o,subscribe:u.subscribe})}else await oe(n,{...e,...r,...s},o);l++;continue}if(n.hasAttribute("cv-for")){const i=n.getAttribute("cv-for");n.removeAttribute("cv-for");const r=i.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(r){const[,s,u,m]=r,p=n.getAttribute(":key")??null;p&&n.removeAttribute(":key");const b=n.getAttribute("cv-transition")??null;b&&n.removeAttribute("cv-transition");const g=document.createComment(`cv-for: ${m}`);n.replaceWith(g);let k=[],j=[];const F=new Map,U=async()=>{var G;const z=N(m,e),M=z?typeof z=="number"?Array.from({length:z},(I,B)=>[B+1,B]):Array.isArray(z)?z.map((I,B)=>[I,B]):Object.entries(z).map(([I,B])=>[B,I]):[];if(p){const I=[],B=new Map,Q=new Set;for(const[X,Y]of M){const re=N(p,ze(e,X,s,Y,u));Q.has(re)&&console.warn(`[courvux] cv-for: duplicate :key "${re}" in "${m}"`),Q.add(re),I.push(re),B.set(re,[X,Y])}const q=[];for(const[X,{el:Y,destroy:re}]of F)B.has(X)||(b?(Y.classList.add(`${b}-leave`),q.push(ie(Y).then(()=>{var ae;Y.classList.remove(`${b}-leave`),re(),(ae=Y.parentNode)==null||ae.removeChild(Y),F.delete(X)}))):(re(),(G=Y.parentNode)==null||G.removeChild(Y),F.delete(X)));q.length&&await Promise.all(q);const W=g.parentNode,te=[];for(const X of I){const[Y,re]=B.get(X);if(F.has(X)){const ae=F.get(X);ae.itemRef!==Y&&(ae.reactive[s]=Y,ae.itemRef=Y),u&&(ae.reactive[u]=re)}else{const ae=n.cloneNode(!0),Se=[],{subscribe:mt,createReactiveState:ht}=Pe(),Ee=ht({[s]:Y,...u?{[u]:re}:{}}),ft=new Proxy({},{has(se,ee){return!0},get(se,ee){return typeof ee!="string"?e[ee]:ee===s||u&&ee===u?Ee[ee]:e[ee]},set(se,ee,ce){return ee===s||u&&ee===u?(Ee[ee]=ce,!0):(e[ee]=ce,!0)}}),vt={...o,subscribe:(se,ee)=>{const ce=se.split(".")[0];let de;return ce===s||u&&ce===u?de=mt(ce,ee):de=o.subscribe(se,ee),Se.push(de),de},storeSubscribeOverride:(se,ee,ce)=>{const de=ve(se,ee,ce);return Se.push(de),de}},_e=document.createDocumentFragment();_e.appendChild(ae),await oe(_e,ft,vt);const Te=_e.firstChild??ae;b&&Te.classList.add(`${b}-enter`),F.set(X,{el:Te,reactive:Ee,itemRef:Y,destroy:()=>Se.forEach(se=>se())}),b&&te.push(Te)}}let J=g.nextSibling,pe=0;for(const X of I){const{el:Y}=F.get(X);Y!==J?pe++:J=Y.nextSibling}if(pe>0)if(pe>I.length>>1){const X=document.createDocumentFragment();for(const Y of I)X.appendChild(F.get(Y).el);W.insertBefore(X,g.nextSibling)}else{J=g.nextSibling;for(const X of I){const{el:Y}=F.get(X);Y!==J?W.insertBefore(Y,J):J=Y.nextSibling}}k=I.map(X=>F.get(X).el),te.length&&Promise.all(te.map(X=>ie(X).then(()=>X.classList.remove(`${b}-enter`))))}else{if(j.forEach(q=>q()),j=[],k.forEach(q=>{var W;return(W=q.parentNode)==null?void 0:W.removeChild(q)}),k=[],!M.length)return;const I=g.parentNode,B=g.nextSibling,Q={...o,subscribe:(q,W)=>{const te=o.subscribe(q,W);return j.push(te),te},storeSubscribeOverride:(q,W,te)=>{const J=ve(q,W,te);return j.push(J),J}};for(const[q,W]of M){const te=n.cloneNode(!0),J=document.createDocumentFragment();J.appendChild(te),await oe(J,ze(e,q,s,W,u),Q);const pe=J.firstChild??te;I.insertBefore(J,B),k.push(pe)}}};(D=o.registerCleanup)==null||D.call(o,()=>{F.forEach(({el:z,destroy:M})=>{var G;M(),(G=z.parentNode)==null||G.removeChild(z)}),F.clear(),j.forEach(z=>z()),k.forEach(z=>{var M;return(M=z.parentNode)==null?void 0:M.removeChild(z)}),k=[]}),K(m,o,U),await U()}l++;continue}if(n.hasAttribute("cv-if")){const i=[],r=n.getAttribute("cv-if");n.removeAttribute("cv-if");const s=document.createComment("cv-if");n.replaceWith(s),i.push({condition:r,template:n,anchor:s});let u=l+1;for(;u<c.length;){const k=c[u];if(k.nodeType===3&&((($=k.textContent)==null?void 0:$.trim())??"")===""){u++;continue}if(k.nodeType!==1)break;const j=k;if(j.hasAttribute("cv-else-if")){const F=j.getAttribute("cv-else-if");j.removeAttribute("cv-else-if");const U=document.createComment("cv-else-if");j.replaceWith(U),i.push({condition:F,template:j,anchor:U}),u++;continue}if(j.hasAttribute("cv-else")){j.removeAttribute("cv-else");const F=document.createComment("cv-else");j.replaceWith(F),i.push({condition:null,template:j,anchor:F}),u++;break}break}l=u;let m=null,p=!1,b=!1;const g=async()=>{var k,j;if(p){b=!0;return}p=!0;try{do{b=!1,m&&((k=m.parentNode)==null||k.removeChild(m),m=null);for(const F of i)if(F.condition===null||N(F.condition,e)){const U=F.template.cloneNode(!0),z=document.createDocumentFragment();z.appendChild(U),await oe(z,e,o);const M=z.firstChild??U;(j=F.anchor.parentNode)==null||j.insertBefore(z,F.anchor.nextSibling),m=M;break}}while(b)}finally{p=!1}};i.filter(k=>k.condition).forEach(k=>{K(k.condition,o,g)}),await g();continue}if(n.hasAttribute("cv-show")){const i=n.getAttribute("cv-show");n.removeAttribute("cv-show");const r=Array.from(n.attributes).filter(s=>s.name==="cv-transition"||s.name.startsWith("cv-transition:")||s.name.startsWith("cv-transition."));if(r.length>0){const s=M=>(n.getAttribute(M)??"").split(" ").filter(Boolean),u=s("cv-transition:enter"),m=s("cv-transition:enter-start"),p=s("cv-transition:enter-end"),b=s("cv-transition:leave"),g=s("cv-transition:leave-start"),k=s("cv-transition:leave-end"),j=n.getAttribute("cv-transition")??"",F=new Set(j.split(".").slice(1)),U=[...F].find(M=>/^\d+$/.test(M)),z=U?parseInt(U):200;if(u.length||m.length||b.length||g.length){r.forEach(q=>n.removeAttribute(q.name));const M=()=>new Promise(q=>requestAnimationFrame(()=>requestAnimationFrame(()=>q())));let G=!!N(i,e),I=!1,B=null;const Q=async q=>{if(I){B=q;return}I=!0;try{q?(n.style.display="",n.classList.add(...u,...m),await M(),n.classList.remove(...m),n.classList.add(...p),await ie(n),n.classList.remove(...u,...p)):(n.classList.add(...b,...g),await M(),n.classList.remove(...g),n.classList.add(...k),await ie(n),n.classList.remove(...b,...k),n.style.display="none"),G=q}finally{if(I=!1,B!==null&&B!==G){const W=B;B=null,Q(W)}else B=null}};G||(n.style.display="none"),K(i,o,()=>{const q=!!N(i,e);q!==G&&Q(q)})}else{const M=[...F].find(W=>W==="scale"||/^scale$/.test(W)),G=(()=>{const W=[...F].find(te=>/^\d+$/.test(te)&&te!==U);return W?parseInt(W)/100:.9})(),I=[];(!F.has("scale")||F.has("opacity"))&&I.push(`opacity ${z}ms ease`),M&&I.push(`transform ${z}ms ease`),I.length||I.push(`opacity ${z}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+I.join(", "),r.forEach(W=>n.removeAttribute(W.name));let B=!!N(i,e);const Q=()=>new Promise(W=>requestAnimationFrame(()=>requestAnimationFrame(()=>W()))),q=async W=>{W?(n.style.display="",n.style.opacity="0",M&&(n.style.transform=`scale(${G})`),await Q(),n.style.opacity="",M&&(n.style.transform=""),await ie(n)):(n.style.opacity="0",M&&(n.style.transform=`scale(${G})`),await ie(n),n.style.display="none",n.style.opacity="",M&&(n.style.transform="")),B=W};B||(n.style.display="none"),K(i,o,()=>{const W=!!N(i,e);W!==B&&q(W)})}}else{const s=n.getAttribute("cv-show-transition"),u=n.getAttribute(":transition");s&&n.removeAttribute("cv-show-transition"),u&&n.removeAttribute(":transition");const m=s??(u?String(N(u,e)):null);if(m){We();let p=!!N(i,e);p||(n.style.display="none");let b=!1,g=null;const k=async j=>{if(b){g=j;return}b=!0;try{j?(n.style.display="",n.classList.add(`${m}-enter`),await ie(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ie(n),n.classList.remove(`${m}-leave`),n.style.display="none"),p=j}finally{if(b=!1,g!==null&&g!==p){const F=g;g=null,k(F)}else g=null}};K(i,o,()=>{const j=!!N(i,e);j!==p&&k(j)})}else{const p=()=>{n.style.display=N(i,e)?"":"none"};K(i,o,p),p()}}}if(n.hasAttribute("cv-focus")){const i=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!i)Promise.resolve().then(()=>n.focus());else{const r=()=>{N(i,e)&&Promise.resolve().then(()=>n.focus())};K(i,o,r),r()}}{const i=Array.from(n.attributes).filter(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect:")||r.name.startsWith("cv-intersect."));if(i.length&&typeof IntersectionObserver<"u"){const r=i.find(M=>M.name==="cv-intersect"||M.name==="cv-intersect:enter"||M.name.startsWith("cv-intersect.")),s=i.find(M=>M.name==="cv-intersect:leave"),u=(r==null?void 0:r.value)??"",m=(s==null?void 0:s.value)??"",p=((r==null?void 0:r.name)??"cv-intersect").split("."),b=new Set(p.slice(1)),g=b.has("once");let k=0;if(b.has("half"))k=.5;else if(b.has("full"))k=1;else{const M=[...b].find(G=>G.startsWith("threshold-"));M&&(k=parseInt(M.replace("threshold-",""))/100)}const j=[...b].find(M=>M.startsWith("margin-")),F=j?`${j.replace("margin-","")}px`:void 0;i.forEach(M=>n.removeAttribute(M.name));const U=M=>{if(M)try{new Function("$data",`with($data){${M}}`)(e)}catch(G){console.warn(`[courvux] cv-intersect error "${M}":`,G)}},z=new IntersectionObserver(M=>{M.forEach(G=>{G.isIntersecting?(U(u),g&&z.disconnect()):U(m)})},{threshold:k,...F?{rootMargin:F}:{}});z.observe(n),(w=o.registerCleanup)==null||w.call(o,()=>z.disconnect())}}{const i=Array.from(n.attributes).find(r=>r.name==="cv-html"||r.name.startsWith("cv-html."));if(i){const r=i.value;n.removeAttribute(i.name);const s=i.name.split(".").slice(1).includes("sanitize"),u=()=>{const m=String(N(r,e)??"");n.innerHTML=s?wt(m):m};K(r,o,u),u(),l++;continue}}if(n.hasAttribute("cv-ref")&&!((V=o.components)!=null&&V[h])){const i=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[i]=n)}const f=!!((L=o.components)!=null&&L[h]),T=Array.from(n.attributes).find(i=>i.name==="cv-model"||i.name.startsWith("cv-model."));if(T&&!f){const i=T.value;n.removeAttribute(T.name);const r=new Set(T.name.split(".").slice(1)),s=n,u=(H=s.type)==null?void 0:H.toLowerCase(),m=p=>{if(r.has("number")){const b=parseFloat(p);return isNaN(b)?p:b}return r.has("trim")?p.trim():p};if(u==="checkbox"){const p=()=>{const b=N(i,e);s.checked=Array.isArray(b)?b.includes(s.value):!!b};ue(i,o,p),p(),s.addEventListener("change",()=>{const b=N(i,e);if(Array.isArray(b)){const g=[...b];if(s.checked)g.includes(s.value)||g.push(s.value);else{const k=g.indexOf(s.value);k>-1&&g.splice(k,1)}le(i,e,g)}else le(i,e,s.checked)})}else if(u==="radio"){const p=()=>{s.checked=N(i,e)===s.value};ue(i,o,p),p(),s.addEventListener("change",()=>{s.checked&&le(i,e,m(s.value))})}else if(n.hasAttribute("contenteditable")){const p=n,b=()=>{const g=String(N(i,e)??"");p.innerText!==g&&(p.innerText=g)};if(ue(i,o,b),b(),r.has("debounce")){const g=[...r].find(F=>/^\d+$/.test(F)),k=g?parseInt(g):300;let j;p.addEventListener("input",()=>{clearTimeout(j),j=setTimeout(()=>le(i,e,m(p.innerText)),k)})}else{const g=r.has("lazy")?"blur":"input";p.addEventListener(g,()=>le(i,e,m(p.innerText)))}}else{const p=()=>{s.value=N(i,e)??""};if(ue(i,o,p),p(),r.has("debounce")){const b=[...r].find(j=>/^\d+$/.test(j)),g=b?parseInt(b):300;let k;s.addEventListener("input",()=>{clearTimeout(k),k=setTimeout(()=>le(i,e,m(s.value)),g)})}else{const b=h==="select"||r.has("lazy")?"change":"input";s.addEventListener(b,()=>le(i,e,m(s.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(i=>{var U,z;if(!i.name.startsWith("cv-"))return;const r=i.name.slice(3).split("."),s=r[0],u=r.slice(1),m=s.indexOf(":"),p=m>=0?s.slice(0,m):s,b=m>=0?s.slice(m+1):void 0,g=o.directives[p];if(!g)return;const k=i.value;n.removeAttribute(i.name);const j=typeof g=="function"?{onMount:g}:g,F={value:k?N(k,e):void 0,arg:b,modifiers:Object.fromEntries(u.map(M=>[M,!0]))};(U=j.onMount)==null||U.call(j,n,F),j.onUpdate&&k&&K(k,o,()=>{F.value=N(k,e),j.onUpdate(n,F)}),j.onDestroy&&((z=o.registerCleanup)==null||z.call(o,()=>j.onDestroy(n,F)))}),h==="slot"){const i=n.getAttribute("name")??"default",r=(R=o.slots)==null?void 0:R[i];if(r){const s={};Array.from(n.attributes).forEach(p=>{p.name.startsWith(":")&&(s[p.name.slice(1)]=N(p.value,e))});const u=await r(s),m=document.createDocumentFragment();u.forEach(p=>m.appendChild(p)),n.replaceWith(m)}else{const s=document.createDocumentFragment();for(;n.firstChild;)s.appendChild(n.firstChild);await oe(s,e,o),n.replaceWith(s)}l++;continue}if(h==="cv-transition"){We();const i=n.getAttribute("name")??"fade",r=n.getAttribute(":show")??null;n.removeAttribute("name"),r&&n.removeAttribute(":show");const s=document.createElement("div");for(s.className="cv-t-wrap";n.firstChild;)s.appendChild(n.firstChild);if(n.replaceWith(s),await oe(s,e,o),r){let u=!!N(r,e),m=!1,p=null;u||(s.style.display="none");const b=async g=>{if(m){p=g;return}m=!0;try{g?(s.style.display="",s.classList.add(`${i}-enter`),await ie(s),s.classList.remove(`${i}-enter`)):(s.classList.add(`${i}-leave`),await ie(s),s.classList.remove(`${i}-leave`),s.style.display="none"),u=g}finally{if(m=!1,p!==null&&p!==u){const k=p;p=null,b(k)}else p=null}};K(r,o,()=>{const g=!!N(r,e);g!==u&&b(g)})}l++;continue}if(h==="router-view"&&o.mountRouterView){const i=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,i),l++;continue}if(h==="router-link"){const i=n.getAttribute(":to"),r=n.getAttribute("to"),s=()=>i?String(N(i,e)??"/"):r||"/",u=document.createElement("a");u.innerHTML=n.innerHTML,Array.from(n.attributes).forEach(k=>{k.name!=="to"&&k.name!==":to"&&u.setAttribute(k.name,k.value)});const m=((C=o.router)==null?void 0:C.base)??"",p=k=>m?k===m?"/":k.startsWith(m+"/")?k.slice(m.length)||"/":k||"/":k||"/",b=()=>{var k;return((k=o.router)==null?void 0:k.mode)==="history"?p(window.location.pathname):window.location.hash.slice(1)||"/"},g=()=>{var F;const k=s(),j=b()===k;((F=o.router)==null?void 0:F.mode)==="history"?u.href=`${m}${k}`:u.href=`#${k}`,j?(u.setAttribute("aria-current","page"),u.classList.add("active")):(u.removeAttribute("aria-current"),u.classList.remove("active"))};((P=o.router)==null?void 0:P.mode)==="history"?(u.addEventListener("click",k=>{k.preventDefault(),o.router.navigate(s())}),window.addEventListener("popstate",g)):window.addEventListener("hashchange",g),i&&ue(i,o,g),g(),n.replaceWith(u),await oe(u,e,o),l++;continue}if(h==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const i=n.getAttribute(":is");n.removeAttribute(":is");const r=document.createComment("component:is");n.replaceWith(r),await o.mountDynamic(r,i,n,e,o),l++;continue}if((_=o.components)!=null&&_[h]&&o.mountElement){await o.mountElement(n,h,e,o),l++;continue}{const i=Array.from(n.attributes).find(r=>r.name==="cv-intersect"||r.name.startsWith("cv-intersect."));if(i&&typeof IntersectionObserver<"u"){const r=new Set(i.name.split(".").slice(1));n.removeAttribute(i.name);const s=N(i.value,e);let u,m=0,p="0px",b=r.has("once");if(typeof s=="function"?u=g=>s.call(e,g):s&&typeof s=="object"&&(typeof s.handler=="function"&&(u=g=>s.handler.call(e,g)),s.threshold!==void 0&&(m=s.threshold),s.margin&&(p=s.margin),s.once&&(b=!0)),u){const g=new IntersectionObserver(k=>{const j=k[0];u(j),b&&j.isIntersecting&&g.disconnect()},{threshold:m,rootMargin:p});g.observe(n),(d=o.registerCleanup)==null||d.call(o,()=>g.disconnect())}}}if(n.hasAttribute("cv-resize")){const i=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const r=N(i,e);let s,u="content-box";if(typeof r=="function"?s=m=>r.call(e,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(s=m=>r.handler.call(e,m)),r.box&&(u=r.box)),s){const m=new ResizeObserver(p=>{p[0]&&s(p[0])});m.observe(n,{box:u}),(a=o.registerCleanup)==null||a.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const i=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const r=N(i,e);let s,u=0;if(typeof r=="function"?s=m=>r.call(e,m):r&&typeof r=="object"&&(typeof r.handler=="function"&&(s=m=>r.handler.call(e,m)),r.throttle&&(u=r.throttle)),s){let m=0;const p=()=>{const b=Date.now();u>0&&b-m<u||(m=b,s({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",p,{passive:!0}),(v=o.registerCleanup)==null||v.call(o,()=>n.removeEventListener("scroll",p))}}if(n.hasAttribute("cv-clickoutside")){const i=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const r=s=>{n.contains(s.target)||(typeof e[i]=="function"?e[i].call(e,s):Ne(i,e,s))};document.addEventListener("click",r,!0),(S=o.registerCleanup)==null||S.call(o,()=>document.removeEventListener("click",r,!0))}if(n.hasAttribute("cv-bind")){const i=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const r=n.getAttribute("class")??"",s=n.getAttribute("style")??"";let u=[];const m=()=>{const p=N(i,e)??{},b=Object.keys(p);for(const g of u)g in p||(g==="class"?n.className=r:g==="style"?n.style.cssText=s:n.removeAttribute(g));for(const[g,k]of Object.entries(p))g==="class"?n.className=[r,De(k)].filter(Boolean).join(" "):g==="style"?He(n,k,s):k==null||k===!1?n.removeAttribute(g):n.setAttribute(g,k===!0?"":String(k));u=b};K(i,o,m),m()}const O={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(i=>{if(i.name.startsWith("@")||i.name.startsWith("cv:on:")){const r=(i.name.startsWith("@")?i.name.substring(1):i.name.substring(6)).split("."),s=r[0],u=new Set(r.slice(1)),m=[...u].find(k=>k in O),p=i.value,b=k=>{u.has("prevent")&&k.preventDefault(),u.has("stop")&&k.stopPropagation(),!(u.has("self")&&k.target!==k.currentTarget)&&(m&&k.key!==O[m]||(typeof e[p]=="function"?e[p].call(e,k):Ne(p,e,k)))},g={};u.has("once")&&(g.once=!0),u.has("passive")&&(g.passive=!0),u.has("capture")&&(g.capture=!0),n.addEventListener(s,b,Object.keys(g).length?g:void 0)}else if(i.name.startsWith(":")){const r=i.name.slice(1),s=i.value;if(r==="class"){const u=n.getAttribute("class")??"",m=()=>{n.className=[u,De(N(s,e))].filter(Boolean).join(" ")};K(s,o,m),m()}else if(r==="style"){const u=n.getAttribute("style")??"",m=()=>He(n,N(s,e),u);K(s,o,m),m()}else if(r.includes("-")){const u=()=>{const m=N(s,e);m==null||m===!1?n.removeAttribute(r):n.setAttribute(r,m===!0?"":String(m))};K(s,o,u),u()}else{const u=()=>{n[r]=N(s,e)??""};K(s,o,u),u()}}}),A.hasChildNodes()&&await oe(A,e,o),l++}}var xt=`
...
`;function At(){if(document.getElementById("cv-transitions"))return;const t=document.createElement("style");t.id="cv-transitions",t.textContent=xt,document.head.appendChild(t)}async function ge(t,e,o){t.classList.add(`${e}-${o}`);const c=getComputedStyle(t),l=Math.max(parseFloat(c.animationDuration)||0,parseFloat(c.transitionDuration)||0)*1e3;l>0&&await new Promise(y=>{const E=()=>y();t.addEventListener("animationend",E,{once:!0}),t.addEventListener("transitionend",E,{once:!0}),setTimeout(E,l+50)}),t.classList.remove(`${e}-${o}`)}var we=new Map;async function St(t){if(typeof t!="function")return t;if(we.has(t))return we.get(t);const e=await t();return we.set(t,e.default),e.default}function qe(t,e){if(t.components)return t.components[e];if(e==="default")return t.component}function Ve(t,e){if(t==="*")return{};const o=[],c=t.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=e.match(new RegExp(`^${c}$`));return l?Object.fromEntries(o.map((y,E)=>[y,l[E+1]])):null}function Et(t,e){if(t==="/")return{params:{},remaining:e};const o=[],c=t.replace(/:(\w+)/g,(y,E)=>(o.push(E),"([^/]+)")),l=e.match(new RegExp(`^${c}(/.+)?$`));return l?{params:Object.fromEntries(o.map((y,E)=>[y,l[E+1]])),remaining:l[o.length+1]||"/"}:null}function dt(t,e=""){return t.map(o=>{var l;if(o.path==="*")return o;const c=((e.endsWith("/")?e.slice(0,-1):e)+o.path).replace(/\/+/g,"/")||"/";return(l=o.children)!=null&&l.length?{...o,path:c,children:dt(o.children,c==="/"?"":c)}:{...o,path:c}})}var me=(t,e)=>new Promise(o=>t(e,o)),Ge=(t,e)=>t!=null&&t.beforeLeave?new Promise(o=>t.beforeLeave(e,o)):Promise.resolve(void 0);function _t(t,e={}){const o=e.mode??"hash",c=Tt(e.base??"");return{routes:dt(t),mode:o,base:c,transition:e.transition,beforeEach:e.beforeEach,afterEach:e.afterEach,scrollBehavior:e.scrollBehavior,navigate(l,y){const E=Ye(l,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=E},replace(l,y){const E=Ye(l,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${c}${E}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${E}`)}},back(){history.back()},forward(){history.forward()}}}function Tt(t){if(!t||t==="/")return"";let e=t.startsWith("/")?t:`/${t}`;return e.endsWith("/")&&(e=e.slice(0,-1)),e}function $t(t,e){return e?t===e?"/":t.startsWith(e+"/")?t.slice(e.length)||"/":t||"/":t||"/"}function Ye(t,e){return!e||!Object.keys(e).length?t:`${t}?${new URLSearchParams(e).toString()}`}function Xe(t){if(!t)return{};const e=new URLSearchParams(t.startsWith("?")?t.slice(1):t),o={};return e.forEach((c,l)=>{o[l]=c}),o}function Ze(t,e,o,c="default",l){const y=e.base??"",E=()=>e.mode==="history"?$t(window.location.pathname,y):(window.location.hash.slice(1)||"/").split("?")[0]||"/",x=()=>{if(e.mode==="history")return Xe(window.location.search);const a=window.location.hash.slice(1)||"/",v=a.indexOf("?");return v>=0?Xe(a.slice(v+1)):{}};e.transition&&At();let D=null,$=null,w=null,V=null,L=!1;const H=()=>{L||(L=!0,l==null||l())},R=new Map,C=a=>{var v;if(a!=null&&a.keepAlive&&w){(v=w.deactivate)==null||v.call(w);const S=document.createDocumentFragment();for(;t.firstChild;)S.appendChild(t.firstChild);R.set(D.path,{fragment:S,activation:w}),w=null}else w==null||w.destroy(),w=null,t.innerHTML=""},P=async(a,v,S,A,n)=>{const h=typeof v=="function"&&!we.has(v),f=h?v.__asyncOptions:void 0,T=a.loadingTemplate??(f==null?void 0:f.loadingTemplate);h&&T&&(t.innerHTML=T);let O;try{O=await St(v)}catch(i){const r=f==null?void 0:f.errorTemplate;if(r)return t.innerHTML=r,{destroy:()=>{t.innerHTML=""}};throw i}return h&&T&&(t.innerHTML=""),o(t,O,S,A,n)},_=async()=>{var S,A,n,h,f,T,O,i;const a=E(),v=x();for(const r of e.routes){if((S=r.children)!=null&&S.length){const u=Et(r.path,a);if(u!==null)for(const m of r.children){const p=Ve(m.path,a);if(p!==null){const b={params:u.params,query:v,path:a,meta:r.meta};if(m.redirect){const F={params:p,query:v,path:a,meta:m.meta},U=typeof m.redirect=="function"?m.redirect(F):m.redirect;e.navigate(U);return}if(e.beforeEach){const F=await me(e.beforeEach,b);if(F){e.navigate(F);return}}if(r.beforeEnter){const F=await me(r.beforeEnter,b);if(F){e.navigate(F);return}}if(m.beforeEnter){const F={params:p,query:v,path:a,meta:m.meta},U=await me(m.beforeEnter,F);if(U){e.navigate(U);return}}const g=`${r.path}::${JSON.stringify(u.params)}`;if(V!==g){const F=await Ge(w,b);if(F){e.navigate(F);return}const U=r.transition??e.transition;U&&t.hasChildNodes()&&await ge(t,U,"leave"),C($);const z=qe(r,c);if(z){const M={routes:r.children,mode:e.mode,base:e.base,transition:r.transition??e.transition,beforeEach:e.beforeEach,afterEach:e.afterEach,scrollBehavior:e.scrollBehavior,navigate:(G,I)=>e.navigate(G,I),replace:(G,I)=>e.replace(G,I),back:()=>e.back(),forward:()=>e.forward()};w=await P(r,z,b,c==="default"?r.layout:void 0,c==="default"?M:void 0),(A=w.enter)==null||A.call(w,D)}else t.innerHTML="";V=g,U&&await ge(t,U,"enter")}const k={params:{...u.params,...p},query:v,path:a,meta:m.meta??r.meta};(n=e.afterEach)==null||n.call(e,k,D);const j=(h=e.scrollBehavior)==null?void 0:h.call(e,k,D);j&&window.scrollTo(j.x??0,j.y??0),D=k,$=r,H();return}}}const s=Ve(r.path,a);if(s!==null){V=null;const u={params:s,query:v,path:a,meta:r.meta};if(r.redirect){const k=typeof r.redirect=="function"?r.redirect(u):r.redirect;e.navigate(k);return}if(e.beforeEach){const k=await me(e.beforeEach,u);if(k){e.navigate(k);return}}if(r.beforeEnter){const k=await me(r.beforeEnter,u);if(k){e.navigate(k);return}}const m=await Ge(w,u);if(m){e.navigate(m);return}const p=r.transition??e.transition;p&&t.hasChildNodes()&&await ge(t,p,"leave"),C($);const b=qe(r,c);if(b){const k=u.path;if(r.keepAlive&&R.has(k)){const j=R.get(k);t.appendChild(j.fragment),w=j.activation,(f=w.activate)==null||f.call(w),R.delete(k)}else{const j=D;w=await P(r,b,u,c==="default"?r.layout:void 0),(T=w.enter)==null||T.call(w,j)}}else t.innerHTML="",w=null;p&&await ge(t,p,"enter"),(O=e.afterEach)==null||O.call(e,u,D);const g=(i=e.scrollBehavior)==null?void 0:i.call(e,u,D);g&&window.scrollTo(g.x??0,g.y??0),D=u,$=r,H();return}}V=null,C($),$=null,H()},d=e.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,_),_(),()=>{window.removeEventListener(d,_),w==null||w.destroy(),w=null,R.forEach(({activation:a})=>a.destroy()),R.clear()}}function Ct(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const t=new Map,e={instances:[],stores:[],on(o,c){return t.has(o)||t.set(o,new Set),t.get(o).add(c),()=>{var l;return(l=t.get(o))==null?void 0:l.delete(c)}},_emit(o,c){var l;(l=t.get(o))==null||l.forEach(y=>{try{y(c)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const c=this.instances.findIndex(l=>l.id===o);if(c!==-1){const l=this.instances[c];this.instances.splice(c,1),this._emit("destroy",l)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=e,e}var Ft=0;function Ot(){return++Ft}var jt=`
...
`;function Lt(){if(document.getElementById("cvd-styles"))return;const t=document.createElement("style");t.id="cvd-styles",t.textContent=jt,document.head.appendChild(t)}function be(t){return t===null?"null":t===void 0?"undefined":typeof t=="string"?`"${t}"`:typeof t=="object"?JSON.stringify(t):String(t)}function Je(t){try{return JSON.parse(t)}catch{return t}}function Pt(t){if(typeof document>"u")return;Lt();const e=document.createElement("div");e.id="cvd",document.body.appendChild(e);let o=!1,c="components",l=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',e.appendChild(y);const E=document.createElement("div");E.id="cvd-panel",E.style.display="none",e.appendChild(E),E.innerHTML=`
        <div id="cvd-head">
...
createApp({
    ...
    `,onMount(){Z({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~10 KB gzip.",slug:"/"})}},Qt={data:{s1:`npm install github:vanjexdev/courvux
# or
