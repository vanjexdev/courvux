(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const y of i)if(y.type==="childList")for(const S of y.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&s(S)}).observe(document,{childList:!0,subtree:!0});function o(i){const y={};return i.integrity&&(y.integrity=i.integrity),i.referrerPolicy&&(y.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?y.credentials="include":i.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function s(i){if(i.ep)return;i.ep=!0;const y=o(i);fetch(i.href,y)}})();var kt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),lt=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,De=new WeakSet,Ae=Symbol("raw"),Oe=e=>e===null||typeof e!="object"?e:e[Ae]??e,ke=0,Me=new Map,ve=null;function He(e){const t=[],o=ve;ve=t;try{e()}finally{ve=o}return t}function St(e){ke++;try{e()}finally{if(ke--,ke===0){const t=[...Me.values()];Me.clear(),t.forEach(o=>o())}}}function ut(e,t){return e===null||typeof e!="object"||De.has(e)||lt(e)?e:new Proxy(e,{get(o,s){if(s===Ae)return o[Ae]??o;if(typeof s=="string"&&Array.isArray(o)&&kt.has(s))return(...y)=>{const S=Array.prototype[s].apply(o,y);return t(),S};const i=o[s];return i!==null&&typeof i=="object"&&!De.has(i)?ut(i,t):i},set(o,s,i){return o[s]=i,t(),!0}})}function Ie(){const e={},t=Math.random().toString(36).slice(2),o=(y,S)=>(e[y]||(e[y]=new Set),e[y].add(S),()=>{var w;(w=e[y])==null||w.delete(S)}),s=y=>{ke>0?Me.set(`${t}:${y}`,()=>{(e[y]?[...e[y]]:[]).forEach(S=>S())}):(e[y]?[...e[y]]:[]).forEach(S=>S())},i={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(S,w){if(w===Ae)return y;typeof w=="string"&&!w.startsWith("$")&&ve&&ve.push({sub:o,key:w});const R=S[w];return typeof w=="string"&&!w.startsWith("$")&&R!==null&&typeof R=="object"&&!De.has(R)&&!lt(R)?ut(R,()=>s(w)):R},set(S,w,R){if(i[w])return i[w](R),!0;const $=S[w];return S[w]=R,($!==R||R!==null&&typeof R=="object")&&s(w),!0}}),registerSetInterceptor:(y,S)=>{i[y]=S},notifyAll:()=>{Object.keys(e).forEach(y=>s(y))}}}var je=new WeakMap;function be(e,t,o){var i,y;const s=t.indexOf(".");if(s>=0){const S=t.slice(0,s),w=t.slice(s+1),R=e[S];return R&&je.has(R)?be(R,w,o):((i=je.get(e))==null?void 0:i(S,o))??(()=>{})}return((y=je.get(e))==null?void 0:y(t,o))??(()=>{})}var pt=(e,t)=>e.split(".").reduce((o,s)=>o==null?void 0:o[s],t),ze=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),Ne=new Map,We=new Map,mt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!mt(o.slice(1).trim(),t):pt(o,t)},U=(e,t)=>{if(!ze)return mt(e,t);try{let o=Ne.get(e);return o||(o=new Function("$data",`with($data) { return (${e}) }`),Ne.set(e,o)),o(t)}catch{return pt(e,t)}},ht=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):be(t.store,e.slice(7),o):t.subscribe(e,o),J=(e,t,o)=>{const s=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),i=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(i.map(w=>w.startsWith("$store.")?w:w.split(".")[0]).filter(w=>!s.has(w)))];if(y.length===0)return()=>{};const S=y.map(w=>ht(w,t,o));return()=>S.forEach(w=>w())},Ue=new Map,pe=(e,t,o)=>{if(ze)try{let i=Ue.get(e);i||(i=new Function("__s__","__v__",`with(__s__){ (${e}) = __v__ }`),Ue.set(e,i)),i(t,o);return}catch(i){console.warn(`[courvux] setStateValue: write failed for "${e}":`,i);return}const s=e.split(".");if(s.length===1)t[s[0]]=o;else{const i=s.slice(0,-1).reduce((y,S)=>y==null?void 0:y[S],t);i&&(i[s[s.length-1]]=o)}},qe=(e,t,o,s,i)=>{const y={};return Object.keys(e).forEach(S=>y[S]=e[S]),y[o]=t,i&&(y[i]=s),y},Le=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(Le).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Be=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([s,i])=>{e.style[s]=i??""}))},Ve=(e,t,o)=>{if(ze)try{let s=We.get(e);s||(s=new Function("__p__",`with(__p__){${e}}`),We.set(e,s));const i=new Proxy({},{has:()=>!0,get:(y,S)=>S==="$event"?o:S in t?t[S]:globalThis[S],set:(y,S,w)=>(t[S]=w,!0)});s(i)}catch(s){console.warn(`[courvux] handler error "${e}":`,s)}},ce=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(s=>{const i=()=>s();e.addEventListener("animationend",i,{once:!0}),e.addEventListener("transitionend",i,{once:!0}),setTimeout(i,o+50)})},At=`
...
`,Ge=!1;function Ye(){if(Ge||typeof document>"u")return;Ge=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=At,document.head.appendChild(e)}var Xe=!1;function Ct(){if(Xe||typeof document>"u")return;Xe=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function Et(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(s=>{(s.name.startsWith("on")||s.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(s.name)})}),t.body.innerHTML}async function te(e,t,o){var y,S,w,R,$,C,M,_,I,z,O,L,E,c,d,p,x;const s=Array.from(e.childNodes);let i=0;for(;i<s.length;){const k=s[i];if(k.nodeType===3){const a=k.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,f=()=>{let m=r;l.forEach(u=>{const h=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(u,U(h,t)??"")}),k.textContent=m};l.forEach(m=>{J(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,f)}),f()}i++;continue}if(k.nodeType!==1){i++;continue}const n=k,v=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),i++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await te(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),i++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await te(n,t,o),l.appendChild(n),i++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(h=>U(h.trim(),t));let r=l();const f=[],m=h=>(f.push(h),()=>{const g=f.indexOf(h);g>-1&&f.splice(g,1)});await te(n,t,{...o,subscribe:(h,g)=>m(g),storeSubscribeOverride:(h,g,T)=>m(T)});const u=J(a,o,()=>{const h=l();h.some((g,T)=>g!==r[T])&&(r=h,[...f].forEach(g=>g()))});(y=o.registerCleanup)==null||y.call(o,()=>u()),i++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const f=U(a,t)??{};Object.entries(f).forEach(([m,u])=>{typeof u=="function"?r[m]=u:l[m]=u})}else if(a){const f=(S=o.components)==null?void 0:S[a];if(f){const m=typeof f.data=="function"?f.data():f.data??{};m instanceof Promise||Object.assign(l,m),Object.assign(r,f.methods??{})}}if(o.createChildScope){const f=o.createChildScope(l,r);(w=o.registerCleanup)==null||w.call(o,f.cleanup),await te(n,f.state,{...o,subscribe:f.subscribe})}else await te(n,{...t,...l,...r},o);i++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,f,m]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const h=n.getAttribute("cv-transition")??null;h&&n.removeAttribute("cv-transition");const g=document.createComment(`cv-for: ${m}`);n.replaceWith(g);let T=[],j=[];const F=new Map;let W=!1,N=!1;const D=async()=>{var K;const q=U(m,t),H=q?typeof q=="number"?Array.from({length:q},(V,B)=>[B+1,B]):Array.isArray(q)?q.map((V,B)=>[V,B]):Object.entries(q).map(([V,B])=>[B,V]):[];if(u){const V=[],B=new Map,de=new Set;for(const[X,Y]of H){const ie=U(u,qe(t,X,r,Y,f));de.has(ie)&&console.warn(`[courvux] cv-for: duplicate :key "${ie}" in "${m}"`),de.add(ie),V.push(ie),B.set(ie,[X,Y])}const Q=[];for(const[X,{el:Y,destroy:ie}]of F)B.has(X)||(h?(Y.classList.add(`${h}-leave`),Q.push(ce(Y).then(()=>{var se;Y.classList.remove(`${h}-leave`),ie(),(se=Y.parentNode)==null||se.removeChild(Y),F.delete(X)}))):(ie(),(K=Y.parentNode)==null||K.removeChild(Y),F.delete(X)));Q.length&&await Promise.all(Q);const re=g.parentNode,ae=[];for(const X of V){const[Y,ie]=B.get(X);if(F.has(X)){const se=F.get(X);se.itemRef!==Y&&(se.reactive[r]=Y,se.itemRef=Y),f&&(se.reactive[f]=ie)}else{const se=n.cloneNode(!0),Ee=[],{subscribe:bt,createReactiveState:yt}=Ie(),Te=yt({[r]:Y,...f?{[f]:ie}:{}}),wt=new Proxy({},{has(le,ee){return!0},get(le,ee){return typeof ee!="string"?t[ee]:ee===r||f&&ee===f?Te[ee]:t[ee]},set(le,ee,ue){return ee===r||f&&ee===f?(Te[ee]=ue,!0):(t[ee]=ue,!0)}}),xt={...o,subscribe:(le,ee)=>{const ue=le.split(".")[0];let me;return ue===r||f&&ue===f?me=bt(ue,ee):me=o.subscribe(le,ee),Ee.push(me),me},storeSubscribeOverride:(le,ee,ue)=>{const me=be(le,ee,ue);return Ee.push(me),me}},_e=document.createDocumentFragment();_e.appendChild(se),await te(_e,wt,xt);const $e=_e.firstChild??se;h&&$e.classList.add(`${h}-enter`),F.set(X,{el:$e,reactive:Te,itemRef:Y,destroy:()=>Ee.forEach(le=>le())}),h&&ae.push($e)}}let oe=g.nextSibling,he=0;for(const X of V){const{el:Y}=F.get(X);Y!==oe?he++:oe=Y.nextSibling}if(he>0)if(he>V.length>>1){const X=document.createDocumentFragment();for(const Y of V)X.appendChild(F.get(Y).el);re.insertBefore(X,g.nextSibling)}else{oe=g.nextSibling;for(const X of V){const{el:Y}=F.get(X);Y!==oe?re.insertBefore(Y,oe):oe=Y.nextSibling}}T=V.map(X=>F.get(X).el),ae.length&&Promise.all(ae.map(X=>ce(X).then(()=>X.classList.remove(`${h}-enter`))))}else{if(j.forEach(Q=>Q()),j=[],T.forEach(Q=>{var re;return(re=Q.parentNode)==null?void 0:re.removeChild(Q)}),T=[],!H.length)return;const V=g.parentNode,B=g.nextSibling,de={...o,subscribe:(Q,re)=>{const ae=o.subscribe(Q,re);return j.push(ae),ae},storeSubscribeOverride:(Q,re,ae)=>{const oe=be(Q,re,ae);return j.push(oe),oe}};for(const[Q,re]of H){const ae=n.cloneNode(!0),oe=document.createDocumentFragment();oe.appendChild(ae),await te(oe,qe(t,Q,r,re,f),de);const he=oe.firstChild??ae;V.insertBefore(oe,B),T.push(he)}}},G=async()=>{if(W){N=!0;return}W=!0;try{for(await D();N;)N=!1,await D()}finally{W=!1}};(R=o.registerCleanup)==null||R.call(o,()=>{F.forEach(({el:q,destroy:H})=>{var K;H(),(K=q.parentNode)==null||K.removeChild(q)}),F.clear(),j.forEach(q=>q()),T.forEach(q=>{var H;return(H=q.parentNode)==null?void 0:H.removeChild(q)}),T=[]}),J(m,o,G),await G()}i++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let f=i+1;for(;f<s.length;){const T=s[f];if(T.nodeType===3&&((($=T.textContent)==null?void 0:$.trim())??"")===""){f++;continue}if(T.nodeType!==1)break;const j=T;if(j.hasAttribute("cv-else-if")){const F=j.getAttribute("cv-else-if");j.removeAttribute("cv-else-if");const W=document.createComment("cv-else-if");j.replaceWith(W),a.push({condition:F,template:j,anchor:W}),f++;continue}if(j.hasAttribute("cv-else")){j.removeAttribute("cv-else");const F=document.createComment("cv-else");j.replaceWith(F),a.push({condition:null,template:j,anchor:F}),f++;break}break}i=f;let m=null,u=!1,h=!1;const g=async()=>{var T,j;if(u){h=!0;return}u=!0;try{do{h=!1,m&&((T=m.parentNode)==null||T.removeChild(m),m=null);for(const F of a)if(F.condition===null||U(F.condition,t)){const W=F.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(W),await te(N,t,o);const D=N.firstChild??W;(j=F.anchor.parentNode)==null||j.insertBefore(N,F.anchor.nextSibling),m=D;break}}while(h)}finally{u=!1}};a.filter(T=>T.condition).forEach(T=>{J(T.condition,o,g)}),await g();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=D=>(n.getAttribute(D)??"").split(" ").filter(Boolean),f=r("cv-transition:enter"),m=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),h=r("cv-transition:leave"),g=r("cv-transition:leave-start"),T=r("cv-transition:leave-end"),j=n.getAttribute("cv-transition")??"",F=new Set(j.split(".").slice(1)),W=[...F].find(D=>/^\d+$/.test(D)),N=W?parseInt(W):200;if(f.length||m.length||h.length||g.length){l.forEach(V=>n.removeAttribute(V.name));const D=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!U(a,t),q=!1,H=null;const K=async V=>{if(q){H=V;return}q=!0;try{V?(n.style.display="",n.classList.add(...f,...m),await D(),n.classList.remove(...m),n.classList.add(...u),await ce(n),n.classList.remove(...f,...u)):(n.classList.add(...h,...g),await D(),n.classList.remove(...g),n.classList.add(...T),await ce(n),n.classList.remove(...h,...T),n.style.display="none"),G=V}finally{if(q=!1,H!==null&&H!==G){const B=H;H=null,K(B)}else H=null}};G||(n.style.display="none"),J(a,o,()=>{const V=!!U(a,t);V!==G&&K(V)})}else{const D=[...F].find(B=>B==="scale"||/^scale$/.test(B)),G=(()=>{const B=[...F].find(de=>/^\d+$/.test(de)&&de!==W);return B?parseInt(B)/100:.9})(),q=[];(!F.has("scale")||F.has("opacity"))&&q.push(`opacity ${N}ms ease`),D&&q.push(`transform ${N}ms ease`),q.length||q.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+q.join(", "),l.forEach(B=>n.removeAttribute(B.name));let H=!!U(a,t);const K=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B()))),V=async B=>{B?(n.style.display="",n.style.opacity="0",D&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",D&&(n.style.transform=""),await ce(n)):(n.style.opacity="0",D&&(n.style.transform=`scale(${G})`),await ce(n),n.style.display="none",n.style.opacity="",D&&(n.style.transform="")),H=B};H||(n.style.display="none"),J(a,o,()=>{const B=!!U(a,t);B!==H&&V(B)})}}else{const r=n.getAttribute("cv-show-transition"),f=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),f&&n.removeAttribute(":transition");const m=r??(f?String(U(f,t)):null);if(m){Ye();let u=!!U(a,t);u||(n.style.display="none");let h=!1,g=null;const T=async j=>{if(h){g=j;return}h=!0;try{j?(n.style.display="",n.classList.add(`${m}-enter`),await ce(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ce(n),n.classList.remove(`${m}-leave`),n.style.display="none"),u=j}finally{if(h=!1,g!==null&&g!==u){const F=g;g=null,T(F)}else g=null}};J(a,o,()=>{const j=!!U(a,t);j!==u&&T(j)})}else{const u=()=>{n.style.display=U(a,t)?"":"none"};J(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{U(a,t)&&Promise.resolve().then(()=>n.focus())};J(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(D=>D.name==="cv-intersect"||D.name==="cv-intersect:enter"||D.name.startsWith("cv-intersect.")),r=a.find(D=>D.name==="cv-intersect:leave"),f=(l==null?void 0:l.value)??"",m=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),h=new Set(u.slice(1)),g=h.has("once");let T=0;if(h.has("half"))T=.5;else if(h.has("full"))T=1;else{const D=[...h].find(G=>G.startsWith("threshold-"));D&&(T=parseInt(D.replace("threshold-",""))/100)}const j=[...h].find(D=>D.startsWith("margin-")),F=j?`${j.replace("margin-","")}px`:void 0;a.forEach(D=>n.removeAttribute(D.name));const W=D=>{if(D)try{new Function("$data",`with($data){${D}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${D}":`,G)}},N=new IntersectionObserver(D=>{D.forEach(G=>{G.isIntersecting?(W(f),g&&N.disconnect()):W(m)})},{threshold:T,...F?{rootMargin:F}:{}});N.observe(n),(C=o.registerCleanup)==null||C.call(o,()=>N.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=a.name.split(".").slice(1).includes("sanitize"),f=()=>{const m=String(U(l,t)??"");n.innerHTML=r?Et(m):m};J(l,o,f),f(),i++;continue}}if(n.hasAttribute("cv-ref")&&!((M=o.components)!=null&&M[v])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const b=!!((_=o.components)!=null&&_[v]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!b){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,f=(I=r.type)==null?void 0:I.toLowerCase(),m=u=>{if(l.has("number")){const h=parseFloat(u);return isNaN(h)?u:h}return l.has("trim")?u.trim():u};if(f==="checkbox"){const u=()=>{const h=U(a,t);r.checked=Array.isArray(h)?h.includes(r.value):!!h};J(a,o,u),u(),r.addEventListener("change",()=>{const h=U(a,t);if(Array.isArray(h)){const g=[...h];if(r.checked)g.includes(r.value)||g.push(r.value);else{const T=g.indexOf(r.value);T>-1&&g.splice(T,1)}pe(a,t,g)}else pe(a,t,r.checked)})}else if(f==="radio"){const u=()=>{r.checked=U(a,t)===r.value};J(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&pe(a,t,m(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,h=()=>{const g=String(U(a,t)??"");u.innerText!==g&&(u.innerText=g)};if(J(a,o,h),h(),l.has("debounce")){const g=[...l].find(F=>/^\d+$/.test(F)),T=g?parseInt(g):300;let j;u.addEventListener("input",()=>{clearTimeout(j),j=setTimeout(()=>pe(a,t,m(u.innerText)),T)})}else{const g=l.has("lazy")?"blur":"input";u.addEventListener(g,()=>pe(a,t,m(u.innerText)))}}else{const u=()=>{r.value=U(a,t)??""};if(J(a,o,u),u(),l.has("debounce")){const h=[...l].find(j=>/^\d+$/.test(j)),g=h?parseInt(h):300;let T;r.addEventListener("input",()=>{clearTimeout(T),T=setTimeout(()=>pe(a,t,m(r.value)),g)})}else{const h=v==="select"||l.has("lazy")?"change":"input";r.addEventListener(h,()=>pe(a,t,m(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var W,N;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],f=l.slice(1),m=r.indexOf(":"),u=m>=0?r.slice(0,m):r,h=m>=0?r.slice(m+1):void 0,g=o.directives[u];if(!g)return;const T=a.value;n.removeAttribute(a.name);const j=typeof g=="function"?{onMount:g}:g,F={value:T?U(T,t):void 0,arg:h,modifiers:Object.fromEntries(f.map(D=>[D,!0]))};(W=j.onMount)==null||W.call(j,n,F),j.onUpdate&&T&&J(T,o,()=>{F.value=U(T,t),j.onUpdate(n,F)}),j.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>j.onDestroy(n,F)))}),v==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=U(u.value,t))});const f=await l(r),m=document.createDocumentFragment();f.forEach(u=>m.appendChild(u)),n.replaceWith(m)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await te(r,t,o),n.replaceWith(r)}i++;continue}if(v==="cv-transition"){Ye();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await te(r,t,o),l){let f=!!U(l,t),m=!1,u=null;f||(r.style.display="none");const h=async g=>{if(m){u=g;return}m=!0;try{g?(r.style.display="",r.classList.add(`${a}-enter`),await ce(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ce(r),r.classList.remove(`${a}-leave`),r.style.display="none"),f=g}finally{if(m=!1,u!==null&&u!==f){const T=u;u=null,h(T)}else u=null}};J(l,o,()=>{const g=!!U(l,t);g!==f&&h(g)})}i++;continue}if(v==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),i++;continue}if(v==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(U(a,t)??"/"):l||"/",f=D=>String(D).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let m="";Array.from(n.attributes).forEach(D=>{D.name==="to"||D.name===":to"||(m+=` ${D.name}="${f(D.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${m}></a>`;const h=u.firstElementChild;for(;n.firstChild;)h.appendChild(n.firstChild);const g=((O=o.router)==null?void 0:O.base)??"",T=D=>g?D===g?"/":D.startsWith(g+"/")?D.slice(g.length)||"/":D||"/":D||"/",j=()=>{var D;return((D=o.router)==null?void 0:D.mode)==="history"?T(window.location.pathname):window.location.hash.slice(1)||"/"},F=()=>{var q;const D=r(),G=j()===D;((q=o.router)==null?void 0:q.mode)==="history"?h.href=`${g}${D}`:h.href=`#${D}`,G?(h.setAttribute("aria-current","page"),h.classList.add("active")):(h.removeAttribute("aria-current"),h.classList.remove("active"))};((L=o.router)==null?void 0:L.mode)==="history"?(h.addEventListener("click",D=>{D.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",F)):window.addEventListener("hashchange",F),a&&J(a,o,F),F();const W=document.createDocumentFragment();W.appendChild(h),await te(W,t,o);const N=W.firstChild??h;n.replaceWith(N),i++;continue}if(v==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),i++;continue}if((E=o.components)!=null&&E[v]&&o.mountElement){await o.mountElement(n,v,t,o),i++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=U(a.value,t);let f,m=0,u="0px",h=l.has("once");if(typeof r=="function"?f=g=>r.call(t,g):r&&typeof r=="object"&&(typeof r.handler=="function"&&(f=g=>r.handler.call(t,g)),r.threshold!==void 0&&(m=r.threshold),r.margin&&(u=r.margin),r.once&&(h=!0)),f){const g=new IntersectionObserver(T=>{const j=T[0];f(j),h&&j.isIntersecting&&g.disconnect()},{threshold:m,rootMargin:u});g.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>g.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=U(a,t);let r,f="content-box";if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.box&&(f=l.box)),r){const m=new ResizeObserver(u=>{u[0]&&r(u[0])});m.observe(n,{box:f}),(d=o.registerCleanup)==null||d.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=U(a,t);let r,f=0;if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.throttle&&(f=l.throttle)),r){let m=0;const u=()=>{const h=Date.now();f>0&&h-m<f||(m=h,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(p=o.registerCleanup)==null||p.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):Ve(a,t,r))};document.addEventListener("click",l,!0),(x=o.registerCleanup)==null||x.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let f=[];const m=()=>{const u=U(a,t)??{},h=Object.keys(u);for(const g of f)g in u||(g==="class"?n.className=l:g==="style"?n.style.cssText=r:n.removeAttribute(g));for(const[g,T]of Object.entries(u))if(g==="class")n.className=[l,Le(T)].filter(Boolean).join(" ");else if(g==="style")Be(n,T,r);else if(T==null||T===!1)try{n.removeAttribute(g)}catch{}else try{n.setAttribute(g,T===!0?"":String(T))}catch(j){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${g}":`,j)}f=h};J(a,o,m),m()}const P={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],f=new Set(l.slice(1)),m=[...f].find(T=>T in P),u=a.value,h=T=>{f.has("prevent")&&T.preventDefault(),f.has("stop")&&T.stopPropagation(),!(f.has("self")&&T.target!==T.currentTarget)&&(m&&T.key!==P[m]||(typeof t[u]=="function"?t[u].call(t,T):Ve(u,t,T)))},g={};f.has("once")&&(g.once=!0),f.has("passive")&&(g.passive=!0),f.has("capture")&&(g.capture=!0),n.addEventListener(r,h,Object.keys(g).length?g:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const f=n.getAttribute("class")??"",m=()=>{n.className=[f,Le(U(r,t))].filter(Boolean).join(" ")};J(r,o,m),m()}else if(l==="style"){const f=n.getAttribute("style")??"",m=()=>Be(n,U(r,t),f);J(r,o,m),m()}else if(l.includes("-")){const f=()=>{const m=U(r,t);m==null||m===!1?n.removeAttribute(l):n.setAttribute(l,m===!0?"":String(m))};J(r,o,f),f()}else{const f=()=>{n[l]=U(r,t)??""};J(r,o,f),f()}}}),k.hasChildNodes()&&await te(k,t,o),i++}}var Tt=`
...
`;function _t(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=Tt,document.head.appendChild(e)}async function ye(e,t,o){e.classList.add(`${t}-${o}`);const s=getComputedStyle(e),i=Math.max(parseFloat(s.animationDuration)||0,parseFloat(s.transitionDuration)||0)*1e3;i>0&&await new Promise(y=>{const S=()=>y();e.addEventListener("animationend",S,{once:!0}),e.addEventListener("transitionend",S,{once:!0}),setTimeout(S,i+50)}),e.classList.remove(`${t}-${o}`)}var Se=new Map;async function $t(e){if(typeof e!="function")return e;if(Se.has(e))return Se.get(e);const t=await e();return Se.set(e,t.default),t.default}function Je(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ze(e,t){if(e==="*")return{};const o=[],s=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),i=t.match(new RegExp(`^${s}$`));return i?Object.fromEntries(o.map((y,S)=>[y,i[S+1]])):null}function Ot(e,t){if(e==="/")return{params:{},remaining:t};const o=[],s=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),i=t.match(new RegExp(`^${s}(/.+)?$`));return i?{params:Object.fromEntries(o.map((y,S)=>[y,i[S+1]])),remaining:i[o.length+1]||"/"}:null}function ft(e,t=""){return e.map(o=>{var i;if(o.path==="*")return o;const s=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(i=o.children)!=null&&i.length?{...o,path:s,children:ft(o.children,s==="/"?"":s)}:{...o,path:s}})}var fe=(e,t)=>new Promise(o=>e(t,o)),Ke=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function jt(e,t={}){const o=t.mode??"hash",s=Ft(t.base??"");return{routes:ft(e),mode:o,base:s,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(i,y){const S=Qe(i,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${s}${S}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=S},replace(i,y){const S=Qe(i,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${s}${S}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const w=window.location.href.split("#")[0];window.location.replace(`${w}#${S}`)}},back(){history.back()},forward(){history.forward()}}}function Ft(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function Pt(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Qe(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function et(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((s,i)=>{o[i]=s}),o}function tt(e,t,o,s="default",i){const y=t.base??"",S=p=>p.length>1&&p.endsWith("/")?p.slice(0,-1):p,w=()=>t.mode==="history"?S(Pt(window.location.pathname,y)):S((window.location.hash.slice(1)||"/").split("?")[0]||"/"),R=()=>{if(t.mode==="history")return et(window.location.search);const p=window.location.hash.slice(1)||"/",x=p.indexOf("?");return x>=0?et(p.slice(x+1)):{}};t.transition&&_t();let $=null,C=null,M=null,_=null,I=!1;const z=()=>{I||(I=!0,i==null||i())},O=new Map,L=p=>{var x;if(p!=null&&p.keepAlive&&M){(x=M.deactivate)==null||x.call(M);const k=document.createDocumentFragment();for(;e.firstChild;)k.appendChild(e.firstChild);O.set($.path,{fragment:k,activation:M}),M=null}else M==null||M.destroy(),M=null,e.innerHTML=""},E=async(p,x,k,n,v)=>{const b=typeof x=="function"&&!Se.has(x),A=b?x.__asyncOptions:void 0,P=p.loadingTemplate??(A==null?void 0:A.loadingTemplate);b&&P&&(e.innerHTML=P);let a;try{a=await $t(x)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return b&&P&&(e.innerHTML=""),o(e,a,k,n,v)},c=async()=>{var k,n,v,b,A,P,a,l;const p=w(),x=R();for(const r of t.routes){if((k=r.children)!=null&&k.length){const m=Ot(r.path,p);if(m!==null)for(const u of r.children){const h=Ze(u.path,p);if(h!==null){const g={params:m.params,query:x,path:p,meta:r.meta};if(u.redirect){const W={params:h,query:x,path:p,meta:u.meta},N=typeof u.redirect=="function"?u.redirect(W):u.redirect;t.navigate(N);return}if(t.beforeEach){const W=await fe(t.beforeEach,g);if(W){t.navigate(W);return}}if(r.beforeEnter){const W=await fe(r.beforeEnter,g);if(W){t.navigate(W);return}}if(u.beforeEnter){const W={params:h,query:x,path:p,meta:u.meta},N=await fe(u.beforeEnter,W);if(N){t.navigate(N);return}}const T=`${r.path}::${JSON.stringify(m.params)}`;if(_!==T){const W=await Ke(M,g);if(W){t.navigate(W);return}const N=r.transition??t.transition;N&&e.hasChildNodes()&&await ye(e,N,"leave"),L(C);const D=Je(r,s);if(D){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(q,H)=>t.navigate(q,H),replace:(q,H)=>t.replace(q,H),back:()=>t.back(),forward:()=>t.forward()};M=await E(r,D,g,s==="default"?r.layout:void 0,s==="default"?G:void 0),(n=M.enter)==null||n.call(M,$)}else e.innerHTML="";_=T,N&&await ye(e,N,"enter")}const j={params:{...m.params,...h},query:x,path:p,meta:u.meta??r.meta};(v=t.afterEach)==null||v.call(t,j,$);const F=(b=t.scrollBehavior)==null?void 0:b.call(t,j,$);F&&window.scrollTo(F.x??0,F.y??0),$=j,C=r,z();return}}}const f=Ze(r.path,p);if(f!==null){_=null;const m={params:f,query:x,path:p,meta:r.meta};if(r.redirect){const j=typeof r.redirect=="function"?r.redirect(m):r.redirect;t.navigate(j);return}if(t.beforeEach){const j=await fe(t.beforeEach,m);if(j){t.navigate(j);return}}if(r.beforeEnter){const j=await fe(r.beforeEnter,m);if(j){t.navigate(j);return}}const u=await Ke(M,m);if(u){t.navigate(u);return}const h=r.transition??t.transition;h&&e.hasChildNodes()&&await ye(e,h,"leave"),L(C);const g=Je(r,s);if(g){const j=m.path;if(r.keepAlive&&O.has(j)){const F=O.get(j);e.appendChild(F.fragment),M=F.activation,(A=M.activate)==null||A.call(M),O.delete(j)}else{const F=$;M=await E(r,g,m,s==="default"?r.layout:void 0),(P=M.enter)==null||P.call(M,F)}}else e.innerHTML="",M=null;h&&await ye(e,h,"enter"),(a=t.afterEach)==null||a.call(t,m,$);const T=(l=t.scrollBehavior)==null?void 0:l.call(t,m,$);T&&window.scrollTo(T.x??0,T.y??0),$=m,C=r,z();return}}_=null,L(C),C=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),M==null||M.destroy(),M=null,O.forEach(({activation:p})=>p.destroy()),O.clear()}}function Dt(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,s){return e.has(o)||e.set(o,new Set),e.get(o).add(s),()=>{var i;return(i=e.get(o))==null?void 0:i.delete(s)}},_emit(o,s){var i;(i=e.get(o))==null||i.forEach(y=>{try{y(s)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const s=this.instances.findIndex(i=>i.id===o);if(s!==-1){const i=this.instances[s];this.instances.splice(s,1),this._emit("destroy",i)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Mt=0;function It(){return++Mt}var Lt=`
...
`;function Rt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Lt,document.head.appendChild(e)}function we(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function ot(e){try{return JSON.parse(e)}catch{return e}}function zt(e){if(typeof document>"u")return;Rt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,s="components",i=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(y);const S=document.createElement("div");S.id="cvd-panel",S.style.display="none",t.appendChild(S),S.innerHTML=`
        <div id="cvd-head">
        ...
        <div id="cvd-body"></div>
    `;const w=S.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",S.style.display="flex",M()}),S.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,S.style.display="none",y.style.display=""}),S.querySelectorAll(".cvd-tab").forEach(_=>{_.addEventListener("click",()=>{s=_.dataset.tab,S.querySelectorAll(".cvd-tab").forEach(I=>I.classList.remove("active")),_.classList.add("active"),M()})});const R=S.querySelector("#cvd-head");R.addEventListener("pointerdown",_=>{if(_.target.closest("button"))return;R.setPointerCapture(_.pointerId);const I=_.clientX,z=_.clientY,O=t.offsetLeft,L=t.offsetTop,E=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${O+(d.clientX-I)}px`,t.style.top=`${L+(d.clientY-z)}px`},c=d=>{R.releasePointerCapture(d.pointerId),R.removeEventListener("pointermove",E),R.removeEventListener("pointerup",c),R.removeEventListener("pointercancel",c)};R.addEventListener("pointermove",E),R.addEventListener("pointerup",c),R.addEventListener("pointercancel",c)});function $(){const _=e.instances;if(!_.length){w.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}w.innerHTML=_.map(I=>{const z=I.getState(),O=Object.keys(z);return`
                <div class="cvd-inst${i.has(I.id)?" open":""}" data-id="${I.id}">
                    ...
                    <div class="cvd-kv">
                        ${O.length?O.map(L=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-inst="${I.id}" data-key="${L}" title="click to edit">${we(z[L])}</span>
                            </div>
                        `).join(""):'<span style="color:#555">— sin datos reactivos —</span>'}
                    </div>
                </div>
            `}).join(""),w.querySelectorAll(".cvd-inst-head").forEach(I=>{I.addEventListener("click",()=>{const z=I.closest(".cvd-inst"),O=parseInt(z.dataset.id);i.has(O)?i.delete(O):i.add(O),z.classList.toggle("open")})}),w.querySelectorAll(".cvd-val").forEach(I=>{I.addEventListener("click",z=>{z.stopPropagation();const O=I;if(O.querySelector("input"))return;const L=parseInt(O.dataset.inst),E=O.dataset.key,c=e.instances.find(k=>k.id===L);if(!c)return;const d=we(c.getState()[E]);O.classList.add("editing"),O.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const p=O.querySelector("input");p.focus(),p.select();const x=()=>{c.setState(E,ot(p.value)),O.classList.remove("editing")};p.addEventListener("blur",x),p.addEventListener("keydown",k=>{k.key==="Enter"&&(k.preventDefault(),x()),k.key==="Escape"&&(O.classList.remove("editing"),M())})})})}function C(){if(!e.stores.length){w.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}w.innerHTML=e.stores.map((_,I)=>{const z=_.getState(),O=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${O.map(L=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${I}" data-key="${L}" title="click to edit">${we(z[L])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),w.querySelectorAll(".cvd-inst-head").forEach(_=>{_.addEventListener("click",()=>_.closest(".cvd-inst").classList.toggle("open"))}),w.querySelectorAll("[data-store][data-key]").forEach(_=>{_.addEventListener("click",I=>{I.stopPropagation();const z=_;if(z.querySelector("input"))return;const O=parseInt(z.dataset.store),L=z.dataset.key,E=e.stores[O];if(!E)return;const c=we(E.getState()[L]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const p=()=>{E.setState(L,ot(d.value)),z.classList.remove("editing")};d.addEventListener("blur",p),d.addEventListener("keydown",x=>{x.key==="Enter"&&(x.preventDefault(),p()),x.key==="Escape"&&(z.classList.remove("editing"),M())})})})}function M(){o&&(s==="components"?$():C())}e.on("mount",()=>M()),e.on("update",()=>M()),e.on("destroy",()=>M()),e.on("store-update",()=>M())}var Ht="__COURVUX_HEAD_COLLECTOR__";function Nt(){return globalThis[Ht]??null}var Wt=(e,t)=>{Object.entries(t).forEach(([o,s])=>{o!=="innerHTML"&&(s==null||s===!1||e.setAttribute(o,s===!0?"":String(s)))})},Ut=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},qt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,s])=>e.setAttribute(o,s))},nt=(e,t,o,s)=>{let i=o?document.head.querySelector(o):null;i?(s.push({el:i,prevAttrs:Ut(i),created:!1}),Array.from(i.attributes).forEach(y=>i.removeAttribute(y.name))):(i=document.createElement(e),document.head.appendChild(i),s.push({el:i,created:!0})),Wt(i,t)};function Bt(e){var S,w,R;const t=Nt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let s;const i={},y={};if(e.title!==void 0){s=document.title;const $=e.titleTemplate,C=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=C}return(S=e.meta)==null||S.forEach($=>{nt("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(w=e.link)==null||w.forEach($=>{nt("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(R=e.script)==null||R.forEach($=>{const C=document.createElement("script");Object.entries($).forEach(([M,_])=>{M==="innerHTML"?C.textContent=String(_):_!=null&&_!==!1&&C.setAttribute(M,_===!0?"":String(_))}),document.head.appendChild(C),o.push({el:C,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,C])=>{i[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,C)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,C])=>{y[$]=document.body.getAttribute($),document.body.setAttribute($,C)}),function(){s!==void 0&&(document.title=s),o.forEach(({el:$,prevAttrs:C,created:M})=>{var _;M?(_=$.parentNode)==null||_.removeChild($):C&&qt($,C)}),Object.entries(i).forEach(([$,C])=>{C===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,C)}),Object.entries(y).forEach(([$,C])=>{C===null?document.body.removeAttribute($):document.body.setAttribute($,C)})}}var Fe="data-courvux-ssr",Vt=e=>e?Promise.resolve().then(e):Promise.resolve();function rt(e,t){const o=e.trim();if(o.startsWith("{")){const s=o.replace(/[{}]/g,"").split(",").map(i=>i.trim()).filter(Boolean);return Object.fromEntries(s.map(i=>[i,t[i]]))}return{[o]:t}}var xe=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var x,k,n;const s={},{subscribe:i,createReactiveState:y,registerSetInterceptor:S,notifyAll:w}=Ie();let R;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),R=await t.data()):R=t.data??{},t.templateUrl){const v=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,b=await fetch(v);if(!b.ok)throw new Error(`Failed to load template: ${v} (${b.status})`);e.innerHTML=await b.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Fe),(x=e.querySelector(`[${Fe}]`))==null||x.removeAttribute(Fe);const $={};if(t.inject&&o.provided){const v=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(b=>[b,b])):t.inject;Object.entries(v).forEach(([b,A])=>{o.provided&&A in o.provided&&($[b]=o.provided[A])})}const C=y({...o.globalProperties??{},...R,...$,...t.methods,$refs:s,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(v=>[v,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});C.$watch=(v,b,A)=>{const P=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=P?xe(C[v]):C[v];const r=i(v,()=>{const f=C[v];b.call(C,f,l),l=P?xe(f):f});return a&&b.call(C,C[v],void 0),r},C.$batch=St,C.$nextTick=v=>Vt(v),C.$dispatch=(v,b,A)=>{e.dispatchEvent(new CustomEvent(v,{bubbles:!0,composed:!0,...A??{},detail:b}))},o.magics&&Object.entries(o.magics).forEach(([v,b])=>{C[v]=b(C)}),C.$forceUpdate=()=>w();const M=[];C.$watchEffect=v=>{let b=[];const A=()=>{b.forEach(r=>r()),b=[];const a=He(()=>{try{v()}catch{}}),l=new Map;for(const{sub:r,key:f}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(f)&&(l.get(r).add(f),b.push(r(f,A)))};A();const P=()=>{b.forEach(l=>l()),b=[];const a=M.indexOf(P);a>-1&&M.splice(a,1)};return M.push(P),P};const _=[];t.computed&&Object.entries(t.computed).forEach(([v,b])=>{const A=typeof b=="function"?b:b.get,P=typeof b!="function"?b.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const f=He(()=>{try{r=A.call(C)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});C[v]=r;const m=new Map;for(const{sub:u,key:h}of f)m.has(u)||m.set(u,new Set),!m.get(u).has(h)&&(m.get(u).add(h),a.push(u(h,l)))};l(),_.push(()=>a.forEach(r=>r())),P&&S(v,r=>P.call(C,r))});const I=[];t.watch&&Object.entries(t.watch).forEach(([v,b])=>{const A=typeof b=="object"&&b!==null&&"handler"in b,P=A?b.handler:b,a=A?b.immediate??!1:!1,l=A?b.deep??!1:!1;let r=l?xe(C[v]):C[v];const f=i(v,()=>{const m=C[v];P.call(C,m,r),r=l?xe(m):m});I.push(f),a&&P.call(C,C[v],void 0)});const z={...o.provided??{}};if(t.provide){const v=typeof t.provide=="function"?t.provide.call(C):t.provide;Object.assign(z,v)}const O={...o,provided:z,components:{...o.components,...t.components}};O.mountElement=Ce(O),O.createChildScope=(v,b)=>{const A=new Set(Object.keys(v)),P=new Set(Object.keys(b)),{subscribe:a,createReactiveState:l}=Ie(),r=l(v);let f;return f=new Proxy({},{get(m,u){return typeof u!="string"?C[u]:A.has(u)?r[u]:P.has(u)?b[u].bind(f):C[u]},set(m,u,h){return typeof u!="string"?!1:A.has(u)?(r[u]=h,!0):(C[u]=h,!0)},has(m,u){return A.has(u)||P.has(u)||u in C},ownKeys(){return[...A,...P,...Object.keys(C)]},getOwnPropertyDescriptor(m,u){return A.has(u)||P.has(u)||u in C?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:f,subscribe:(m,u)=>A.has(m)?a(m,u):c(m,u),cleanup:()=>{}}},O.mountDynamic=async(v,b,A,P,a)=>{let l=null,r=null;const f=A.getAttribute("loading-template")??"",m=async()=>{var D,G,q;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=U(b,P);if(!u)return;let h;if(typeof u=="function"){if(f){const H=document.createElement("div");H.innerHTML=f,(D=v.parentNode)==null||D.insertBefore(H,v.nextSibling),l=H}h=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?h=(G=O.components)==null?void 0:G[u]:u&&typeof u=="object"&&(h=u);if(!h)return;const g=document.createElement("div"),T=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{T(H.name)||g.setAttribute(H.name,H.value)}),g.innerHTML=A.innerHTML;const j={},F={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))j[H.name.slice(1)]=U(H.value,P);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);F[V]=(...B)=>{typeof P[K]=="function"&&P[K].call(P,...B)}}});const W={...h,data:{...h.data,...j},methods:{...h.methods,$emit(H,...K){var V;gt(h,H,K),(V=F[H])==null||V.call(F,...K)}}},N={...O,components:{...O.components,...h.components}};N.mountElement=Ce(N),r=(await ne(g,W,N)).destroy,(q=v.parentNode)==null||q.insertBefore(g,v.nextSibling),l=g};J(b,a,m),await m()};const L=[];C.$addCleanup=v=>{L.push(v)};let E=!1;const c=(v,b)=>!t.onBeforeUpdate&&!t.onUpdated?i(v,b):i(v,()=>{var A;E||(E=!0,(A=t.onBeforeUpdate)==null||A.call(C),Promise.resolve().then(()=>{var P;E=!1,(P=t.onUpdated)==null||P.call(C)})),b()});try{(k=t.onBeforeMount)==null||k.call(C),await te(e,C,{subscribe:c,refs:s,...O,registerCleanup:v=>L.push(v)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(C)}catch(v){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(C,v);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(v,C,t.name??e.tagName.toLowerCase());else throw v}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,p=d?It():0;if(d){const v=C,b=new Set,A={id:p,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const P={};for(const a of Object.keys(v))if(!(a.startsWith("$")||typeof v[a]=="function"))try{P[a]=v[a]}catch{}return P},setState:(P,a)=>{v[P]=a},subscribe:P=>(b.add(P),()=>b.delete(P)),children:[]};Object.keys(v).filter(P=>!P.startsWith("$")&&typeof v[P]!="function").forEach(P=>{i(P,()=>{d._emit("update",A),b.forEach(a=>a())})}),d._registerInstance(A),L.push(()=>d._unregisterInstance(p))}return{state:C,destroy:()=>{var v,b;(v=t.onBeforeUnmount)==null||v.call(C),_.forEach(A=>A()),I.forEach(A=>A()),M.forEach(A=>A()),L.forEach(A=>A()),(b=t.onDestroy)==null||b.call(C)},activate:()=>{var v;(v=t.onActivated)==null||v.call(C)},deactivate:()=>{var v;(v=t.onDeactivated)==null||v.call(C)},beforeLeave:t.onBeforeRouteLeave?(v,b)=>t.onBeforeRouteLeave.call(C,v,b):void 0,enter:t.onBeforeRouteEnter?v=>t.onBeforeRouteEnter.call(C,v):void 0}}function gt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const s=e.emits[t];typeof s=="function"&&!s(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ce(e){return async(t,o,s,i)=>{const y=e.components[o],S=t.getAttribute("cv-ref");S&&t.removeAttribute("cv-ref");const w={},R=[],$={};Array.from(t.attributes).filter(E=>E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:")).forEach(E=>{t.removeAttribute(E.name);const c=E.value,d=E.name.indexOf(":"),p=d>=0?E.name.slice(d+1).split(".")[0]:"modelValue",x=p==="modelValue"?"update:modelValue":`update:${p}`;w[p]=Oe(U(c,s)),R.push({propName:p,expr:c}),$[x]=k=>{pe(c,s,k)}});const C={};Array.from(t.attributes).forEach(E=>{const c=E.name.startsWith(":"),d=E.name.startsWith("@")||E.name.startsWith("cv:on:"),p=E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:"),x=E.name.startsWith("v-slot"),k=E.name==="slot";!c&&!d&&!p&&!x&&!k&&(C[E.name]=E.value)}),y.inheritAttrs===!1&&Object.keys(C).forEach(E=>t.removeAttribute(E)),Array.from(t.attributes).forEach(E=>{if(E.name.startsWith(":")){const c=E.name.slice(1),d=E.value;w[c]=Oe(U(d,s)),R.push({propName:c,expr:d})}else if(E.name.startsWith("@")||E.name.startsWith("cv:on:")){const c=E.name.startsWith("@")?E.name.slice(1):E.name.slice(6),d=E.value;$[c]=(...p)=>{typeof s[d]=="function"&&s[d].call(s,...p)}}});const M=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");M&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const _=new Map,I=[];Array.from(t.childNodes).forEach(E=>{const c=E.nodeType===1?E.getAttribute("slot"):null;if(c){if(!_.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),_.set(c,{nodes:[],vSlot:d})}_.get(c).nodes.push(E.cloneNode(!0))}else I.push(E.cloneNode(!0))});const z={};I.some(E=>{var c;return E.nodeType===1||E.nodeType===3&&(((c=E.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async E=>{const c=M?{...s,...rt(M,E)}:s,d=document.createDocumentFragment();return I.forEach(p=>d.appendChild(p.cloneNode(!0))),await te(d,c,i),Array.from(d.childNodes)});for(const[E,{nodes:c,vSlot:d}]of _)z[E]=async p=>{const x=d?{...s,...rt(d,p)}:s,k=document.createDocumentFragment();return c.forEach(n=>k.appendChild(n.cloneNode(!0))),await te(k,x,i),Array.from(k.childNodes)};const O={...e,components:{...e.components,...y.components},slots:z};O.mountElement=Ce(O);const{state:L}=await ne(t,{...y,data:{...y.data,...w,$attrs:C,$parent:s},methods:{...y.methods,$emit(E,...c){var d;gt(y,E,c),(d=$[E])==null||d.call($,...c)}}},O);L&&(R.forEach(({propName:E,expr:c})=>{ht(c,{...i,subscribe:i.subscribe},()=>{L[E]=Oe(U(c,s))})}),S&&i.refs&&(i.refs[S]=L))}}function Gt(e){Ct();const t=typeof window<"u"?Dt():void 0,o=[],s={...e.directives},i={...e.components??{}},y=[],S=new Map,w={},R=new Map;if(e.debug&&t&&zt(t),t&&e.store){const _=e.store,I=Object.keys(_).filter(z=>typeof _[z]!="function");t._registerStore({getState(){const z={};return I.forEach(O=>{try{z[O]=_[O]}catch{}}),z},setState(z,O){_[z]=O},subscribe(z){const O=I.map(L=>{try{return be(_,L,z)}catch{return()=>{}}});return()=>O.forEach(L=>L())}})}const $={router:e.router,use(_){return o.includes(_)||(o.push(_),_.install($)),$},directive(_,I){return s[_]=I,$},component(_,I){return i[_]=I,$},provide(_,I){return typeof _=="string"?w[_]=I:Object.assign(w,_),$},magic(_,I){return R.set(`$${_}`,I),$},mount:async _=>(await M(_),$),mountAll:async(_="[data-courvux]")=>{const I=Array.from(document.querySelectorAll(_));return await Promise.all(I.map(z=>C(z))),$},mountEl:async _=>C(_),unmount(_){if(!_)y.forEach(I=>I()),y.length=0,S.clear();else{const I=document.querySelector(_);if(I){const z=S.get(I);if(z){z(),S.delete(I);const O=y.indexOf(z);O>-1&&y.splice(O,1)}}}return $},destroy(){y.forEach(_=>_()),y.length=0,S.clear()}},C=async _=>{const I=new URL(".",document.baseURI).href,z={components:i,router:e.router,store:e.store,directives:s,baseUrl:I,provided:{...w},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:R.size?Object.fromEntries(R):void 0};if(z.mountElement=Ce(z),e.router){const L=e.router;z.mountRouterView=async(E,c)=>{await new Promise(d=>{tt(E,L,async(p,x,k,n,v)=>{const b={...z,currentRoute:k};if(v){let A=null;const P={...b,mountRouterView:async(a,l)=>{A=tt(a,v,async(r,f,m,u)=>{const h={...b,currentRoute:m};if(u){let g=null;const T={...h,mountRouterView:async(F,W)=>{g=await ne(F,f,h)}},{destroy:j}=await ne(r,{template:u},T);return{destroy:()=>{g==null||g.destroy(),j()},activate:()=>g==null?void 0:g.activate(),deactivate:()=>g==null?void 0:g.deactivate()}}else return await ne(r,f,h)},l)}};if(n){let a=null;const l={...P,mountRouterView:async(f,m)=>{a=await ne(f,x,P)}},{destroy:r}=await ne(p,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(p,x,P);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const P={...b,mountRouterView:async(l,r)=>{A=await ne(l,x,b)}},{destroy:a}=await ne(p,{template:n},P);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(p,x,b)},c,d)})}}const O=await ne(_,e,z);return y.push(O.destroy),S.set(_,O.destroy),O.state},M=async _=>{const I=document.querySelector(_);if(I)return C(I)};return $}var at=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Yt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Pe={exports:{}},it;function Xt(){return it||(it=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
 ...
 * @namespace
 * @public
 */var o=(function(s){var i=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,y=0,S={},w={manual:s.Prism&&s.Prism.manual,disableWorkerMessageHandler:s.Prism&&s.Prism.disableWorkerMessageHandler,util:{encode:function c(d){return d instanceof R?new R(d.type,c(d.content),d.alias):Array.isArray(d)?d.map(c):d.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(c){return Object.prototype.toString.call(c).slice(8,-1)},objId:function(c){return c.__id||Object.defineProperty(c,"__id",{value:++y}),c.__id},clone:function c(d,p){p=p||{};var x,k;switch(w.util.type(d)){case"Object":if(k=w.util.objId(d),p[k])return p[k];x={},p[k]=x;for(var n in d)d.hasOwnProperty(n)&&(x[n]=c(d[n],p));return x;case"Array":return k=w.util.objId(d),p[k]?p[k]:(x=[],p[k]=x,d.forEach(function(v,b){x[b]=c(v,p)}),x);default:return d}},getLanguage:function(c){for(;c;){var d=i.exec(c.className);if(d)return d[1].toLowerCase();c=c.parentElement}return"none"},setLanguage:function(c,d){c.className=c.className.replace(RegExp(i,"gi"),""),c.classList.add("language-"+d)},currentScript:function(){if(typeof document>"u")return null;if(document.currentScript&&document.currentScript.tagName==="SCRIPT")return document.currentScript;try{throw new Error}catch(x){var c=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(x.stack)||[])[1];if(c){var d=document.getElementsByTagName("script");for(var p in d)if(d[p].src==c)return d[p]}return null}},isActive:function(c,d,p){for(var x="no-"+d;c;){var k=c.classList;if(k.contains(d))return!0;if(k.contains(x))return!1;c=c.parentElement}return!!p}},languages:{plain:S,plaintext:S,text:S,txt:S,extend:function(c,d){var p=w.util.clone(w.languages[c]);for(var x in d)p[x]=d[x];return p},insertBefore:function(c,d,p,x){x=x||w.languages;var k=x[c],n={};for(var v in k)if(k.hasOwnProperty(v)){if(v==d)for(var b in p)p.hasOwnProperty(b)&&(n[b]=p[b]);p.hasOwnProperty(v)||(n[v]=k[v])}var A=x[c];return x[c]=n,w.languages.DFS(w.languages,function(P,a){a===A&&P!=c&&(this[P]=n)}),n},DFS:function c(d,p,x,k){k=k||{};var n=w.util.objId;for(var v in d)if(d.hasOwnProperty(v)){p.call(d,v,d[v],x||v);var b=d[v],A=w.util.type(b);A==="Object"&&!k[n(b)]?(k[n(b)]=!0,c(b,p,null,k)):A==="Array"&&!k[n(b)]&&(k[n(b)]=!0,c(b,p,v,k))}}},plugins:{},highlightAll:function(c,d){w.highlightAllUnder(document,c,d)},highlightAllUnder:function(c,d,p){var x={callback:p,container:c,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};w.hooks.run("before-highlightall",x),x.elements=Array.prototype.slice.apply(x.container.querySelectorAll(x.selector)),w.hooks.run("before-all-elements-highlight",x);for(var k=0,n;n=x.elements[k++];)w.highlightElement(n,d===!0,x.callback)},highlightElement:function(c,d,p){var x=w.util.getLanguage(c),k=w.languages[x];w.util.setLanguage(c,x);var n=c.parentElement;n&&n.nodeName.toLowerCase()==="pre"&&w.util.setLanguage(n,x);var v=c.textContent,b={element:c,language:x,grammar:k,code:v};function A(a){b.highlightedCode=a,w.hooks.run("before-insert",b),b.element.innerHTML=b.highlightedCode,w.hooks.run("after-highlight",b),w.hooks.run("complete",b),p&&p.call(b.element)}if(w.hooks.run("before-sanity-check",b),n=b.element.parentElement,n&&n.nodeName.toLowerCase()==="pre"&&!n.hasAttribute("tabindex")&&n.setAttribute("tabindex","0"),!b.code){w.hooks.run("complete",b),p&&p.call(b.element);return}if(w.hooks.run("before-highlight",b),!b.grammar){A(w.util.encode(b.code));return}if(d&&s.Worker){var P=new Worker(w.filename);P.onmessage=function(a){A(a.data)},P.postMessage(JSON.stringify({language:b.language,code:b.code,immediateClose:!0}))}else A(w.highlight(b.code,b.grammar,b.language))},highlight:function(c,d,p){var x={code:c,grammar:d,language:p};if(w.hooks.run("before-tokenize",x),!x.grammar)throw new Error('The language "'+x.language+'" has no grammar.');return x.tokens=w.tokenize(x.code,x.grammar),w.hooks.run("after-tokenize",x),R.stringify(w.util.encode(x.tokens),x.language)},tokenize:function(c,d){var p=d.rest;if(p){for(var x in p)d[x]=p[x];delete d.rest}var k=new M;return _(k,k.head,c),C(c,k,d,k.head,0),z(k)},hooks:{all:{},add:function(c,d){var p=w.hooks.all;p[c]=p[c]||[],p[c].push(d)},run:function(c,d){var p=w.hooks.all[c];if(!(!p||!p.length))for(var x=0,k;k=p[x++];)k(d)}},Token:R};s.Prism=w;function R(c,d,p,x){this.type=c,this.content=d,this.alias=p,this.length=(x||"").length|0}R.stringify=function c(d,p){if(typeof d=="string")return d;if(Array.isArray(d)){var x="";return d.forEach(function(A){x+=c(A,p)}),x}var k={type:d.type,content:c(d.content,p),tag:"span",classes:["token",d.type],attributes:{},language:p},n=d.alias;n&&(Array.isArray(n)?Array.prototype.push.apply(k.classes,n):k.classes.push(n)),w.hooks.run("wrap",k);var v="";for(var b in k.attributes)v+=" "+b+'="'+(k.attributes[b]||"").replace(/"/g,"&quot;")+'"';return"<"+k.tag+' class="'+k.classes.join(" ")+'"'+v+">"+k.content+"</"+k.tag+">"};function $(c,d,p,x){c.lastIndex=d;var k=c.exec(p);if(k&&x&&k[1]){var n=k[1].length;k.index+=n,k[0]=k[0].slice(n)}return k}function C(c,d,p,x,k,n){for(var v in p)if(!(!p.hasOwnProperty(v)||!p[v])){var b=p[v];b=Array.isArray(b)?b:[b];for(var A=0;A<b.length;++A){if(n&&n.cause==v+","+A)return;var P=b[A],a=P.inside,l=!!P.lookbehind,r=!!P.greedy,f=P.alias;if(r&&!P.pattern.global){var m=P.pattern.toString().match(/[imsuy]*$/)[0];P.pattern=RegExp(P.pattern.source,m+"g")}for(var u=P.pattern||P,h=x.next,g=k;h!==d.tail&&!(n&&g>=n.reach);g+=h.value.length,h=h.next){var T=h.value;if(d.length>c.length)return;if(!(T instanceof R)){var j=1,F;if(r){if(F=$(u,g,c,l),!F||F.index>=c.length)break;var G=F.index,W=F.index+F[0].length,N=g;for(N+=h.value.length;G>=N;)h=h.next,N+=h.value.length;if(N-=h.value.length,g=N,h.value instanceof R)continue;for(var D=h;D!==d.tail&&(N<W||typeof D.value=="string");D=D.next)j++,N+=D.value.length;j--,T=c.slice(g,N),F.index-=g}else if(F=$(u,0,T,l),!F)continue;var G=F.index,q=F[0],H=T.slice(0,G),K=T.slice(G+q.length),V=g+T.length;n&&V>n.reach&&(n.reach=V);var B=h.prev;H&&(B=_(d,B,H),g+=H.length),I(d,B,j);var de=new R(v,a?w.tokenize(q,a):q,f,q);if(h=_(d,B,de),K&&_(d,h,K),j>1){var Q={cause:v+","+A,reach:V};C(c,d,p,h.prev,g,Q),n&&Q.reach>n.reach&&(n.reach=Q.reach)}}}}}}function M(){var c={value:null,prev:null,next:null},d={value:null,prev:c,next:null};c.next=d,this.head=c,this.tail=d,this.length=0}function _(c,d,p){var x=d.next,k={value:p,prev:d,next:x};return d.next=k,x.prev=k,c.length++,k}function I(c,d,p){for(var x=d.next,k=0;k<p&&x!==c.tail;k++)x=x.next;d.next=x,x.prev=d,c.length-=k}function z(c){for(var d=[],p=c.head.next;p!==c.tail;)d.push(p.value),p=p.next;return d}if(!s.document)return s.addEventListener&&(w.disableWorkerMessageHandler||s.addEventListener("message",function(c){var d=JSON.parse(c.data),p=d.language,x=d.code,k=d.immediateClose;s.postMessage(w.highlight(x,w.languages[p],p)),k&&s.close()},!1)),w;var O=w.util.currentScript();O&&(w.filename=O.src,O.hasAttribute("data-manual")&&(w.manual=!0));function L(){w.manual||w.highlightAll()}if(!w.manual){var E=document.readyState;E==="loading"||E==="interactive"&&O&&O.defer?document.addEventListener("DOMContentLoaded",L):window.requestAnimationFrame?window.requestAnimationFrame(L):window.setTimeout(L,16)}return w})(t);e.exports&&(e.exports=o),typeof at<"u"&&(at.Prism=o),o.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},o.languages.markup.tag.inside["attr-value"].inside.entity=o.languages.markup.entity,o.languages.markup.doctype.inside["internal-subset"].inside=o.languages.markup,o.hooks.add("wrap",function(s){s.type==="entity"&&(s.attributes.title=s.content.replace(/&amp;/,"&"))}),Object.defineProperty(o.languages.markup.tag,"addInlined",{value:function(i,y){var S={};S["language-"+y]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:o.languages[y]},S.cdata=/^<!\[CDATA\[|\]\]>$/i;var w={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:S}};w["language-"+y]={pattern:/[\s\S]+/,inside:o.languages[y]};var R={};R[i]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return i}),"i"),lookbehind:!0,greedy:!0,inside:w},o.languages.insertBefore("markup","cdata",R)}}),Object.defineProperty(o.languages.markup.tag,"addAttribute",{value:function(s,i){o.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+s+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[i,"language-"+i],inside:o.languages[i]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),o.languages.html=o.languages.markup,o.languages.mathml=o.languages.markup,o.languages.svg=o.languages.markup,o.languages.xml=o.languages.extend("markup",{}),o.languages.ssml=o.languages.xml,o.languages.atom=o.languages.xml,o.languages.rss=o.languages.xml,(function(s){var i=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;s.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+i.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+i.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+i.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+i.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:i,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},s.languages.css.atrule.inside.rest=s.languages.css;var y=s.languages.markup;y&&(y.tag.addInlined("style","css"),y.tag.addAttribute("style","css"))})(o),o.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},o.languages.javascript=o.languages.extend("clike",{"class-name":[o.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),o.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,o.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:o.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:o.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:o.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:o.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:o.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),o.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:o.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),o.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),o.languages.markup&&(o.languages.markup.tag.addInlined("script","javascript"),o.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),o.languages.js=o.languages.javascript,(function(){if(typeof o>"u"||typeof document>"u")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var s="Loading…",i=function(O,L){return"✖ Error "+O+" while fetching file: "+L},y="✖ Error: File does not exist or is empty",S={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},w="data-src-status",R="loading",$="loaded",C="failed",M="pre[data-src]:not(["+w+'="'+$+'"]):not(['+w+'="'+R+'"])';function _(O,L,E){var c=new XMLHttpRequest;c.open("GET",O,!0),c.onreadystatechange=function(){c.readyState==4&&(c.status<400&&c.responseText?L(c.responseText):c.status>=400?E(i(c.status,c.statusText)):E(y))},c.send(null)}function I(O){var L=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(O||"");if(L){var E=Number(L[1]),c=L[2],d=L[3];return c?d?[E,Number(d)]:[E,void 0]:[E,E]}}o.hooks.add("before-highlightall",function(O){O.selector+=", "+M}),o.hooks.add("before-sanity-check",function(O){var L=O.element;if(L.matches(M)){O.code="",L.setAttribute(w,R);var E=L.appendChild(document.createElement("CODE"));E.textContent=s;var c=L.getAttribute("data-src"),d=O.language;if(d==="none"){var p=(/\.(\w+)$/.exec(c)||[,"none"])[1];d=S[p]||p}o.util.setLanguage(E,d),o.util.setLanguage(L,d);var x=o.plugins.autoloader;x&&x.loadLanguages(d),_(c,function(k){L.setAttribute(w,$);var n=I(L.getAttribute("data-range"));if(n){var v=k.split(/\r\n?|\n/g),b=n[0],A=n[1]==null?v.length:n[1];b<0&&(b+=v.length),b=Math.max(0,Math.min(b-1,v.length)),A<0&&(A+=v.length),A=Math.max(0,Math.min(A,v.length)),k=v.slice(b,A).join(`
`),L.hasAttribute("data-start")||L.setAttribute("data-start",String(b+1))}E.textContent=k,o.highlightElement(E)},function(k){L.setAttribute(w,C),E.textContent=k})}}),o.plugins.fileHighlight={highlight:function(L){for(var E=(L||document).querySelectorAll(M),c=0,d;d=E[c++];)o.highlightElement(d)}};var z=!1;o.fileHighlight=function(){z||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),z=!0),o.plugins.fileHighlight.highlight.apply(this,arguments)}})()})(Pe)),Pe.exports}var Jt=Xt();const Zt=Yt(Jt);Prism.languages.javascript=Prism.languages.extend("clike",{"class-name":[Prism.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/});Prism.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/;Prism.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:Prism.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:Prism.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/});Prism.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:Prism.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}});Prism.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}});Prism.languages.markup&&(Prism.languages.markup.tag.addInlined("script","javascript"),Prism.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript"));Prism.languages.js=Prism.languages.javascript;Prism.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]};Prism.languages.markup.tag.inside["attr-value"].inside.entity=Prism.languages.markup.entity;Prism.languages.markup.doctype.inside["internal-subset"].inside=Prism.languages.markup;Prism.hooks.add("wrap",function(e){e.type==="entity"&&(e.attributes.title=e.content.replace(/&amp;/,"&"))});Object.defineProperty(Prism.languages.markup.tag,"addInlined",{value:function(t,o){var s={};s["language-"+o]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:Prism.languages[o]},s.cdata=/^<!\[CDATA\[|\]\]>$/i;var i={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:s}};i["language-"+o]={pattern:/[\s\S]+/,inside:Prism.languages[o]};var y={};y[t]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return t}),"i"),lookbehind:!0,greedy:!0,inside:i},Prism.languages.insertBefore("markup","cdata",y)}});Object.defineProperty(Prism.languages.markup.tag,"addAttribute",{value:function(e,t){Prism.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+e+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[t,"language-"+t],inside:Prism.languages[t]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}});Prism.languages.html=Prism.languages.markup;Prism.languages.mathml=Prism.languages.markup;Prism.languages.svg=Prism.languages.markup;Prism.languages.xml=Prism.languages.extend("markup",{});Prism.languages.ssml=Prism.languages.xml;Prism.languages.atom=Prism.languages.xml;Prism.languages.rss=Prism.languages.xml;(function(e){var t="\\b(?:BASH|BASHOPTS|BASH_ALIASES|BASH_ARGC|BASH_ARGV|BASH_CMDS|BASH_COMPLETION_COMPAT_DIR|BASH_LINENO|BASH_REMATCH|BASH_SOURCE|BASH_VERSINFO|BASH_VERSION|COLORTERM|COLUMNS|COMP_WORDBREAKS|DBUS_SESSION_BUS_ADDRESS|DEFAULTS_PATH|DESKTOP_SESSION|DIRSTACK|DISPLAY|EUID|GDMSESSION|GDM_LANG|GNOME_KEYRING_CONTROL|GNOME_KEYRING_PID|GPG_AGENT_INFO|GROUPS|HISTCONTROL|HISTFILE|HISTFILESIZE|HISTSIZE|HOME|HOSTNAME|HOSTTYPE|IFS|INSTANCE|JOB|LANG|LANGUAGE|LC_ADDRESS|LC_ALL|LC_IDENTIFICATION|LC_MEASUREMENT|LC_MONETARY|LC_NAME|LC_NUMERIC|LC_PAPER|LC_TELEPHONE|LC_TIME|LESSCLOSE|LESSOPEN|LINES|LOGNAME|LS_COLORS|MACHTYPE|MAILCHECK|MANDATORY_PATH|NO_AT_BRIDGE|OLDPWD|OPTERR|OPTIND|ORBIT_SOCKETDIR|OSTYPE|PAPERSIZE|PATH|PIPESTATUS|PPID|PS1|PS2|PS3|PS4|PWD|RANDOM|REPLY|SECONDS|SELINUX_INIT|SESSION|SESSIONTYPE|SESSION_MANAGER|SHELL|SHELLOPTS|SHLVL|SSH_AUTH_SOCK|TERM|UID|UPSTART_EVENTS|UPSTART_INSTANCE|UPSTART_JOB|UPSTART_SESSION|USER|WINDOWID|XAUTHORITY|XDG_CONFIG_DIRS|XDG_CURRENT_DESKTOP|XDG_DATA_DIRS|XDG_GREETER_DATA_DIR|XDG_MENU_PREFIX|XDG_RUNTIME_DIR|XDG_SEAT|XDG_SEAT_PATH|XDG_SESSION_DESKTOP|XDG_SESSION_ID|XDG_SESSION_PATH|XDG_SESSION_TYPE|XDG_VTNR|XMODIFIERS)\\b",o={pattern:/(^(["']?)\w+\2)[ \t]+\S.*/,lookbehind:!0,alias:"punctuation",inside:null},s={bash:o,environment:{pattern:RegExp("\\$"+t),alias:"constant"},variable:[{pattern:/\$?\(\([\s\S]+?\)\)/,greedy:!0,inside:{variable:[{pattern:/(^\$\(\([\s\S]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b0x[\dA-Fa-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:[Ee]-?\d+)?/,operator:/--|\+\+|\*\*=?|<<=?|>>=?|&&|\|\||[=!+\-*/%<>^&|]=?|[?~:]/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/,greedy:!0,inside:{variable:/^\$\(|^`|\)$|`$/}},{pattern:/\$\{[^}]+\}/,greedy:!0,inside:{operator:/:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,punctuation:/[\[\]]/,environment:{pattern:RegExp("(\\{)"+t),lookbehind:!0,alias:"constant"}}},/\$(?:\w+|[#?*!@$])/],entity:/\\(?:[abceEfnrtv\\"]|O?[0-7]{1,3}|U[0-9a-fA-F]{8}|u[0-9a-fA-F]{4}|x[0-9a-fA-F]{1,2})/};e.languages.bash={shebang:{pattern:/^#!\s*\/.*/,alias:"important"},comment:{pattern:/(^|[^"{\\$])#.*/,lookbehind:!0},"function-name":[{pattern:/(\bfunction\s+)[\w-]+(?=(?:\s*\(?:\s*\))?\s*\{)/,lookbehind:!0,alias:"function"},{pattern:/\b[\w-]+(?=\s*\(\s*\)\s*\{)/,alias:"function"}],"for-or-select":{pattern:/(\b(?:for|select)\s+)\w+(?=\s+in\s)/,alias:"variable",lookbehind:!0},"assign-left":{pattern:/(^|[\s;|&]|[<>]\()\w+(?:\.\w+)*(?=\+?=)/,inside:{environment:{pattern:RegExp("(^|[\\s;|&]|[<>]\\()"+t),lookbehind:!0,alias:"constant"}},alias:"variable",lookbehind:!0},parameter:{pattern:/(^|\s)-{1,2}(?:\w+:[+-]?)?\w+(?:\.\w+)*(?=[=\s]|$)/,alias:"variable",lookbehind:!0},string:[{pattern:/((?:^|[^<])<<-?\s*)(\w+)\s[\s\S]*?(?:\r?\n|\r)\2/,lookbehind:!0,greedy:!0,inside:s},{pattern:/((?:^|[^<])<<-?\s*)(["'])(\w+)\2\s[\s\S]*?(?:\r?\n|\r)\3/,lookbehind:!0,greedy:!0,inside:{bash:o}},{pattern:/(^|[^\\](?:\\\\)*)"(?:\\[\s\S]|\$\([^)]+\)|\$(?!\()|`[^`]+`|[^"\\`$])*"/,lookbehind:!0,greedy:!0,inside:s},{pattern:/(^|[^$\\])'[^']*'/,lookbehind:!0,greedy:!0},{pattern:/\$'(?:[^'\\]|\\[\s\S])*'/,greedy:!0,inside:{entity:s.entity}}],environment:{pattern:RegExp("\\$?"+t),alias:"constant"},variable:s.variable,function:{pattern:/(^|[\s;|&]|[<>]\()(?:add|apropos|apt|apt-cache|apt-get|aptitude|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cargo|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|docker|docker-compose|du|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|java|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|node|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|podman|podman-compose|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|sysctl|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vcpkg|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|whereis|which|who|whoami|write|xargs|xdg-open|yarn|yes|zenity|zip|zsh|zypper)(?=$|[)\s;|&])/,lookbehind:!0},keyword:{pattern:/(^|[\s;|&]|[<>]\()(?:case|do|done|elif|else|esac|fi|for|function|if|in|select|then|until|while)(?=$|[)\s;|&])/,lookbehind:!0},builtin:{pattern:/(^|[\s;|&]|[<>]\()(?:\.|:|alias|bind|break|builtin|caller|cd|command|continue|declare|echo|enable|eval|exec|exit|export|getopts|hash|help|let|local|logout|mapfile|printf|pwd|read|readarray|readonly|return|set|shift|shopt|source|test|times|trap|type|typeset|ulimit|umask|unalias|unset)(?=$|[)\s;|&])/,lookbehind:!0,alias:"class-name"},boolean:{pattern:/(^|[\s;|&]|[<>]\()(?:false|true)(?=$|[)\s;|&])/,lookbehind:!0},"file-descriptor":{pattern:/\B&\d\b/,alias:"important"},operator:{pattern:/\d?<>|>\||\+=|=[=~]?|!=?|<<[<-]?|[&\d]?>>|\d[<>]&?|[<>][&=]?|&[>&]?|\|[&|]?/,inside:{"file-descriptor":{pattern:/^\d/,alias:"important"}}},punctuation:/\$?\(\(?|\)\)?|\.\.|[{}[\];\\]/,number:{pattern:/(^|\s)(?:[1-9]\d*|0)(?:[.,]\d+)?\b/,lookbehind:!0}},o.inside=e.languages.bash;for(var i=["comment","function-name","for-or-select","assign-left","parameter","string","environment","function","keyword","builtin","boolean","file-descriptor","operator","punctuation","number"],y=s.variable[1].inside,S=0;S<i.length;S++)y[i[S]]=e.languages.bash[i[S]];e.languages.sh=e.languages.bash,e.languages.shell=e.languages.bash})(Prism);Prism.languages.json={property:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?=\s*:)/,lookbehind:!0,greedy:!0},string:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?!\s*:)/,lookbehind:!0,greedy:!0},comment:{pattern:/\/\/.*|\/\*[\s\S]*?(?:\*\/|$)/,greedy:!0},number:/-?\b\d+(?:\.\d+)?(?:e[+-]?\d+)?\b/i,punctuation:/[{}[\],]/,operator:/:/,boolean:/\b(?:false|true)\b/,null:{pattern:/\bnull\b/,alias:"keyword"}};Prism.languages.webmanifest=Prism.languages.json;var st={},ct;function Kt(){return ct||(ct=1,(function(e){e.languages.typescript=e.languages.extend("javascript",{"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|type)\s+)(?!keyof\b)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?:\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/,lookbehind:!0,greedy:!0,inside:null},builtin:/\b(?:Array|Function|Promise|any|boolean|console|never|number|string|symbol|unknown)\b/}),e.languages.typescript.keyword.push(/\b(?:abstract|declare|is|keyof|readonly|require)\b/,/\b(?:asserts|infer|interface|module|namespace|type)\b(?=\s*(?:[{_$a-zA-Z\xA0-\uFFFF]|$))/,/\btype\b(?=\s*(?:[\{*]|$))/),delete e.languages.typescript.parameter,delete e.languages.typescript["literal-property"];var t=e.languages.extend("typescript",{});delete t["class-name"],e.languages.typescript["class-name"].inside=t,e.languages.insertBefore("typescript","function",{decorator:{pattern:/@[$\w\xA0-\uFFFF]+/,inside:{at:{pattern:/^@/,alias:"operator"},function:/^[\s\S]+/}},"generic-function":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>(?=\s*\()/,greedy:!0,inside:{function:/^#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*/,generic:{pattern:/<[\s\S]+/,alias:"class-name",inside:t}}}}),e.languages.ts=e.languages.typescript})(Prism)),st}Kt();const Qt={js:"JavaScript",ts:"TypeScript",html:"HTML",bash:"Shell",json:"JSON"};function eo(e){const t=e.split(`
`);for(;t.length&&!t[0].trim();)t.shift();for(;t.length&&!t[t.length-1].trim();)t.pop();const o=t.filter(s=>s.trim()).reduce((s,i)=>Math.min(s,i.match(/^(\s*)/)[1].length),1/0);return t.map(s=>s.slice(o)).join(`
`)}const to={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Qt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=eo(this.code),e.textContent=this._cleanCode,Zt.highlightElement(e))}},ge="Courvux",oo="https://vanjexdev.github.io/courvux";function Z({title:e,description:t,slug:o="/"}){const s=e?`${e} — ${ge}`:`${ge} — Lightweight reactive UI framework`,i=oo+o;return Bt({title:e??`${ge} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${ge}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:s},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:i},{property:"og:site_name",content:ge},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:s},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:i}]})}const no={data:{install:`# From GitHub — pin a tag for stable installs
...
createApp({
    ...
    `,onMount(){Z({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~20 KB gzip with everything (router, store, devtools, composables, useHead, SSR).",slug:"/"})}},ro={data:{s1:`# Latest commit on main (rolling)
pnpm add github:vanjexdev/courvux

# Pin to a tagged release (recommended for production)
pnpm add github:vanjexdev/courvux#v0.5.2`,s2:`<script type="importmap">
{
  "imports": {
...
{
  "imports": {
    "courvux": "https://cdn.jsdelivr.net/gh/vanjexdev/courvux@v0.5.2/dist/index.js"
  }
}
<\/script>
...
<\/script>`},onMount(){Z({title:"Installation",description:"Install Courvux from GitHub or via import map / CDN. Vite plugin for templateUrl inlining and jsDelivr CDN setup.",slug:"/installation"});const e=this.$refs.pen;if(!e)return;const t=document.createElement("iframe");t.src="https://codepen.io/jesusuzcategui-the-bold/embed/VYmZNgZ?default-tab=html%2Cresult&theme-id=dark",t.height="420",t.style.cssText="width:100%; border:0; border-radius:8px; display:block; margin-bottom:1rem;",t.scrolling="no",t.setAttribute("frameborder","no"),t.setAttribute("allowtransparency","true"),t.allowFullscreen=!0,t.title="Courvux CDN demo on CodePen",e.replaceWith(t)},template:`
    ...
    `},ao={data:{s1:`import { createApp } from 'courvux';
...
createApp({ store, router, template: '<router-view />' }).mount('#app');`},template:`
    ...
    `,onMount(){Z({title:"Quick Start",description:"Build your first reactive Courvux app — counter example, methods, computed properties.",slug:"/quick-start"})}},io={data:{s_interp:`<!-- Text interpolation -->
<p>{{ count }}</p>
<p>{{ price * qty }}</p>
<p>{{ active ? 'On' : 'Off' }}</p>
...
<div id="app" cv-cloak></div>`},template:`
    ...
    `,onMount(){Z({title:"Template Syntax",description:"Courvux directives and bindings: cv-if, cv-for, cv-model, cv-show, :class, :style, @event.",slug:"/template"})}},so={data:{s_define:`createApp({
    components: {
        'user-card': {
...
<editor cv-model:title="docTitle" cv-model:body="docBody" />`},template:`
    ...
    `,onMount(){Z({title:"Components",description:"Define, register, and compose Courvux components with props, slots, emits, and scoped slots.",slug:"/components"})}},co={data:{s_computed:`{
    data: { price: 10, qty: 3 },
    computed: {
...
this.$batch(() => {
    ...
    `,onMount(){Z({title:"Reactivity",description:"Proxy-based reactive state, computed properties, watchers, and refs in Courvux.",slug:"/reactivity"})}},lo={data:{s1:`{
    data: { ticks: 0 },
...
}`,s3:`// Error boundary — catches errors from descendant onMount
{
    ...
    `,onMount(){Z({title:"Lifecycle Hooks",description:"onMount, onBeforeUnmount, onDestroy, error boundaries, and async data in Courvux.",slug:"/lifecycle"})}},uo={data:{s_storage:`import { cvStorage } from 'courvux';
...
export const useCounter = defineComposable((initial = 0) => useComposables(
    ...
    `,onMount(){Z({title:"Composables",description:"Author and reuse logic in Courvux with defineComposable + useComposables, plus the built-in cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener helpers.",slug:"/composables"})}},po={data:{s_basic:`import { createEventBus } from 'courvux';
...
bus.emit('toast:show', 'Saved again');  // handler does NOT run`},template:`
    ...
    `,onMount(){Z({title:"Event Bus",description:"Typed cross-component event bus in Courvux: on, off, emit, once, clear, and provide/inject patterns.",slug:"/event-bus"})}},mo={data:{s_setup:`import { createApp, createRouter } from 'courvux';
...
methods: {
    ...
    `,onMount(){Z({title:"Router",description:"SPA routing in Courvux: dynamic params, nested routes, navigation guards, transitions.",slug:"/router"})}},ho={data:{s1:`import { createStore } from 'courvux';
...
{ inject: { localTheme: 'theme', endpoint: 'apiUrl' } }`},template:`
    ...
    `,onMount(){Z({title:"Store",description:"Global reactive state in Courvux with createStore, modules, and namespaced actions.",slug:"/store"})}},fo={data:{s_basic:`import { useHead } from 'courvux';
...
// → <title>Install | site</title>`},template:`
    ...
    `,onMount(){Z({title:"useHead — SEO and metadata",description:"Per-component head management with useHead in Courvux: title, meta tags, Open Graph, JSON-LD, htmlAttrs.",slug:"/head"})}},go={data:{s_vite:`// vite.config.js
import { defineConfig } from 'vite';
...
// → embed headHtml in your shell, then html in the mount root`},template:`
    ...
    `,onMount(){Z({title:"Static Site Generation",description:"Pre-render every route to static HTML at build time with the courvux/plugin/ssg Vite plugin.",slug:"/ssg"})}},vo={data:{s_setup:`import { createApp, setupDevTools, mountDevOverlay } from 'courvux';
...
inst.setState('filter', 'completed');`},template:`
    ...
    `,onMount(){Z({title:"DevTools",description:"In-app DevTools overlay for Courvux: live component state inspection and inline editing, no browser extension needed.",slug:"/devtools"})}},bo={data:{s_basic:`import { mount } from 'courvux/test-utils';
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,onMount(){Z({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},yo={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
autoInit({
    ...
    `,onMount(){Z({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},xo={template:`
        <div class="prose">
    ...
    `,onMount(){Z({title:"Design decisions",description:"Why Courvux uses Proxy over signals, Options API over Composition, no Virtual DOM, embedded DevTools, cv- prefix, and SSG over per-request SSR. Trade-offs documented.",slug:"/design-decisions"})}},ko={data:{s_keyed:`<!-- Without :key, every state change rebuilds the whole list -->
...
this.cards.splice(idx, 1);`},template:`
    ...
    `,onMount(){Z({title:"FAQ",description:"Frequently asked questions and troubleshooting for Courvux: cv-for keys, strict CSP, TypeScript, lazy loading, Vite/Tauri integration, testing, migration.",slug:"/faq"})}},So={data:{s_component_vue:`// Vue 3 — Options API
export default {
    data() { return { count: 0 } },
...
this.$store.addToCart(product);`},template:`
    ...
    `,onMount(){Z({title:"Migrating from Vue",description:"Mapping table from Vue 3 Options API to Courvux: directives, lifecycle hooks, props, emits, router, Pinia store. Surgical migration, mostly identical syntax.",slug:"/migrating-from-vue"})}},Ao={data:{s_xdata:`<!-- Alpine -->
...
// Used in HTML: $store.cart.count`},template:`
    ...
    `,onMount(){Z({title:"Migrating from Alpine",description:"Mapping table from Alpine.js to Courvux: x-data → cv-data, directives, named components, stores. Mostly identical syntax with a prefix swap.",slug:"/migrating-from-alpine"})}},vt="courvux-demo-todos",Co=`const STORAGE_KEY = 'courvux-demo-todos';
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function To(){try{return JSON.parse(localStorage.getItem(vt))||[]}catch{return[]}}function _o(e){localStorage.setItem(vt,JSON.stringify(e))}const $o={data:{todos:To(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:Co,srcHtml:Eo,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(e=>!e.done):this.filter==="completed"?this.todos.filter(e=>e.done):this.todos},remaining(){return this.todos.filter(e=>!e.done).length},allDone(){return this.todos.length>0&&this.todos.every(e=>e.done)}},watch:{todos:{deep:!0,handler(e){_o(e)}}},methods:{add(){const e=this.newTodo.trim();e&&(this.todos=[...this.todos,{id:this._nextId++,text:e,done:!1}],this.newTodo="")},toggle(e){this.todos=this.todos.map(t=>t.id===e?{...t,done:!t.done}:t)},remove(e){this.todos=this.todos.filter(t=>t.id!==e)},clearCompleted(){this.todos=this.todos.filter(e=>!e.done)},toggleAll(){const e=this.allDone;this.todos=this.todos.map(t=>({...t,done:!e}))},startEdit(e){this.editingId=e.id,this.editText=e.text,this.$nextTick(()=>{var t;return(t=this.$refs["edit_"+e.id])==null?void 0:t.focus()})},commitEdit(e){const t=this.editText.trim();t?this.todos=this.todos.map(o=>o.id===e?{...o,text:t}:o):this.remove(e),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(e){this.filter=e}},template:`
    ...
    `,onMount(){Z({title:"Demo — TODO App",description:"Interactive TODO app built with Courvux. Live demo with full source code (JS + HTML).",slug:"/demo"})}},Oo=[{path:"/",component:no},{path:"/installation",component:ro},{path:"/quick-start",component:ao},{path:"/template",component:io},{path:"/components",component:so},{path:"/reactivity",component:co},{path:"/lifecycle",component:lo},{path:"/composables",component:uo},{path:"/event-bus",component:po},{path:"/router",component:mo},{path:"/store",component:ho},{path:"/head",component:fo},{path:"/ssg",component:go},{path:"/devtools",component:vo},{path:"/testing",component:bo},{path:"/pwa",component:yo},{path:"/advanced",component:wo},{path:"/design-decisions",component:xo},{path:"/faq",component:ko},{path:"/migrating-from-vue",component:So},{path:"/migrating-from-alpine",component:Ao},{path:"/demo",component:$o}],jo={methods:{goBack(){window.history.back()}},template:`
        ...
        <div style="display:flex; min-height:100vh; position:relative;">
            ...
            ">
                ...
                <div style="padding: 20px 16px 12px; border-bottom: 1px solid #f0f0f0;">
                    <router-link to="/" @click="closeSidebar()" style="text-decoration:none; display:flex; align-items:center; gap:8px;" aria-label="Courvux v0.5.2 home">
                        <span style="font-size:1.3rem;" aria-hidden="true">⚡</span>
                        <span style="font-weight:700; font-size:15px; color:#111;">Courvux</span>
                        <span style="font-size:10px; color:#666; margin-left:2px;">v0.5.2</span>
                    </router-link>
                </div>
