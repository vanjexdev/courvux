(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))c(l);new MutationObserver(l=>{for(const y of l)if(y.type==="childList")for(const S of y.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&c(S)}).observe(document,{childList:!0,subtree:!0});function o(l){const y={};return l.integrity&&(y.integrity=l.integrity),l.referrerPolicy&&(y.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?y.credentials="include":l.crossOrigin==="anonymous"?y.credentials="omit":y.credentials="same-origin",y}function c(l){if(l.ep)return;l.ep=!0;const y=o(l);fetch(l.href,y)}})();var bt=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),it=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,je=new WeakSet,ke=Symbol("raw"),Te=e=>e===null||typeof e!="object"?e:e[ke]??e,xe=0,Le=new Map,fe=null;function Ie(e){const t=[],o=fe;fe=t;try{e()}finally{fe=o}return t}function yt(e){xe++;try{e()}finally{if(xe--,xe===0){const t=[...Le.values()];Le.clear(),t.forEach(o=>o())}}}function st(e,t){return e===null||typeof e!="object"||je.has(e)||it(e)?e:new Proxy(e,{get(o,c){if(c===ke)return o[ke]??o;if(typeof c=="string"&&Array.isArray(o)&&bt.has(c))return(...y)=>{const S=Array.prototype[c].apply(o,y);return t(),S};const l=o[c];return l!==null&&typeof l=="object"&&!je.has(l)?st(l,t):l},set(o,c,l){return o[c]=l,t(),!0}})}function Pe(){const e={},t=Math.random().toString(36).slice(2),o=(y,S)=>(e[y]||(e[y]=new Set),e[y].add(S),()=>{var x;(x=e[y])==null||x.delete(S)}),c=y=>{xe>0?Le.set(`${t}:${y}`,()=>{(e[y]?[...e[y]]:[]).forEach(S=>S())}):(e[y]?[...e[y]]:[]).forEach(S=>S())},l={};return{subscribe:o,createReactiveState:y=>new Proxy(y,{get(S,x){if(x===ke)return y;typeof x=="string"&&!x.startsWith("$")&&fe&&fe.push({sub:o,key:x});const P=S[x];return typeof x=="string"&&!x.startsWith("$")&&P!==null&&typeof P=="object"&&!je.has(P)&&!it(P)?st(P,()=>c(x)):P},set(S,x,P){if(l[x])return l[x](P),!0;const C=S[x];return S[x]=P,(C!==P||P!==null&&typeof P=="object")&&c(x),!0}}),registerSetInterceptor:(y,S)=>{l[y]=S},notifyAll:()=>{Object.keys(e).forEach(y=>c(y))}}}var Ce=new WeakMap;function ve(e,t,o){var l,y;const c=t.indexOf(".");if(c>=0){const S=t.slice(0,c),x=t.slice(c+1),P=e[S];return P&&Ce.has(P)?ve(P,x,o):((l=Ce.get(e))==null?void 0:l(S,o))??(()=>{})}return((y=Ce.get(e))==null?void 0:y(t,o))??(()=>{})}var ct=(e,t)=>e.split(".").reduce((o,c)=>o==null?void 0:o[c],t),lt=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),Re=new Map,ze=new Map,dt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!dt(o.slice(1).trim(),t):ct(o,t)},N=(e,t)=>{if(!lt)return dt(e,t);try{let o=Re.get(e);return o||(o=new Function("$data",`with($data) { return (${e}) }`),Re.set(e,o)),o(t)}catch{return ct(e,t)}},ue=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):ve(t.store,e.slice(7),o):t.subscribe(e,o),Q=(e,t,o)=>{const c=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),l=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],y=[...new Set(l.map(x=>x.startsWith("$store.")?x:x.split(".")[0]).filter(x=>!c.has(x)))];if(y.length===0)return()=>{};const S=y.map(x=>ue(x,t,o));return()=>S.forEach(x=>x())},le=(e,t,o)=>{const c=e.split(".");if(c.length===1)t[c[0]]=o;else{const l=c.slice(0,-1).reduce((y,S)=>y==null?void 0:y[S],t);l&&(l[c[c.length-1]]=o)}},He=(e,t,o,c,l)=>{const y={};return Object.keys(e).forEach(S=>y[S]=e[S]),y[o]=t,l&&(y[l]=c),y},De=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(De).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Ne=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([c,l])=>{e.style[c]=l??""}))},We=(e,t,o)=>{if(lt)try{let c=ze.get(e);c||(c=new Function("__p__",`with(__p__){${e}}`),ze.set(e,c));const l=new Proxy({},{has:()=>!0,get:(y,S)=>S==="$event"?o:S in t?t[S]:globalThis[S],set:(y,S,x)=>(t[S]=x,!0)});c(l)}catch(c){console.warn(`[courvux] handler error "${e}":`,c)}},ie=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(c=>{const l=()=>c();e.addEventListener("animationend",l,{once:!0}),e.addEventListener("transitionend",l,{once:!0}),setTimeout(l,o+50)})},xt=`
...
`,Ue=!1;function Be(){if(Ue||typeof document>"u")return;Ue=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=xt,document.head.appendChild(e)}var qe=!1;function wt(){if(qe||typeof document>"u")return;qe=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function kt(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(c=>{(c.name.startsWith("on")||c.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(c.name)})}),t.body.innerHTML}async function oe(e,t,o){var y,S,x,P,C,w,U,T,I,M,j,R,$,d,r,f,k;const c=Array.from(e.childNodes);let l=0;for(;l<c.length;){const A=c[l];if(A.nodeType===3){const i=A.textContent||"",a=i.match(/\{\{([\s\S]+?)\}\}/g);if(a){const s=i,p=()=>{let m=s;a.forEach(u=>{const h=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(u,N(h,t)??"")}),A.textContent=m};a.forEach(m=>{Q(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,p)}),p()}l++;continue}if(A.nodeType!==1){l++;continue}const n=A,g=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),l++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await oe(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),l++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const i=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const a=document.querySelector(i)??document.body,s=document.createComment(`cv-teleport: ${i}`);n.replaceWith(s),await oe(n,t,o),a.appendChild(n),l++;continue}if(n.hasAttribute("cv-memo")){const i=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const a=()=>i.split(",").map(h=>N(h.trim(),t));let s=a();const p=[],m=h=>(p.push(h),()=>{const v=p.indexOf(h);v>-1&&p.splice(v,1)});await oe(n,t,{...o,subscribe:(h,v)=>m(v),storeSubscribeOverride:(h,v,_)=>m(_)});const u=Q(i,o,()=>{const h=a();h.some((v,_)=>v!==s[_])&&(s=h,[...p].forEach(v=>v()))});(y=o.registerCleanup)==null||y.call(o,()=>u()),l++;continue}if(n.hasAttribute("cv-data")){const i=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let a={},s={};if(i.startsWith("{")){const p=N(i,t)??{};Object.entries(p).forEach(([m,u])=>{typeof u=="function"?s[m]=u:a[m]=u})}else if(i){const p=(S=o.components)==null?void 0:S[i];if(p){const m=typeof p.data=="function"?p.data():p.data??{};m instanceof Promise||Object.assign(a,m),Object.assign(s,p.methods??{})}}if(o.createChildScope){const p=o.createChildScope(a,s);(x=o.registerCleanup)==null||x.call(o,p.cleanup),await oe(n,p.state,{...o,subscribe:p.subscribe})}else await oe(n,{...t,...a,...s},o);l++;continue}if(n.hasAttribute("cv-for")){const i=n.getAttribute("cv-for");n.removeAttribute("cv-for");const a=i.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(a){const[,s,p,m]=a,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const h=n.getAttribute("cv-transition")??null;h&&n.removeAttribute("cv-transition");const v=document.createComment(`cv-for: ${m}`);n.replaceWith(v);let _=[],D=[];const F=new Map,B=async()=>{var G;const H=N(m,t),O=H?typeof H=="number"?Array.from({length:H},(W,z)=>[z+1,z]):Array.isArray(H)?H.map((W,z)=>[W,z]):Object.entries(H).map(([W,z])=>[z,W]):[];if(u){const W=[],z=new Map,J=new Set;for(const[X,Y]of O){const ae=N(u,He(t,X,s,Y,p));J.has(ae)&&console.warn(`[courvux] cv-for: duplicate :key "${ae}" in "${m}"`),J.add(ae),W.push(ae),z.set(ae,[X,Y])}const q=[];for(const[X,{el:Y,destroy:ae}]of F)z.has(X)||(h?(Y.classList.add(`${h}-leave`),q.push(ie(Y).then(()=>{var re;Y.classList.remove(`${h}-leave`),ae(),(re=Y.parentNode)==null||re.removeChild(Y),F.delete(X)}))):(ae(),(G=Y.parentNode)==null||G.removeChild(Y),F.delete(X)));q.length&&await Promise.all(q);const V=v.parentNode,te=[];for(const X of W){const[Y,ae]=z.get(X);if(F.has(X)){const re=F.get(X);re.itemRef!==Y&&(re.reactive[s]=Y,re.itemRef=Y),p&&(re.reactive[p]=ae)}else{const re=n.cloneNode(!0),Se=[],{subscribe:ht,createReactiveState:ft}=Pe(),Ee=ft({[s]:Y,...p?{[p]:ae}:{}}),vt=new Proxy({},{has(se,ee){return!0},get(se,ee){return typeof ee!="string"?t[ee]:ee===s||p&&ee===p?Ee[ee]:t[ee]},set(se,ee,ce){return ee===s||p&&ee===p?(Ee[ee]=ce,!0):(t[ee]=ce,!0)}}),gt={...o,subscribe:(se,ee)=>{const ce=se.split(".")[0];let de;return ce===s||p&&ce===p?de=ht(ce,ee):de=o.subscribe(se,ee),Se.push(de),de},storeSubscribeOverride:(se,ee,ce)=>{const de=ve(se,ee,ce);return Se.push(de),de}},_e=document.createDocumentFragment();_e.appendChild(re),await oe(_e,vt,gt);const $e=_e.firstChild??re;h&&$e.classList.add(`${h}-enter`),F.set(X,{el:$e,reactive:Ee,itemRef:Y,destroy:()=>Se.forEach(se=>se())}),h&&te.push($e)}}let K=v.nextSibling,pe=0;for(const X of W){const{el:Y}=F.get(X);Y!==K?pe++:K=Y.nextSibling}if(pe>0)if(pe>W.length>>1){const X=document.createDocumentFragment();for(const Y of W)X.appendChild(F.get(Y).el);V.insertBefore(X,v.nextSibling)}else{K=v.nextSibling;for(const X of W){const{el:Y}=F.get(X);Y!==K?V.insertBefore(Y,K):K=Y.nextSibling}}_=W.map(X=>F.get(X).el),te.length&&Promise.all(te.map(X=>ie(X).then(()=>X.classList.remove(`${h}-enter`))))}else{if(D.forEach(q=>q()),D=[],_.forEach(q=>{var V;return(V=q.parentNode)==null?void 0:V.removeChild(q)}),_=[],!O.length)return;const W=v.parentNode,z=v.nextSibling,J={...o,subscribe:(q,V)=>{const te=o.subscribe(q,V);return D.push(te),te},storeSubscribeOverride:(q,V,te)=>{const K=ve(q,V,te);return D.push(K),K}};for(const[q,V]of O){const te=n.cloneNode(!0),K=document.createDocumentFragment();K.appendChild(te),await oe(K,He(t,q,s,V,p),J);const pe=K.firstChild??te;W.insertBefore(K,z),_.push(pe)}}};(P=o.registerCleanup)==null||P.call(o,()=>{F.forEach(({el:H,destroy:O})=>{var G;O(),(G=H.parentNode)==null||G.removeChild(H)}),F.clear(),D.forEach(H=>H()),_.forEach(H=>{var O;return(O=H.parentNode)==null?void 0:O.removeChild(H)}),_=[]}),Q(m,o,B),await B()}l++;continue}if(n.hasAttribute("cv-if")){const i=[],a=n.getAttribute("cv-if");n.removeAttribute("cv-if");const s=document.createComment("cv-if");n.replaceWith(s),i.push({condition:a,template:n,anchor:s});let p=l+1;for(;p<c.length;){const _=c[p];if(_.nodeType===3&&(((C=_.textContent)==null?void 0:C.trim())??"")===""){p++;continue}if(_.nodeType!==1)break;const D=_;if(D.hasAttribute("cv-else-if")){const F=D.getAttribute("cv-else-if");D.removeAttribute("cv-else-if");const B=document.createComment("cv-else-if");D.replaceWith(B),i.push({condition:F,template:D,anchor:B}),p++;continue}if(D.hasAttribute("cv-else")){D.removeAttribute("cv-else");const F=document.createComment("cv-else");D.replaceWith(F),i.push({condition:null,template:D,anchor:F}),p++;break}break}l=p;let m=null,u=!1,h=!1;const v=async()=>{var _,D;if(u){h=!0;return}u=!0;try{do{h=!1,m&&((_=m.parentNode)==null||_.removeChild(m),m=null);for(const F of i)if(F.condition===null||N(F.condition,t)){const B=F.template.cloneNode(!0),H=document.createDocumentFragment();H.appendChild(B),await oe(H,t,o);const O=H.firstChild??B;(D=F.anchor.parentNode)==null||D.insertBefore(H,F.anchor.nextSibling),m=O;break}}while(h)}finally{u=!1}};i.filter(_=>_.condition).forEach(_=>{Q(_.condition,o,v)}),await v();continue}if(n.hasAttribute("cv-show")){const i=n.getAttribute("cv-show");n.removeAttribute("cv-show");const a=Array.from(n.attributes).filter(s=>s.name==="cv-transition"||s.name.startsWith("cv-transition:")||s.name.startsWith("cv-transition."));if(a.length>0){const s=O=>(n.getAttribute(O)??"").split(" ").filter(Boolean),p=s("cv-transition:enter"),m=s("cv-transition:enter-start"),u=s("cv-transition:enter-end"),h=s("cv-transition:leave"),v=s("cv-transition:leave-start"),_=s("cv-transition:leave-end"),D=n.getAttribute("cv-transition")??"",F=new Set(D.split(".").slice(1)),B=[...F].find(O=>/^\d+$/.test(O)),H=B?parseInt(B):200;if(p.length||m.length||h.length||v.length){a.forEach(q=>n.removeAttribute(q.name));const O=()=>new Promise(q=>requestAnimationFrame(()=>requestAnimationFrame(()=>q())));let G=!!N(i,t),W=!1,z=null;const J=async q=>{if(W){z=q;return}W=!0;try{q?(n.style.display="",n.classList.add(...p,...m),await O(),n.classList.remove(...m),n.classList.add(...u),await ie(n),n.classList.remove(...p,...u)):(n.classList.add(...h,...v),await O(),n.classList.remove(...v),n.classList.add(..._),await ie(n),n.classList.remove(...h,..._),n.style.display="none"),G=q}finally{if(W=!1,z!==null&&z!==G){const V=z;z=null,J(V)}else z=null}};G||(n.style.display="none"),Q(i,o,()=>{const q=!!N(i,t);q!==G&&J(q)})}else{const O=[...F].find(V=>V==="scale"||/^scale$/.test(V)),G=(()=>{const V=[...F].find(te=>/^\d+$/.test(te)&&te!==B);return V?parseInt(V)/100:.9})(),W=[];(!F.has("scale")||F.has("opacity"))&&W.push(`opacity ${H}ms ease`),O&&W.push(`transform ${H}ms ease`),W.length||W.push(`opacity ${H}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+W.join(", "),a.forEach(V=>n.removeAttribute(V.name));let z=!!N(i,t);const J=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V()))),q=async V=>{V?(n.style.display="",n.style.opacity="0",O&&(n.style.transform=`scale(${G})`),await J(),n.style.opacity="",O&&(n.style.transform=""),await ie(n)):(n.style.opacity="0",O&&(n.style.transform=`scale(${G})`),await ie(n),n.style.display="none",n.style.opacity="",O&&(n.style.transform="")),z=V};z||(n.style.display="none"),Q(i,o,()=>{const V=!!N(i,t);V!==z&&q(V)})}}else{const s=n.getAttribute("cv-show-transition"),p=n.getAttribute(":transition");s&&n.removeAttribute("cv-show-transition"),p&&n.removeAttribute(":transition");const m=s??(p?String(N(p,t)):null);if(m){Be();let u=!!N(i,t);u||(n.style.display="none");let h=!1,v=null;const _=async D=>{if(h){v=D;return}h=!0;try{D?(n.style.display="",n.classList.add(`${m}-enter`),await ie(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ie(n),n.classList.remove(`${m}-leave`),n.style.display="none"),u=D}finally{if(h=!1,v!==null&&v!==u){const F=v;v=null,_(F)}else v=null}};Q(i,o,()=>{const D=!!N(i,t);D!==u&&_(D)})}else{const u=()=>{n.style.display=N(i,t)?"":"none"};Q(i,o,u),u()}}}if(n.hasAttribute("cv-focus")){const i=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!i)Promise.resolve().then(()=>n.focus());else{const a=()=>{N(i,t)&&Promise.resolve().then(()=>n.focus())};Q(i,o,a),a()}}{const i=Array.from(n.attributes).filter(a=>a.name==="cv-intersect"||a.name.startsWith("cv-intersect:")||a.name.startsWith("cv-intersect."));if(i.length&&typeof IntersectionObserver<"u"){const a=i.find(O=>O.name==="cv-intersect"||O.name==="cv-intersect:enter"||O.name.startsWith("cv-intersect.")),s=i.find(O=>O.name==="cv-intersect:leave"),p=(a==null?void 0:a.value)??"",m=(s==null?void 0:s.value)??"",u=((a==null?void 0:a.name)??"cv-intersect").split("."),h=new Set(u.slice(1)),v=h.has("once");let _=0;if(h.has("half"))_=.5;else if(h.has("full"))_=1;else{const O=[...h].find(G=>G.startsWith("threshold-"));O&&(_=parseInt(O.replace("threshold-",""))/100)}const D=[...h].find(O=>O.startsWith("margin-")),F=D?`${D.replace("margin-","")}px`:void 0;i.forEach(O=>n.removeAttribute(O.name));const B=O=>{if(O)try{new Function("$data",`with($data){${O}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${O}":`,G)}},H=new IntersectionObserver(O=>{O.forEach(G=>{G.isIntersecting?(B(p),v&&H.disconnect()):B(m)})},{threshold:_,...F?{rootMargin:F}:{}});H.observe(n),(w=o.registerCleanup)==null||w.call(o,()=>H.disconnect())}}{const i=Array.from(n.attributes).find(a=>a.name==="cv-html"||a.name.startsWith("cv-html."));if(i){const a=i.value;n.removeAttribute(i.name);const s=i.name.split(".").slice(1).includes("sanitize"),p=()=>{const m=String(N(a,t)??"");n.innerHTML=s?kt(m):m};Q(a,o,p),p(),l++;continue}}if(n.hasAttribute("cv-ref")&&!((U=o.components)!=null&&U[g])){const i=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[i]=n)}const b=!!((T=o.components)!=null&&T[g]),E=Array.from(n.attributes).find(i=>i.name==="cv-model"||i.name.startsWith("cv-model."));if(E&&!b){const i=E.value;n.removeAttribute(E.name);const a=new Set(E.name.split(".").slice(1)),s=n,p=(I=s.type)==null?void 0:I.toLowerCase(),m=u=>{if(a.has("number")){const h=parseFloat(u);return isNaN(h)?u:h}return a.has("trim")?u.trim():u};if(p==="checkbox"){const u=()=>{const h=N(i,t);s.checked=Array.isArray(h)?h.includes(s.value):!!h};ue(i,o,u),u(),s.addEventListener("change",()=>{const h=N(i,t);if(Array.isArray(h)){const v=[...h];if(s.checked)v.includes(s.value)||v.push(s.value);else{const _=v.indexOf(s.value);_>-1&&v.splice(_,1)}le(i,t,v)}else le(i,t,s.checked)})}else if(p==="radio"){const u=()=>{s.checked=N(i,t)===s.value};ue(i,o,u),u(),s.addEventListener("change",()=>{s.checked&&le(i,t,m(s.value))})}else if(n.hasAttribute("contenteditable")){const u=n,h=()=>{const v=String(N(i,t)??"");u.innerText!==v&&(u.innerText=v)};if(ue(i,o,h),h(),a.has("debounce")){const v=[...a].find(F=>/^\d+$/.test(F)),_=v?parseInt(v):300;let D;u.addEventListener("input",()=>{clearTimeout(D),D=setTimeout(()=>le(i,t,m(u.innerText)),_)})}else{const v=a.has("lazy")?"blur":"input";u.addEventListener(v,()=>le(i,t,m(u.innerText)))}}else{const u=()=>{s.value=N(i,t)??""};if(ue(i,o,u),u(),a.has("debounce")){const h=[...a].find(D=>/^\d+$/.test(D)),v=h?parseInt(h):300;let _;s.addEventListener("input",()=>{clearTimeout(_),_=setTimeout(()=>le(i,t,m(s.value)),v)})}else{const h=g==="select"||a.has("lazy")?"change":"input";s.addEventListener(h,()=>le(i,t,m(s.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(i=>{var B,H;if(!i.name.startsWith("cv-"))return;const a=i.name.slice(3).split("."),s=a[0],p=a.slice(1),m=s.indexOf(":"),u=m>=0?s.slice(0,m):s,h=m>=0?s.slice(m+1):void 0,v=o.directives[u];if(!v)return;const _=i.value;n.removeAttribute(i.name);const D=typeof v=="function"?{onMount:v}:v,F={value:_?N(_,t):void 0,arg:h,modifiers:Object.fromEntries(p.map(O=>[O,!0]))};(B=D.onMount)==null||B.call(D,n,F),D.onUpdate&&_&&Q(_,o,()=>{F.value=N(_,t),D.onUpdate(n,F)}),D.onDestroy&&((H=o.registerCleanup)==null||H.call(o,()=>D.onDestroy(n,F)))}),g==="slot"){const i=n.getAttribute("name")??"default",a=(M=o.slots)==null?void 0:M[i];if(a){const s={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(s[u.name.slice(1)]=N(u.value,t))});const p=await a(s),m=document.createDocumentFragment();p.forEach(u=>m.appendChild(u)),n.replaceWith(m)}else{const s=document.createDocumentFragment();for(;n.firstChild;)s.appendChild(n.firstChild);await oe(s,t,o),n.replaceWith(s)}l++;continue}if(g==="cv-transition"){Be();const i=n.getAttribute("name")??"fade",a=n.getAttribute(":show")??null;n.removeAttribute("name"),a&&n.removeAttribute(":show");const s=document.createElement("div");for(s.className="cv-t-wrap";n.firstChild;)s.appendChild(n.firstChild);if(n.replaceWith(s),await oe(s,t,o),a){let p=!!N(a,t),m=!1,u=null;p||(s.style.display="none");const h=async v=>{if(m){u=v;return}m=!0;try{v?(s.style.display="",s.classList.add(`${i}-enter`),await ie(s),s.classList.remove(`${i}-enter`)):(s.classList.add(`${i}-leave`),await ie(s),s.classList.remove(`${i}-leave`),s.style.display="none"),p=v}finally{if(m=!1,u!==null&&u!==p){const _=u;u=null,h(_)}else u=null}};Q(a,o,()=>{const v=!!N(a,t);v!==p&&h(v)})}l++;continue}if(g==="router-view"&&o.mountRouterView){const i=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,i),l++;continue}if(g==="router-link"){const i=n.getAttribute(":to"),a=n.getAttribute("to"),s=()=>i?String(N(i,t)??"/"):a||"/",p=O=>String(O).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let m="";Array.from(n.attributes).forEach(O=>{O.name==="to"||O.name===":to"||(m+=` ${O.name}="${p(O.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${m}></a>`;const h=u.firstElementChild;for(;n.firstChild;)h.appendChild(n.firstChild);const v=((j=o.router)==null?void 0:j.base)??"",_=O=>v?O===v?"/":O.startsWith(v+"/")?O.slice(v.length)||"/":O||"/":O||"/",D=()=>{var O;return((O=o.router)==null?void 0:O.mode)==="history"?_(window.location.pathname):window.location.hash.slice(1)||"/"},F=()=>{var W;const O=s(),G=D()===O;((W=o.router)==null?void 0:W.mode)==="history"?h.href=`${v}${O}`:h.href=`#${O}`,G?(h.setAttribute("aria-current","page"),h.classList.add("active")):(h.removeAttribute("aria-current"),h.classList.remove("active"))};((R=o.router)==null?void 0:R.mode)==="history"?(h.addEventListener("click",O=>{O.preventDefault(),o.router.navigate(s())}),window.addEventListener("popstate",F)):window.addEventListener("hashchange",F),i&&ue(i,o,F),F();const B=document.createDocumentFragment();B.appendChild(h),await oe(B,t,o);const H=B.firstChild??h;n.replaceWith(H),l++;continue}if(g==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const i=n.getAttribute(":is");n.removeAttribute(":is");const a=document.createComment("component:is");n.replaceWith(a),await o.mountDynamic(a,i,n,t,o),l++;continue}if(($=o.components)!=null&&$[g]&&o.mountElement){await o.mountElement(n,g,t,o),l++;continue}{const i=Array.from(n.attributes).find(a=>a.name==="cv-intersect"||a.name.startsWith("cv-intersect."));if(i&&typeof IntersectionObserver<"u"){const a=new Set(i.name.split(".").slice(1));n.removeAttribute(i.name);const s=N(i.value,t);let p,m=0,u="0px",h=a.has("once");if(typeof s=="function"?p=v=>s.call(t,v):s&&typeof s=="object"&&(typeof s.handler=="function"&&(p=v=>s.handler.call(t,v)),s.threshold!==void 0&&(m=s.threshold),s.margin&&(u=s.margin),s.once&&(h=!0)),p){const v=new IntersectionObserver(_=>{const D=_[0];p(D),h&&D.isIntersecting&&v.disconnect()},{threshold:m,rootMargin:u});v.observe(n),(d=o.registerCleanup)==null||d.call(o,()=>v.disconnect())}}}if(n.hasAttribute("cv-resize")){const i=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const a=N(i,t);let s,p="content-box";if(typeof a=="function"?s=m=>a.call(t,m):a&&typeof a=="object"&&(typeof a.handler=="function"&&(s=m=>a.handler.call(t,m)),a.box&&(p=a.box)),s){const m=new ResizeObserver(u=>{u[0]&&s(u[0])});m.observe(n,{box:p}),(r=o.registerCleanup)==null||r.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const i=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const a=N(i,t);let s,p=0;if(typeof a=="function"?s=m=>a.call(t,m):a&&typeof a=="object"&&(typeof a.handler=="function"&&(s=m=>a.handler.call(t,m)),a.throttle&&(p=a.throttle)),s){let m=0;const u=()=>{const h=Date.now();p>0&&h-m<p||(m=h,s({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(f=o.registerCleanup)==null||f.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const i=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const a=s=>{n.contains(s.target)||(typeof t[i]=="function"?t[i].call(t,s):We(i,t,s))};document.addEventListener("click",a,!0),(k=o.registerCleanup)==null||k.call(o,()=>document.removeEventListener("click",a,!0))}if(n.hasAttribute("cv-bind")){const i=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const a=n.getAttribute("class")??"",s=n.getAttribute("style")??"";let p=[];const m=()=>{const u=N(i,t)??{},h=Object.keys(u);for(const v of p)v in u||(v==="class"?n.className=a:v==="style"?n.style.cssText=s:n.removeAttribute(v));for(const[v,_]of Object.entries(u))if(v==="class")n.className=[a,De(_)].filter(Boolean).join(" ");else if(v==="style")Ne(n,_,s);else if(_==null||_===!1)try{n.removeAttribute(v)}catch{}else try{n.setAttribute(v,_===!0?"":String(_))}catch(D){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${v}":`,D)}p=h};Q(i,o,m),m()}const L={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(i=>{if(i.name.startsWith("@")||i.name.startsWith("cv:on:")){const a=(i.name.startsWith("@")?i.name.substring(1):i.name.substring(6)).split("."),s=a[0],p=new Set(a.slice(1)),m=[...p].find(_=>_ in L),u=i.value,h=_=>{p.has("prevent")&&_.preventDefault(),p.has("stop")&&_.stopPropagation(),!(p.has("self")&&_.target!==_.currentTarget)&&(m&&_.key!==L[m]||(typeof t[u]=="function"?t[u].call(t,_):We(u,t,_)))},v={};p.has("once")&&(v.once=!0),p.has("passive")&&(v.passive=!0),p.has("capture")&&(v.capture=!0),n.addEventListener(s,h,Object.keys(v).length?v:void 0)}else if(i.name.startsWith(":")){const a=i.name.slice(1),s=i.value;if(a==="class"){const p=n.getAttribute("class")??"",m=()=>{n.className=[p,De(N(s,t))].filter(Boolean).join(" ")};Q(s,o,m),m()}else if(a==="style"){const p=n.getAttribute("style")??"",m=()=>Ne(n,N(s,t),p);Q(s,o,m),m()}else if(a.includes("-")){const p=()=>{const m=N(s,t);m==null||m===!1?n.removeAttribute(a):n.setAttribute(a,m===!0?"":String(m))};Q(s,o,p),p()}else{const p=()=>{n[a]=N(s,t)??""};Q(s,o,p),p()}}}),A.hasChildNodes()&&await oe(A,t,o),l++}}var At=`
...
`;function St(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=At,document.head.appendChild(e)}async function ge(e,t,o){e.classList.add(`${t}-${o}`);const c=getComputedStyle(e),l=Math.max(parseFloat(c.animationDuration)||0,parseFloat(c.transitionDuration)||0)*1e3;l>0&&await new Promise(y=>{const S=()=>y();e.addEventListener("animationend",S,{once:!0}),e.addEventListener("transitionend",S,{once:!0}),setTimeout(S,l+50)}),e.classList.remove(`${t}-${o}`)}var we=new Map;async function Et(e){if(typeof e!="function")return e;if(we.has(e))return we.get(e);const t=await e();return we.set(e,t.default),t.default}function Ve(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ge(e,t){if(e==="*")return{};const o=[],c=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),l=t.match(new RegExp(`^${c}$`));return l?Object.fromEntries(o.map((y,S)=>[y,l[S+1]])):null}function _t(e,t){if(e==="/")return{params:{},remaining:t};const o=[],c=e.replace(/:(\w+)/g,(y,S)=>(o.push(S),"([^/]+)")),l=t.match(new RegExp(`^${c}(/.+)?$`));return l?{params:Object.fromEntries(o.map((y,S)=>[y,l[S+1]])),remaining:l[o.length+1]||"/"}:null}function ut(e,t=""){return e.map(o=>{var l;if(o.path==="*")return o;const c=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(l=o.children)!=null&&l.length?{...o,path:c,children:ut(o.children,c==="/"?"":c)}:{...o,path:c}})}var me=(e,t)=>new Promise(o=>e(t,o)),Ye=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function $t(e,t={}){const o=t.mode??"hash",c=Tt(t.base??"");return{routes:ut(e),mode:o,base:c,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(l,y){const S=Xe(l,y==null?void 0:y.query);o==="history"?(history.pushState({},"",`${c}${S}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=S},replace(l,y){const S=Xe(l,y==null?void 0:y.query);if(o==="history")history.replaceState({},"",`${c}${S}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const x=window.location.href.split("#")[0];window.location.replace(`${x}#${S}`)}},back(){history.back()},forward(){history.forward()}}}function Tt(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function Ct(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function Xe(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function Ze(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((c,l)=>{o[l]=c}),o}function Je(e,t,o,c="default",l){const y=t.base??"",S=()=>t.mode==="history"?Ct(window.location.pathname,y):(window.location.hash.slice(1)||"/").split("?")[0]||"/",x=()=>{if(t.mode==="history")return Ze(window.location.search);const r=window.location.hash.slice(1)||"/",f=r.indexOf("?");return f>=0?Ze(r.slice(f+1)):{}};t.transition&&St();let P=null,C=null,w=null,U=null,T=!1;const I=()=>{T||(T=!0,l==null||l())},M=new Map,j=r=>{var f;if(r!=null&&r.keepAlive&&w){(f=w.deactivate)==null||f.call(w);const k=document.createDocumentFragment();for(;e.firstChild;)k.appendChild(e.firstChild);M.set(P.path,{fragment:k,activation:w}),w=null}else w==null||w.destroy(),w=null,e.innerHTML=""},R=async(r,f,k,A,n)=>{const g=typeof f=="function"&&!we.has(f),b=g?f.__asyncOptions:void 0,E=r.loadingTemplate??(b==null?void 0:b.loadingTemplate);g&&E&&(e.innerHTML=E);let L;try{L=await Et(f)}catch(i){const a=b==null?void 0:b.errorTemplate;if(a)return e.innerHTML=a,{destroy:()=>{e.innerHTML=""}};throw i}return g&&E&&(e.innerHTML=""),o(e,L,k,A,n)},$=async()=>{var k,A,n,g,b,E,L,i;const r=S(),f=x();for(const a of t.routes){if((k=a.children)!=null&&k.length){const p=_t(a.path,r);if(p!==null)for(const m of a.children){const u=Ge(m.path,r);if(u!==null){const h={params:p.params,query:f,path:r,meta:a.meta};if(m.redirect){const F={params:u,query:f,path:r,meta:m.meta},B=typeof m.redirect=="function"?m.redirect(F):m.redirect;t.navigate(B);return}if(t.beforeEach){const F=await me(t.beforeEach,h);if(F){t.navigate(F);return}}if(a.beforeEnter){const F=await me(a.beforeEnter,h);if(F){t.navigate(F);return}}if(m.beforeEnter){const F={params:u,query:f,path:r,meta:m.meta},B=await me(m.beforeEnter,F);if(B){t.navigate(B);return}}const v=`${a.path}::${JSON.stringify(p.params)}`;if(U!==v){const F=await Ye(w,h);if(F){t.navigate(F);return}const B=a.transition??t.transition;B&&e.hasChildNodes()&&await ge(e,B,"leave"),j(C);const H=Ve(a,c);if(H){const O={routes:a.children,mode:t.mode,base:t.base,transition:a.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(G,W)=>t.navigate(G,W),replace:(G,W)=>t.replace(G,W),back:()=>t.back(),forward:()=>t.forward()};w=await R(a,H,h,c==="default"?a.layout:void 0,c==="default"?O:void 0),(A=w.enter)==null||A.call(w,P)}else e.innerHTML="";U=v,B&&await ge(e,B,"enter")}const _={params:{...p.params,...u},query:f,path:r,meta:m.meta??a.meta};(n=t.afterEach)==null||n.call(t,_,P);const D=(g=t.scrollBehavior)==null?void 0:g.call(t,_,P);D&&window.scrollTo(D.x??0,D.y??0),P=_,C=a,I();return}}}const s=Ge(a.path,r);if(s!==null){U=null;const p={params:s,query:f,path:r,meta:a.meta};if(a.redirect){const _=typeof a.redirect=="function"?a.redirect(p):a.redirect;t.navigate(_);return}if(t.beforeEach){const _=await me(t.beforeEach,p);if(_){t.navigate(_);return}}if(a.beforeEnter){const _=await me(a.beforeEnter,p);if(_){t.navigate(_);return}}const m=await Ye(w,p);if(m){t.navigate(m);return}const u=a.transition??t.transition;u&&e.hasChildNodes()&&await ge(e,u,"leave"),j(C);const h=Ve(a,c);if(h){const _=p.path;if(a.keepAlive&&M.has(_)){const D=M.get(_);e.appendChild(D.fragment),w=D.activation,(b=w.activate)==null||b.call(w),M.delete(_)}else{const D=P;w=await R(a,h,p,c==="default"?a.layout:void 0),(E=w.enter)==null||E.call(w,D)}}else e.innerHTML="",w=null;u&&await ge(e,u,"enter"),(L=t.afterEach)==null||L.call(t,p,P);const v=(i=t.scrollBehavior)==null?void 0:i.call(t,p,P);v&&window.scrollTo(v.x??0,v.y??0),P=p,C=a,I();return}}U=null,j(C),C=null,I()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,$),$(),()=>{window.removeEventListener(d,$),w==null||w.destroy(),w=null,M.forEach(({activation:r})=>r.destroy()),M.clear()}}function Ft(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,c){return e.has(o)||e.set(o,new Set),e.get(o).add(c),()=>{var l;return(l=e.get(o))==null?void 0:l.delete(c)}},_emit(o,c){var l;(l=e.get(o))==null||l.forEach(y=>{try{y(c)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const c=this.instances.findIndex(l=>l.id===o);if(c!==-1){const l=this.instances[c];this.instances.splice(c,1),this._emit("destroy",l)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Ot=0;function jt(){return++Ot}var Lt=`
...
`;function Pt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Lt,document.head.appendChild(e)}function be(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function Ke(e){try{return JSON.parse(e)}catch{return e}}function Dt(e){if(typeof document>"u")return;Pt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,c="components",l=new Set;const y=document.createElement("div");y.id="cvd-badge",y.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(y);const S=document.createElement("div");S.id="cvd-panel",S.style.display="none",t.appendChild(S),S.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const x=S.querySelector("#cvd-body");y.addEventListener("click",()=>{o=!0,y.style.display="none",S.style.display="flex",U()}),S.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,S.style.display="none",y.style.display=""}),S.querySelectorAll(".cvd-tab").forEach(T=>{T.addEventListener("click",()=>{c=T.dataset.tab,S.querySelectorAll(".cvd-tab").forEach(I=>I.classList.remove("active")),T.classList.add("active"),U()})});const P=S.querySelector("#cvd-head");P.addEventListener("pointerdown",T=>{if(T.target.closest("button"))return;P.setPointerCapture(T.pointerId);const I=T.clientX,M=T.clientY,j=t.offsetLeft,R=t.offsetTop,$=r=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${j+(r.clientX-I)}px`,t.style.top=`${R+(r.clientY-M)}px`},d=r=>{P.releasePointerCapture(r.pointerId),P.removeEventListener("pointermove",$),P.removeEventListener("pointerup",d),P.removeEventListener("pointercancel",d)};P.addEventListener("pointermove",$),P.addEventListener("pointerup",d),P.addEventListener("pointercancel",d)});function C(){const T=e.instances;if(!T.length){x.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}x.innerHTML=T.map(I=>{const M=I.getState(),j=Object.keys(M);return`
                <div class="cvd-inst${l.has(I.id)?" open":""}" data-id="${I.id}">
                    ...
                    <div class="cvd-kv">
                        ${j.length?j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-inst="${I.id}" data-key="${R}" title="click to edit">${be(M[R])}</span>
                            </div>
                        `).join(""):'<span style="color:#555">— sin datos reactivos —</span>'}
                    </div>
                </div>
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(I=>{I.addEventListener("click",()=>{const M=I.closest(".cvd-inst"),j=parseInt(M.dataset.id);l.has(j)?l.delete(j):l.add(j),M.classList.toggle("open")})}),x.querySelectorAll(".cvd-val").forEach(I=>{I.addEventListener("click",M=>{M.stopPropagation();const j=I;if(j.querySelector("input"))return;const R=parseInt(j.dataset.inst),$=j.dataset.key,d=e.instances.find(A=>A.id===R);if(!d)return;const r=be(d.getState()[$]);j.classList.add("editing"),j.innerHTML=`<input class="cvd-edit" value='${r.replace(/'/g,"&#39;")}'>`;const f=j.querySelector("input");f.focus(),f.select();const k=()=>{d.setState($,Ke(f.value)),j.classList.remove("editing")};f.addEventListener("blur",k),f.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),k()),A.key==="Escape"&&(j.classList.remove("editing"),U())})})})}function w(){if(!e.stores.length){x.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}x.innerHTML=e.stores.map((T,I)=>{const M=T.getState(),j=Object.keys(M);return`
                    ...
                    <div class="cvd-kv">
                        ${j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${I}" data-key="${R}" title="click to edit">${be(M[R])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),x.querySelectorAll(".cvd-inst-head").forEach(T=>{T.addEventListener("click",()=>T.closest(".cvd-inst").classList.toggle("open"))}),x.querySelectorAll("[data-store][data-key]").forEach(T=>{T.addEventListener("click",I=>{I.stopPropagation();const M=T;if(M.querySelector("input"))return;const j=parseInt(M.dataset.store),R=M.dataset.key,$=e.stores[j];if(!$)return;const d=be($.getState()[R]);M.classList.add("editing"),M.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const r=M.querySelector("input");r.focus(),r.select();const f=()=>{$.setState(R,Ke(r.value)),M.classList.remove("editing")};r.addEventListener("blur",f),r.addEventListener("keydown",k=>{k.key==="Enter"&&(k.preventDefault(),f()),k.key==="Escape"&&(M.classList.remove("editing"),U())})})})}function U(){o&&(c==="components"?C():w())}e.on("mount",()=>U()),e.on("update",()=>U()),e.on("destroy",()=>U()),e.on("store-update",()=>U())}var Mt="__COURVUX_HEAD_COLLECTOR__";function It(){return globalThis[Mt]??null}var Rt=(e,t)=>{Object.entries(t).forEach(([o,c])=>{o!=="innerHTML"&&(c==null||c===!1||e.setAttribute(o,c===!0?"":String(c)))})},zt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Ht=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,c])=>e.setAttribute(o,c))},Qe=(e,t,o,c)=>{let l=o?document.head.querySelector(o):null;l?(c.push({el:l,prevAttrs:zt(l),created:!1}),Array.from(l.attributes).forEach(y=>l.removeAttribute(y.name))):(l=document.createElement(e),document.head.appendChild(l),c.push({el:l,created:!0})),Rt(l,t)};function Nt(e){var S,x,P;const t=It();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let c;const l={},y={};if(e.title!==void 0){c=document.title;const C=e.titleTemplate,w=typeof C=="function"?C(e.title):typeof C=="string"?C.replace("%s",e.title):e.title;document.title=w}return(S=e.meta)==null||S.forEach(C=>{Qe("meta",C,C.name?`meta[name="${CSS.escape(C.name)}"]`:C.property?`meta[property="${CSS.escape(C.property)}"]`:C["http-equiv"]?`meta[http-equiv="${CSS.escape(C["http-equiv"])}"]`:null,o)}),(x=e.link)==null||x.forEach(C=>{Qe("link",C,C.rel==="canonical"?'link[rel="canonical"]':C.rel&&C.href?`link[rel="${CSS.escape(C.rel)}"][href="${CSS.escape(C.href)}"]`:null,o)}),(P=e.script)==null||P.forEach(C=>{const w=document.createElement("script");Object.entries(C).forEach(([U,T])=>{U==="innerHTML"?w.textContent=String(T):T!=null&&T!==!1&&w.setAttribute(U,T===!0?"":String(T))}),document.head.appendChild(w),o.push({el:w,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([C,w])=>{l[C]=document.documentElement.getAttribute(C),document.documentElement.setAttribute(C,w)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([C,w])=>{y[C]=document.body.getAttribute(C),document.body.setAttribute(C,w)}),function(){c!==void 0&&(document.title=c),o.forEach(({el:C,prevAttrs:w,created:U})=>{var T;U?(T=C.parentNode)==null||T.removeChild(C):w&&Ht(C,w)}),Object.entries(l).forEach(([C,w])=>{w===null?document.documentElement.removeAttribute(C):document.documentElement.setAttribute(C,w)}),Object.entries(y).forEach(([C,w])=>{w===null?document.body.removeAttribute(C):document.body.setAttribute(C,w)})}}var Fe="data-courvux-ssr",Wt=e=>e?Promise.resolve().then(e):Promise.resolve();function et(e,t){const o=e.trim();if(o.startsWith("{")){const c=o.replace(/[{}]/g,"").split(",").map(l=>l.trim()).filter(Boolean);return Object.fromEntries(c.map(l=>[l,t[l]]))}return{[o]:t}}var ye=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var k,A,n;const c={},{subscribe:l,createReactiveState:y,registerSetInterceptor:S,notifyAll:x}=Pe();let P;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),P=await t.data()):P=t.data??{},t.templateUrl){const g=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,b=await fetch(g);if(!b.ok)throw new Error(`Failed to load template: ${g} (${b.status})`);e.innerHTML=await b.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Fe),(k=e.querySelector(`[${Fe}]`))==null||k.removeAttribute(Fe);const C={};if(t.inject&&o.provided){const g=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(b=>[b,b])):t.inject;Object.entries(g).forEach(([b,E])=>{o.provided&&E in o.provided&&(C[b]=o.provided[E])})}const w=y({...o.globalProperties??{},...P,...C,...t.methods,$refs:c,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(g=>[g,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});w.$watch=(g,b,E)=>{const L=(E==null?void 0:E.deep)??!1,i=(E==null?void 0:E.immediate)??!1;let a=L?ye(w[g]):w[g];const s=l(g,()=>{const p=w[g];b.call(w,p,a),a=L?ye(p):p});return i&&b.call(w,w[g],void 0),s},w.$batch=yt,w.$nextTick=g=>Wt(g),w.$dispatch=(g,b,E)=>{e.dispatchEvent(new CustomEvent(g,{bubbles:!0,composed:!0,...E??{},detail:b}))},o.magics&&Object.entries(o.magics).forEach(([g,b])=>{w[g]=b(w)}),w.$forceUpdate=()=>x();const U=[];w.$watchEffect=g=>{let b=[];const E=()=>{b.forEach(s=>s()),b=[];const i=Ie(()=>{try{g()}catch{}}),a=new Map;for(const{sub:s,key:p}of i)a.has(s)||a.set(s,new Set),!a.get(s).has(p)&&(a.get(s).add(p),b.push(s(p,E)))};E();const L=()=>{b.forEach(a=>a()),b=[];const i=U.indexOf(L);i>-1&&U.splice(i,1)};return U.push(L),L};const T=[];t.computed&&Object.entries(t.computed).forEach(([g,b])=>{const E=typeof b=="function"?b:b.get,L=typeof b!="function"?b.set:void 0;let i=[];const a=()=>{i.forEach(u=>u()),i=[];let s;const p=Ie(()=>{try{s=E.call(w)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});w[g]=s;const m=new Map;for(const{sub:u,key:h}of p)m.has(u)||m.set(u,new Set),!m.get(u).has(h)&&(m.get(u).add(h),i.push(u(h,a)))};a(),T.push(()=>i.forEach(s=>s())),L&&S(g,s=>L.call(w,s))});const I=[];t.watch&&Object.entries(t.watch).forEach(([g,b])=>{const E=typeof b=="object"&&b!==null&&"handler"in b,L=E?b.handler:b,i=E?b.immediate??!1:!1,a=E?b.deep??!1:!1;let s=a?ye(w[g]):w[g];const p=l(g,()=>{const m=w[g];L.call(w,m,s),s=a?ye(m):m});I.push(p),i&&L.call(w,w[g],void 0)});const M={...o.provided??{}};if(t.provide){const g=typeof t.provide=="function"?t.provide.call(w):t.provide;Object.assign(M,g)}const j={...o,provided:M,components:{...o.components,...t.components}};j.mountElement=Ae(j),j.createChildScope=(g,b)=>{const E=new Set(Object.keys(g)),L=new Set(Object.keys(b)),{subscribe:i,createReactiveState:a}=Pe(),s=a(g);let p;return p=new Proxy({},{get(m,u){return typeof u!="string"?w[u]:E.has(u)?s[u]:L.has(u)?b[u].bind(p):w[u]},set(m,u,h){return typeof u!="string"?!1:E.has(u)?(s[u]=h,!0):(w[u]=h,!0)},has(m,u){return E.has(u)||L.has(u)||u in w},ownKeys(){return[...E,...L,...Object.keys(w)]},getOwnPropertyDescriptor(m,u){return E.has(u)||L.has(u)||u in w?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:p,subscribe:(m,u)=>E.has(m)?i(m,u):d(m,u),cleanup:()=>{}}},j.mountDynamic=async(g,b,E,L,i)=>{let a=null,s=null;const p=E.getAttribute("loading-template")??"",m=async()=>{var O,G,W;s==null||s(),s=null,a!=null&&a.parentNode&&(a.parentNode.removeChild(a),a=null);const u=N(b,L);if(!u)return;let h;if(typeof u=="function"){if(p){const z=document.createElement("div");z.innerHTML=p,(O=g.parentNode)==null||O.insertBefore(z,g.nextSibling),a=z}h=(await u()).default,a!=null&&a.parentNode&&(a.parentNode.removeChild(a),a=null)}else typeof u=="string"?h=(G=j.components)==null?void 0:G[u]:u&&typeof u=="object"&&(h=u);if(!h)return;const v=document.createElement("div"),_=z=>z.startsWith("@")||z.startsWith("cv:on:")||z.startsWith(":")||z.startsWith("cv-")||z.startsWith("v-slot");Array.from(E.attributes).forEach(z=>{_(z.name)||v.setAttribute(z.name,z.value)}),v.innerHTML=E.innerHTML;const D={},F={};Array.from(E.attributes).forEach(z=>{if(z.name.startsWith(":"))D[z.name.slice(1)]=N(z.value,L);else if(z.name.startsWith("@")||z.name.startsWith("cv:on:")){const J=z.value,q=z.name.startsWith("@")?z.name.slice(1):z.name.slice(6);F[q]=(...V)=>{typeof L[J]=="function"&&L[J].call(L,...V)}}});const B={...h,data:{...h.data,...D},methods:{...h.methods,$emit(z,...J){var q;pt(h,z,J),(q=F[z])==null||q.call(F,...J)}}},H={...j,components:{...j.components,...h.components}};H.mountElement=Ae(H),s=(await ne(v,B,H)).destroy,(W=g.parentNode)==null||W.insertBefore(v,g.nextSibling),a=v};Q(b,i,m),await m()};const R=[];w.$addCleanup=g=>{R.push(g)};let $=!1;const d=(g,b)=>!t.onBeforeUpdate&&!t.onUpdated?l(g,b):l(g,()=>{var E;$||($=!0,(E=t.onBeforeUpdate)==null||E.call(w),Promise.resolve().then(()=>{var L;$=!1,(L=t.onUpdated)==null||L.call(w)})),b()});try{(A=t.onBeforeMount)==null||A.call(w),await oe(e,w,{subscribe:d,refs:c,...j,registerCleanup:g=>R.push(g)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(w)}catch(g){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(w,g);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(g,w,t.name??e.tagName.toLowerCase());else throw g}const r=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,f=r?jt():0;if(r){const g=w,b=new Set,E={id:f,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const L={};for(const i of Object.keys(g))if(!(i.startsWith("$")||typeof g[i]=="function"))try{L[i]=g[i]}catch{}return L},setState:(L,i)=>{g[L]=i},subscribe:L=>(b.add(L),()=>b.delete(L)),children:[]};Object.keys(g).filter(L=>!L.startsWith("$")&&typeof g[L]!="function").forEach(L=>{l(L,()=>{r._emit("update",E),b.forEach(i=>i())})}),r._registerInstance(E),R.push(()=>r._unregisterInstance(f))}return{state:w,destroy:()=>{var g,b;(g=t.onBeforeUnmount)==null||g.call(w),T.forEach(E=>E()),I.forEach(E=>E()),U.forEach(E=>E()),R.forEach(E=>E()),(b=t.onDestroy)==null||b.call(w)},activate:()=>{var g;(g=t.onActivated)==null||g.call(w)},deactivate:()=>{var g;(g=t.onDeactivated)==null||g.call(w)},beforeLeave:t.onBeforeRouteLeave?(g,b)=>t.onBeforeRouteLeave.call(w,g,b):void 0,enter:t.onBeforeRouteEnter?g=>t.onBeforeRouteEnter.call(w,g):void 0}}function pt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const c=e.emits[t];typeof c=="function"&&!c(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ae(e){return async(t,o,c,l)=>{const y=e.components[o],S=t.getAttribute("cv-ref");S&&t.removeAttribute("cv-ref");const x={},P=[],C={};Array.from(t.attributes).filter($=>$.name==="cv-model"||$.name.startsWith("cv-model.")||$.name.startsWith("cv-model:")).forEach($=>{t.removeAttribute($.name);const d=$.value,r=$.name.indexOf(":"),f=r>=0?$.name.slice(r+1).split(".")[0]:"modelValue",k=f==="modelValue"?"update:modelValue":`update:${f}`;x[f]=Te(N(d,c)),P.push({propName:f,expr:d}),C[k]=A=>{le(d,c,A)}});const w={};Array.from(t.attributes).forEach($=>{const d=$.name.startsWith(":"),r=$.name.startsWith("@")||$.name.startsWith("cv:on:"),f=$.name==="cv-model"||$.name.startsWith("cv-model.")||$.name.startsWith("cv-model:"),k=$.name.startsWith("v-slot"),A=$.name==="slot";!d&&!r&&!f&&!k&&!A&&(w[$.name]=$.value)}),y.inheritAttrs===!1&&Object.keys(w).forEach($=>t.removeAttribute($)),Array.from(t.attributes).forEach($=>{if($.name.startsWith(":")){const d=$.name.slice(1),r=$.value;x[d]=Te(N(r,c)),P.push({propName:d,expr:r})}else if($.name.startsWith("@")||$.name.startsWith("cv:on:")){const d=$.name.startsWith("@")?$.name.slice(1):$.name.slice(6),r=$.value;C[d]=(...f)=>{typeof c[r]=="function"&&c[r].call(c,...f)}}});const U=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");U&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const T=new Map,I=[];Array.from(t.childNodes).forEach($=>{const d=$.nodeType===1?$.getAttribute("slot"):null;if(d){if(!T.has(d)){const r=t.getAttribute(`v-slot:${d}`)??null;r&&t.removeAttribute(`v-slot:${d}`),T.set(d,{nodes:[],vSlot:r})}T.get(d).nodes.push($.cloneNode(!0))}else I.push($.cloneNode(!0))});const M={};I.some($=>{var d;return $.nodeType===1||$.nodeType===3&&(((d=$.textContent)==null?void 0:d.trim())??"")!==""})&&(M.default=async $=>{const d=U?{...c,...et(U,$)}:c,r=document.createDocumentFragment();return I.forEach(f=>r.appendChild(f.cloneNode(!0))),await oe(r,d,l),Array.from(r.childNodes)});for(const[$,{nodes:d,vSlot:r}]of T)M[$]=async f=>{const k=r?{...c,...et(r,f)}:c,A=document.createDocumentFragment();return d.forEach(n=>A.appendChild(n.cloneNode(!0))),await oe(A,k,l),Array.from(A.childNodes)};const j={...e,components:{...e.components,...y.components},slots:M};j.mountElement=Ae(j);const{state:R}=await ne(t,{...y,data:{...y.data,...x,$attrs:w,$parent:c},methods:{...y.methods,$emit($,...d){var r;pt(y,$,d),(r=C[$])==null||r.call(C,...d)}}},j);R&&(P.forEach(({propName:$,expr:d})=>{ue(d,{...l,subscribe:l.subscribe},()=>{R[$]=Te(N(d,c))})}),S&&l.refs&&(l.refs[S]=R))}}function Ut(e){wt();const t=typeof window<"u"?Ft():void 0,o=[],c={...e.directives},l={...e.components??{}},y=[],S=new Map,x={},P=new Map;if(e.debug&&t&&Dt(t),t&&e.store){const T=e.store,I=Object.keys(T).filter(M=>typeof T[M]!="function");t._registerStore({getState(){const M={};return I.forEach(j=>{try{M[j]=T[j]}catch{}}),M},setState(M,j){T[M]=j},subscribe(M){const j=I.map(R=>{try{return ve(T,R,M)}catch{return()=>{}}});return()=>j.forEach(R=>R())}})}const C={router:e.router,use(T){return o.includes(T)||(o.push(T),T.install(C)),C},directive(T,I){return c[T]=I,C},component(T,I){return l[T]=I,C},provide(T,I){return typeof T=="string"?x[T]=I:Object.assign(x,T),C},magic(T,I){return P.set(`$${T}`,I),C},mount:async T=>(await U(T),C),mountAll:async(T="[data-courvux]")=>{const I=Array.from(document.querySelectorAll(T));return await Promise.all(I.map(M=>w(M))),C},mountEl:async T=>w(T),unmount(T){if(!T)y.forEach(I=>I()),y.length=0,S.clear();else{const I=document.querySelector(T);if(I){const M=S.get(I);if(M){M(),S.delete(I);const j=y.indexOf(M);j>-1&&y.splice(j,1)}}}return C},destroy(){y.forEach(T=>T()),y.length=0,S.clear()}},w=async T=>{const I=new URL(".",document.baseURI).href,M={components:l,router:e.router,store:e.store,directives:c,baseUrl:I,provided:{...x},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:P.size?Object.fromEntries(P):void 0};if(M.mountElement=Ae(M),e.router){const R=e.router;M.mountRouterView=async($,d)=>{await new Promise(r=>{Je($,R,async(f,k,A,n,g)=>{const b={...M,currentRoute:A};if(g){let E=null;const L={...b,mountRouterView:async(i,a)=>{E=Je(i,g,async(s,p,m,u)=>{const h={...b,currentRoute:m};if(u){let v=null;const _={...h,mountRouterView:async(F,B)=>{v=await ne(F,p,h)}},{destroy:D}=await ne(s,{template:u},_);return{destroy:()=>{v==null||v.destroy(),D()},activate:()=>v==null?void 0:v.activate(),deactivate:()=>v==null?void 0:v.deactivate()}}else return await ne(s,p,h)},a)}};if(n){let i=null;const a={...L,mountRouterView:async(p,m)=>{i=await ne(p,k,L)}},{destroy:s}=await ne(f,{template:n},a);return{destroy:()=>{E==null||E(),i==null||i.destroy(),s()},activate:()=>i==null?void 0:i.activate(),deactivate:()=>i==null?void 0:i.deactivate()}}else{const i=await ne(f,k,L);return{destroy:()=>{E==null||E(),i.destroy()},activate:()=>i.activate(),deactivate:()=>i.deactivate()}}}else if(n){let E=null;const L={...b,mountRouterView:async(a,s)=>{E=await ne(a,k,b)}},{destroy:i}=await ne(f,{template:n},L);return{destroy:()=>{E==null||E.destroy(),i()},activate:()=>E==null?void 0:E.activate(),deactivate:()=>E==null?void 0:E.deactivate()}}else return await ne(f,k,b)},d,r)})}}const j=await ne(T,e,M);return y.push(j.destroy),S.set(T,j.destroy),j.state},U=async T=>{const I=document.querySelector(T);if(I)return w(I)};return C}var tt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Bt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Oe={exports:{}},ot;function qt(){return ot||(ot=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
 ...
 * @namespace
 * @public
 */var o=(function(c){var l=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,y=0,S={},x={manual:c.Prism&&c.Prism.manual,disableWorkerMessageHandler:c.Prism&&c.Prism.disableWorkerMessageHandler,util:{encode:function d(r){return r instanceof P?new P(r.type,d(r.content),r.alias):Array.isArray(r)?r.map(d):r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(d){return Object.prototype.toString.call(d).slice(8,-1)},objId:function(d){return d.__id||Object.defineProperty(d,"__id",{value:++y}),d.__id},clone:function d(r,f){f=f||{};var k,A;switch(x.util.type(r)){case"Object":if(A=x.util.objId(r),f[A])return f[A];k={},f[A]=k;for(var n in r)r.hasOwnProperty(n)&&(k[n]=d(r[n],f));return k;case"Array":return A=x.util.objId(r),f[A]?f[A]:(k=[],f[A]=k,r.forEach(function(g,b){k[b]=d(g,f)}),k);default:return r}},getLanguage:function(d){for(;d;){var r=l.exec(d.className);if(r)return r[1].toLowerCase();d=d.parentElement}return"none"},setLanguage:function(d,r){d.className=d.className.replace(RegExp(l,"gi"),""),d.classList.add("language-"+r)},currentScript:function(){if(typeof document>"u")return null;if(document.currentScript&&document.currentScript.tagName==="SCRIPT")return document.currentScript;try{throw new Error}catch(k){var d=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(k.stack)||[])[1];if(d){var r=document.getElementsByTagName("script");for(var f in r)if(r[f].src==d)return r[f]}return null}},isActive:function(d,r,f){for(var k="no-"+r;d;){var A=d.classList;if(A.contains(r))return!0;if(A.contains(k))return!1;d=d.parentElement}return!!f}},languages:{plain:S,plaintext:S,text:S,txt:S,extend:function(d,r){var f=x.util.clone(x.languages[d]);for(var k in r)f[k]=r[k];return f},insertBefore:function(d,r,f,k){k=k||x.languages;var A=k[d],n={};for(var g in A)if(A.hasOwnProperty(g)){if(g==r)for(var b in f)f.hasOwnProperty(b)&&(n[b]=f[b]);f.hasOwnProperty(g)||(n[g]=A[g])}var E=k[d];return k[d]=n,x.languages.DFS(x.languages,function(L,i){i===E&&L!=d&&(this[L]=n)}),n},DFS:function d(r,f,k,A){A=A||{};var n=x.util.objId;for(var g in r)if(r.hasOwnProperty(g)){f.call(r,g,r[g],k||g);var b=r[g],E=x.util.type(b);E==="Object"&&!A[n(b)]?(A[n(b)]=!0,d(b,f,null,A)):E==="Array"&&!A[n(b)]&&(A[n(b)]=!0,d(b,f,g,A))}}},plugins:{},highlightAll:function(d,r){x.highlightAllUnder(document,d,r)},highlightAllUnder:function(d,r,f){var k={callback:f,container:d,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};x.hooks.run("before-highlightall",k),k.elements=Array.prototype.slice.apply(k.container.querySelectorAll(k.selector)),x.hooks.run("before-all-elements-highlight",k);for(var A=0,n;n=k.elements[A++];)x.highlightElement(n,r===!0,k.callback)},highlightElement:function(d,r,f){var k=x.util.getLanguage(d),A=x.languages[k];x.util.setLanguage(d,k);var n=d.parentElement;n&&n.nodeName.toLowerCase()==="pre"&&x.util.setLanguage(n,k);var g=d.textContent,b={element:d,language:k,grammar:A,code:g};function E(i){b.highlightedCode=i,x.hooks.run("before-insert",b),b.element.innerHTML=b.highlightedCode,x.hooks.run("after-highlight",b),x.hooks.run("complete",b),f&&f.call(b.element)}if(x.hooks.run("before-sanity-check",b),n=b.element.parentElement,n&&n.nodeName.toLowerCase()==="pre"&&!n.hasAttribute("tabindex")&&n.setAttribute("tabindex","0"),!b.code){x.hooks.run("complete",b),f&&f.call(b.element);return}if(x.hooks.run("before-highlight",b),!b.grammar){E(x.util.encode(b.code));return}if(r&&c.Worker){var L=new Worker(x.filename);L.onmessage=function(i){E(i.data)},L.postMessage(JSON.stringify({language:b.language,code:b.code,immediateClose:!0}))}else E(x.highlight(b.code,b.grammar,b.language))},highlight:function(d,r,f){var k={code:d,grammar:r,language:f};if(x.hooks.run("before-tokenize",k),!k.grammar)throw new Error('The language "'+k.language+'" has no grammar.');return k.tokens=x.tokenize(k.code,k.grammar),x.hooks.run("after-tokenize",k),P.stringify(x.util.encode(k.tokens),k.language)},tokenize:function(d,r){var f=r.rest;if(f){for(var k in f)r[k]=f[k];delete r.rest}var A=new U;return T(A,A.head,d),w(d,A,r,A.head,0),M(A)},hooks:{all:{},add:function(d,r){var f=x.hooks.all;f[d]=f[d]||[],f[d].push(r)},run:function(d,r){var f=x.hooks.all[d];if(!(!f||!f.length))for(var k=0,A;A=f[k++];)A(r)}},Token:P};c.Prism=x;function P(d,r,f,k){this.type=d,this.content=r,this.alias=f,this.length=(k||"").length|0}P.stringify=function d(r,f){if(typeof r=="string")return r;if(Array.isArray(r)){var k="";return r.forEach(function(E){k+=d(E,f)}),k}var A={type:r.type,content:d(r.content,f),tag:"span",classes:["token",r.type],attributes:{},language:f},n=r.alias;n&&(Array.isArray(n)?Array.prototype.push.apply(A.classes,n):A.classes.push(n)),x.hooks.run("wrap",A);var g="";for(var b in A.attributes)g+=" "+b+'="'+(A.attributes[b]||"").replace(/"/g,"&quot;")+'"';return"<"+A.tag+' class="'+A.classes.join(" ")+'"'+g+">"+A.content+"</"+A.tag+">"};function C(d,r,f,k){d.lastIndex=r;var A=d.exec(f);if(A&&k&&A[1]){var n=A[1].length;A.index+=n,A[0]=A[0].slice(n)}return A}function w(d,r,f,k,A,n){for(var g in f)if(!(!f.hasOwnProperty(g)||!f[g])){var b=f[g];b=Array.isArray(b)?b:[b];for(var E=0;E<b.length;++E){if(n&&n.cause==g+","+E)return;var L=b[E],i=L.inside,a=!!L.lookbehind,s=!!L.greedy,p=L.alias;if(s&&!L.pattern.global){var m=L.pattern.toString().match(/[imsuy]*$/)[0];L.pattern=RegExp(L.pattern.source,m+"g")}for(var u=L.pattern||L,h=k.next,v=A;h!==r.tail&&!(n&&v>=n.reach);v+=h.value.length,h=h.next){var _=h.value;if(r.length>d.length)return;if(!(_ instanceof P)){var D=1,F;if(s){if(F=C(u,v,d,a),!F||F.index>=d.length)break;var G=F.index,B=F.index+F[0].length,H=v;for(H+=h.value.length;G>=H;)h=h.next,H+=h.value.length;if(H-=h.value.length,v=H,h.value instanceof P)continue;for(var O=h;O!==r.tail&&(H<B||typeof O.value=="string");O=O.next)D++,H+=O.value.length;D--,_=d.slice(v,H),F.index-=v}else if(F=C(u,0,_,a),!F)continue;var G=F.index,W=F[0],z=_.slice(0,G),J=_.slice(G+W.length),q=v+_.length;n&&q>n.reach&&(n.reach=q);var V=h.prev;z&&(V=T(r,V,z),v+=z.length),I(r,V,D);var te=new P(g,i?x.tokenize(W,i):W,p,W);if(h=T(r,V,te),J&&T(r,h,J),D>1){var K={cause:g+","+E,reach:q};w(d,r,f,h.prev,v,K),n&&K.reach>n.reach&&(n.reach=K.reach)}}}}}}function U(){var d={value:null,prev:null,next:null},r={value:null,prev:d,next:null};d.next=r,this.head=d,this.tail=r,this.length=0}function T(d,r,f){var k=r.next,A={value:f,prev:r,next:k};return r.next=A,k.prev=A,d.length++,A}function I(d,r,f){for(var k=r.next,A=0;A<f&&k!==d.tail;A++)k=k.next;r.next=k,k.prev=r,d.length-=A}function M(d){for(var r=[],f=d.head.next;f!==d.tail;)r.push(f.value),f=f.next;return r}if(!c.document)return c.addEventListener&&(x.disableWorkerMessageHandler||c.addEventListener("message",function(d){var r=JSON.parse(d.data),f=r.language,k=r.code,A=r.immediateClose;c.postMessage(x.highlight(k,x.languages[f],f)),A&&c.close()},!1)),x;var j=x.util.currentScript();j&&(x.filename=j.src,j.hasAttribute("data-manual")&&(x.manual=!0));function R(){x.manual||x.highlightAll()}if(!x.manual){var $=document.readyState;$==="loading"||$==="interactive"&&j&&j.defer?document.addEventListener("DOMContentLoaded",R):window.requestAnimationFrame?window.requestAnimationFrame(R):window.setTimeout(R,16)}return x})(t);e.exports&&(e.exports=o),typeof tt<"u"&&(tt.Prism=o),o.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},o.languages.markup.tag.inside["attr-value"].inside.entity=o.languages.markup.entity,o.languages.markup.doctype.inside["internal-subset"].inside=o.languages.markup,o.hooks.add("wrap",function(c){c.type==="entity"&&(c.attributes.title=c.content.replace(/&amp;/,"&"))}),Object.defineProperty(o.languages.markup.tag,"addInlined",{value:function(l,y){var S={};S["language-"+y]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:o.languages[y]},S.cdata=/^<!\[CDATA\[|\]\]>$/i;var x={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:S}};x["language-"+y]={pattern:/[\s\S]+/,inside:o.languages[y]};var P={};P[l]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return l}),"i"),lookbehind:!0,greedy:!0,inside:x},o.languages.insertBefore("markup","cdata",P)}}),Object.defineProperty(o.languages.markup.tag,"addAttribute",{value:function(c,l){o.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+c+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[l,"language-"+l],inside:o.languages[l]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),o.languages.html=o.languages.markup,o.languages.mathml=o.languages.markup,o.languages.svg=o.languages.markup,o.languages.xml=o.languages.extend("markup",{}),o.languages.ssml=o.languages.xml,o.languages.atom=o.languages.xml,o.languages.rss=o.languages.xml,(function(c){var l=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;c.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+l.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+l.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+l.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+l.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:l,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},c.languages.css.atrule.inside.rest=c.languages.css;var y=c.languages.markup;y&&(y.tag.addInlined("style","css"),y.tag.addAttribute("style","css"))})(o),o.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},o.languages.javascript=o.languages.extend("clike",{"class-name":[o.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),o.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,o.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:o.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:o.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:o.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:o.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:o.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),o.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:o.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),o.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),o.languages.markup&&(o.languages.markup.tag.addInlined("script","javascript"),o.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),o.languages.js=o.languages.javascript,(function(){if(typeof o>"u"||typeof document>"u")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var c="Loading…",l=function(j,R){return"✖ Error "+j+" while fetching file: "+R},y="✖ Error: File does not exist or is empty",S={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},x="data-src-status",P="loading",C="loaded",w="failed",U="pre[data-src]:not(["+x+'="'+C+'"]):not(['+x+'="'+P+'"])';function T(j,R,$){var d=new XMLHttpRequest;d.open("GET",j,!0),d.onreadystatechange=function(){d.readyState==4&&(d.status<400&&d.responseText?R(d.responseText):d.status>=400?$(l(d.status,d.statusText)):$(y))},d.send(null)}function I(j){var R=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(j||"");if(R){var $=Number(R[1]),d=R[2],r=R[3];return d?r?[$,Number(r)]:[$,void 0]:[$,$]}}o.hooks.add("before-highlightall",function(j){j.selector+=", "+U}),o.hooks.add("before-sanity-check",function(j){var R=j.element;if(R.matches(U)){j.code="",R.setAttribute(x,P);var $=R.appendChild(document.createElement("CODE"));$.textContent=c;var d=R.getAttribute("data-src"),r=j.language;if(r==="none"){var f=(/\.(\w+)$/.exec(d)||[,"none"])[1];r=S[f]||f}o.util.setLanguage($,r),o.util.setLanguage(R,r);var k=o.plugins.autoloader;k&&k.loadLanguages(r),T(d,function(A){R.setAttribute(x,C);var n=I(R.getAttribute("data-range"));if(n){var g=A.split(/\r\n?|\n/g),b=n[0],E=n[1]==null?g.length:n[1];b<0&&(b+=g.length),b=Math.max(0,Math.min(b-1,g.length)),E<0&&(E+=g.length),E=Math.max(0,Math.min(E,g.length)),A=g.slice(b,E).join(`
`),R.hasAttribute("data-start")||R.setAttribute("data-start",String(b+1))}$.textContent=A,o.highlightElement($)},function(A){R.setAttribute(x,w),$.textContent=A})}}),o.plugins.fileHighlight={highlight:function(R){for(var $=(R||document).querySelectorAll(U),d=0,r;r=$[d++];)o.highlightElement(r)}};var M=!1;o.fileHighlight=function(){M||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),M=!0),o.plugins.fileHighlight.highlight.apply(this,arguments)}})()})(Oe)),Oe.exports}var Vt=qt();const Gt=Bt(Vt);Prism.languages.javascript=Prism.languages.extend("clike",{"class-name":[Prism.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/});Prism.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/;Prism.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:Prism.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:Prism.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/});Prism.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:Prism.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}});Prism.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}});Prism.languages.markup&&(Prism.languages.markup.tag.addInlined("script","javascript"),Prism.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript"));Prism.languages.js=Prism.languages.javascript;Prism.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]};Prism.languages.markup.tag.inside["attr-value"].inside.entity=Prism.languages.markup.entity;Prism.languages.markup.doctype.inside["internal-subset"].inside=Prism.languages.markup;Prism.hooks.add("wrap",function(e){e.type==="entity"&&(e.attributes.title=e.content.replace(/&amp;/,"&"))});Object.defineProperty(Prism.languages.markup.tag,"addInlined",{value:function(t,o){var c={};c["language-"+o]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:Prism.languages[o]},c.cdata=/^<!\[CDATA\[|\]\]>$/i;var l={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:c}};l["language-"+o]={pattern:/[\s\S]+/,inside:Prism.languages[o]};var y={};y[t]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return t}),"i"),lookbehind:!0,greedy:!0,inside:l},Prism.languages.insertBefore("markup","cdata",y)}});Object.defineProperty(Prism.languages.markup.tag,"addAttribute",{value:function(e,t){Prism.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+e+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[t,"language-"+t],inside:Prism.languages[t]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}});Prism.languages.html=Prism.languages.markup;Prism.languages.mathml=Prism.languages.markup;Prism.languages.svg=Prism.languages.markup;Prism.languages.xml=Prism.languages.extend("markup",{});Prism.languages.ssml=Prism.languages.xml;Prism.languages.atom=Prism.languages.xml;Prism.languages.rss=Prism.languages.xml;(function(e){var t="\\b(?:BASH|BASHOPTS|BASH_ALIASES|BASH_ARGC|BASH_ARGV|BASH_CMDS|BASH_COMPLETION_COMPAT_DIR|BASH_LINENO|BASH_REMATCH|BASH_SOURCE|BASH_VERSINFO|BASH_VERSION|COLORTERM|COLUMNS|COMP_WORDBREAKS|DBUS_SESSION_BUS_ADDRESS|DEFAULTS_PATH|DESKTOP_SESSION|DIRSTACK|DISPLAY|EUID|GDMSESSION|GDM_LANG|GNOME_KEYRING_CONTROL|GNOME_KEYRING_PID|GPG_AGENT_INFO|GROUPS|HISTCONTROL|HISTFILE|HISTFILESIZE|HISTSIZE|HOME|HOSTNAME|HOSTTYPE|IFS|INSTANCE|JOB|LANG|LANGUAGE|LC_ADDRESS|LC_ALL|LC_IDENTIFICATION|LC_MEASUREMENT|LC_MONETARY|LC_NAME|LC_NUMERIC|LC_PAPER|LC_TELEPHONE|LC_TIME|LESSCLOSE|LESSOPEN|LINES|LOGNAME|LS_COLORS|MACHTYPE|MAILCHECK|MANDATORY_PATH|NO_AT_BRIDGE|OLDPWD|OPTERR|OPTIND|ORBIT_SOCKETDIR|OSTYPE|PAPERSIZE|PATH|PIPESTATUS|PPID|PS1|PS2|PS3|PS4|PWD|RANDOM|REPLY|SECONDS|SELINUX_INIT|SESSION|SESSIONTYPE|SESSION_MANAGER|SHELL|SHELLOPTS|SHLVL|SSH_AUTH_SOCK|TERM|UID|UPSTART_EVENTS|UPSTART_INSTANCE|UPSTART_JOB|UPSTART_SESSION|USER|WINDOWID|XAUTHORITY|XDG_CONFIG_DIRS|XDG_CURRENT_DESKTOP|XDG_DATA_DIRS|XDG_GREETER_DATA_DIR|XDG_MENU_PREFIX|XDG_RUNTIME_DIR|XDG_SEAT|XDG_SEAT_PATH|XDG_SESSION_DESKTOP|XDG_SESSION_ID|XDG_SESSION_PATH|XDG_SESSION_TYPE|XDG_VTNR|XMODIFIERS)\\b",o={pattern:/(^(["']?)\w+\2)[ \t]+\S.*/,lookbehind:!0,alias:"punctuation",inside:null},c={bash:o,environment:{pattern:RegExp("\\$"+t),alias:"constant"},variable:[{pattern:/\$?\(\([\s\S]+?\)\)/,greedy:!0,inside:{variable:[{pattern:/(^\$\(\([\s\S]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b0x[\dA-Fa-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:[Ee]-?\d+)?/,operator:/--|\+\+|\*\*=?|<<=?|>>=?|&&|\|\||[=!+\-*/%<>^&|]=?|[?~:]/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/,greedy:!0,inside:{variable:/^\$\(|^`|\)$|`$/}},{pattern:/\$\{[^}]+\}/,greedy:!0,inside:{operator:/:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,punctuation:/[\[\]]/,environment:{pattern:RegExp("(\\{)"+t),lookbehind:!0,alias:"constant"}}},/\$(?:\w+|[#?*!@$])/],entity:/\\(?:[abceEfnrtv\\"]|O?[0-7]{1,3}|U[0-9a-fA-F]{8}|u[0-9a-fA-F]{4}|x[0-9a-fA-F]{1,2})/};e.languages.bash={shebang:{pattern:/^#!\s*\/.*/,alias:"important"},comment:{pattern:/(^|[^"{\\$])#.*/,lookbehind:!0},"function-name":[{pattern:/(\bfunction\s+)[\w-]+(?=(?:\s*\(?:\s*\))?\s*\{)/,lookbehind:!0,alias:"function"},{pattern:/\b[\w-]+(?=\s*\(\s*\)\s*\{)/,alias:"function"}],"for-or-select":{pattern:/(\b(?:for|select)\s+)\w+(?=\s+in\s)/,alias:"variable",lookbehind:!0},"assign-left":{pattern:/(^|[\s;|&]|[<>]\()\w+(?:\.\w+)*(?=\+?=)/,inside:{environment:{pattern:RegExp("(^|[\\s;|&]|[<>]\\()"+t),lookbehind:!0,alias:"constant"}},alias:"variable",lookbehind:!0},parameter:{pattern:/(^|\s)-{1,2}(?:\w+:[+-]?)?\w+(?:\.\w+)*(?=[=\s]|$)/,alias:"variable",lookbehind:!0},string:[{pattern:/((?:^|[^<])<<-?\s*)(\w+)\s[\s\S]*?(?:\r?\n|\r)\2/,lookbehind:!0,greedy:!0,inside:c},{pattern:/((?:^|[^<])<<-?\s*)(["'])(\w+)\2\s[\s\S]*?(?:\r?\n|\r)\3/,lookbehind:!0,greedy:!0,inside:{bash:o}},{pattern:/(^|[^\\](?:\\\\)*)"(?:\\[\s\S]|\$\([^)]+\)|\$(?!\()|`[^`]+`|[^"\\`$])*"/,lookbehind:!0,greedy:!0,inside:c},{pattern:/(^|[^$\\])'[^']*'/,lookbehind:!0,greedy:!0},{pattern:/\$'(?:[^'\\]|\\[\s\S])*'/,greedy:!0,inside:{entity:c.entity}}],environment:{pattern:RegExp("\\$?"+t),alias:"constant"},variable:c.variable,function:{pattern:/(^|[\s;|&]|[<>]\()(?:add|apropos|apt|apt-cache|apt-get|aptitude|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cargo|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|docker|docker-compose|du|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|java|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|node|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|podman|podman-compose|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|sysctl|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vcpkg|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|whereis|which|who|whoami|write|xargs|xdg-open|yarn|yes|zenity|zip|zsh|zypper)(?=$|[)\s;|&])/,lookbehind:!0},keyword:{pattern:/(^|[\s;|&]|[<>]\()(?:case|do|done|elif|else|esac|fi|for|function|if|in|select|then|until|while)(?=$|[)\s;|&])/,lookbehind:!0},builtin:{pattern:/(^|[\s;|&]|[<>]\()(?:\.|:|alias|bind|break|builtin|caller|cd|command|continue|declare|echo|enable|eval|exec|exit|export|getopts|hash|help|let|local|logout|mapfile|printf|pwd|read|readarray|readonly|return|set|shift|shopt|source|test|times|trap|type|typeset|ulimit|umask|unalias|unset)(?=$|[)\s;|&])/,lookbehind:!0,alias:"class-name"},boolean:{pattern:/(^|[\s;|&]|[<>]\()(?:false|true)(?=$|[)\s;|&])/,lookbehind:!0},"file-descriptor":{pattern:/\B&\d\b/,alias:"important"},operator:{pattern:/\d?<>|>\||\+=|=[=~]?|!=?|<<[<-]?|[&\d]?>>|\d[<>]&?|[<>][&=]?|&[>&]?|\|[&|]?/,inside:{"file-descriptor":{pattern:/^\d/,alias:"important"}}},punctuation:/\$?\(\(?|\)\)?|\.\.|[{}[\];\\]/,number:{pattern:/(^|\s)(?:[1-9]\d*|0)(?:[.,]\d+)?\b/,lookbehind:!0}},o.inside=e.languages.bash;for(var l=["comment","function-name","for-or-select","assign-left","parameter","string","environment","function","keyword","builtin","boolean","file-descriptor","operator","punctuation","number"],y=c.variable[1].inside,S=0;S<l.length;S++)y[l[S]]=e.languages.bash[l[S]];e.languages.sh=e.languages.bash,e.languages.shell=e.languages.bash})(Prism);Prism.languages.json={property:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?=\s*:)/,lookbehind:!0,greedy:!0},string:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?!\s*:)/,lookbehind:!0,greedy:!0},comment:{pattern:/\/\/.*|\/\*[\s\S]*?(?:\*\/|$)/,greedy:!0},number:/-?\b\d+(?:\.\d+)?(?:e[+-]?\d+)?\b/i,punctuation:/[{}[\],]/,operator:/:/,boolean:/\b(?:false|true)\b/,null:{pattern:/\bnull\b/,alias:"keyword"}};Prism.languages.webmanifest=Prism.languages.json;var nt={},at;function Yt(){return at||(at=1,(function(e){e.languages.typescript=e.languages.extend("javascript",{"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|type)\s+)(?!keyof\b)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?:\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/,lookbehind:!0,greedy:!0,inside:null},builtin:/\b(?:Array|Function|Promise|any|boolean|console|never|number|string|symbol|unknown)\b/}),e.languages.typescript.keyword.push(/\b(?:abstract|declare|is|keyof|readonly|require)\b/,/\b(?:asserts|infer|interface|module|namespace|type)\b(?=\s*(?:[{_$a-zA-Z\xA0-\uFFFF]|$))/,/\btype\b(?=\s*(?:[\{*]|$))/),delete e.languages.typescript.parameter,delete e.languages.typescript["literal-property"];var t=e.languages.extend("typescript",{});delete t["class-name"],e.languages.typescript["class-name"].inside=t,e.languages.insertBefore("typescript","function",{decorator:{pattern:/@[$\w\xA0-\uFFFF]+/,inside:{at:{pattern:/^@/,alias:"operator"},function:/^[\s\S]+/}},"generic-function":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>(?=\s*\()/,greedy:!0,inside:{function:/^#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*/,generic:{pattern:/<[\s\S]+/,alias:"class-name",inside:t}}}}),e.languages.ts=e.languages.typescript})(Prism)),nt}Yt();const Xt={js:"JavaScript",ts:"TypeScript",html:"HTML",bash:"Shell",json:"JSON"};function Zt(e){const t=e.split(`
...
`)}const Jt={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,computed:{langLabel(){return Xt[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=Zt(this.code),e.textContent=this._cleanCode,Gt.highlightElement(e))}},he="Courvux",Kt="https://vanjexdev.github.io/courvux";function Z({title:e,description:t,slug:o="/"}){const c=e?`${e} — ${he}`:`${he} — Lightweight reactive UI framework`,l=Kt+o;return Nt({title:e??`${he} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${he}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:c},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:l},{property:"og:site_name",content:he},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:c},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:l}]})}const Qt={data:{install:`# From GitHub — pin a tag for stable installs
