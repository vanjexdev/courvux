(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const p of s)if(p.type==="childList")for(const k of p.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&i(k)}).observe(document,{childList:!0,subtree:!0});function o(s){const p={};return s.integrity&&(p.integrity=s.integrity),s.referrerPolicy&&(p.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?p.credentials="include":s.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function i(s){if(s.ep)return;s.ep=!0;const p=o(s);fetch(s.href,p)}})();var St=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),ut=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,Ie=new WeakSet,Ae=Symbol("raw"),Oe=e=>e===null||typeof e!="object"?e:e[Ae]??e,ke=0,Me=new Map,ve=null;function Ne(e){const t=[],o=ve;ve=t;try{e()}finally{ve=o}return t}function At(e){ke++;try{e()}finally{if(ke--,ke===0){const t=[...Me.values()];Me.clear(),t.forEach(o=>o())}}}function pt(e,t){return e===null||typeof e!="object"||Ie.has(e)||ut(e)?e:new Proxy(e,{get(o,i){if(i===Ae)return o[Ae]??o;if(typeof i=="string"&&Array.isArray(o)&&St.has(i))return(...p)=>{const k=Array.prototype[i].apply(o,p);return t(),k};const s=o[i];return s!==null&&typeof s=="object"&&!Ie.has(s)?pt(s,t):s},set(o,i,s){return o[i]=s,t(),!0}})}function Le(){const e={},t=Math.random().toString(36).slice(2),o=(p,k)=>(e[p]||(e[p]=new Set),e[p].add(k),()=>{var f;(f=e[p])==null||f.delete(k)}),i=p=>{ke>0?Me.set(`${t}:${p}`,()=>{(e[p]?[...e[p]]:[]).forEach(k=>k())}):(e[p]?[...e[p]]:[]).forEach(k=>k())},s={};return{subscribe:o,createReactiveState:p=>new Proxy(p,{get(k,f){if(f===Ae)return p;typeof f=="string"&&!f.startsWith("$")&&ve&&ve.push({sub:o,key:f});const P=k[f];return typeof f=="string"&&!f.startsWith("$")&&P!==null&&typeof P=="object"&&!Ie.has(P)&&!ut(P)?pt(P,()=>i(f)):P},set(k,f,P){if(s[f])return s[f](P),!0;const $=k[f];return k[f]=P,($!==P||P!==null&&typeof P=="object")&&i(f),!0}}),registerSetInterceptor:(p,k)=>{s[p]=k},notifyAll:()=>{Object.keys(e).forEach(p=>i(p))}}}var Fe=new WeakMap;function be(e,t,o){var s,p;const i=t.indexOf(".");if(i>=0){const k=t.slice(0,i),f=t.slice(i+1),P=e[k];return P&&Fe.has(P)?be(P,f,o):((s=Fe.get(e))==null?void 0:s(k,o))??(()=>{})}return((p=Fe.get(e))==null?void 0:p(t,o))??(()=>{})}var mt=(e,t)=>e.split(".").reduce((o,i)=>o==null?void 0:o[i],t),He=(()=>{try{return new Function("return 1")(),!0}catch{return console.warn("[courvux] CSP blocks eval. Expressions limited to property access and literals."),!1}})(),We=new Map,Ue=new Map,_e=new WeakMap,_t=(e,t)=>{const o=_e.get(e);o?Object.assign(o,t):_e.set(e,{...t})},ht=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!ht(o.slice(1).trim(),t):mt(o,t)},W=(e,t)=>{var i;const o=(i=_e.get(t))==null?void 0:i[e];if(o)try{return o(t)}catch{}if(!He)return ht(e,t);try{let s=We.get(e);return s||(s=new Function("$data",`with($data) { return (${e}) }`),We.set(e,s)),s(t)}catch{return mt(e,t)}},ft=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):be(t.store,e.slice(7),o):t.subscribe(e,o),J=(e,t,o)=>{const i=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),s=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],p=[...new Set(s.map(f=>f.startsWith("$store.")?f:f.split(".")[0]).filter(f=>!i.has(f)))];if(p.length===0)return()=>{};const k=p.map(f=>ft(f,t,o));return()=>k.forEach(f=>f())},Be=new Map,Ct=e=>{const t=Be.get(e);if(t)return t;const o=e.trim();let i=0,s=-1,p=null;for(let f=0;f<o.length;f++){const P=o[f];P==="["?(i===0&&(s=f,p="bracket"),i++):P==="]"?i--:P==="."&&i===0&&(s=f,p="dot")}let k;if(s<0)k={parent:"",keyExpr:JSON.stringify(o)};else if(p==="dot")k={parent:o.slice(0,s),keyExpr:JSON.stringify(o.slice(s+1))};else{const f=o.lastIndexOf("]");k=f>s?{parent:o.slice(0,s),keyExpr:o.slice(s+1,f)}:{parent:"",keyExpr:JSON.stringify(o)}}return Be.set(e,k),k},pe=(e,t,o)=>{if(He)try{const{parent:s,keyExpr:p}=Ct(e),k=s?W(s,t):t,f=W(p,t);if(k==null)return;k[f]=o;return}catch(s){console.warn(`[courvux] setStateValue: write failed for "${e}":`,s);return}const i=e.split(".");if(i.length===1)t[i[0]]=o;else{const s=i.slice(0,-1).reduce((p,k)=>p==null?void 0:p[k],t);s&&(s[i[i.length-1]]=o)}},qe=(e,t,o,i,s)=>{const p={};return Object.keys(e).forEach(k=>p[k]=e[k]),p[o]=t,s&&(p[s]=i),p},Re=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(Re).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Ve=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([i,s])=>{e.style[i]=s??""}))},Ge=(e,t,o)=>{var s;const i=(s=_e.get(t))==null?void 0:s[e];if(i)try{i(new Proxy(t,{get(p,k){return k==="$event"?o:p[k]},set(p,k,f){return p[k]=f,!0},has(p,k){return!0}}));return}catch(p){console.warn(`[courvux] handler error "${e}":`,p);return}if(He)try{let p=Ue.get(e);p||(p=new Function("__p__",`with(__p__){${e}}`),Ue.set(e,p));const k=new Proxy({},{has:()=>!0,get:(f,P)=>P==="$event"?o:P in t?t[P]:globalThis[P],set:(f,P,$)=>(t[P]=$,!0)});p(k)}catch(p){console.warn(`[courvux] handler error "${e}":`,p)}},ce=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(i=>{const s=()=>i();e.addEventListener("animationend",s,{once:!0}),e.addEventListener("transitionend",s,{once:!0}),setTimeout(s,o+50)})},Et=`
...
`,Ye=!1;function Xe(){if(Ye||typeof document>"u")return;Ye=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=Et,document.head.appendChild(e)}var Je=!1;function Tt(){if(Je||typeof document>"u")return;Je=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function $t(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(i=>{(i.name.startsWith("on")||i.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(i.name)})}),t.body.innerHTML}async function te(e,t,o){var p,k,f,P,$,_,M,T,L,z,j,R,C,c,d,m,w;const i=Array.from(e.childNodes);let s=0;for(;s<i.length;){const S=i[s];if(S.nodeType===3){const a=S.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,v=()=>{let h=r;l.forEach(u=>{const g=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");h=h.replace(u,W(g,t)??"")}),S.textContent=h};l.forEach(h=>{J(h.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,v)}),v()}s++;continue}if(S.nodeType!==1){s++;continue}const n=S,y=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),s++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await te(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),s++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await te(n,t,o),l.appendChild(n),s++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(g=>W(g.trim(),t));let r=l();const v=[],h=g=>(v.push(g),()=>{const b=v.indexOf(g);b>-1&&v.splice(b,1)});await te(n,t,{...o,subscribe:(g,b)=>h(b),storeSubscribeOverride:(g,b,E)=>h(E)});const u=J(a,o,()=>{const g=l();g.some((b,E)=>b!==r[E])&&(r=g,[...v].forEach(b=>b()))});(p=o.registerCleanup)==null||p.call(o,()=>u()),s++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const v=W(a,t)??{};Object.entries(v).forEach(([h,u])=>{typeof u=="function"?r[h]=u:l[h]=u})}else if(a){const v=(k=o.components)==null?void 0:k[a];if(v){const h=typeof v.data=="function"?v.data():v.data??{};h instanceof Promise||Object.assign(l,h),Object.assign(r,v.methods??{})}}if(o.createChildScope){const v=o.createChildScope(l,r);(f=o.registerCleanup)==null||f.call(o,v.cleanup),await te(n,v.state,{...o,subscribe:v.subscribe})}else await te(n,{...t,...l,...r},o);s++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,v,h]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const g=n.getAttribute("cv-transition")??null;g&&n.removeAttribute("cv-transition");const b=document.createComment(`cv-for: ${h}`);n.replaceWith(b);let E=[],O=[];const F=new Map;let U=!1,N=!1;const I=async()=>{var K;const B=W(h,t),H=B?typeof B=="number"?Array.from({length:B},(V,q)=>[q+1,q]):Array.isArray(B)?B.map((V,q)=>[V,q]):Object.entries(B).map(([V,q])=>[q,V]):[];if(u){const V=[],q=new Map,de=new Set;for(const[X,Y]of H){const ae=W(u,qe(t,X,r,Y,v));de.has(ae)&&console.warn(`[courvux] cv-for: duplicate :key "${ae}" in "${h}"`),de.add(ae),V.push(ae),q.set(ae,[X,Y])}const Q=[];for(const[X,{el:Y,destroy:ae}]of F)q.has(X)||(g?(Y.classList.add(`${g}-leave`),Q.push(ce(Y).then(()=>{var ie;Y.classList.remove(`${g}-leave`),ae(),(ie=Y.parentNode)==null||ie.removeChild(Y),F.delete(X)}))):(ae(),(K=Y.parentNode)==null||K.removeChild(Y),F.delete(X)));Q.length&&await Promise.all(Q);const re=b.parentNode,se=[];for(const X of V){const[Y,ae]=q.get(X);if(F.has(X)){const ie=F.get(X);ie.itemRef!==Y&&(ie.reactive[r]=Y,ie.itemRef=Y),v&&(ie.reactive[v]=ae)}else{const ie=n.cloneNode(!0),Ee=[],{subscribe:yt,createReactiveState:xt}=Le(),Te=xt({[r]:Y,...v?{[v]:ae}:{}}),wt=new Proxy({},{has(le,ee){return!0},get(le,ee){return typeof ee!="string"?t[ee]:ee===r||v&&ee===v?Te[ee]:t[ee]},set(le,ee,ue){return ee===r||v&&ee===v?(Te[ee]=ue,!0):(t[ee]=ue,!0)}}),kt={...o,subscribe:(le,ee)=>{const ue=le.split(".")[0];let me;return ue===r||v&&ue===v?me=yt(ue,ee):me=o.subscribe(le,ee),Ee.push(me),me},storeSubscribeOverride:(le,ee,ue)=>{const me=be(le,ee,ue);return Ee.push(me),me}},$e=document.createDocumentFragment();$e.appendChild(ie),await te($e,wt,kt);const je=$e.firstChild??ie;g&&je.classList.add(`${g}-enter`),F.set(X,{el:je,reactive:Te,itemRef:Y,destroy:()=>Ee.forEach(le=>le())}),g&&se.push(je)}}let oe=b.nextSibling,he=0;for(const X of V){const{el:Y}=F.get(X);Y!==oe?he++:oe=Y.nextSibling}if(he>0)if(he>V.length>>1){const X=document.createDocumentFragment();for(const Y of V)X.appendChild(F.get(Y).el);re.insertBefore(X,b.nextSibling)}else{oe=b.nextSibling;for(const X of V){const{el:Y}=F.get(X);Y!==oe?re.insertBefore(Y,oe):oe=Y.nextSibling}}E=V.map(X=>F.get(X).el),se.length&&Promise.all(se.map(X=>ce(X).then(()=>X.classList.remove(`${g}-enter`))))}else{if(O.forEach(Q=>Q()),O=[],E.forEach(Q=>{var re;return(re=Q.parentNode)==null?void 0:re.removeChild(Q)}),E=[],!H.length)return;const V=b.parentNode,q=b.nextSibling,de={...o,subscribe:(Q,re)=>{const se=o.subscribe(Q,re);return O.push(se),se},storeSubscribeOverride:(Q,re,se)=>{const oe=be(Q,re,se);return O.push(oe),oe}};for(const[Q,re]of H){const se=n.cloneNode(!0),oe=document.createDocumentFragment();oe.appendChild(se),await te(oe,qe(t,Q,r,re,v),de);const he=oe.firstChild??se;V.insertBefore(oe,q),E.push(he)}}},G=async()=>{if(U){N=!0;return}U=!0;try{for(await I();N;)N=!1,await I()}finally{U=!1}};(P=o.registerCleanup)==null||P.call(o,()=>{F.forEach(({el:B,destroy:H})=>{var K;H(),(K=B.parentNode)==null||K.removeChild(B)}),F.clear(),O.forEach(B=>B()),E.forEach(B=>{var H;return(H=B.parentNode)==null?void 0:H.removeChild(B)}),E=[]}),J(h,o,G),await G()}s++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let v=s+1;for(;v<i.length;){const E=i[v];if(E.nodeType===3&&((($=E.textContent)==null?void 0:$.trim())??"")===""){v++;continue}if(E.nodeType!==1)break;const O=E;if(O.hasAttribute("cv-else-if")){const F=O.getAttribute("cv-else-if");O.removeAttribute("cv-else-if");const U=document.createComment("cv-else-if");O.replaceWith(U),a.push({condition:F,template:O,anchor:U}),v++;continue}if(O.hasAttribute("cv-else")){O.removeAttribute("cv-else");const F=document.createComment("cv-else");O.replaceWith(F),a.push({condition:null,template:O,anchor:F}),v++;break}break}s=v;let h=null,u=!1,g=!1;const b=async()=>{var E,O;if(u){g=!0;return}u=!0;try{do{g=!1,h&&((E=h.parentNode)==null||E.removeChild(h),h=null);for(const F of a)if(F.condition===null||W(F.condition,t)){const U=F.template.cloneNode(!0),N=document.createDocumentFragment();N.appendChild(U),await te(N,t,o);const I=N.firstChild??U;(O=F.anchor.parentNode)==null||O.insertBefore(N,F.anchor.nextSibling),h=I;break}}while(g)}finally{u=!1}};a.filter(E=>E.condition).forEach(E=>{J(E.condition,o,b)}),await b();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=I=>(n.getAttribute(I)??"").split(" ").filter(Boolean),v=r("cv-transition:enter"),h=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),g=r("cv-transition:leave"),b=r("cv-transition:leave-start"),E=r("cv-transition:leave-end"),O=n.getAttribute("cv-transition")??"",F=new Set(O.split(".").slice(1)),U=[...F].find(I=>/^\d+$/.test(I)),N=U?parseInt(U):200;if(v.length||h.length||g.length||b.length){l.forEach(V=>n.removeAttribute(V.name));const I=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!W(a,t),B=!1,H=null;const K=async V=>{if(B){H=V;return}B=!0;try{V?(n.style.display="",n.classList.add(...v,...h),await I(),n.classList.remove(...h),n.classList.add(...u),await ce(n),n.classList.remove(...v,...u)):(n.classList.add(...g,...b),await I(),n.classList.remove(...b),n.classList.add(...E),await ce(n),n.classList.remove(...g,...E),n.style.display="none"),G=V}finally{if(B=!1,H!==null&&H!==G){const q=H;H=null,K(q)}else H=null}};G||(n.style.display="none"),J(a,o,()=>{const V=!!W(a,t);V!==G&&K(V)})}else{const I=[...F].find(q=>q==="scale"||/^scale$/.test(q)),G=(()=>{const q=[...F].find(de=>/^\d+$/.test(de)&&de!==U);return q?parseInt(q)/100:.9})(),B=[];(!F.has("scale")||F.has("opacity"))&&B.push(`opacity ${N}ms ease`),I&&B.push(`transform ${N}ms ease`),B.length||B.push(`opacity ${N}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+B.join(", "),l.forEach(q=>n.removeAttribute(q.name));let H=!!W(a,t);const K=()=>new Promise(q=>requestAnimationFrame(()=>requestAnimationFrame(()=>q()))),V=async q=>{q?(n.style.display="",n.style.opacity="0",I&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",I&&(n.style.transform=""),await ce(n)):(n.style.opacity="0",I&&(n.style.transform=`scale(${G})`),await ce(n),n.style.display="none",n.style.opacity="",I&&(n.style.transform="")),H=q};H||(n.style.display="none"),J(a,o,()=>{const q=!!W(a,t);q!==H&&V(q)})}}else{const r=n.getAttribute("cv-show-transition"),v=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),v&&n.removeAttribute(":transition");const h=r??(v?String(W(v,t)):null);if(h){Xe();let u=!!W(a,t);u||(n.style.display="none");let g=!1,b=null;const E=async O=>{if(g){b=O;return}g=!0;try{O?(n.style.display="",n.classList.add(`${h}-enter`),await ce(n),n.classList.remove(`${h}-enter`)):(n.classList.add(`${h}-leave`),await ce(n),n.classList.remove(`${h}-leave`),n.style.display="none"),u=O}finally{if(g=!1,b!==null&&b!==u){const F=b;b=null,E(F)}else b=null}};J(a,o,()=>{const O=!!W(a,t);O!==u&&E(O)})}else{const u=()=>{n.style.display=W(a,t)?"":"none"};J(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{W(a,t)&&Promise.resolve().then(()=>n.focus())};J(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(I=>I.name==="cv-intersect"||I.name==="cv-intersect:enter"||I.name.startsWith("cv-intersect.")),r=a.find(I=>I.name==="cv-intersect:leave"),v=(l==null?void 0:l.value)??"",h=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),g=new Set(u.slice(1)),b=g.has("once");let E=0;if(g.has("half"))E=.5;else if(g.has("full"))E=1;else{const I=[...g].find(G=>G.startsWith("threshold-"));I&&(E=parseInt(I.replace("threshold-",""))/100)}const O=[...g].find(I=>I.startsWith("margin-")),F=O?`${O.replace("margin-","")}px`:void 0;a.forEach(I=>n.removeAttribute(I.name));const U=I=>{if(I)try{new Function("$data",`with($data){${I}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${I}":`,G)}},N=new IntersectionObserver(I=>{I.forEach(G=>{G.isIntersecting?(U(v),b&&N.disconnect()):U(h)})},{threshold:E,...F?{rootMargin:F}:{}});N.observe(n),(_=o.registerCleanup)==null||_.call(o,()=>N.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=!a.name.split(".").slice(1).includes("raw"),v=()=>{const h=String(W(l,t)??"");n.innerHTML=r?$t(h):h};J(l,o,v),v(),s++;continue}}if(n.hasAttribute("cv-ref")&&!((M=o.components)!=null&&M[y])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const x=!!((T=o.components)!=null&&T[y]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!x){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,v=(L=r.type)==null?void 0:L.toLowerCase(),h=u=>{if(l.has("number")){const g=parseFloat(u);return isNaN(g)?u:g}return l.has("trim")?u.trim():u};if(v==="checkbox"){const u=()=>{const g=W(a,t);r.checked=Array.isArray(g)?g.includes(r.value):!!g};J(a,o,u),u(),r.addEventListener("change",()=>{const g=W(a,t);if(Array.isArray(g)){const b=[...g];if(r.checked)b.includes(r.value)||b.push(r.value);else{const E=b.indexOf(r.value);E>-1&&b.splice(E,1)}pe(a,t,b)}else pe(a,t,r.checked)})}else if(v==="radio"){const u=()=>{r.checked=W(a,t)===r.value};J(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&pe(a,t,h(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,g=()=>{const b=String(W(a,t)??"");u.innerText!==b&&(u.innerText=b)};if(J(a,o,g),g(),l.has("debounce")){const b=[...l].find(F=>/^\d+$/.test(F)),E=b?parseInt(b):300;let O;u.addEventListener("input",()=>{clearTimeout(O),O=setTimeout(()=>pe(a,t,h(u.innerText)),E)})}else{const b=l.has("lazy")?"blur":"input";u.addEventListener(b,()=>pe(a,t,h(u.innerText)))}}else{const u=()=>{r.value=W(a,t)??""};if(J(a,o,u),u(),l.has("debounce")){const g=[...l].find(O=>/^\d+$/.test(O)),b=g?parseInt(g):300;let E;r.addEventListener("input",()=>{clearTimeout(E),E=setTimeout(()=>pe(a,t,h(r.value)),b)})}else{const g=y==="select"||l.has("lazy")?"change":"input";r.addEventListener(g,()=>pe(a,t,h(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var U,N;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],v=l.slice(1),h=r.indexOf(":"),u=h>=0?r.slice(0,h):r,g=h>=0?r.slice(h+1):void 0,b=o.directives[u];if(!b)return;const E=a.value;n.removeAttribute(a.name);const O=typeof b=="function"?{onMount:b}:b,F={value:E?W(E,t):void 0,arg:g,modifiers:Object.fromEntries(v.map(I=>[I,!0]))};(U=O.onMount)==null||U.call(O,n,F),O.onUpdate&&E&&J(E,o,()=>{F.value=W(E,t),O.onUpdate(n,F)}),O.onDestroy&&((N=o.registerCleanup)==null||N.call(o,()=>O.onDestroy(n,F)))}),y==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=W(u.value,t))});const v=await l(r),h=document.createDocumentFragment();v.forEach(u=>h.appendChild(u)),n.replaceWith(h)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await te(r,t,o),n.replaceWith(r)}s++;continue}if(y==="cv-transition"){Xe();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await te(r,t,o),l){let v=!!W(l,t),h=!1,u=null;v||(r.style.display="none");const g=async b=>{if(h){u=b;return}h=!0;try{b?(r.style.display="",r.classList.add(`${a}-enter`),await ce(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ce(r),r.classList.remove(`${a}-leave`),r.style.display="none"),v=b}finally{if(h=!1,u!==null&&u!==v){const E=u;u=null,g(E)}else u=null}};J(l,o,()=>{const b=!!W(l,t);b!==v&&g(b)})}s++;continue}if(y==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),s++;continue}if(y==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(W(a,t)??"/"):l||"/",v=I=>String(I).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let h="";Array.from(n.attributes).forEach(I=>{I.name==="to"||I.name===":to"||(h+=` ${I.name}="${v(I.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${h}></a>`;const g=u.firstElementChild;for(;n.firstChild;)g.appendChild(n.firstChild);const b=((j=o.router)==null?void 0:j.base)??"",E=I=>b?I===b?"/":I.startsWith(b+"/")?I.slice(b.length)||"/":I||"/":I||"/",O=()=>{var I;return((I=o.router)==null?void 0:I.mode)==="history"?E(window.location.pathname):window.location.hash.slice(1)||"/"},F=()=>{var B;const I=r(),G=O()===I;((B=o.router)==null?void 0:B.mode)==="history"?g.href=`${b}${I}`:g.href=`#${I}`,G?(g.setAttribute("aria-current","page"),g.classList.add("active")):(g.removeAttribute("aria-current"),g.classList.remove("active"))};((R=o.router)==null?void 0:R.mode)==="history"?(g.addEventListener("click",I=>{I.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",F)):window.addEventListener("hashchange",F),a&&J(a,o,F),F();const U=document.createDocumentFragment();U.appendChild(g),await te(U,t,o);const N=U.firstChild??g;n.replaceWith(N),s++;continue}if(y==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),s++;continue}if((C=o.components)!=null&&C[y]&&o.mountElement){await o.mountElement(n,y,t,o),s++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=W(a.value,t);let v,h=0,u="0px",g=l.has("once");if(typeof r=="function"?v=b=>r.call(t,b):r&&typeof r=="object"&&(typeof r.handler=="function"&&(v=b=>r.handler.call(t,b)),r.threshold!==void 0&&(h=r.threshold),r.margin&&(u=r.margin),r.once&&(g=!0)),v){const b=new IntersectionObserver(E=>{const O=E[0];v(O),g&&O.isIntersecting&&b.disconnect()},{threshold:h,rootMargin:u});b.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>b.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=W(a,t);let r,v="content-box";if(typeof l=="function"?r=h=>l.call(t,h):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=h=>l.handler.call(t,h)),l.box&&(v=l.box)),r){const h=new ResizeObserver(u=>{u[0]&&r(u[0])});h.observe(n,{box:v}),(d=o.registerCleanup)==null||d.call(o,()=>h.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=W(a,t);let r,v=0;if(typeof l=="function"?r=h=>l.call(t,h):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=h=>l.handler.call(t,h)),l.throttle&&(v=l.throttle)),r){let h=0;const u=()=>{const g=Date.now();v>0&&g-h<v||(h=g,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(m=o.registerCleanup)==null||m.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):Ge(a,t,r))};document.addEventListener("click",l,!0),(w=o.registerCleanup)==null||w.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let v=[];const h=()=>{const u=W(a,t)??{},g=Object.keys(u);for(const b of v)b in u||(b==="class"?n.className=l:b==="style"?n.style.cssText=r:n.removeAttribute(b));for(const[b,E]of Object.entries(u))if(b==="class")n.className=[l,Re(E)].filter(Boolean).join(" ");else if(b==="style")Ve(n,E,r);else if(E==null||E===!1)try{n.removeAttribute(b)}catch{}else try{n.setAttribute(b,E===!0?"":String(E))}catch(O){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${b}":`,O)}v=g};J(a,o,h),h()}const D={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],v=new Set(l.slice(1)),h=[...v].find(E=>E in D),u=a.value,g=E=>{v.has("prevent")&&E.preventDefault(),v.has("stop")&&E.stopPropagation(),!(v.has("self")&&E.target!==E.currentTarget)&&(h&&E.key!==D[h]||(typeof t[u]=="function"?t[u].call(t,E):Ge(u,t,E)))},b={};v.has("once")&&(b.once=!0),v.has("passive")&&(b.passive=!0),v.has("capture")&&(b.capture=!0),n.addEventListener(r,g,Object.keys(b).length?b:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const v=n.getAttribute("class")??"",h=()=>{n.className=[v,Re(W(r,t))].filter(Boolean).join(" ")};J(r,o,h),h()}else if(l==="style"){const v=n.getAttribute("style")??"",h=()=>Ve(n,W(r,t),v);J(r,o,h),h()}else if(l.includes("-")){const v=()=>{const h=W(r,t);h==null||h===!1?n.removeAttribute(l):n.setAttribute(l,h===!0?"":String(h))};J(r,o,v),v()}else{const v=()=>{n[l]=W(r,t)??""};J(r,o,v),v()}}}),S.hasChildNodes()&&await te(S,t,o),s++}}var jt=`
...
`;function Ot(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=jt,document.head.appendChild(e)}async function ye(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(p=>{const k=()=>p();e.addEventListener("animationend",k,{once:!0}),e.addEventListener("transitionend",k,{once:!0}),setTimeout(k,s+50)}),e.classList.remove(`${t}-${o}`)}var Se=new Map;async function Ft(e){if(typeof e!="function")return e;if(Se.has(e))return Se.get(e);const t=await e();return Se.set(e,t.default),t.default}function Ze(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function Ke(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((p,k)=>[p,s[k+1]])):null}function Pt(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((p,k)=>[p,s[k+1]])),remaining:s[o.length+1]||"/"}:null}function gt(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:gt(o.children,i==="/"?"":i)}:{...o,path:i}})}var fe=(e,t)=>new Promise(o=>e(t,o)),Qe=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Dt(e,t={}){const o=t.mode??"hash",i=It(t.base??"");return{routes:gt(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,p){const k=et(s,p==null?void 0:p.query);o==="history"?(history.pushState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=k},replace(s,p){const k=et(s,p==null?void 0:p.query);if(o==="history")history.replaceState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const f=window.location.href.split("#")[0];window.location.replace(`${f}#${k}`)}},back(){history.back()},forward(){history.forward()}}}function It(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function Mt(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function et(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function tt(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function ot(e,t,o,i="default",s){const p=t.base??"",k=m=>m.length>1&&m.endsWith("/")?m.slice(0,-1):m,f=()=>t.mode==="history"?k(Mt(window.location.pathname,p)):k((window.location.hash.slice(1)||"/").split("?")[0]||"/"),P=()=>{if(t.mode==="history")return tt(window.location.search);const m=window.location.hash.slice(1)||"/",w=m.indexOf("?");return w>=0?tt(m.slice(w+1)):{}};t.transition&&Ot();let $=null,_=null,M=null,T=null,L=!1;const z=()=>{L||(L=!0,s==null||s())},j=new Map,R=m=>{var w;if(m!=null&&m.keepAlive&&M){(w=M.deactivate)==null||w.call(M);const S=document.createDocumentFragment();for(;e.firstChild;)S.appendChild(e.firstChild);j.set($.path,{fragment:S,activation:M}),M=null}else M==null||M.destroy(),M=null,e.innerHTML=""},C=async(m,w,S,n,y)=>{const x=typeof w=="function"&&!Se.has(w),A=x?w.__asyncOptions:void 0,D=m.loadingTemplate??(A==null?void 0:A.loadingTemplate);x&&D&&(e.innerHTML=D);let a;try{a=await Ft(w)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return x&&D&&(e.innerHTML=""),o(e,a,S,n,y)},c=async()=>{var S,n,y,x,A,D,a,l;const m=f(),w=P();for(const r of t.routes){if((S=r.children)!=null&&S.length){const h=Pt(r.path,m);if(h!==null)for(const u of r.children){const g=Ke(u.path,m);if(g!==null){const b={params:h.params,query:w,path:m,meta:r.meta};if(u.redirect){const U={params:g,query:w,path:m,meta:u.meta},N=typeof u.redirect=="function"?u.redirect(U):u.redirect;t.navigate(N);return}if(t.beforeEach){const U=await fe(t.beforeEach,b);if(U){t.navigate(U);return}}if(r.beforeEnter){const U=await fe(r.beforeEnter,b);if(U){t.navigate(U);return}}if(u.beforeEnter){const U={params:g,query:w,path:m,meta:u.meta},N=await fe(u.beforeEnter,U);if(N){t.navigate(N);return}}const E=`${r.path}::${JSON.stringify(h.params)}`;if(T!==E){const U=await Qe(M,b);if(U){t.navigate(U);return}const N=r.transition??t.transition;N&&e.hasChildNodes()&&await ye(e,N,"leave"),R(_);const I=Ze(r,i);if(I){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(B,H)=>t.navigate(B,H),replace:(B,H)=>t.replace(B,H),back:()=>t.back(),forward:()=>t.forward()};M=await C(r,I,b,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=M.enter)==null||n.call(M,$)}else e.innerHTML="";T=E,N&&await ye(e,N,"enter")}const O={params:{...h.params,...g},query:w,path:m,meta:u.meta??r.meta};(y=t.afterEach)==null||y.call(t,O,$);const F=(x=t.scrollBehavior)==null?void 0:x.call(t,O,$);F&&window.scrollTo(F.x??0,F.y??0),$=O,_=r,z();return}}}const v=Ke(r.path,m);if(v!==null){T=null;const h={params:v,query:w,path:m,meta:r.meta};if(r.redirect){const O=typeof r.redirect=="function"?r.redirect(h):r.redirect;t.navigate(O);return}if(t.beforeEach){const O=await fe(t.beforeEach,h);if(O){t.navigate(O);return}}if(r.beforeEnter){const O=await fe(r.beforeEnter,h);if(O){t.navigate(O);return}}const u=await Qe(M,h);if(u){t.navigate(u);return}const g=r.transition??t.transition;g&&e.hasChildNodes()&&await ye(e,g,"leave"),R(_);const b=Ze(r,i);if(b){const O=h.path;if(r.keepAlive&&j.has(O)){const F=j.get(O);e.appendChild(F.fragment),M=F.activation,(A=M.activate)==null||A.call(M),j.delete(O)}else{const F=$;M=await C(r,b,h,i==="default"?r.layout:void 0),(D=M.enter)==null||D.call(M,F)}}else e.innerHTML="",M=null;g&&await ye(e,g,"enter"),(a=t.afterEach)==null||a.call(t,h,$);const E=(l=t.scrollBehavior)==null?void 0:l.call(t,h,$);E&&window.scrollTo(E.x??0,E.y??0),$=h,_=r,z();return}}T=null,R(_),_=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),M==null||M.destroy(),M=null,j.forEach(({activation:m})=>m.destroy()),j.clear()}}function Lt(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(p=>{try{p(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Rt=0;function zt(){return++Rt}var Ht=`
...
`;function Nt(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=Ht,document.head.appendChild(e)}function xe(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function nt(e){try{return JSON.parse(e)}catch{return e}}function Wt(e){if(typeof document>"u")return;Nt();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,i="components",s=new Set;const p=document.createElement("div");p.id="cvd-badge",p.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(p);const k=document.createElement("div");k.id="cvd-panel",k.style.display="none",t.appendChild(k),k.innerHTML=`
        <div id="cvd-head">
        ...
        <div id="cvd-body"></div>
    `;const f=k.querySelector("#cvd-body");p.addEventListener("click",()=>{o=!0,p.style.display="none",k.style.display="flex",M()}),k.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,k.style.display="none",p.style.display=""}),k.querySelectorAll(".cvd-tab").forEach(T=>{T.addEventListener("click",()=>{i=T.dataset.tab,k.querySelectorAll(".cvd-tab").forEach(L=>L.classList.remove("active")),T.classList.add("active"),M()})});const P=k.querySelector("#cvd-head");P.addEventListener("pointerdown",T=>{if(T.target.closest("button"))return;P.setPointerCapture(T.pointerId);const L=T.clientX,z=T.clientY,j=t.offsetLeft,R=t.offsetTop,C=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${j+(d.clientX-L)}px`,t.style.top=`${R+(d.clientY-z)}px`},c=d=>{P.releasePointerCapture(d.pointerId),P.removeEventListener("pointermove",C),P.removeEventListener("pointerup",c),P.removeEventListener("pointercancel",c)};P.addEventListener("pointermove",C),P.addEventListener("pointerup",c),P.addEventListener("pointercancel",c)});function $(){const T=e.instances;if(!T.length){f.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}f.innerHTML=T.map(L=>{const z=L.getState(),j=Object.keys(z);return`
                <div class="cvd-inst${s.has(L.id)?" open":""}" data-id="${L.id}">
                    <div class="cvd-inst-head">
                        ...
                        <span class="cvd-count">${j.length} keys</span>
                    ...
                    <div class="cvd-kv">
                        ${j.length?j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-inst="${L.id}" data-key="${R}" title="click to edit">${xe(z[R])}</span>
                            </div>
                        `).join(""):'<span style="color:#555">— sin datos reactivos —</span>'}
                    </div>
                </div>
            `}).join(""),f.querySelectorAll(".cvd-inst-head").forEach(L=>{L.addEventListener("click",()=>{const z=L.closest(".cvd-inst"),j=parseInt(z.dataset.id);s.has(j)?s.delete(j):s.add(j),z.classList.toggle("open")})}),f.querySelectorAll(".cvd-val").forEach(L=>{L.addEventListener("click",z=>{z.stopPropagation();const j=L;if(j.querySelector("input"))return;const R=parseInt(j.dataset.inst),C=j.dataset.key,c=e.instances.find(S=>S.id===R);if(!c)return;const d=xe(c.getState()[C]);j.classList.add("editing"),j.innerHTML=`<input class="cvd-edit" value='${d.replace(/'/g,"&#39;")}'>`;const m=j.querySelector("input");m.focus(),m.select();const w=()=>{c.setState(C,nt(m.value)),j.classList.remove("editing")};m.addEventListener("blur",w),m.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),w()),S.key==="Escape"&&(j.classList.remove("editing"),M())})})})}function _(){if(!e.stores.length){f.innerHTML='<div class="cvd-empty">No hay store registrado</div>';return}f.innerHTML=e.stores.map((T,L)=>{const z=T.getState(),j=Object.keys(z);return`
                    ...
                    <div class="cvd-kv">
                        ${j.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${L}" data-key="${R}" title="click to edit">${xe(z[R])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),f.querySelectorAll(".cvd-inst-head").forEach(T=>{T.addEventListener("click",()=>T.closest(".cvd-inst").classList.toggle("open"))}),f.querySelectorAll("[data-store][data-key]").forEach(T=>{T.addEventListener("click",L=>{L.stopPropagation();const z=T;if(z.querySelector("input"))return;const j=parseInt(z.dataset.store),R=z.dataset.key,C=e.stores[j];if(!C)return;const c=xe(C.getState()[R]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const m=()=>{C.setState(R,nt(d.value)),z.classList.remove("editing")};d.addEventListener("blur",m),d.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),m()),w.key==="Escape"&&(z.classList.remove("editing"),M())})})})}function M(){o&&(i==="components"?$():_())}e.on("mount",()=>M()),e.on("update",()=>M()),e.on("destroy",()=>M()),e.on("store-update",()=>M())}var Ut="__COURVUX_HEAD_COLLECTOR__";function Bt(){return globalThis[Ut]??null}var qt=(e,t)=>{Object.entries(t).forEach(([o,i])=>{o!=="innerHTML"&&(i==null||i===!1||e.setAttribute(o,i===!0?"":String(i)))})},Vt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Gt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,i])=>e.setAttribute(o,i))},rt=(e,t,o,i)=>{let s=o?document.head.querySelector(o):null;s?(i.push({el:s,prevAttrs:Vt(s),created:!1}),Array.from(s.attributes).forEach(p=>s.removeAttribute(p.name))):(s=document.createElement(e),document.head.appendChild(s),i.push({el:s,created:!0})),qt(s,t)};function Yt(e){var k,f,P;const t=Bt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let i;const s={},p={};if(e.title!==void 0){i=document.title;const $=e.titleTemplate,_=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=_}return(k=e.meta)==null||k.forEach($=>{rt("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(f=e.link)==null||f.forEach($=>{rt("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(P=e.script)==null||P.forEach($=>{const _=document.createElement("script");Object.entries($).forEach(([M,T])=>{M==="innerHTML"?_.textContent=String(T):T!=null&&T!==!1&&_.setAttribute(M,T===!0?"":String(T))}),document.head.appendChild(_),o.push({el:_,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,_])=>{s[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,_)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,_])=>{p[$]=document.body.getAttribute($),document.body.setAttribute($,_)}),function(){i!==void 0&&(document.title=i),o.forEach(({el:$,prevAttrs:_,created:M})=>{var T;M?(T=$.parentNode)==null||T.removeChild($):_&&Gt($,_)}),Object.entries(s).forEach(([$,_])=>{_===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,_)}),Object.entries(p).forEach(([$,_])=>{_===null?document.body.removeAttribute($):document.body.setAttribute($,_)})}}var Pe="data-courvux-ssr",Xt=e=>e?Promise.resolve().then(e):Promise.resolve();function st(e,t){const o=e.trim();if(o.startsWith("{")){const i=o.replace(/[{}]/g,"").split(",").map(s=>s.trim()).filter(Boolean);return Object.fromEntries(i.map(s=>[s,t[s]]))}return{[o]:t}}var we=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var w,S,n;const i={},{subscribe:s,createReactiveState:p,registerSetInterceptor:k,notifyAll:f}=Le();let P;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),P=await t.data()):P=t.data??{},t.templateUrl){const y=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,x=await fetch(y);if(!x.ok)throw new Error(`Failed to load template: ${y} (${x.status})`);e.innerHTML=await x.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Pe),(w=e.querySelector(`[${Pe}]`))==null||w.removeAttribute(Pe);const $={};if(t.inject&&o.provided){const y=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(x=>[x,x])):t.inject;Object.entries(y).forEach(([x,A])=>{o.provided&&A in o.provided&&($[x]=o.provided[A])})}const _=p({...o.globalProperties??{},...P,...$,...t.methods,$refs:i,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(y=>[y,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});t.exprs&&typeof t.exprs=="object"&&_t(_,t.exprs),_.$watch=(y,x,A)=>{const D=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=D?we(_[y]):_[y];const r=s(y,()=>{const v=_[y];x.call(_,v,l),l=D?we(v):v});return a&&x.call(_,_[y],void 0),r},_.$batch=At,_.$nextTick=y=>Xt(y),_.$dispatch=(y,x,A)=>{e.dispatchEvent(new CustomEvent(y,{bubbles:!0,composed:!0,...A??{},detail:x}))},o.magics&&Object.entries(o.magics).forEach(([y,x])=>{_[y]=x(_)}),_.$forceUpdate=()=>f();const M=[];_.$watchEffect=y=>{let x=[];const A=()=>{x.forEach(r=>r()),x=[];const a=Ne(()=>{try{y()}catch{}}),l=new Map;for(const{sub:r,key:v}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(v)&&(l.get(r).add(v),x.push(r(v,A)))};A();const D=()=>{x.forEach(l=>l()),x=[];const a=M.indexOf(D);a>-1&&M.splice(a,1)};return M.push(D),D};const T=[];t.computed&&Object.entries(t.computed).forEach(([y,x])=>{const A=typeof x=="function"?x:x.get,D=typeof x!="function"?x.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const v=Ne(()=>{try{r=A.call(_)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});_[y]=r;const h=new Map;for(const{sub:u,key:g}of v)h.has(u)||h.set(u,new Set),!h.get(u).has(g)&&(h.get(u).add(g),a.push(u(g,l)))};l(),T.push(()=>a.forEach(r=>r())),D&&k(y,r=>D.call(_,r))});const L=[];t.watch&&Object.entries(t.watch).forEach(([y,x])=>{const A=typeof x=="object"&&x!==null&&"handler"in x,D=A?x.handler:x,a=A?x.immediate??!1:!1,l=A?x.deep??!1:!1;let r=l?we(_[y]):_[y];const v=s(y,()=>{const h=_[y];D.call(_,h,r),r=l?we(h):h});L.push(v),a&&D.call(_,_[y],void 0)});const z={...o.provided??{}};if(t.provide){const y=typeof t.provide=="function"?t.provide.call(_):t.provide;Object.assign(z,y)}const j={...o,provided:z,components:{...o.components,...t.components}};j.mountElement=Ce(j),j.createChildScope=(y,x)=>{const A=new Set(Object.keys(y)),D=new Set(Object.keys(x)),{subscribe:a,createReactiveState:l}=Le(),r=l(y);let v;return v=new Proxy({},{get(h,u){return typeof u!="string"?_[u]:A.has(u)?r[u]:D.has(u)?x[u].bind(v):_[u]},set(h,u,g){return typeof u!="string"?!1:A.has(u)?(r[u]=g,!0):(_[u]=g,!0)},has(h,u){return A.has(u)||D.has(u)||u in _},ownKeys(){return[...A,...D,...Object.keys(_)]},getOwnPropertyDescriptor(h,u){return A.has(u)||D.has(u)||u in _?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:v,subscribe:(h,u)=>A.has(h)?a(h,u):c(h,u),cleanup:()=>{}}},j.mountDynamic=async(y,x,A,D,a)=>{let l=null,r=null;const v=A.getAttribute("loading-template")??"",h=async()=>{var I,G,B;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=W(x,D);if(!u)return;let g;if(typeof u=="function"){if(v){const H=document.createElement("div");H.innerHTML=v,(I=y.parentNode)==null||I.insertBefore(H,y.nextSibling),l=H}g=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?g=(G=j.components)==null?void 0:G[u]:u&&typeof u=="object"&&(g=u);if(!g)return;const b=document.createElement("div"),E=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{E(H.name)||b.setAttribute(H.name,H.value)}),b.innerHTML=A.innerHTML;const O={},F={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))O[H.name.slice(1)]=W(H.value,D);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);F[V]=(...q)=>{typeof D[K]=="function"&&D[K].call(D,...q)}}});const U={...g,data:{...g.data,...O},methods:{...g.methods,$emit(H,...K){var V;vt(g,H,K),(V=F[H])==null||V.call(F,...K)}}},N={...j,components:{...j.components,...g.components}};N.mountElement=Ce(N),r=(await ne(b,U,N)).destroy,(B=y.parentNode)==null||B.insertBefore(b,y.nextSibling),l=b};J(x,a,h),await h()};const R=[];_.$addCleanup=y=>{R.push(y)};let C=!1;const c=(y,x)=>!t.onBeforeUpdate&&!t.onUpdated?s(y,x):s(y,()=>{var A;C||(C=!0,(A=t.onBeforeUpdate)==null||A.call(_),Promise.resolve().then(()=>{var D;C=!1,(D=t.onUpdated)==null||D.call(_)})),x()});try{(S=t.onBeforeMount)==null||S.call(_),await te(e,_,{subscribe:c,refs:i,...j,registerCleanup:y=>R.push(y)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(_)}catch(y){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(_,y);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(y,_,t.name??e.tagName.toLowerCase());else throw y}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,m=d?zt():0;if(d){const y=_,x=new Set,A={id:m,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const D={};for(const a of Object.keys(y))if(!(a.startsWith("$")||typeof y[a]=="function"))try{D[a]=y[a]}catch{}return D},setState:(D,a)=>{y[D]=a},subscribe:D=>(x.add(D),()=>x.delete(D)),children:[]};Object.keys(y).filter(D=>!D.startsWith("$")&&typeof y[D]!="function").forEach(D=>{s(D,()=>{d._emit("update",A),x.forEach(a=>a())})}),d._registerInstance(A),R.push(()=>d._unregisterInstance(m))}return{state:_,destroy:()=>{var y,x;(y=t.onBeforeUnmount)==null||y.call(_),T.forEach(A=>A()),L.forEach(A=>A()),M.forEach(A=>A()),R.forEach(A=>A()),(x=t.onDestroy)==null||x.call(_)},activate:()=>{var y;(y=t.onActivated)==null||y.call(_)},deactivate:()=>{var y;(y=t.onDeactivated)==null||y.call(_)},beforeLeave:t.onBeforeRouteLeave?(y,x)=>t.onBeforeRouteLeave.call(_,y,x):void 0,enter:t.onBeforeRouteEnter?y=>t.onBeforeRouteEnter.call(_,y):void 0}}function vt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const i=e.emits[t];typeof i=="function"&&!i(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ce(e){return async(t,o,i,s)=>{const p=e.components[o],k=t.getAttribute("cv-ref");k&&t.removeAttribute("cv-ref");const f={},P=[],$={};Array.from(t.attributes).filter(C=>C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:")).forEach(C=>{t.removeAttribute(C.name);const c=C.value,d=C.name.indexOf(":"),m=d>=0?C.name.slice(d+1).split(".")[0]:"modelValue",w=m==="modelValue"?"update:modelValue":`update:${m}`;f[m]=Oe(W(c,i)),P.push({propName:m,expr:c}),$[w]=S=>{pe(c,i,S)}});const _={};Array.from(t.attributes).forEach(C=>{const c=C.name.startsWith(":"),d=C.name.startsWith("@")||C.name.startsWith("cv:on:"),m=C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:"),w=C.name.startsWith("v-slot"),S=C.name==="slot";!c&&!d&&!m&&!w&&!S&&(_[C.name]=C.value)}),p.inheritAttrs===!1&&Object.keys(_).forEach(C=>t.removeAttribute(C)),Array.from(t.attributes).forEach(C=>{if(C.name.startsWith(":")){const c=C.name.slice(1),d=C.value;f[c]=Oe(W(d,i)),P.push({propName:c,expr:d})}else if(C.name.startsWith("@")||C.name.startsWith("cv:on:")){const c=C.name.startsWith("@")?C.name.slice(1):C.name.slice(6),d=C.value;$[c]=(...m)=>{typeof i[d]=="function"&&i[d].call(i,...m)}}});const M=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");M&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const T=new Map,L=[];Array.from(t.childNodes).forEach(C=>{const c=C.nodeType===1?C.getAttribute("slot"):null;if(c){if(!T.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),T.set(c,{nodes:[],vSlot:d})}T.get(c).nodes.push(C.cloneNode(!0))}else L.push(C.cloneNode(!0))});const z={};L.some(C=>{var c;return C.nodeType===1||C.nodeType===3&&(((c=C.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async C=>{const c=M?{...i,...st(M,C)}:i,d=document.createDocumentFragment();return L.forEach(m=>d.appendChild(m.cloneNode(!0))),await te(d,c,s),Array.from(d.childNodes)});for(const[C,{nodes:c,vSlot:d}]of T)z[C]=async m=>{const w=d?{...i,...st(d,m)}:i,S=document.createDocumentFragment();return c.forEach(n=>S.appendChild(n.cloneNode(!0))),await te(S,w,s),Array.from(S.childNodes)};const j={...e,components:{...e.components,...p.components},slots:z};j.mountElement=Ce(j);const{state:R}=await ne(t,{...p,data:{...p.data,...f,$attrs:_,$parent:i},methods:{...p.methods,$emit(C,...c){var d;vt(p,C,c),(d=$[C])==null||d.call($,...c)}}},j);R&&(P.forEach(({propName:C,expr:c})=>{ft(c,{...s,subscribe:s.subscribe},()=>{R[C]=Oe(W(c,i))})}),k&&s.refs&&(s.refs[k]=R))}}function Jt(e){Tt();const t=typeof window<"u"?Lt():void 0,o=[],i={...e.directives},s={...e.components??{}},p=[],k=new Map,f={},P=new Map;if(e.debug&&t&&Wt(t),t&&e.store){const T=e.store,L=Object.keys(T).filter(z=>typeof T[z]!="function");t._registerStore({getState(){const z={};return L.forEach(j=>{try{z[j]=T[j]}catch{}}),z},setState(z,j){T[z]=j},subscribe(z){const j=L.map(R=>{try{return be(T,R,z)}catch{return()=>{}}});return()=>j.forEach(R=>R())}})}const $={router:e.router,use(T){return o.includes(T)||(o.push(T),T.install($)),$},directive(T,L){return i[T]=L,$},component(T,L){return s[T]=L,$},provide(T,L){return typeof T=="string"?f[T]=L:Object.assign(f,T),$},magic(T,L){return P.set(`$${T}`,L),$},mount:async T=>(await M(T),$),mountAll:async(T="[data-courvux]")=>{const L=Array.from(document.querySelectorAll(T));return await Promise.all(L.map(z=>_(z))),$},mountEl:async T=>_(T),unmount(T){if(!T)p.forEach(L=>L()),p.length=0,k.clear();else{const L=document.querySelector(T);if(L){const z=k.get(L);if(z){z(),k.delete(L);const j=p.indexOf(z);j>-1&&p.splice(j,1)}}}return $},destroy(){p.forEach(T=>T()),p.length=0,k.clear()}},_=async T=>{const L=new URL(".",document.baseURI).href,z={components:s,router:e.router,store:e.store,directives:i,baseUrl:L,provided:{...f},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:P.size?Object.fromEntries(P):void 0};if(z.mountElement=Ce(z),e.router){const R=e.router;z.mountRouterView=async(C,c)=>{await new Promise(d=>{ot(C,R,async(m,w,S,n,y)=>{const x={...z,currentRoute:S};if(y){let A=null;const D={...x,mountRouterView:async(a,l)=>{A=ot(a,y,async(r,v,h,u)=>{const g={...x,currentRoute:h};if(u){let b=null;const E={...g,mountRouterView:async(F,U)=>{b=await ne(F,v,g)}},{destroy:O}=await ne(r,{template:u},E);return{destroy:()=>{b==null||b.destroy(),O()},activate:()=>b==null?void 0:b.activate(),deactivate:()=>b==null?void 0:b.deactivate()}}else return await ne(r,v,g)},l)}};if(n){let a=null;const l={...D,mountRouterView:async(v,h)=>{a=await ne(v,w,D)}},{destroy:r}=await ne(m,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(m,w,D);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const D={...x,mountRouterView:async(l,r)=>{A=await ne(l,w,x)}},{destroy:a}=await ne(m,{template:n},D);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(m,w,x)},c,d)})}}const j=await ne(T,e,z);return p.push(j.destroy),k.set(T,j.destroy),j.state},M=async T=>{const L=document.querySelector(T);if(L)return _(L)};return $}var at=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Zt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var De={exports:{}},it;function Kt(){return it||(it=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
 ...
 * @namespace
 * @public
 */var o=(function(i){var s=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,p=0,k={},f={manual:i.Prism&&i.Prism.manual,disableWorkerMessageHandler:i.Prism&&i.Prism.disableWorkerMessageHandler,util:{encode:function c(d){return d instanceof P?new P(d.type,c(d.content),d.alias):Array.isArray(d)?d.map(c):d.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(c){return Object.prototype.toString.call(c).slice(8,-1)},objId:function(c){return c.__id||Object.defineProperty(c,"__id",{value:++p}),c.__id},clone:function c(d,m){m=m||{};var w,S;switch(f.util.type(d)){case"Object":if(S=f.util.objId(d),m[S])return m[S];w={},m[S]=w;for(var n in d)d.hasOwnProperty(n)&&(w[n]=c(d[n],m));return w;case"Array":return S=f.util.objId(d),m[S]?m[S]:(w=[],m[S]=w,d.forEach(function(y,x){w[x]=c(y,m)}),w);default:return d}},getLanguage:function(c){for(;c;){var d=s.exec(c.className);if(d)return d[1].toLowerCase();c=c.parentElement}return"none"},setLanguage:function(c,d){c.className=c.className.replace(RegExp(s,"gi"),""),c.classList.add("language-"+d)},currentScript:function(){if(typeof document>"u")return null;if(document.currentScript&&document.currentScript.tagName==="SCRIPT")return document.currentScript;try{throw new Error}catch(w){var c=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(w.stack)||[])[1];if(c){var d=document.getElementsByTagName("script");for(var m in d)if(d[m].src==c)return d[m]}return null}},isActive:function(c,d,m){for(var w="no-"+d;c;){var S=c.classList;if(S.contains(d))return!0;if(S.contains(w))return!1;c=c.parentElement}return!!m}},languages:{plain:k,plaintext:k,text:k,txt:k,extend:function(c,d){var m=f.util.clone(f.languages[c]);for(var w in d)m[w]=d[w];return m},insertBefore:function(c,d,m,w){w=w||f.languages;var S=w[c],n={};for(var y in S)if(S.hasOwnProperty(y)){if(y==d)for(var x in m)m.hasOwnProperty(x)&&(n[x]=m[x]);m.hasOwnProperty(y)||(n[y]=S[y])}var A=w[c];return w[c]=n,f.languages.DFS(f.languages,function(D,a){a===A&&D!=c&&(this[D]=n)}),n},DFS:function c(d,m,w,S){S=S||{};var n=f.util.objId;for(var y in d)if(d.hasOwnProperty(y)){m.call(d,y,d[y],w||y);var x=d[y],A=f.util.type(x);A==="Object"&&!S[n(x)]?(S[n(x)]=!0,c(x,m,null,S)):A==="Array"&&!S[n(x)]&&(S[n(x)]=!0,c(x,m,y,S))}}},plugins:{},highlightAll:function(c,d){f.highlightAllUnder(document,c,d)},highlightAllUnder:function(c,d,m){var w={callback:m,container:c,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};f.hooks.run("before-highlightall",w),w.elements=Array.prototype.slice.apply(w.container.querySelectorAll(w.selector)),f.hooks.run("before-all-elements-highlight",w);for(var S=0,n;n=w.elements[S++];)f.highlightElement(n,d===!0,w.callback)},highlightElement:function(c,d,m){var w=f.util.getLanguage(c),S=f.languages[w];f.util.setLanguage(c,w);var n=c.parentElement;n&&n.nodeName.toLowerCase()==="pre"&&f.util.setLanguage(n,w);var y=c.textContent,x={element:c,language:w,grammar:S,code:y};function A(a){x.highlightedCode=a,f.hooks.run("before-insert",x),x.element.innerHTML=x.highlightedCode,f.hooks.run("after-highlight",x),f.hooks.run("complete",x),m&&m.call(x.element)}if(f.hooks.run("before-sanity-check",x),n=x.element.parentElement,n&&n.nodeName.toLowerCase()==="pre"&&!n.hasAttribute("tabindex")&&n.setAttribute("tabindex","0"),!x.code){f.hooks.run("complete",x),m&&m.call(x.element);return}if(f.hooks.run("before-highlight",x),!x.grammar){A(f.util.encode(x.code));return}if(d&&i.Worker){var D=new Worker(f.filename);D.onmessage=function(a){A(a.data)},D.postMessage(JSON.stringify({language:x.language,code:x.code,immediateClose:!0}))}else A(f.highlight(x.code,x.grammar,x.language))},highlight:function(c,d,m){var w={code:c,grammar:d,language:m};if(f.hooks.run("before-tokenize",w),!w.grammar)throw new Error('The language "'+w.language+'" has no grammar.');return w.tokens=f.tokenize(w.code,w.grammar),f.hooks.run("after-tokenize",w),P.stringify(f.util.encode(w.tokens),w.language)},tokenize:function(c,d){var m=d.rest;if(m){for(var w in m)d[w]=m[w];delete d.rest}var S=new M;return T(S,S.head,c),_(c,S,d,S.head,0),z(S)},hooks:{all:{},add:function(c,d){var m=f.hooks.all;m[c]=m[c]||[],m[c].push(d)},run:function(c,d){var m=f.hooks.all[c];if(!(!m||!m.length))for(var w=0,S;S=m[w++];)S(d)}},Token:P};i.Prism=f;function P(c,d,m,w){this.type=c,this.content=d,this.alias=m,this.length=(w||"").length|0}P.stringify=function c(d,m){if(typeof d=="string")return d;if(Array.isArray(d)){var w="";return d.forEach(function(A){w+=c(A,m)}),w}var S={type:d.type,content:c(d.content,m),tag:"span",classes:["token",d.type],attributes:{},language:m},n=d.alias;n&&(Array.isArray(n)?Array.prototype.push.apply(S.classes,n):S.classes.push(n)),f.hooks.run("wrap",S);var y="";for(var x in S.attributes)y+=" "+x+'="'+(S.attributes[x]||"").replace(/"/g,"&quot;")+'"';return"<"+S.tag+' class="'+S.classes.join(" ")+'"'+y+">"+S.content+"</"+S.tag+">"};function $(c,d,m,w){c.lastIndex=d;var S=c.exec(m);if(S&&w&&S[1]){var n=S[1].length;S.index+=n,S[0]=S[0].slice(n)}return S}function _(c,d,m,w,S,n){for(var y in m)if(!(!m.hasOwnProperty(y)||!m[y])){var x=m[y];x=Array.isArray(x)?x:[x];for(var A=0;A<x.length;++A){if(n&&n.cause==y+","+A)return;var D=x[A],a=D.inside,l=!!D.lookbehind,r=!!D.greedy,v=D.alias;if(r&&!D.pattern.global){var h=D.pattern.toString().match(/[imsuy]*$/)[0];D.pattern=RegExp(D.pattern.source,h+"g")}for(var u=D.pattern||D,g=w.next,b=S;g!==d.tail&&!(n&&b>=n.reach);b+=g.value.length,g=g.next){var E=g.value;if(d.length>c.length)return;if(!(E instanceof P)){var O=1,F;if(r){if(F=$(u,b,c,l),!F||F.index>=c.length)break;var G=F.index,U=F.index+F[0].length,N=b;for(N+=g.value.length;G>=N;)g=g.next,N+=g.value.length;if(N-=g.value.length,b=N,g.value instanceof P)continue;for(var I=g;I!==d.tail&&(N<U||typeof I.value=="string");I=I.next)O++,N+=I.value.length;O--,E=c.slice(b,N),F.index-=b}else if(F=$(u,0,E,l),!F)continue;var G=F.index,B=F[0],H=E.slice(0,G),K=E.slice(G+B.length),V=b+E.length;n&&V>n.reach&&(n.reach=V);var q=g.prev;H&&(q=T(d,q,H),b+=H.length),L(d,q,O);var de=new P(y,a?f.tokenize(B,a):B,v,B);if(g=T(d,q,de),K&&T(d,g,K),O>1){var Q={cause:y+","+A,reach:V};_(c,d,m,g.prev,b,Q),n&&Q.reach>n.reach&&(n.reach=Q.reach)}}}}}}function M(){var c={value:null,prev:null,next:null},d={value:null,prev:c,next:null};c.next=d,this.head=c,this.tail=d,this.length=0}function T(c,d,m){var w=d.next,S={value:m,prev:d,next:w};return d.next=S,w.prev=S,c.length++,S}function L(c,d,m){for(var w=d.next,S=0;S<m&&w!==c.tail;S++)w=w.next;d.next=w,w.prev=d,c.length-=S}function z(c){for(var d=[],m=c.head.next;m!==c.tail;)d.push(m.value),m=m.next;return d}if(!i.document)return i.addEventListener&&(f.disableWorkerMessageHandler||i.addEventListener("message",function(c){var d=JSON.parse(c.data),m=d.language,w=d.code,S=d.immediateClose;i.postMessage(f.highlight(w,f.languages[m],m)),S&&i.close()},!1)),f;var j=f.util.currentScript();j&&(f.filename=j.src,j.hasAttribute("data-manual")&&(f.manual=!0));function R(){f.manual||f.highlightAll()}if(!f.manual){var C=document.readyState;C==="loading"||C==="interactive"&&j&&j.defer?document.addEventListener("DOMContentLoaded",R):window.requestAnimationFrame?window.requestAnimationFrame(R):window.setTimeout(R,16)}return f})(t);e.exports&&(e.exports=o),typeof at<"u"&&(at.Prism=o),o.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},o.languages.markup.tag.inside["attr-value"].inside.entity=o.languages.markup.entity,o.languages.markup.doctype.inside["internal-subset"].inside=o.languages.markup,o.hooks.add("wrap",function(i){i.type==="entity"&&(i.attributes.title=i.content.replace(/&amp;/,"&"))}),Object.defineProperty(o.languages.markup.tag,"addInlined",{value:function(s,p){var k={};k["language-"+p]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:o.languages[p]},k.cdata=/^<!\[CDATA\[|\]\]>$/i;var f={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:k}};f["language-"+p]={pattern:/[\s\S]+/,inside:o.languages[p]};var P={};P[s]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return s}),"i"),lookbehind:!0,greedy:!0,inside:f},o.languages.insertBefore("markup","cdata",P)}}),Object.defineProperty(o.languages.markup.tag,"addAttribute",{value:function(i,s){o.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+i+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[s,"language-"+s],inside:o.languages[s]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),o.languages.html=o.languages.markup,o.languages.mathml=o.languages.markup,o.languages.svg=o.languages.markup,o.languages.xml=o.languages.extend("markup",{}),o.languages.ssml=o.languages.xml,o.languages.atom=o.languages.xml,o.languages.rss=o.languages.xml,(function(i){var s=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;i.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+s.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+s.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+s.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+s.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:s,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},i.languages.css.atrule.inside.rest=i.languages.css;var p=i.languages.markup;p&&(p.tag.addInlined("style","css"),p.tag.addAttribute("style","css"))})(o),o.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},o.languages.javascript=o.languages.extend("clike",{"class-name":[o.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),o.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,o.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:o.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:o.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:o.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:o.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:o.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),o.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:o.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),o.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),o.languages.markup&&(o.languages.markup.tag.addInlined("script","javascript"),o.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),o.languages.js=o.languages.javascript,(function(){if(typeof o>"u"||typeof document>"u")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var i="Loading…",s=function(j,R){return"✖ Error "+j+" while fetching file: "+R},p="✖ Error: File does not exist or is empty",k={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},f="data-src-status",P="loading",$="loaded",_="failed",M="pre[data-src]:not(["+f+'="'+$+'"]):not(['+f+'="'+P+'"])';function T(j,R,C){var c=new XMLHttpRequest;c.open("GET",j,!0),c.onreadystatechange=function(){c.readyState==4&&(c.status<400&&c.responseText?R(c.responseText):c.status>=400?C(s(c.status,c.statusText)):C(p))},c.send(null)}function L(j){var R=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(j||"");if(R){var C=Number(R[1]),c=R[2],d=R[3];return c?d?[C,Number(d)]:[C,void 0]:[C,C]}}o.hooks.add("before-highlightall",function(j){j.selector+=", "+M}),o.hooks.add("before-sanity-check",function(j){var R=j.element;if(R.matches(M)){j.code="",R.setAttribute(f,P);var C=R.appendChild(document.createElement("CODE"));C.textContent=i;var c=R.getAttribute("data-src"),d=j.language;if(d==="none"){var m=(/\.(\w+)$/.exec(c)||[,"none"])[1];d=k[m]||m}o.util.setLanguage(C,d),o.util.setLanguage(R,d);var w=o.plugins.autoloader;w&&w.loadLanguages(d),T(c,function(S){R.setAttribute(f,$);var n=L(R.getAttribute("data-range"));if(n){var y=S.split(/\r\n?|\n/g),x=n[0],A=n[1]==null?y.length:n[1];x<0&&(x+=y.length),x=Math.max(0,Math.min(x-1,y.length)),A<0&&(A+=y.length),A=Math.max(0,Math.min(A,y.length)),S=y.slice(x,A).join(`
`),R.hasAttribute("data-start")||R.setAttribute("data-start",String(x+1))}C.textContent=S,o.highlightElement(C)},function(S){R.setAttribute(f,_),C.textContent=S})}}),o.plugins.fileHighlight={highlight:function(R){for(var C=(R||document).querySelectorAll(M),c=0,d;d=C[c++];)o.highlightElement(d)}};var z=!1;o.fileHighlight=function(){z||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),z=!0),o.plugins.fileHighlight.highlight.apply(this,arguments)}})()})(De)),De.exports}var Qt=Kt();const eo=Zt(Qt);Prism.languages.javascript=Prism.languages.extend("clike",{"class-name":[Prism.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/});Prism.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/;Prism.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:Prism.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:Prism.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/});Prism.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:Prism.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}});Prism.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}});Prism.languages.markup&&(Prism.languages.markup.tag.addInlined("script","javascript"),Prism.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript"));Prism.languages.js=Prism.languages.javascript;Prism.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]};Prism.languages.markup.tag.inside["attr-value"].inside.entity=Prism.languages.markup.entity;Prism.languages.markup.doctype.inside["internal-subset"].inside=Prism.languages.markup;Prism.hooks.add("wrap",function(e){e.type==="entity"&&(e.attributes.title=e.content.replace(/&amp;/,"&"))});Object.defineProperty(Prism.languages.markup.tag,"addInlined",{value:function(t,o){var i={};i["language-"+o]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:Prism.languages[o]},i.cdata=/^<!\[CDATA\[|\]\]>$/i;var s={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:i}};s["language-"+o]={pattern:/[\s\S]+/,inside:Prism.languages[o]};var p={};p[t]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return t}),"i"),lookbehind:!0,greedy:!0,inside:s},Prism.languages.insertBefore("markup","cdata",p)}});Object.defineProperty(Prism.languages.markup.tag,"addAttribute",{value:function(e,t){Prism.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+e+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[t,"language-"+t],inside:Prism.languages[t]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}});Prism.languages.html=Prism.languages.markup;Prism.languages.mathml=Prism.languages.markup;Prism.languages.svg=Prism.languages.markup;Prism.languages.xml=Prism.languages.extend("markup",{});Prism.languages.ssml=Prism.languages.xml;Prism.languages.atom=Prism.languages.xml;Prism.languages.rss=Prism.languages.xml;(function(e){var t="\\b(?:BASH|BASHOPTS|BASH_ALIASES|BASH_ARGC|BASH_ARGV|BASH_CMDS|BASH_COMPLETION_COMPAT_DIR|BASH_LINENO|BASH_REMATCH|BASH_SOURCE|BASH_VERSINFO|BASH_VERSION|COLORTERM|COLUMNS|COMP_WORDBREAKS|DBUS_SESSION_BUS_ADDRESS|DEFAULTS_PATH|DESKTOP_SESSION|DIRSTACK|DISPLAY|EUID|GDMSESSION|GDM_LANG|GNOME_KEYRING_CONTROL|GNOME_KEYRING_PID|GPG_AGENT_INFO|GROUPS|HISTCONTROL|HISTFILE|HISTFILESIZE|HISTSIZE|HOME|HOSTNAME|HOSTTYPE|IFS|INSTANCE|JOB|LANG|LANGUAGE|LC_ADDRESS|LC_ALL|LC_IDENTIFICATION|LC_MEASUREMENT|LC_MONETARY|LC_NAME|LC_NUMERIC|LC_PAPER|LC_TELEPHONE|LC_TIME|LESSCLOSE|LESSOPEN|LINES|LOGNAME|LS_COLORS|MACHTYPE|MAILCHECK|MANDATORY_PATH|NO_AT_BRIDGE|OLDPWD|OPTERR|OPTIND|ORBIT_SOCKETDIR|OSTYPE|PAPERSIZE|PATH|PIPESTATUS|PPID|PS1|PS2|PS3|PS4|PWD|RANDOM|REPLY|SECONDS|SELINUX_INIT|SESSION|SESSIONTYPE|SESSION_MANAGER|SHELL|SHELLOPTS|SHLVL|SSH_AUTH_SOCK|TERM|UID|UPSTART_EVENTS|UPSTART_INSTANCE|UPSTART_JOB|UPSTART_SESSION|USER|WINDOWID|XAUTHORITY|XDG_CONFIG_DIRS|XDG_CURRENT_DESKTOP|XDG_DATA_DIRS|XDG_GREETER_DATA_DIR|XDG_MENU_PREFIX|XDG_RUNTIME_DIR|XDG_SEAT|XDG_SEAT_PATH|XDG_SESSION_DESKTOP|XDG_SESSION_ID|XDG_SESSION_PATH|XDG_SESSION_TYPE|XDG_VTNR|XMODIFIERS)\\b",o={pattern:/(^(["']?)\w+\2)[ \t]+\S.*/,lookbehind:!0,alias:"punctuation",inside:null},i={bash:o,environment:{pattern:RegExp("\\$"+t),alias:"constant"},variable:[{pattern:/\$?\(\([\s\S]+?\)\)/,greedy:!0,inside:{variable:[{pattern:/(^\$\(\([\s\S]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b0x[\dA-Fa-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:[Ee]-?\d+)?/,operator:/--|\+\+|\*\*=?|<<=?|>>=?|&&|\|\||[=!+\-*/%<>^&|]=?|[?~:]/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/,greedy:!0,inside:{variable:/^\$\(|^`|\)$|`$/}},{pattern:/\$\{[^}]+\}/,greedy:!0,inside:{operator:/:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,punctuation:/[\[\]]/,environment:{pattern:RegExp("(\\{)"+t),lookbehind:!0,alias:"constant"}}},/\$(?:\w+|[#?*!@$])/],entity:/\\(?:[abceEfnrtv\\"]|O?[0-7]{1,3}|U[0-9a-fA-F]{8}|u[0-9a-fA-F]{4}|x[0-9a-fA-F]{1,2})/};e.languages.bash={shebang:{pattern:/^#!\s*\/.*/,alias:"important"},comment:{pattern:/(^|[^"{\\$])#.*/,lookbehind:!0},"function-name":[{pattern:/(\bfunction\s+)[\w-]+(?=(?:\s*\(?:\s*\))?\s*\{)/,lookbehind:!0,alias:"function"},{pattern:/\b[\w-]+(?=\s*\(\s*\)\s*\{)/,alias:"function"}],"for-or-select":{pattern:/(\b(?:for|select)\s+)\w+(?=\s+in\s)/,alias:"variable",lookbehind:!0},"assign-left":{pattern:/(^|[\s;|&]|[<>]\()\w+(?:\.\w+)*(?=\+?=)/,inside:{environment:{pattern:RegExp("(^|[\\s;|&]|[<>]\\()"+t),lookbehind:!0,alias:"constant"}},alias:"variable",lookbehind:!0},parameter:{pattern:/(^|\s)-{1,2}(?:\w+:[+-]?)?\w+(?:\.\w+)*(?=[=\s]|$)/,alias:"variable",lookbehind:!0},string:[{pattern:/((?:^|[^<])<<-?\s*)(\w+)\s[\s\S]*?(?:\r?\n|\r)\2/,lookbehind:!0,greedy:!0,inside:i},{pattern:/((?:^|[^<])<<-?\s*)(["'])(\w+)\2\s[\s\S]*?(?:\r?\n|\r)\3/,lookbehind:!0,greedy:!0,inside:{bash:o}},{pattern:/(^|[^\\](?:\\\\)*)"(?:\\[\s\S]|\$\([^)]+\)|\$(?!\()|`[^`]+`|[^"\\`$])*"/,lookbehind:!0,greedy:!0,inside:i},{pattern:/(^|[^$\\])'[^']*'/,lookbehind:!0,greedy:!0},{pattern:/\$'(?:[^'\\]|\\[\s\S])*'/,greedy:!0,inside:{entity:i.entity}}],environment:{pattern:RegExp("\\$?"+t),alias:"constant"},variable:i.variable,function:{pattern:/(^|[\s;|&]|[<>]\()(?:add|apropos|apt|apt-cache|apt-get|aptitude|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cargo|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|docker|docker-compose|du|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|java|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|node|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|podman|podman-compose|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|sysctl|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vcpkg|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|whereis|which|who|whoami|write|xargs|xdg-open|yarn|yes|zenity|zip|zsh|zypper)(?=$|[)\s;|&])/,lookbehind:!0},keyword:{pattern:/(^|[\s;|&]|[<>]\()(?:case|do|done|elif|else|esac|fi|for|function|if|in|select|then|until|while)(?=$|[)\s;|&])/,lookbehind:!0},builtin:{pattern:/(^|[\s;|&]|[<>]\()(?:\.|:|alias|bind|break|builtin|caller|cd|command|continue|declare|echo|enable|eval|exec|exit|export|getopts|hash|help|let|local|logout|mapfile|printf|pwd|read|readarray|readonly|return|set|shift|shopt|source|test|times|trap|type|typeset|ulimit|umask|unalias|unset)(?=$|[)\s;|&])/,lookbehind:!0,alias:"class-name"},boolean:{pattern:/(^|[\s;|&]|[<>]\()(?:false|true)(?=$|[)\s;|&])/,lookbehind:!0},"file-descriptor":{pattern:/\B&\d\b/,alias:"important"},operator:{pattern:/\d?<>|>\||\+=|=[=~]?|!=?|<<[<-]?|[&\d]?>>|\d[<>]&?|[<>][&=]?|&[>&]?|\|[&|]?/,inside:{"file-descriptor":{pattern:/^\d/,alias:"important"}}},punctuation:/\$?\(\(?|\)\)?|\.\.|[{}[\];\\]/,number:{pattern:/(^|\s)(?:[1-9]\d*|0)(?:[.,]\d+)?\b/,lookbehind:!0}},o.inside=e.languages.bash;for(var s=["comment","function-name","for-or-select","assign-left","parameter","string","environment","function","keyword","builtin","boolean","file-descriptor","operator","punctuation","number"],p=i.variable[1].inside,k=0;k<s.length;k++)p[s[k]]=e.languages.bash[s[k]];e.languages.sh=e.languages.bash,e.languages.shell=e.languages.bash})(Prism);Prism.languages.json={property:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?=\s*:)/,lookbehind:!0,greedy:!0},string:{pattern:/(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?!\s*:)/,lookbehind:!0,greedy:!0},comment:{pattern:/\/\/.*|\/\*[\s\S]*?(?:\*\/|$)/,greedy:!0},number:/-?\b\d+(?:\.\d+)?(?:e[+-]?\d+)?\b/i,punctuation:/[{}[\],]/,operator:/:/,boolean:/\b(?:false|true)\b/,null:{pattern:/\bnull\b/,alias:"keyword"}};Prism.languages.webmanifest=Prism.languages.json;var ct={},dt;function to(){return dt||(dt=1,(function(e){e.languages.typescript=e.languages.extend("javascript",{"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|type)\s+)(?!keyof\b)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?:\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/,lookbehind:!0,greedy:!0,inside:null},builtin:/\b(?:Array|Function|Promise|any|boolean|console|never|number|string|symbol|unknown)\b/}),e.languages.typescript.keyword.push(/\b(?:abstract|declare|is|keyof|readonly|require)\b/,/\b(?:asserts|infer|interface|module|namespace|type)\b(?=\s*(?:[{_$a-zA-Z\xA0-\uFFFF]|$))/,/\btype\b(?=\s*(?:[\{*]|$))/),delete e.languages.typescript.parameter,delete e.languages.typescript["literal-property"];var t=e.languages.extend("typescript",{});delete t["class-name"],e.languages.typescript["class-name"].inside=t,e.languages.insertBefore("typescript","function",{decorator:{pattern:/@[$\w\xA0-\uFFFF]+/,inside:{at:{pattern:/^@/,alias:"operator"},function:/^[\s\S]+/}},"generic-function":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>(?=\s*\()/,greedy:!0,inside:{function:/^#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*/,generic:{pattern:/<[\s\S]+/,alias:"class-name",inside:t}}}}),e.languages.ts=e.languages.typescript})(Prism)),ct}to();const oo={js:"JavaScript",ts:"TypeScript",html:"HTML",bash:"Shell",json:"JSON"};function no(e){const t=e.split(`
...
`)}const ro={data:{lang:"js",code:"",label:"",copied:!1},template:`
    ...
    `,exprs:{"label || langLabel":(e=>e.label||e.langLabel),"copied ? '✓ Copied' : 'Copy'":(e=>e.copied?"â Copied":"Copy"),"copy()":(e=>e.copy()),"'language-' + lang":(e=>"language-"+e.lang)},computed:{langLabel(){return oo[this.lang]||this.lang.toUpperCase()}},methods:{copy(){var e;(e=navigator.clipboard)==null||e.writeText(this._cleanCode).then(()=>{this.copied=!0,setTimeout(()=>{this.copied=!1},1800)})}},onMount(){const e=this.$refs.el;e&&(this._cleanCode=no(this.code),e.textContent=this._cleanCode,eo.highlightElement(e))}},ge="Courvux",so="https://vanjexdev.github.io/courvux";function Z({title:e,description:t,slug:o="/"}){const i=e?`${e} — ${ge}`:`${ge} — Lightweight reactive UI framework`,s=so+o;return Yt({title:e??`${ge} — Lightweight reactive UI framework`,titleTemplate:e?`%s — ${ge}`:void 0,meta:[{name:"description",content:t},{property:"og:title",content:i},{property:"og:description",content:t},{property:"og:type",content:"website"},{property:"og:url",content:s},{property:"og:site_name",content:ge},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:i},{name:"twitter:description",content:t}],link:[{rel:"canonical",href:s}]})}const ao={data:{install:`# From GitHub — pin a tag for stable installs
...
createApp({
    ...
    `,exprs:{"'bash'":(e=>"bash"),install:(e=>e.install),"'terminal'":(e=>"terminal"),"'js'":(e=>"js"),counter:(e=>e.counter),"'main.js'":(e=>"main.js")},onMount(){Z({description:"Lightweight reactive UI framework for the browser. No virtual DOM. Proxy-based reactivity. ~20 KB gzip with everything (router, store, devtools, composables, useHead, SSR).",slug:"/"})}},io={data:{s1:`# Latest commit on main (rolling)
pnpm add github:vanjexdev/courvux

# Pin to a tagged release (recommended for production)
pnpm add github:vanjexdev/courvux#v0.6.0`,s2:`<script type="importmap">
{
  "imports": {
...
{
  "imports": {
    "courvux": "https://cdn.jsdelivr.net/gh/vanjexdev/courvux@v0.6.0/dist/index.js"
  }
}
<\/script>
...
<\/script>`},onMount(){Z({title:"Installation",description:"Install Courvux from GitHub or via import map / CDN. Vite plugin for templateUrl inlining and jsDelivr CDN setup.",slug:"/installation"});const e=this.$refs.pen;if(!e)return;const t=document.createElement("iframe");t.src="https://codepen.io/jesusuzcategui-the-bold/embed/VYmZNgZ?default-tab=html%2Cresult&theme-id=dark",t.height="420",t.style.cssText="width:100%; border:0; border-radius:8px; display:block; margin-bottom:1rem;",t.scrolling="no",t.setAttribute("frameborder","no"),t.setAttribute("allowtransparency","true"),t.allowFullscreen=!0,t.title="Courvux CDN demo on CodePen",e.replaceWith(t)},template:`
    ...
    `,exprs:{"'html'":(e=>"html"),sCdn:(e=>e.sCdn),"'index.html'":(e=>"index.html"),sCdnMap:(e=>e.sCdnMap),"'bash'":(e=>"bash"),s1:(e=>e.s1),"'terminal'":(e=>"terminal"),s2:(e=>e.s2),"'js'":(e=>"js"),s3:(e=>e.s3),"'main.js'":(e=>"main.js"),s4:(e=>e.s4),"'vite.config.js'":(e=>"vite.config.js"),"'json'":(e=>"json"),s5:(e=>e.s5),"'tsconfig.json'":(e=>"tsconfig.json")}},co={data:{s1:`import { createApp } from 'courvux';
...
createApp({ store, router, template: '<router-view />' }).mount('#app');`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),"'main.js'":(e=>"main.js"),s2:(e=>e.s2),s3:(e=>e.s3),s4:(e=>e.s4)},onMount(){Z({title:"Quick Start",description:"Build your first reactive Courvux app — counter example, methods, computed properties.",slug:"/quick-start"})}},lo={data:{s_interp:`<!-- Text interpolation -->
<p>{{ count }}</p>
<p>{{ price * qty }}</p>
<p>{{ active ? 'On' : 'Off' }}</p>
...
<div id="app" cv-cloak></div>`},template:`
    ...
    `,exprs:{"'html'":(e=>"html"),s_interp:(e=>e.s_interp),s_bind:(e=>e.s_bind),s_events:(e=>e.s_events),s_cvfor:(e=>e.s_cvfor),s_cvif:(e=>e.s_cvif),s_cvshow:(e=>e.s_cvshow),s_cvmodel:(e=>e.s_cvmodel),s_cvhtml:(e=>e.s_cvhtml),s_cvdata:(e=>e.s_cvdata),s_misc:(e=>e.s_misc)},onMount(){Z({title:"Template Syntax",description:"Courvux directives and bindings: cv-if, cv-for, cv-model, cv-show, :class, :style, @event.",slug:"/template"})}},uo={data:{s_define:`createApp({
    components: {
        'user-card': {
...
<editor cv-model:title="docTitle" cv-model:body="docBody" />`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_define:(e=>e.s_define),s_props:(e=>e.s_props),s_emit:(e=>e.s_emit),s_dispatch:(e=>e.s_dispatch),"'html'":(e=>"html"),s_slots:(e=>e.s_slots),s_dynamic:(e=>e.s_dynamic),s_refs:(e=>e.s_refs),s_model:(e=>e.s_model)},onMount(){Z({title:"Components",description:"Define, register, and compose Courvux components with props, slots, emits, and scoped slots.",slug:"/components"})}},po={data:{s_computed:`{
    data: { price: 10, qty: 3 },
    computed: {
...
}`,s3:`// Error boundary — catches errors from descendant onMount
{
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),s2:(e=>e.s2),s3:(e=>e.s3)},onMount(){Z({title:"Lifecycle Hooks",description:"onMount, onBeforeUnmount, onDestroy, error boundaries, and async data in Courvux.",slug:"/lifecycle"})}},ho={data:{s_storage:`import { cvStorage } from 'courvux';
...
export const useCounter = defineComposable((initial = 0) => useComposables(
    ...
    `,exprs:{"'js'":(e=>"js"),s_define:(e=>e.s_define),s_useMany:(e=>e.s_useMany),s_nested:(e=>e.s_nested),s_storage:(e=>e.s_storage),s_fetch:(e=>e.s_fetch),s_fetch_opts:(e=>e.s_fetch_opts),s_debounce:(e=>e.s_debounce),s_throttle:(e=>e.s_throttle),s_media:(e=>e.s_media),s_listener:(e=>e.s_listener)},onMount(){Z({title:"Composables",description:"Author and reuse logic in Courvux with defineComposable + useComposables, plus the built-in cvStorage, cvFetch, cvDebounce, cvThrottle, cvMediaQuery, cvListener helpers.",slug:"/composables"})}},fo={data:{s_basic:`import { createEventBus } from 'courvux';
...
bus.emit('toast:show', 'Saved again');  // handler does NOT run`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_basic:(e=>e.s_basic),"'ts'":(e=>"ts"),s_typed:(e=>e.s_typed),s_once:(e=>e.s_once),s_provide:(e=>e.s_provide),s_inject:(e=>e.s_inject)},onMount(){Z({title:"Event Bus",description:"Typed cross-component event bus in Courvux: on, off, emit, once, clear, and provide/inject patterns.",slug:"/event-bus"})}},go={data:{s_setup:`import { createApp, createRouter } from 'courvux';
...
{ inject: { localTheme: 'theme', endpoint: 'apiUrl' } }`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s1:(e=>e.s1),"'html'":(e=>"html"),s2:(e=>e.s2),s3:(e=>e.s3),s4:(e=>e.s4),s5:(e=>e.s5),s6:(e=>e.s6)},onMount(){Z({title:"Store",description:"Global reactive state in Courvux with createStore, modules, and namespaced actions.",slug:"/store"})}},bo={data:{s_basic:`import { useHead } from 'courvux';
...
// → embed headHtml in your shell, then html in the mount root`},template:`
    ...
    mode: 'history',
    base: '/courvux',
});`)},onMount(){Z({title:"Static Site Generation",description:"Pre-render every route to static HTML at build time with the courvux/plugin/ssg Vite plugin.",slug:"/ssg"})}},xo={data:{s_setup:`import { createApp, setupDevTools, mountDevOverlay } from 'courvux';
...
inst.setState('filter', 'completed');`},template:`
    ...
    `,exprs:{"'js'":(e=>"js"),s_setup:(e=>e.s_setup),s_external:(e=>e.s_external),"'ts'":(e=>"ts"),s_hook:(e=>e.s_hook)},onMount(){Z({title:"DevTools",description:"In-app DevTools overlay for Courvux: live component state inspection and inline editing, no browser extension needed.",slug:"/devtools"})}},wo={data:{s_basic:`import { mount } from 'courvux/test-utils';
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,exprs:{"'js'":(e=>"js"),s_config:(e=>e.s_config),s_basic:(e=>e.s_basic),s_state:(e=>e.s_state),s_global:(e=>e.s_global),s_async:(e=>e.s_async)},onMount(){Z({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},ko={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
autoInit({
    ...
    `,exprs:{"'js'":(e=>"js"),s_dir:(e=>e.s_dir),"'html'":(e=>"html"),s_dir_use:(e=>e.s_dir_use),s_transition:(e=>e.s_transition),s_intersect:(e=>e.s_intersect),s_plugins:(e=>e.s_plugins),s_magic:(e=>e.s_magic),s_autoinit:(e=>e.s_autoinit)},onMount(){Z({title:"Advanced",description:"Custom directives, plugins, transitions, and the cv-data inline scope in Courvux.",slug:"/advanced"})}},Ao={template:`
        <div class="prose">
...
this.cards.splice(idx, 1);`},template:`
    ...
    `,exprs:{"'html'":(e=>"html"),s_keyed:(e=>e.s_keyed),"item.id":(e=>e.item.id),"'js'":(e=>"js"),s_csp:(e=>e.s_csp),"'ts'":(e=>"ts"),s_ts:(e=>e.s_ts),s_lazy:(e=>e.s_lazy),s_vite:(e=>e.s_vite),s_tauri:(e=>e.s_tauri),s_test:(e=>e.s_test),s_proxyId_faq:(e=>e.s_proxyId_faq)},onMount(){Z({title:"FAQ",description:"Frequently asked questions and troubleshooting for Courvux: cv-for keys, strict CSP, TypeScript, lazy loading, Vite/Tauri integration, testing, migration.",slug:"/faq"})}},Co={data:{s_component_vue:`// Vue 3 — Options API
export default {
    data() { return { count: 0 } },
...
this.$store.addToCart(product);`},template:`
    ...
    `,exprs:{expression:(e=>e.expression),items:(e=>e.items),"'js'":(e=>"js"),s_component_vue:(e=>e.s_component_vue),s_component_courvux:(e=>e.s_component_courvux),s_setup_warn:(e=>e.s_setup_warn),s_props:(e=>e.s_props),x:(e=>e.x),s_router:(e=>e.s_router),s_store:(e=>e.s_store)},onMount(){Z({title:"Migrating from Vue",description:"Mapping table from Vue 3 Options API to Courvux: directives, lifecycle hooks, props, emits, router, Pinia store. Surgical migration, mostly identical syntax.",slug:"/migrating-from-vue"})}},Eo={data:{s_xdata:`<!-- Alpine -->
...
// Used in HTML: $store.cart.count`},template:`
    ...
    `,exprs:{"{ open: false }":(e=>({open:!1})),open:(e=>e.open),items:(e=>e.items),"'foo_'+id":(e=>"foo_"+e.id),"'html'":(e=>"html"),s_xdata:(e=>e.s_xdata),s_init:(e=>e.s_init),"'js'":(e=>"js"),s_components:(e=>e.s_components),counter:(e=>e.counter),s_store:(e=>e.s_store)},onMount(){Z({title:"Migrating from Alpine",description:"Mapping table from Alpine.js to Courvux: x-data → cv-data, directives, named components, stores. Mostly identical syntax with a prefix swap.",slug:"/migrating-from-alpine"})}},bt="courvux-demo-todos",To=`const STORAGE_KEY = 'courvux-demo-todos';
...
<button cv-show="todos.some(t => t.done)" @click="clearCompleted()">Clear completed</button>`;function jo(){try{return JSON.parse(localStorage.getItem(bt))||[]}catch{return[]}}function Oo(e){localStorage.setItem(bt,JSON.stringify(e))}const Fo={data:{todos:jo(),newTodo:"",filter:"all",editingId:null,editText:"",_nextId:Date.now(),srcJs:To,srcHtml:$o,srcTab:"js"},computed:{filteredTodos(){return this.filter==="active"?this.todos.filter(e=>!e.done):this.filter==="completed"?this.todos.filter(e=>e.done):this.todos},remaining(){return this.todos.filter(e=>!e.done).length},allDone(){return this.todos.length>0&&this.todos.every(e=>e.done)}},watch:{todos:{deep:!0,handler(e){Oo(e)}}},methods:{add(){const e=this.newTodo.trim();e&&(this.todos=[...this.todos,{id:this._nextId++,text:e,done:!1}],this.newTodo="")},toggle(e){this.todos=this.todos.map(t=>t.id===e?{...t,done:!t.done}:t)},remove(e){this.todos=this.todos.filter(t=>t.id!==e)},clearCompleted(){this.todos=this.todos.filter(e=>!e.done)},toggleAll(){const e=this.allDone;this.todos=this.todos.map(t=>({...t,done:!e}))},startEdit(e){this.editingId=e.id,this.editText=e.text,this.$nextTick(()=>{var t;return(t=this.$refs["edit_"+e.id])==null?void 0:t.focus()})},commitEdit(e){const t=this.editText.trim();t?this.todos=this.todos.map(o=>o.id===e?{...o,text:t}:o):this.remove(e),this.editingId=null,this.editText=""},cancelEdit(){this.editingId=null,this.editText=""},setFilter(e){this.filter=e}},template:`
    ...
    `,exprs:{"goBack()":(e=>e.goBack()),"$event.currentTarget.style.background='#f5f5f5'":(e=>e.$event.currentTarget.style.background="#f5f5f5"),"$event.currentTarget.style.background='#fff'":(e=>e.$event.currentTarget.style.background="#fff"),"$event.currentTarget.style.opacity='0.85'":(e=>e.$event.currentTarget.style.opacity="0.85"),"$event.currentTarget.style.opacity='1'":(e=>e.$event.currentTarget.style.opacity="1")},onMount(){Z({title:"404 — Page not found",description:"The page you are looking for does not exist on Courvux docs.",slug:"/404"})}};let ze=null;function Io(e){ze=e}const Mo=Dt([...Po,{path:"*",component:Do}],{mode:"history",base:"/courvux",afterEach(){ze&&ze()},scrollBehavior:()=>{var e;return(e=document.querySelector("main"))==null||e.scrollTo({top:0,behavior:"instant"}),{x:0,y:0}}}),lt=[{key:"start",label:"Getting Started",items:[{to:"/",label:"Introduction"},{to:"/installation",label:"Installation"},{to:"/quick-start",label:"Quick Start"}]},{key:"template",label:"Template Syntax",items:[{to:"/template",label:"Directives & Bindings"}]},{key:"components",label:"Components",items:[{to:"/components",label:"Components"},{to:"/reactivity",label:"Reactivity"},{to:"/lifecycle",label:"Lifecycle"},{to:"/composables",label:"Composables"},{to:"/event-bus",label:"Event Bus"}]},{key:"router",label:"Router & Store",items:[{to:"/router",label:"Router"},{to:"/store",label:"Store"}]},{key:"seo",label:"SEO & SSG",items:[{to:"/head",label:"useHead"},{to:"/ssg",label:"Static Generation"}]},{key:"tooling",label:"Tooling",items:[{to:"/devtools",label:"DevTools"},{to:"/testing",label:"Testing"},{to:"/pwa",label:"PWA"}]},{key:"advanced",label:"Advanced",items:[{to:"/advanced",label:"Directives & Plugins"}]},{key:"reference",label:"Reference",items:[{to:"/design-decisions",label:"Design Decisions"},{to:"/faq",label:"FAQ & Troubleshooting"},{to:"/migrating-from-vue",label:"Migrating from Vue"},{to:"/migrating-from-alpine",label:"Migrating from Alpine"}]},{key:"demo",label:"Demo",items:[{to:"/demo",label:"⚡ TODO App"}]}];Jt({router:Mo,components:{"code-block":ro},data:{nav:lt,open:lt.reduce((e,t)=>(e[t.key]=!0,e),{}),sidebarOpen:!1},methods:{toggle(e){this.open={...this.open,[e]:!this.open[e]}},toggleSidebar(){if(this.sidebarOpen=!this.sidebarOpen,this.sidebarOpen)document.body.style.overflow="hidden",this.$nextTick(()=>{const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(0)")});else{document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(-100%)")}},closeSidebar(){if(window.innerWidth<=1024){this.sidebarOpen=!1,document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="translateX(-100%)")}}},onMount(){Io(()=>{this.closeSidebar()})},onBeforeMount(){typeof window<"u"&&window.addEventListener("resize",()=>{if(window.innerWidth>1024&&this.sidebarOpen){this.sidebarOpen=!1,document.body.style.overflow="";const e=document.querySelector(".sidebar");e&&(e.style.transform="")}})},template:`
    ...
    `,exprs:{"section.label":(e=>e.section.label),"item.label":(e=>e.item.label),"sidebarOpen ? '✕' : '☰'":(e=>e.sidebarOpen?"â":"â°"),sidebarOpen:(e=>e.sidebarOpen),closeSidebar:(e=>e.closeSidebar),"sidebarOpen ? 'opacity:1' : 'opacity:0'":(e=>e.sidebarOpen?"opacity:1":"opacity:0"),"closeSidebar()":(e=>e.closeSidebar()),nav:(e=>e.nav),"section.key":(e=>e.section.key),"toggle(section.key)":(e=>e.toggle(e.section.key)),"open[section.key] ? 'true' : 'false'":(e=>e.open[e.section.key]?"true":"false"),"$event.currentTarget.style.color='#111'":(e=>e.$event.currentTarget.style.color="#111"),"$event.currentTarget.style.color='#666'":(e=>e.$event.currentTarget.style.color="#666"),"open[section.key] ? 'transform:rotate(90deg)' : 'transform:rotate(0deg)'":(e=>e.open[e.section.key]?"transform:rotate(90deg)":"transform:rotate(0deg)"),"open[section.key]":(e=>e.open[e.section.key]),"section.items":(e=>e.section.items),"item.to":(e=>e.item.to),"$event.target.style.color='#111'":(e=>e.$event.target.style.color="#111"),"$event.target.style.color='#555'":(e=>e.$event.target.style.color="#555"),"toggleSidebar()":(e=>e.toggleSidebar()),"sidebarOpen ? 'Close navigation' : 'Open navigation'":(e=>e.sidebarOpen?"Close navigation":"Open navigation"),"sidebarOpen ? 'true' : 'false'":(e=>e.sidebarOpen?"true":"false"),"$event.currentTarget.style.transform='scale(1.1)'":(e=>e.$event.currentTarget.style.transform="scale(1.1)"),"$event.currentTarget.style.transform='scale(1)'":(e=>e.$event.currentTarget.style.transform="scale(1)")}}).mount("#app").catch(e=>{console.error("[courvux] mount failed:",e);const t=document.getElementById("app");t&&(t.innerHTML=`
