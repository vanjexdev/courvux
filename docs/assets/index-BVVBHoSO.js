(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const p of s)if(p.type==="childList")for(const k of p.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&i(k)}).observe(document,{childList:!0,subtree:!0});function o(s){const p={};return s.integrity&&(p.integrity=s.integrity),s.referrerPolicy&&(p.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?p.credentials="include":s.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function i(s){if(s.ep)return;s.ep=!0;const p=o(s);fetch(s.href,p)}})();var Ct=new Set(["push","pop","shift","unshift","splice","sort","reverse"]),ft=e=>e instanceof Date||e instanceof RegExp||e instanceof Map||e instanceof Set||e instanceof WeakMap||e instanceof WeakSet||ArrayBuffer.isView(e)||e instanceof ArrayBuffer,Me=new WeakSet,$e=Symbol("raw"),Pe=e=>e===null||typeof e!="object"?e:e[$e]??e,Ae=0,Re=new Map,be=null;function Ue(e){const t=[],o=be;be=t;try{e()}finally{be=o}return t}function $t(e){Ae++;try{e()}finally{if(Ae--,Ae===0){const t=[...Re.values()];Re.clear(),t.forEach(o=>o())}}}function gt(e,t){return e===null||typeof e!="object"||Me.has(e)||ft(e)?e:new Proxy(e,{get(o,i){if(i===$e)return o[$e]??o;if(typeof i=="string"&&Array.isArray(o)&&Ct.has(i))return(...p)=>{const k=Array.prototype[i].apply(o,p);return t(),k};const s=o[i];return s!==null&&typeof s=="object"&&!Me.has(s)?gt(s,t):s},set(o,i,s){return o[i]=s,t(),!0}})}function ze(){const e={},t=Math.random().toString(36).slice(2),o=(p,k)=>(e[p]||(e[p]=new Set),e[p].add(k),()=>{var g;(g=e[p])==null||g.delete(k)}),i=p=>{Ae>0?Re.set(`${t}:${p}`,()=>{(e[p]?[...e[p]]:[]).forEach(k=>k())}):(e[p]?[...e[p]]:[]).forEach(k=>k())},s={};return{subscribe:o,createReactiveState:p=>new Proxy(p,{get(k,g){if(g===$e)return p;typeof g=="string"&&!g.startsWith("$")&&be&&be.push({sub:o,key:g});const D=k[g];return typeof g=="string"&&!g.startsWith("$")&&D!==null&&typeof D=="object"&&!Me.has(D)&&!ft(D)?gt(D,()=>i(g)):D},set(k,g,D){if(s[g])return s[g](D),!0;const T=k[g];return k[g]=D,(T!==D||D!==null&&typeof D=="object")&&i(g),!0}}),registerSetInterceptor:(p,k)=>{s[p]=k},notifyAll:()=>{Object.keys(e).forEach(p=>i(p))}}}var De=new WeakMap;function ye(e,t,o){var s,p;const i=t.indexOf(".");if(i>=0){const k=t.slice(0,i),g=t.slice(i+1),D=e[k];return D&&De.has(D)?ye(D,g,o):((s=De.get(e))==null?void 0:s(k,o))??(()=>{})}return((p=De.get(e))==null?void 0:p(t,o))??(()=>{})}var vt=(e,t)=>e.split(".").reduce((o,i)=>o==null?void 0:o[i],t),Be=!1,xe=!1,We=()=>{if(Be)return xe;Be=!0;try{new Function("return 1")(),xe=!0}catch{console.warn("[courvux] CSP blocks eval. Falling back to a limited evaluator that handles property access and literals only. Add `vite-plugin-courvux-precompile` to your build for full template support under strict CSP."),xe=!1}return xe},Ve=new Map,Ge=new Map,he=new WeakMap,Tt=(e,t)=>{const o=he.get(e);o?Object.assign(o,t):he.set(e,{...t})},_e=(e,t)=>{const o=he.get(t);o&&he.set(e,o)},bt=(e,t)=>{const o=e.trim();if(o==="true")return!0;if(o==="false")return!1;if(o==="null")return null;if(o!=="undefined")return/^-?\d+(\.\d+)?$/.test(o)?parseFloat(o):/^(['"`])(.*)\1$/s.test(o)?o.slice(1,-1):o.startsWith("!")?!bt(o.slice(1).trim(),t):vt(o,t)},q=(e,t)=>{var i;const o=(i=he.get(t))==null?void 0:i[e];if(o)try{return o(t)}catch{}if(!We())return bt(e,t);try{let s=Ve.get(e);return s||(s=new Function("$data",`with($data) { return (${e}) }`),Ve.set(e,s)),s(t)}catch{return vt(e,t)}},yt=(e,t,o)=>e.startsWith("$store.")&&t.store?t.storeSubscribeOverride?t.storeSubscribeOverride(t.store,e.slice(7),o):ye(t.store,e.slice(7),o):t.subscribe(e,o),Z=(e,t,o)=>{const i=new Set(["true","false","null","undefined","in","of","typeof","instanceof"]),s=e.match(/\$?[a-zA-Z_][\w$]*(?:\.\$?[a-zA-Z_][\w$]*)*/g)??[],p=[...new Set(s.map(g=>g.startsWith("$store.")?g:g.split(".")[0]).filter(g=>!i.has(g)))];if(p.length===0)return()=>{};const k=p.map(g=>yt(g,t,o));return()=>k.forEach(g=>g())},Ye=new Map,Et=e=>{const t=Ye.get(e);if(t)return t;const o=e.trim();let i=0,s=-1,p=null;for(let g=0;g<o.length;g++){const D=o[g];D==="["?(i===0&&(s=g,p="bracket"),i++):D==="]"?i--:D==="."&&i===0&&(s=g,p="dot")}let k;if(s<0)k={parent:"",keyExpr:JSON.stringify(o)};else if(p==="dot")k={parent:o.slice(0,s),keyExpr:JSON.stringify(o.slice(s+1))};else{const g=o.lastIndexOf("]");k=g>s?{parent:o.slice(0,s),keyExpr:o.slice(s+1,g)}:{parent:"",keyExpr:JSON.stringify(o)}}return Ye.set(e,k),k},pe=(e,t,o)=>{if(We())try{const{parent:s,keyExpr:p}=Et(e),k=s?q(s,t):t,g=q(p,t);if(k==null)return;k[g]=o;return}catch(s){console.warn(`[courvux] setStateValue: write failed for "${e}":`,s);return}const i=e.split(".");if(i.length===1)t[i[0]]=o;else{const s=i.slice(0,-1).reduce((p,k)=>p==null?void 0:p[k],t);s&&(s[i[i.length-1]]=o)}},Xe=(e,t,o,i,s)=>{const p={};return Object.keys(e).forEach(k=>p[k]=e[k]),p[o]=t,s&&(p[s]=i),_e(p,e),p},He=e=>e?typeof e=="string"?e:Array.isArray(e)?e.map(He).filter(Boolean).join(" "):typeof e=="object"?Object.entries(e).filter(([,t])=>!!t).map(([t])=>t).join(" "):"":"",Je=(e,t,o)=>{if(!t){e.style.cssText=o;return}typeof t=="string"?e.style.cssText=o?`${o};${t}`:t:typeof t=="object"&&(o&&(e.style.cssText=o),Object.entries(t).forEach(([i,s])=>{e.style[i]=s??""}))},Ze=(e,t,o)=>{var s;const i=(s=he.get(t))==null?void 0:s[e];if(i)try{i(new Proxy(t,{get(p,k){return k==="$event"?o:p[k]},set(p,k,g){return p[k]=g,!0},has(p,k){return!0}}));return}catch(p){console.warn(`[courvux] handler error "${e}":`,p);return}if(We())try{let p=Ge.get(e);p||(p=new Function("__p__",`with(__p__){${e}}`),Ge.set(e,p));const k=new Proxy({},{has:()=>!0,get:(g,D)=>D==="$event"?o:D in t?t[D]:globalThis[D],set:(g,D,T)=>(t[D]=T,!0)});p(k)}catch(p){console.warn(`[courvux] handler error "${e}":`,p)}},ce=e=>{const t=getComputedStyle(e),o=Math.max(parseFloat(t.animationDuration)||0,parseFloat(t.transitionDuration)||0)*1e3;return o<=0?Promise.resolve():new Promise(i=>{const s=()=>i();e.addEventListener("animationend",s,{once:!0}),e.addEventListener("transitionend",s,{once:!0}),setTimeout(s,o+50)})},jt=`
...
`,Ke=!1;function Qe(){if(Ke||typeof document>"u")return;Ke=!0;const e=document.createElement("style");e.id="cv-transitions-el",e.textContent=jt,document.head.appendChild(e)}var et=!1;function Ot(){if(et||typeof document>"u")return;et=!0;const e=document.createElement("style");e.id="cv-cloak-style",e.textContent="[cv-cloak]{display:none!important}",document.head.appendChild(e)}function Ft(e){if(typeof window<"u"&&"Sanitizer"in window){const o=document.createElement("div");return o.setHTML(e,{sanitizer:new window.Sanitizer}),o.innerHTML}const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("script,iframe,object,embed,form,meta,link,style").forEach(o=>o.remove()),t.querySelectorAll("*").forEach(o=>{Array.from(o.attributes).forEach(i=>{(i.name.startsWith("on")||i.value.trim().toLowerCase().startsWith("javascript:"))&&o.removeAttribute(i.name)})}),t.body.innerHTML}async function te(e,t,o){var p,k,g,D,T,_,L,$,M,z,E,R,C,c,d,h,w;const i=Array.from(e.childNodes);let s=0;for(;s<i.length;){const S=i[s];if(S.nodeType===3){const a=S.textContent||"",l=a.match(/\{\{([\s\S]+?)\}\}/g);if(l){const r=a,f=()=>{let m=r;l.forEach(u=>{const v=u.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,"");m=m.replace(u,q(v,t)??"")}),S.textContent=m};l.forEach(m=>{Z(m.replace(/^\{\{\s*/,"").replace(/\s*\}\}$/,""),o,f)}),f()}s++;continue}if(S.nodeType!==1){s++;continue}const n=S,y=n.tagName.toLowerCase();if(n.hasAttribute("cv-pre")){n.removeAttribute("cv-pre"),s++;continue}if(n.hasAttribute("cv-once")){n.removeAttribute("cv-once"),await te(n,t,{...o,subscribe:()=>()=>{},storeSubscribeOverride:()=>()=>{}}),s++;continue}if(n.hasAttribute("cv-cloak")&&n.removeAttribute("cv-cloak"),n.hasAttribute("cv-teleport")){const a=n.getAttribute("cv-teleport");n.removeAttribute("cv-teleport");const l=document.querySelector(a)??document.body,r=document.createComment(`cv-teleport: ${a}`);n.replaceWith(r),await te(n,t,o),l.appendChild(n),s++;continue}if(n.hasAttribute("cv-memo")){const a=n.getAttribute("cv-memo");n.removeAttribute("cv-memo");const l=()=>a.split(",").map(v=>q(v.trim(),t));let r=l();const f=[],m=v=>(f.push(v),()=>{const b=f.indexOf(v);b>-1&&f.splice(b,1)});await te(n,t,{...o,subscribe:(v,b)=>m(b),storeSubscribeOverride:(v,b,j)=>m(j)});const u=Z(a,o,()=>{const v=l();v.some((b,j)=>b!==r[j])&&(r=v,[...f].forEach(b=>b()))});(p=o.registerCleanup)==null||p.call(o,()=>u()),s++;continue}if(n.hasAttribute("cv-data")){const a=n.getAttribute("cv-data").trim();n.removeAttribute("cv-data");let l={},r={};if(a.startsWith("{")){const f=q(a,t)??{};Object.entries(f).forEach(([m,u])=>{typeof u=="function"?r[m]=u:l[m]=u})}else if(a){const f=(k=o.components)==null?void 0:k[a];if(f){const m=typeof f.data=="function"?f.data():f.data??{};m instanceof Promise||Object.assign(l,m),Object.assign(r,f.methods??{})}}if(o.createChildScope){const f=o.createChildScope(l,r);(g=o.registerCleanup)==null||g.call(o,f.cleanup),_e(f.state,t),await te(n,f.state,{...o,subscribe:f.subscribe})}else{const f={...t,...l,...r};_e(f,t),await te(n,f,o)}s++;continue}if(n.hasAttribute("cv-for")){const a=n.getAttribute("cv-for");n.removeAttribute("cv-for");const l=a.match(/^\(?(\w+)(?:,\s*(\w+))?\)?\s+in\s+(.+)$/);if(l){const[,r,f,m]=l,u=n.getAttribute(":key")??null;u&&n.removeAttribute(":key");const v=n.getAttribute("cv-transition")??null;v&&n.removeAttribute("cv-transition");const b=document.createComment(`cv-for: ${m}`);n.replaceWith(b);let j=[],F=[];const O=new Map;let N=!1,W=!1;const P=async()=>{var K;const U=q(m,t),H=U?typeof U=="number"?Array.from({length:U},(V,B)=>[B+1,B]):Array.isArray(U)?U.map((V,B)=>[V,B]):Object.entries(U).map(([V,B])=>[B,V]):[];if(u){const V=[],B=new Map,de=new Set;for(const[J,Y]of H){const ae=q(u,Xe(t,J,r,Y,f));de.has(ae)&&console.warn(`[courvux] cv-for: duplicate :key "${ae}" in "${m}"`),de.add(ae),V.push(ae),B.set(ae,[J,Y])}const Q=[];for(const[J,{el:Y,destroy:ae}]of O)B.has(J)||(v?(Y.classList.add(`${v}-leave`),Q.push(ce(Y).then(()=>{var ie;Y.classList.remove(`${v}-leave`),ae(),(ie=Y.parentNode)==null||ie.removeChild(Y),O.delete(J)}))):(ae(),(K=Y.parentNode)==null||K.removeChild(Y),O.delete(J)));Q.length&&await Promise.all(Q);const re=b.parentNode,se=[];for(const J of V){const[Y,ae]=B.get(J);if(O.has(J)){const ie=O.get(J);ie.itemRef!==Y&&(ie.reactive[r]=Y,ie.itemRef=Y),f&&(ie.reactive[f]=ae)}else{const ie=n.cloneNode(!0),Ee=[],{subscribe:St,createReactiveState:At}=ze(),je=At({[r]:Y,...f?{[f]:ae}:{}}),qe=new Proxy({},{has(le,ee){return!0},get(le,ee){return typeof ee!="string"?t[ee]:ee===r||f&&ee===f?je[ee]:t[ee]},set(le,ee,ue){return ee===r||f&&ee===f?(je[ee]=ue,!0):(t[ee]=ue,!0)}});_e(qe,t);const _t={...o,subscribe:(le,ee)=>{const ue=le.split(".")[0];let me;return ue===r||f&&ue===f?me=St(ue,ee):me=o.subscribe(le,ee),Ee.push(me),me},storeSubscribeOverride:(le,ee,ue)=>{const me=ye(le,ee,ue);return Ee.push(me),me}},Oe=document.createDocumentFragment();Oe.appendChild(ie),await te(Oe,qe,_t);const Fe=Oe.firstChild??ie;v&&Fe.classList.add(`${v}-enter`),O.set(J,{el:Fe,reactive:je,itemRef:Y,destroy:()=>Ee.forEach(le=>le())}),v&&se.push(Fe)}}let oe=b.nextSibling,fe=0;for(const J of V){const{el:Y}=O.get(J);Y!==oe?fe++:oe=Y.nextSibling}if(fe>0)if(fe>V.length>>1){const J=document.createDocumentFragment();for(const Y of V)J.appendChild(O.get(Y).el);re.insertBefore(J,b.nextSibling)}else{oe=b.nextSibling;for(const J of V){const{el:Y}=O.get(J);Y!==oe?re.insertBefore(Y,oe):oe=Y.nextSibling}}j=V.map(J=>O.get(J).el),se.length&&Promise.all(se.map(J=>ce(J).then(()=>J.classList.remove(`${v}-enter`))))}else{if(F.forEach(Q=>Q()),F=[],j.forEach(Q=>{var re;return(re=Q.parentNode)==null?void 0:re.removeChild(Q)}),j=[],!H.length)return;const V=b.parentNode,B=b.nextSibling,de={...o,subscribe:(Q,re)=>{const se=o.subscribe(Q,re);return F.push(se),se},storeSubscribeOverride:(Q,re,se)=>{const oe=ye(Q,re,se);return F.push(oe),oe}};for(const[Q,re]of H){const se=n.cloneNode(!0),oe=document.createDocumentFragment();oe.appendChild(se),await te(oe,Xe(t,Q,r,re,f),de);const fe=oe.firstChild??se;V.insertBefore(oe,B),j.push(fe)}}},G=async()=>{if(N){W=!0;return}N=!0;try{for(await P();W;)W=!1,await P()}finally{N=!1}};(D=o.registerCleanup)==null||D.call(o,()=>{O.forEach(({el:U,destroy:H})=>{var K;H(),(K=U.parentNode)==null||K.removeChild(U)}),O.clear(),F.forEach(U=>U()),j.forEach(U=>{var H;return(H=U.parentNode)==null?void 0:H.removeChild(U)}),j=[]}),Z(m,o,G),await G()}s++;continue}if(n.hasAttribute("cv-if")){const a=[],l=n.getAttribute("cv-if");n.removeAttribute("cv-if");const r=document.createComment("cv-if");n.replaceWith(r),a.push({condition:l,template:n,anchor:r});let f=s+1;for(;f<i.length;){const F=i[f];if(F.nodeType===3&&(((T=F.textContent)==null?void 0:T.trim())??"")===""){f++;continue}if(F.nodeType!==1)break;const O=F;if(O.hasAttribute("cv-else-if")){const N=O.getAttribute("cv-else-if");O.removeAttribute("cv-else-if");const W=document.createComment("cv-else-if");O.replaceWith(W),a.push({condition:N,template:O,anchor:W}),f++;continue}if(O.hasAttribute("cv-else")){O.removeAttribute("cv-else");const N=document.createComment("cv-else");O.replaceWith(N),a.push({condition:null,template:O,anchor:N}),f++;break}break}s=f;let m=null,u=-1,v=!1,b=!1;const j=async()=>{var F,O;if(v){b=!0;return}v=!0;try{do{b=!1;let N=-1;for(let H=0;H<a.length;H++){const K=a[H];if(K.condition===null||q(K.condition,t)){N=H;break}}if(N===u&&m||(m&&((F=m.parentNode)==null||F.removeChild(m),m=null),u=N,N<0))continue;const W=a[N],P=W.template.cloneNode(!0),G=document.createDocumentFragment();G.appendChild(P),await te(G,t,o);const U=G.firstChild??P;(O=W.anchor.parentNode)==null||O.insertBefore(G,W.anchor.nextSibling),m=U}while(b)}finally{v=!1}};a.filter(F=>F.condition).forEach(F=>{Z(F.condition,o,j)}),await j();continue}if(n.hasAttribute("cv-show")){const a=n.getAttribute("cv-show");n.removeAttribute("cv-show");const l=Array.from(n.attributes).filter(r=>r.name==="cv-transition"||r.name.startsWith("cv-transition:")||r.name.startsWith("cv-transition."));if(l.length>0){const r=P=>(n.getAttribute(P)??"").split(" ").filter(Boolean),f=r("cv-transition:enter"),m=r("cv-transition:enter-start"),u=r("cv-transition:enter-end"),v=r("cv-transition:leave"),b=r("cv-transition:leave-start"),j=r("cv-transition:leave-end"),F=n.getAttribute("cv-transition")??"",O=new Set(F.split(".").slice(1)),N=[...O].find(P=>/^\d+$/.test(P)),W=N?parseInt(N):200;if(f.length||m.length||v.length||b.length){l.forEach(V=>n.removeAttribute(V.name));const P=()=>new Promise(V=>requestAnimationFrame(()=>requestAnimationFrame(()=>V())));let G=!!q(a,t),U=!1,H=null;const K=async V=>{if(U){H=V;return}U=!0;try{V?(n.style.display="",n.classList.add(...f,...m),await P(),n.classList.remove(...m),n.classList.add(...u),await ce(n),n.classList.remove(...f,...u)):(n.classList.add(...v,...b),await P(),n.classList.remove(...b),n.classList.add(...j),await ce(n),n.classList.remove(...v,...j),n.style.display="none"),G=V}finally{if(U=!1,H!==null&&H!==G){const B=H;H=null,K(B)}else H=null}};G||(n.style.display="none"),Z(a,o,()=>{const V=!!q(a,t);V!==G&&K(V)})}else{const P=[...O].find(B=>B==="scale"||/^scale$/.test(B)),G=(()=>{const B=[...O].find(de=>/^\d+$/.test(de)&&de!==N);return B?parseInt(B)/100:.9})(),U=[];(!O.has("scale")||O.has("opacity"))&&U.push(`opacity ${W}ms ease`),P&&U.push(`transform ${W}ms ease`),U.length||U.push(`opacity ${W}ms ease`),n.style.transition=(n.style.transition?n.style.transition+", ":"")+U.join(", "),l.forEach(B=>n.removeAttribute(B.name));let H=!!q(a,t);const K=()=>new Promise(B=>requestAnimationFrame(()=>requestAnimationFrame(()=>B()))),V=async B=>{B?(n.style.display="",n.style.opacity="0",P&&(n.style.transform=`scale(${G})`),await K(),n.style.opacity="",P&&(n.style.transform=""),await ce(n)):(n.style.opacity="0",P&&(n.style.transform=`scale(${G})`),await ce(n),n.style.display="none",n.style.opacity="",P&&(n.style.transform="")),H=B};H||(n.style.display="none"),Z(a,o,()=>{const B=!!q(a,t);B!==H&&V(B)})}}else{const r=n.getAttribute("cv-show-transition"),f=n.getAttribute(":transition");r&&n.removeAttribute("cv-show-transition"),f&&n.removeAttribute(":transition");const m=r??(f?String(q(f,t)):null);if(m){Qe();let u=!!q(a,t);u||(n.style.display="none");let v=!1,b=null;const j=async F=>{if(v){b=F;return}v=!0;try{F?(n.style.display="",n.classList.add(`${m}-enter`),await ce(n),n.classList.remove(`${m}-enter`)):(n.classList.add(`${m}-leave`),await ce(n),n.classList.remove(`${m}-leave`),n.style.display="none"),u=F}finally{if(v=!1,b!==null&&b!==u){const O=b;b=null,j(O)}else b=null}};Z(a,o,()=>{const F=!!q(a,t);F!==u&&j(F)})}else{const u=()=>{n.style.display=q(a,t)?"":"none"};Z(a,o,u),u()}}}if(n.hasAttribute("cv-focus")){const a=n.getAttribute("cv-focus")??"";if(n.removeAttribute("cv-focus"),!a)Promise.resolve().then(()=>n.focus());else{const l=()=>{q(a,t)&&Promise.resolve().then(()=>n.focus())};Z(a,o,l),l()}}{const a=Array.from(n.attributes).filter(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect:")||l.name.startsWith("cv-intersect."));if(a.length&&typeof IntersectionObserver<"u"){const l=a.find(P=>P.name==="cv-intersect"||P.name==="cv-intersect:enter"||P.name.startsWith("cv-intersect.")),r=a.find(P=>P.name==="cv-intersect:leave"),f=(l==null?void 0:l.value)??"",m=(r==null?void 0:r.value)??"",u=((l==null?void 0:l.name)??"cv-intersect").split("."),v=new Set(u.slice(1)),b=v.has("once");let j=0;if(v.has("half"))j=.5;else if(v.has("full"))j=1;else{const P=[...v].find(G=>G.startsWith("threshold-"));P&&(j=parseInt(P.replace("threshold-",""))/100)}const F=[...v].find(P=>P.startsWith("margin-")),O=F?`${F.replace("margin-","")}px`:void 0;a.forEach(P=>n.removeAttribute(P.name));const N=P=>{if(P)try{new Function("$data",`with($data){${P}}`)(t)}catch(G){console.warn(`[courvux] cv-intersect error "${P}":`,G)}},W=new IntersectionObserver(P=>{P.forEach(G=>{G.isIntersecting?(N(f),b&&W.disconnect()):N(m)})},{threshold:j,...O?{rootMargin:O}:{}});W.observe(n),(_=o.registerCleanup)==null||_.call(o,()=>W.disconnect())}}{const a=Array.from(n.attributes).find(l=>l.name==="cv-html"||l.name.startsWith("cv-html."));if(a){const l=a.value;n.removeAttribute(a.name);const r=!a.name.split(".").slice(1).includes("raw"),f=()=>{const m=String(q(l,t)??"");n.innerHTML=r?Ft(m):m};Z(l,o,f),f(),s++;continue}}if(n.hasAttribute("cv-ref")&&!((L=o.components)!=null&&L[y])){const a=n.getAttribute("cv-ref");n.removeAttribute("cv-ref"),o.refs&&(o.refs[a]=n)}const x=!!(($=o.components)!=null&&$[y]),A=Array.from(n.attributes).find(a=>a.name==="cv-model"||a.name.startsWith("cv-model."));if(A&&!x){const a=A.value;n.removeAttribute(A.name);const l=new Set(A.name.split(".").slice(1)),r=n,f=(M=r.type)==null?void 0:M.toLowerCase(),m=u=>{if(l.has("number")){const v=parseFloat(u);return isNaN(v)?u:v}return l.has("trim")?u.trim():u};if(f==="checkbox"){const u=()=>{const v=q(a,t);r.checked=Array.isArray(v)?v.includes(r.value):!!v};Z(a,o,u),u(),r.addEventListener("change",()=>{const v=q(a,t);if(Array.isArray(v)){const b=[...v];if(r.checked)b.includes(r.value)||b.push(r.value);else{const j=b.indexOf(r.value);j>-1&&b.splice(j,1)}pe(a,t,b)}else pe(a,t,r.checked)})}else if(f==="radio"){const u=()=>{r.checked=q(a,t)===r.value};Z(a,o,u),u(),r.addEventListener("change",()=>{r.checked&&pe(a,t,m(r.value))})}else if(n.hasAttribute("contenteditable")){const u=n,v=()=>{const b=String(q(a,t)??"");u.innerText!==b&&(u.innerText=b)};if(Z(a,o,v),v(),l.has("debounce")){const b=[...l].find(O=>/^\d+$/.test(O)),j=b?parseInt(b):300;let F;u.addEventListener("input",()=>{clearTimeout(F),F=setTimeout(()=>pe(a,t,m(u.innerText)),j)})}else{const b=l.has("lazy")?"blur":"input";u.addEventListener(b,()=>pe(a,t,m(u.innerText)))}}else{const u=()=>{r.value=q(a,t)??""};if(Z(a,o,u),u(),l.has("debounce")){const v=[...l].find(F=>/^\d+$/.test(F)),b=v?parseInt(v):300;let j;r.addEventListener("input",()=>{clearTimeout(j),j=setTimeout(()=>pe(a,t,m(r.value)),b)})}else{const v=y==="select"||l.has("lazy")?"change":"input";r.addEventListener(v,()=>pe(a,t,m(r.value)))}}}if(o.directives&&Array.from(n.attributes).forEach(a=>{var N,W;if(!a.name.startsWith("cv-"))return;const l=a.name.slice(3).split("."),r=l[0],f=l.slice(1),m=r.indexOf(":"),u=m>=0?r.slice(0,m):r,v=m>=0?r.slice(m+1):void 0,b=o.directives[u];if(!b)return;const j=a.value;n.removeAttribute(a.name);const F=typeof b=="function"?{onMount:b}:b,O={value:j?q(j,t):void 0,arg:v,modifiers:Object.fromEntries(f.map(P=>[P,!0]))};(N=F.onMount)==null||N.call(F,n,O),F.onUpdate&&j&&Z(j,o,()=>{O.value=q(j,t),F.onUpdate(n,O)}),F.onDestroy&&((W=o.registerCleanup)==null||W.call(o,()=>F.onDestroy(n,O)))}),y==="slot"){const a=n.getAttribute("name")??"default",l=(z=o.slots)==null?void 0:z[a];if(l){const r={};Array.from(n.attributes).forEach(u=>{u.name.startsWith(":")&&(r[u.name.slice(1)]=q(u.value,t))});const f=await l(r),m=document.createDocumentFragment();f.forEach(u=>m.appendChild(u)),n.replaceWith(m)}else{const r=document.createDocumentFragment();for(;n.firstChild;)r.appendChild(n.firstChild);await te(r,t,o),n.replaceWith(r)}s++;continue}if(y==="cv-transition"){Qe();const a=n.getAttribute("name")??"fade",l=n.getAttribute(":show")??null;n.removeAttribute("name"),l&&n.removeAttribute(":show");const r=document.createElement("div");for(r.className="cv-t-wrap";n.firstChild;)r.appendChild(n.firstChild);if(n.replaceWith(r),await te(r,t,o),l){let f=!!q(l,t),m=!1,u=null;f||(r.style.display="none");const v=async b=>{if(m){u=b;return}m=!0;try{b?(r.style.display="",r.classList.add(`${a}-enter`),await ce(r),r.classList.remove(`${a}-enter`)):(r.classList.add(`${a}-leave`),await ce(r),r.classList.remove(`${a}-leave`),r.style.display="none"),f=b}finally{if(m=!1,u!==null&&u!==f){const j=u;u=null,v(j)}else u=null}};Z(l,o,()=>{const b=!!q(l,t);b!==f&&v(b)})}s++;continue}if(y==="router-view"&&o.mountRouterView){const a=n.getAttribute("name")??void 0;n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),await o.mountRouterView(n,a),s++;continue}if(y==="router-link"){const a=n.getAttribute(":to"),l=n.getAttribute("to"),r=()=>a?String(q(a,t)??"/"):l||"/",f=P=>String(P).replace(/[&"<>]/g,G=>({"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"})[G]);let m="";Array.from(n.attributes).forEach(P=>{P.name==="to"||P.name===":to"||(m+=` ${P.name}="${f(P.value)}"`)});const u=document.createElement("div");u.innerHTML=`<a${m}></a>`;const v=u.firstElementChild;for(;n.firstChild;)v.appendChild(n.firstChild);const b=((E=o.router)==null?void 0:E.base)??"",j=P=>b?P===b?"/":P.startsWith(b+"/")?P.slice(b.length)||"/":P||"/":P||"/",F=()=>{var P;return((P=o.router)==null?void 0:P.mode)==="history"?j(window.location.pathname):window.location.hash.slice(1)||"/"},O=()=>{var U;const P=r(),G=F()===P;((U=o.router)==null?void 0:U.mode)==="history"?v.href=`${b}${P}`:v.href=`#${P}`,G?(v.setAttribute("aria-current","page"),v.classList.add("active")):(v.removeAttribute("aria-current"),v.classList.remove("active"))};((R=o.router)==null?void 0:R.mode)==="history"?(v.addEventListener("click",P=>{P.preventDefault(),o.router.navigate(r())}),window.addEventListener("popstate",O)):window.addEventListener("hashchange",O),a&&Z(a,o,O),O();const N=document.createDocumentFragment();N.appendChild(v),await te(N,t,o);const W=N.firstChild??v;n.replaceWith(W),s++;continue}if(y==="component"&&n.hasAttribute(":is")&&o.mountDynamic){const a=n.getAttribute(":is");n.removeAttribute(":is");const l=document.createComment("component:is");n.replaceWith(l),await o.mountDynamic(l,a,n,t,o),s++;continue}if((C=o.components)!=null&&C[y]&&o.mountElement){await o.mountElement(n,y,t,o),s++;continue}{const a=Array.from(n.attributes).find(l=>l.name==="cv-intersect"||l.name.startsWith("cv-intersect."));if(a&&typeof IntersectionObserver<"u"){const l=new Set(a.name.split(".").slice(1));n.removeAttribute(a.name);const r=q(a.value,t);let f,m=0,u="0px",v=l.has("once");if(typeof r=="function"?f=b=>r.call(t,b):r&&typeof r=="object"&&(typeof r.handler=="function"&&(f=b=>r.handler.call(t,b)),r.threshold!==void 0&&(m=r.threshold),r.margin&&(u=r.margin),r.once&&(v=!0)),f){const b=new IntersectionObserver(j=>{const F=j[0];f(F),v&&F.isIntersecting&&b.disconnect()},{threshold:m,rootMargin:u});b.observe(n),(c=o.registerCleanup)==null||c.call(o,()=>b.disconnect())}}}if(n.hasAttribute("cv-resize")){const a=n.getAttribute("cv-resize");if(n.removeAttribute("cv-resize"),typeof ResizeObserver<"u"){const l=q(a,t);let r,f="content-box";if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.box&&(f=l.box)),r){const m=new ResizeObserver(u=>{u[0]&&r(u[0])});m.observe(n,{box:f}),(d=o.registerCleanup)==null||d.call(o,()=>m.disconnect())}}}if(n.hasAttribute("cv-scroll")){const a=n.getAttribute("cv-scroll");n.removeAttribute("cv-scroll");const l=q(a,t);let r,f=0;if(typeof l=="function"?r=m=>l.call(t,m):l&&typeof l=="object"&&(typeof l.handler=="function"&&(r=m=>l.handler.call(t,m)),l.throttle&&(f=l.throttle)),r){let m=0;const u=()=>{const v=Date.now();f>0&&v-m<f||(m=v,r({scrollTop:n.scrollTop,scrollLeft:n.scrollLeft,scrollHeight:n.scrollHeight,scrollWidth:n.scrollWidth,clientHeight:n.clientHeight,clientWidth:n.clientWidth}))};n.addEventListener("scroll",u,{passive:!0}),(h=o.registerCleanup)==null||h.call(o,()=>n.removeEventListener("scroll",u))}}if(n.hasAttribute("cv-clickoutside")){const a=n.getAttribute("cv-clickoutside");n.removeAttribute("cv-clickoutside");const l=r=>{n.contains(r.target)||(typeof t[a]=="function"?t[a].call(t,r):Ze(a,t,r))};document.addEventListener("click",l,!0),(w=o.registerCleanup)==null||w.call(o,()=>document.removeEventListener("click",l,!0))}if(n.hasAttribute("cv-bind")){const a=n.getAttribute("cv-bind");n.removeAttribute("cv-bind");const l=n.getAttribute("class")??"",r=n.getAttribute("style")??"";let f=[];const m=()=>{const u=q(a,t)??{},v=Object.keys(u);for(const b of f)b in u||(b==="class"?n.className=l:b==="style"?n.style.cssText=r:n.removeAttribute(b));for(const[b,j]of Object.entries(u))if(b==="class")n.className=[l,He(j)].filter(Boolean).join(" ");else if(b==="style")Je(n,j,r);else if(j==null||j===!1)try{n.removeAttribute(b)}catch{}else try{n.setAttribute(b,j===!0?"":String(j))}catch(F){console.warn(`[courvux] cv-bind: skipping invalid attribute name "${b}":`,F)}f=v};Z(a,o,m),m()}const I={enter:"Enter",esc:"Escape",escape:"Escape",space:" ",tab:"Tab",delete:"Delete",backspace:"Backspace",up:"ArrowUp",down:"ArrowDown",left:"ArrowLeft",right:"ArrowRight"};Array.from(n.attributes).forEach(a=>{if(a.name.startsWith("@")||a.name.startsWith("cv:on:")){const l=(a.name.startsWith("@")?a.name.substring(1):a.name.substring(6)).split("."),r=l[0],f=new Set(l.slice(1)),m=[...f].find(j=>j in I),u=a.value,v=j=>{f.has("prevent")&&j.preventDefault(),f.has("stop")&&j.stopPropagation(),!(f.has("self")&&j.target!==j.currentTarget)&&(m&&j.key!==I[m]||(typeof t[u]=="function"?t[u].call(t,j):Ze(u,t,j)))},b={};f.has("once")&&(b.once=!0),f.has("passive")&&(b.passive=!0),f.has("capture")&&(b.capture=!0),n.addEventListener(r,v,Object.keys(b).length?b:void 0)}else if(a.name.startsWith(":")){const l=a.name.slice(1),r=a.value;if(l==="class"){const f=n.getAttribute("class")??"",m=()=>{n.className=[f,He(q(r,t))].filter(Boolean).join(" ")};Z(r,o,m),m()}else if(l==="style"){const f=n.getAttribute("style")??"",m=()=>Je(n,q(r,t),f);Z(r,o,m),m()}else if(l.includes("-")){const f=()=>{const m=q(r,t);m==null||m===!1?n.removeAttribute(l):n.setAttribute(l,m===!0?"":String(m))};Z(r,o,f),f()}else{const f=()=>{n[l]=q(r,t)??""};Z(r,o,f),f()}}}),S.hasChildNodes()&&await te(S,t,o),s++}}var Pt=`
...
`;function Dt(){if(document.getElementById("cv-transitions"))return;const e=document.createElement("style");e.id="cv-transitions",e.textContent=Pt,document.head.appendChild(e)}async function we(e,t,o){e.classList.add(`${t}-${o}`);const i=getComputedStyle(e),s=Math.max(parseFloat(i.animationDuration)||0,parseFloat(i.transitionDuration)||0)*1e3;s>0&&await new Promise(p=>{const k=()=>p();e.addEventListener("animationend",k,{once:!0}),e.addEventListener("transitionend",k,{once:!0}),setTimeout(k,s+50)}),e.classList.remove(`${t}-${o}`)}var Ce=new Map;async function It(e){if(typeof e!="function")return e;if(Ce.has(e))return Ce.get(e);const t=await e();return Ce.set(e,t.default),t.default}function tt(e,t){if(e.components)return e.components[t];if(t==="default")return e.component}function ot(e,t){if(e==="*")return{};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}$`));return s?Object.fromEntries(o.map((p,k)=>[p,s[k+1]])):null}function Lt(e,t){if(e==="/")return{params:{},remaining:t};const o=[],i=e.replace(/:(\w+)/g,(p,k)=>(o.push(k),"([^/]+)")),s=t.match(new RegExp(`^${i}(/.+)?$`));return s?{params:Object.fromEntries(o.map((p,k)=>[p,s[k+1]])),remaining:s[o.length+1]||"/"}:null}function xt(e,t=""){return e.map(o=>{var s;if(o.path==="*")return o;const i=((t.endsWith("/")?t.slice(0,-1):t)+o.path).replace(/\/+/g,"/")||"/";return(s=o.children)!=null&&s.length?{...o,path:i,children:xt(o.children,i==="/"?"":i)}:{...o,path:i}})}var ge=(e,t)=>new Promise(o=>e(t,o)),nt=(e,t)=>e!=null&&e.beforeLeave?new Promise(o=>e.beforeLeave(t,o)):Promise.resolve(void 0);function Mt(e,t={}){const o=t.mode??"hash",i=Rt(t.base??"");return{routes:xt(e),mode:o,base:i,transition:t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate(s,p){const k=rt(s,p==null?void 0:p.query);o==="history"?(history.pushState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"))):window.location.hash=k},replace(s,p){const k=rt(s,p==null?void 0:p.query);if(o==="history")history.replaceState({},"",`${i}${k}`),window.dispatchEvent(new PopStateEvent("popstate"));else{const g=window.location.href.split("#")[0];window.location.replace(`${g}#${k}`)}},back(){history.back()},forward(){history.forward()}}}function Rt(e){if(!e||e==="/")return"";let t=e.startsWith("/")?e:`/${e}`;return t.endsWith("/")&&(t=t.slice(0,-1)),t}function zt(e,t){return t?e===t?"/":e.startsWith(t+"/")?e.slice(t.length)||"/":e||"/":e||"/"}function rt(e,t){return!t||!Object.keys(t).length?e:`${e}?${new URLSearchParams(t).toString()}`}function st(e){if(!e)return{};const t=new URLSearchParams(e.startsWith("?")?e.slice(1):e),o={};return t.forEach((i,s)=>{o[s]=i}),o}function at(e,t,o,i="default",s){const p=t.base??"",k=h=>h.length>1&&h.endsWith("/")?h.slice(0,-1):h,g=()=>t.mode==="history"?k(zt(window.location.pathname,p)):k((window.location.hash.slice(1)||"/").split("?")[0]||"/"),D=()=>{if(t.mode==="history")return st(window.location.search);const h=window.location.hash.slice(1)||"/",w=h.indexOf("?");return w>=0?st(h.slice(w+1)):{}};t.transition&&Dt();let T=null,_=null,L=null,$=null,M=!1;const z=()=>{M||(M=!0,s==null||s())},E=new Map,R=h=>{var w;if(h!=null&&h.keepAlive&&L){(w=L.deactivate)==null||w.call(L);const S=document.createDocumentFragment();for(;e.firstChild;)S.appendChild(e.firstChild);E.set(T.path,{fragment:S,activation:L}),L=null}else L==null||L.destroy(),L=null,e.innerHTML=""},C=async(h,w,S,n,y)=>{const x=typeof w=="function"&&!Ce.has(w),A=x?w.__asyncOptions:void 0,I=h.loadingTemplate??(A==null?void 0:A.loadingTemplate);x&&I&&(e.innerHTML=I);let a;try{a=await It(w)}catch(l){const r=A==null?void 0:A.errorTemplate;if(r)return e.innerHTML=r,{destroy:()=>{e.innerHTML=""}};throw l}return x&&I&&(e.innerHTML=""),o(e,a,S,n,y)},c=async()=>{var S,n,y,x,A,I,a,l;const h=g(),w=D();for(const r of t.routes){if((S=r.children)!=null&&S.length){const m=Lt(r.path,h);if(m!==null)for(const u of r.children){const v=ot(u.path,h);if(v!==null){const b={params:m.params,query:w,path:h,meta:r.meta};if(u.redirect){const N={params:v,query:w,path:h,meta:u.meta},W=typeof u.redirect=="function"?u.redirect(N):u.redirect;t.navigate(W);return}if(t.beforeEach){const N=await ge(t.beforeEach,b);if(N){t.navigate(N);return}}if(r.beforeEnter){const N=await ge(r.beforeEnter,b);if(N){t.navigate(N);return}}if(u.beforeEnter){const N={params:v,query:w,path:h,meta:u.meta},W=await ge(u.beforeEnter,N);if(W){t.navigate(W);return}}const j=`${r.path}::${JSON.stringify(m.params)}`;if($!==j){const N=await nt(L,b);if(N){t.navigate(N);return}const W=r.transition??t.transition;W&&e.hasChildNodes()&&await we(e,W,"leave"),R(_);const P=tt(r,i);if(P){const G={routes:r.children,mode:t.mode,base:t.base,transition:r.transition??t.transition,beforeEach:t.beforeEach,afterEach:t.afterEach,scrollBehavior:t.scrollBehavior,navigate:(U,H)=>t.navigate(U,H),replace:(U,H)=>t.replace(U,H),back:()=>t.back(),forward:()=>t.forward()};L=await C(r,P,b,i==="default"?r.layout:void 0,i==="default"?G:void 0),(n=L.enter)==null||n.call(L,T)}else e.innerHTML="";$=j,W&&await we(e,W,"enter")}const F={params:{...m.params,...v},query:w,path:h,meta:u.meta??r.meta};(y=t.afterEach)==null||y.call(t,F,T);const O=(x=t.scrollBehavior)==null?void 0:x.call(t,F,T);O&&window.scrollTo(O.x??0,O.y??0),T=F,_=r,z();return}}}const f=ot(r.path,h);if(f!==null){$=null;const m={params:f,query:w,path:h,meta:r.meta};if(r.redirect){const F=typeof r.redirect=="function"?r.redirect(m):r.redirect;t.navigate(F);return}if(t.beforeEach){const F=await ge(t.beforeEach,m);if(F){t.navigate(F);return}}if(r.beforeEnter){const F=await ge(r.beforeEnter,m);if(F){t.navigate(F);return}}const u=await nt(L,m);if(u){t.navigate(u);return}const v=r.transition??t.transition;v&&e.hasChildNodes()&&await we(e,v,"leave"),R(_);const b=tt(r,i);if(b){const F=m.path;if(r.keepAlive&&E.has(F)){const O=E.get(F);e.appendChild(O.fragment),L=O.activation,(A=L.activate)==null||A.call(L),E.delete(F)}else{const O=T;L=await C(r,b,m,i==="default"?r.layout:void 0),(I=L.enter)==null||I.call(L,O)}}else e.innerHTML="",L=null;v&&await we(e,v,"enter"),(a=t.afterEach)==null||a.call(t,m,T);const j=(l=t.scrollBehavior)==null?void 0:l.call(t,m,T);j&&window.scrollTo(j.x??0,j.y??0),T=m,_=r,z();return}}$=null,R(_),_=null,z()},d=t.mode==="history"?"popstate":"hashchange";return window.addEventListener(d,c),c(),()=>{window.removeEventListener(d,c),L==null||L.destroy(),L=null,E.forEach(({activation:h})=>h.destroy()),E.clear()}}function Ht(){if(typeof window>"u")return null;if(window.__COURVUX_DEVTOOLS__)return window.__COURVUX_DEVTOOLS__;const e=new Map,t={instances:[],stores:[],on(o,i){return e.has(o)||e.set(o,new Set),e.get(o).add(i),()=>{var s;return(s=e.get(o))==null?void 0:s.delete(i)}},_emit(o,i){var s;(s=e.get(o))==null||s.forEach(p=>{try{p(i)}catch{}})},_registerInstance(o){this.instances.push(o),this._emit("mount",o)},_unregisterInstance(o){const i=this.instances.findIndex(s=>s.id===o);if(i!==-1){const s=this.instances[i];this.instances.splice(i,1),this._emit("destroy",s)}},_registerStore(o){this.stores.push(o),o.subscribe(()=>this._emit("store-update",o))}};return window.__COURVUX_DEVTOOLS__=t,t}var Nt=0;function Wt(){return++Nt}var qt=`
...
`;function Ut(){if(document.getElementById("cvd-styles"))return;const e=document.createElement("style");e.id="cvd-styles",e.textContent=qt,document.head.appendChild(e)}function ke(e){return e===null?"null":e===void 0?"undefined":typeof e=="string"?`"${e}"`:typeof e=="object"?JSON.stringify(e):String(e)}function it(e){try{return JSON.parse(e)}catch{return e}}function Bt(e){if(typeof document>"u")return;Ut();const t=document.createElement("div");t.id="cvd",document.body.appendChild(t);let o=!1,i="components",s=new Set;const p=document.createElement("div");p.id="cvd-badge",p.innerHTML='<span class="cvd-badge-dot"></span>COURVUX',t.appendChild(p);const k=document.createElement("div");k.id="cvd-panel",k.style.display="none",t.appendChild(k),k.innerHTML=`
        ...
        <div id="cvd-body"></div>
    `;const g=k.querySelector("#cvd-body");p.addEventListener("click",()=>{o=!0,p.style.display="none",k.style.display="flex",L()}),k.querySelector("#cvd-close").addEventListener("click",()=>{o=!1,k.style.display="none",p.style.display=""}),k.querySelectorAll(".cvd-tab").forEach($=>{$.addEventListener("click",()=>{i=$.dataset.tab,k.querySelectorAll(".cvd-tab").forEach(M=>M.classList.remove("active")),$.classList.add("active"),L()})});const D=k.querySelector("#cvd-head");D.addEventListener("pointerdown",$=>{if($.target.closest("button"))return;D.setPointerCapture($.pointerId);const M=$.clientX,z=$.clientY,E=t.offsetLeft,R=t.offsetTop,C=d=>{t.style.right="auto",t.style.bottom="auto",t.style.left=`${E+(d.clientX-M)}px`,t.style.top=`${R+(d.clientY-z)}px`},c=d=>{D.releasePointerCapture(d.pointerId),D.removeEventListener("pointermove",C),D.removeEventListener("pointerup",c),D.removeEventListener("pointercancel",c)};D.addEventListener("pointermove",C),D.addEventListener("pointerup",c),D.addEventListener("pointercancel",c)});function T(){const $=e.instances;if(!$.length){g.innerHTML='<div class="cvd-empty">No hay componentes montados</div>';return}g.innerHTML=$.map(M=>{const z=M.getState(),E=Object.keys(z);return`
            ...
            `}).join(""),g.querySelectorAll(".cvd-inst-head").forEach($=>{$.addEventListener("click",()=>$.closest(".cvd-inst").classList.toggle("open"))}),g.querySelectorAll("[data-store][data-key]").forEach($=>{$.addEventListener("click",M=>{M.stopPropagation();const z=$;if(z.querySelector("input"))return;const E=parseInt(z.dataset.store),R=z.dataset.key,C=e.stores[E];if(!C)return;const c=ke(C.getState()[R]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const h=()=>{C.setState(R,it(d.value)),z.classList.remove("editing")};d.addEventListener("blur",h),d.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),h()),w.key==="Escape"&&(z.classList.remove("editing"),L())})})})}function L(){o&&(i==="components"?T():_())}e.on("mount",()=>L()),e.on("update",()=>L()),e.on("destroy",()=>L()),e.on("store-update",()=>L())}var Vt="__COURVUX_HEAD_COLLECTOR__";function Gt(){return globalThis[Vt]??null}var Yt=(e,t)=>{Object.entries(t).forEach(([o,i])=>{o!=="innerHTML"&&(i==null||i===!1||e.setAttribute(o,i===!0?"":String(i)))})},Xt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},Jt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,i])=>e.setAttribute(o,i))},ct=(e,t,o,i)=>{let s=o?document.head.querySelector(o):null;s?(i.push({el:s,prevAttrs:Xt(s),created:!1}),Array.from(s.attributes).forEach(p=>s.removeAttribute(p.name))):(s=document.createElement(e),document.head.appendChild(s),i.push({el:s,created:!0})),Yt(s,t)};function Zt(e){var k,g,D;const t=Gt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let i;const s={},p={};if(e.title!==void 0){i=document.title;const T=e.titleTemplate,_=typeof T=="function"?T(e.title):typeof T=="string"?T.replace("%s",e.title):e.title;document.title=_}return(k=e.meta)==null||k.forEach(T=>{ct("meta",T,T.name?`meta[name="${CSS.escape(T.name)}"]`:T.property?`meta[property="${CSS.escape(T.property)}"]`:T["http-equiv"]?`meta[http-equiv="${CSS.escape(T["http-equiv"])}"]`:null,o)}),(g=e.link)==null||g.forEach(T=>{ct("link",T,T.rel==="canonical"?'link[rel="canonical"]':T.rel&&T.href?`link[rel="${CSS.escape(T.rel)}"][href="${CSS.escape(T.href)}"]`:null,o)}),(D=e.script)==null||D.forEach(T=>{const _=document.createElement("script");Object.entries(T).forEach(([L,$])=>{L==="innerHTML"?_.textContent=String($):$!=null&&$!==!1&&_.setAttribute(L,$===!0?"":String($))}),document.head.appendChild(_),o.push({el:_,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([T,_])=>{s[T]=document.documentElement.getAttribute(T),document.documentElement.setAttribute(T,_)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([T,_])=>{p[T]=document.body.getAttribute(T),document.body.setAttribute(T,_)}),function(){i!==void 0&&(document.title=i),o.forEach(({el:T,prevAttrs:_,created:L})=>{var $;L?($=T.parentNode)==null||$.removeChild(T):_&&Jt(T,_)}),Object.entries(s).forEach(([T,_])=>{_===null?document.documentElement.removeAttribute(T):document.documentElement.setAttribute(T,_)}),Object.entries(p).forEach(([T,_])=>{_===null?document.body.removeAttribute(T):document.body.setAttribute(T,_)})}}var Ie="data-courvux-ssr",Kt=e=>e?Promise.resolve().then(e):Promise.resolve();function dt(e,t){const o=e.trim();if(o.startsWith("{")){const i=o.replace(/[{}]/g,"").split(",").map(s=>s.trim()).filter(Boolean);return Object.fromEntries(i.map(s=>[s,t[s]]))}return{[o]:t}}var Se=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var w,S,n;const i={},{subscribe:s,createReactiveState:p,registerSetInterceptor:k,notifyAll:g}=ze();let D;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),D=await t.data()):D=t.data??{},t.templateUrl){const y=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,x=await fetch(y);if(!x.ok)throw new Error(`Failed to load template: ${y} (${x.status})`);e.innerHTML=await x.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(Ie),(w=e.querySelector(`[${Ie}]`))==null||w.removeAttribute(Ie);const T={};if(t.inject&&o.provided){const y=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(x=>[x,x])):t.inject;Object.entries(y).forEach(([x,A])=>{o.provided&&A in o.provided&&(T[x]=o.provided[A])})}const _=p({...o.globalProperties??{},...D,...T,...t.methods,$refs:i,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(y=>[y,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});t.exprs&&typeof t.exprs=="object"&&Tt(_,t.exprs),_.$watch=(y,x,A)=>{const I=(A==null?void 0:A.deep)??!1,a=(A==null?void 0:A.immediate)??!1;let l=I?Se(_[y]):_[y];const r=s(y,()=>{const f=_[y];x.call(_,f,l),l=I?Se(f):f});return a&&x.call(_,_[y],void 0),r},_.$batch=$t,_.$nextTick=y=>Kt(y),_.$dispatch=(y,x,A)=>{e.dispatchEvent(new CustomEvent(y,{bubbles:!0,composed:!0,...A??{},detail:x}))},o.magics&&Object.entries(o.magics).forEach(([y,x])=>{_[y]=x(_)}),_.$forceUpdate=()=>g();const L=[];_.$watchEffect=y=>{let x=[];const A=()=>{x.forEach(r=>r()),x=[];const a=Ue(()=>{try{y()}catch{}}),l=new Map;for(const{sub:r,key:f}of a)l.has(r)||l.set(r,new Set),!l.get(r).has(f)&&(l.get(r).add(f),x.push(r(f,A)))};A();const I=()=>{x.forEach(l=>l()),x=[];const a=L.indexOf(I);a>-1&&L.splice(a,1)};return L.push(I),I};const $=[];t.computed&&Object.entries(t.computed).forEach(([y,x])=>{const A=typeof x=="function"?x:x.get,I=typeof x!="function"?x.set:void 0;let a=[];const l=()=>{a.forEach(u=>u()),a=[];let r;const f=Ue(()=>{try{r=A.call(_)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});_[y]=r;const m=new Map;for(const{sub:u,key:v}of f)m.has(u)||m.set(u,new Set),!m.get(u).has(v)&&(m.get(u).add(v),a.push(u(v,l)))};l(),$.push(()=>a.forEach(r=>r())),I&&k(y,r=>I.call(_,r))});const M=[];t.watch&&Object.entries(t.watch).forEach(([y,x])=>{const A=typeof x=="object"&&x!==null&&"handler"in x,I=A?x.handler:x,a=A?x.immediate??!1:!1,l=A?x.deep??!1:!1;let r=l?Se(_[y]):_[y];const f=s(y,()=>{const m=_[y];I.call(_,m,r),r=l?Se(m):m});M.push(f),a&&I.call(_,_[y],void 0)});const z={...o.provided??{}};if(t.provide){const y=typeof t.provide=="function"?t.provide.call(_):t.provide;Object.assign(z,y)}const E={...o,provided:z,components:{...o.components,...t.components}};E.mountElement=Te(E),E.createChildScope=(y,x)=>{const A=new Set(Object.keys(y)),I=new Set(Object.keys(x)),{subscribe:a,createReactiveState:l}=ze(),r=l(y);let f;return f=new Proxy({},{get(m,u){return typeof u!="string"?_[u]:A.has(u)?r[u]:I.has(u)?x[u].bind(f):_[u]},set(m,u,v){return typeof u!="string"?!1:A.has(u)?(r[u]=v,!0):(_[u]=v,!0)},has(m,u){return A.has(u)||I.has(u)||u in _},ownKeys(){return[...A,...I,...Object.keys(_)]},getOwnPropertyDescriptor(m,u){return A.has(u)||I.has(u)||u in _?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:f,subscribe:(m,u)=>A.has(m)?a(m,u):c(m,u),cleanup:()=>{}}},E.mountDynamic=async(y,x,A,I,a)=>{let l=null,r=null;const f=A.getAttribute("loading-template")??"",m=async()=>{var P,G,U;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=q(x,I);if(!u)return;let v;if(typeof u=="function"){if(f){const H=document.createElement("div");H.innerHTML=f,(P=y.parentNode)==null||P.insertBefore(H,y.nextSibling),l=H}v=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?v=(G=E.components)==null?void 0:G[u]:u&&typeof u=="object"&&(v=u);if(!v)return;const b=document.createElement("div"),j=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{j(H.name)||b.setAttribute(H.name,H.value)}),b.innerHTML=A.innerHTML;const F={},O={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))F[H.name.slice(1)]=q(H.value,I);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);O[V]=(...B)=>{typeof I[K]=="function"&&I[K].call(I,...B)}}});const N={...v,data:{...v.data,...F},methods:{...v.methods,$emit(H,...K){var V;wt(v,H,K),(V=O[H])==null||V.call(O,...K)}}},W={...E,components:{...E.components,...v.components}};W.mountElement=Te(W),r=(await ne(b,N,W)).destroy,(U=y.parentNode)==null||U.insertBefore(b,y.nextSibling),l=b};Z(x,a,m),await m()};const R=[];_.$addCleanup=y=>{R.push(y)};let C=!1;const c=(y,x)=>!t.onBeforeUpdate&&!t.onUpdated?s(y,x):s(y,()=>{var A;C||(C=!0,(A=t.onBeforeUpdate)==null||A.call(_),Promise.resolve().then(()=>{var I;C=!1,(I=t.onUpdated)==null||I.call(_)})),x()});try{(S=t.onBeforeMount)==null||S.call(_),await te(e,_,{subscribe:c,refs:i,...E,registerCleanup:y=>R.push(y)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(_)}catch(y){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(_,y);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(y,_,t.name??e.tagName.toLowerCase());else throw y}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,h=d?Wt():0;if(d){const y=_,x=new Set,A={id:h,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const I={};for(const a of Object.keys(y))if(!(a.startsWith("$")||typeof y[a]=="function"))try{I[a]=y[a]}catch{}return I},setState:(I,a)=>{y[I]=a},subscribe:I=>(x.add(I),()=>x.delete(I)),children:[]};Object.keys(y).filter(I=>!I.startsWith("$")&&typeof y[I]!="function").forEach(I=>{s(I,()=>{d._emit("update",A),x.forEach(a=>a())})}),d._registerInstance(A),R.push(()=>d._unregisterInstance(h))}return{state:_,destroy:()=>{var y,x;(y=t.onBeforeUnmount)==null||y.call(_),$.forEach(A=>A()),M.forEach(A=>A()),L.forEach(A=>A()),R.forEach(A=>A()),(x=t.onDestroy)==null||x.call(_)},activate:()=>{var y;(y=t.onActivated)==null||y.call(_)},deactivate:()=>{var y;(y=t.onDeactivated)==null||y.call(_)},beforeLeave:t.onBeforeRouteLeave?(y,x)=>t.onBeforeRouteLeave.call(_,y,x):void 0,enter:t.onBeforeRouteEnter?y=>t.onBeforeRouteEnter.call(_,y):void 0}}function wt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const i=e.emits[t];typeof i=="function"&&!i(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Te(e){return async(t,o,i,s)=>{const p=e.components[o],k=t.getAttribute("cv-ref");k&&t.removeAttribute("cv-ref");const g={},D=[],T={};Array.from(t.attributes).filter(C=>C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:")).forEach(C=>{t.removeAttribute(C.name);const c=C.value,d=C.name.indexOf(":"),h=d>=0?C.name.slice(d+1).split(".")[0]:"modelValue",w=h==="modelValue"?"update:modelValue":`update:${h}`;g[h]=Pe(q(c,i)),D.push({propName:h,expr:c}),T[w]=S=>{pe(c,i,S)}});const _={};Array.from(t.attributes).forEach(C=>{const c=C.name.startsWith(":"),d=C.name.startsWith("@")||C.name.startsWith("cv:on:"),h=C.name==="cv-model"||C.name.startsWith("cv-model.")||C.name.startsWith("cv-model:"),w=C.name.startsWith("v-slot"),S=C.name==="slot";!c&&!d&&!h&&!w&&!S&&(_[C.name]=C.value)}),p.inheritAttrs===!1&&Object.keys(_).forEach(C=>t.removeAttribute(C)),Array.from(t.attributes).forEach(C=>{if(C.name.startsWith(":")){const c=C.name.slice(1),d=C.value;g[c]=Pe(q(d,i)),D.push({propName:c,expr:d})}else if(C.name.startsWith("@")||C.name.startsWith("cv:on:")){const c=C.name.startsWith("@")?C.name.slice(1):C.name.slice(6),d=C.value;T[c]=(...h)=>{typeof i[d]=="function"&&i[d].call(i,...h)}}});const L=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");L&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const $=new Map,M=[];Array.from(t.childNodes).forEach(C=>{const c=C.nodeType===1?C.getAttribute("slot"):null;if(c){if(!$.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),$.set(c,{nodes:[],vSlot:d})}$.get(c).nodes.push(C.cloneNode(!0))}else M.push(C.cloneNode(!0))});const z={};M.some(C=>{var c;return C.nodeType===1||C.nodeType===3&&(((c=C.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async C=>{const c=L?{...i,...dt(L,C)}:i,d=document.createDocumentFragment();return M.forEach(h=>d.appendChild(h.cloneNode(!0))),await te(d,c,s),Array.from(d.childNodes)});for(const[C,{nodes:c,vSlot:d}]of $)z[C]=async h=>{const w=d?{...i,...dt(d,h)}:i,S=document.createDocumentFragment();return c.forEach(n=>S.appendChild(n.cloneNode(!0))),await te(S,w,s),Array.from(S.childNodes)};const E={...e,components:{...e.components,...p.components},slots:z};E.mountElement=Te(E);const{state:R}=await ne(t,{...p,data:{...p.data,...g,$attrs:_,$parent:i},methods:{...p.methods,$emit(C,...c){var d;wt(p,C,c),(d=T[C])==null||d.call(T,...c)}}},E);R&&(D.forEach(({propName:C,expr:c})=>{yt(c,{...s,subscribe:s.subscribe},()=>{R[C]=Pe(q(c,i))})}),k&&s.refs&&(s.refs[k]=R))}}function Qt(e){Ot();const t=typeof window<"u"?Ht():void 0,o=[],i={...e.directives},s={...e.components??{}},p=[],k=new Map,g={},D=new Map;if(e.debug&&t&&Bt(t),t&&e.store){const $=e.store,M=Object.keys($).filter(z=>typeof $[z]!="function");t._registerStore({getState(){const z={};return M.forEach(E=>{try{z[E]=$[E]}catch{}}),z},setState(z,E){$[z]=E},subscribe(z){const E=M.map(R=>{try{return ye($,R,z)}catch{return()=>{}}});return()=>E.forEach(R=>R())}})}const T={router:e.router,use($){return o.includes($)||(o.push($),$.install(T)),T},directive($,M){return i[$]=M,T},component($,M){return s[$]=M,T},provide($,M){return typeof $=="string"?g[$]=M:Object.assign(g,$),T},magic($,M){return D.set(`$${$}`,M),T},mount:async $=>(await L($),T),mountAll:async($="[data-courvux]")=>{const M=Array.from(document.querySelectorAll($));return await Promise.all(M.map(z=>_(z))),T},mountEl:async $=>_($),unmount($){if(!$)p.forEach(M=>M()),p.length=0,k.clear();else{const M=document.querySelector($);if(M){const z=k.get(M);if(z){z(),k.delete(M);const E=p.indexOf(z);E>-1&&p.splice(E,1)}}}return T},destroy(){p.forEach($=>$()),p.length=0,k.clear()}},_=async $=>{const M=new URL(".",document.baseURI).href,z={components:s,router:e.router,store:e.store,directives:i,baseUrl:M,provided:{...g},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:D.size?Object.fromEntries(D):void 0};if(z.mountElement=Te(z),e.router){const R=e.router;z.mountRouterView=async(C,c)=>{await new Promise(d=>{at(C,R,async(h,w,S,n,y)=>{const x={...z,currentRoute:S};if(y){let A=null;const I={...x,mountRouterView:async(a,l)=>{A=at(a,y,async(r,f,m,u)=>{const v={...x,currentRoute:m};if(u){let b=null;const j={...v,mountRouterView:async(O,N)=>{b=await ne(O,f,v)}},{destroy:F}=await ne(r,{template:u},j);return{destroy:()=>{b==null||b.destroy(),F()},activate:()=>b==null?void 0:b.activate(),deactivate:()=>b==null?void 0:b.deactivate()}}else return await ne(r,f,v)},l)}};if(n){let a=null;const l={...I,mountRouterView:async(f,m)=>{a=await ne(f,w,I)}},{destroy:r}=await ne(h,{template:n},l);return{destroy:()=>{A==null||A(),a==null||a.destroy(),r()},activate:()=>a==null?void 0:a.activate(),deactivate:()=>a==null?void 0:a.deactivate()}}else{const a=await ne(h,w,I);return{destroy:()=>{A==null||A(),a.destroy()},activate:()=>a.activate(),deactivate:()=>a.deactivate()}}}else if(n){let A=null;const I={...x,mountRouterView:async(l,r)=>{A=await ne(l,w,x)}},{destroy:a}=await ne(h,{template:n},I);return{destroy:()=>{A==null||A.destroy(),a()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(h,w,x)},c,d)})}}const E=await ne($,e,z);return p.push(E.destroy),k.set($,E.destroy),E.state},L=async $=>{const M=document.querySelector($);if(M)return _(M)};return T}var lt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function eo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Le={exports:{}},ut;function to(){return ut||(ut=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
