                    ...
                    <div class="cvd-kv">
                        ${O.map(R=>`
                            <div class="cvd-row">
                                ...
                                <span class="cvd-val" data-store="${M}" data-key="${R}" title="click to edit">${we(z[R])}</span>
                            </div>
                        `).join("")}
                    </div>
                </div>
            `}).join(""),f.querySelectorAll(".cvd-inst-head").forEach(_=>{_.addEventListener("click",()=>_.closest(".cvd-inst").classList.toggle("open"))}),f.querySelectorAll("[data-store][data-key]").forEach(_=>{_.addEventListener("click",M=>{M.stopPropagation();const z=_;if(z.querySelector("input"))return;const O=parseInt(z.dataset.store),R=z.dataset.key,E=e.stores[O];if(!E)return;const c=we(E.getState()[R]);z.classList.add("editing"),z.innerHTML=`<input class="cvd-edit" value='${c.replace(/'/g,"&#39;")}'>`;const d=z.querySelector("input");d.focus(),d.select();const p=()=>{E.setState(R,ot(d.value)),z.classList.remove("editing")};d.addEventListener("blur",p),d.addEventListener("keydown",x=>{x.key==="Enter"&&(x.preventDefault(),p()),x.key==="Escape"&&(z.classList.remove("editing"),L())})})})}function L(){o&&(s==="components"?$():C())}e.on("mount",()=>L()),e.on("update",()=>L()),e.on("destroy",()=>L()),e.on("store-update",()=>L())}var Nt="__COURVUX_HEAD_COLLECTOR__";function Wt(){return globalThis[Nt]??null}var Ut=(e,t)=>{Object.entries(t).forEach(([o,s])=>{o!=="innerHTML"&&(s==null||s===!1||e.setAttribute(o,s===!0?"":String(s)))})},Bt=e=>{const t={};return Array.from(e.attributes).forEach(o=>{t[o.name]=o.value}),t},qt=(e,t)=>{Array.from(e.attributes).forEach(o=>e.removeAttribute(o.name)),Object.entries(t).forEach(([o,s])=>e.setAttribute(o,s))},nt=(e,t,o,s)=>{let a=o?document.head.querySelector(o):null;a?(s.push({el:a,prevAttrs:Bt(a),created:!1}),Array.from(a.attributes).forEach(b=>a.removeAttribute(b.name))):(a=document.createElement(e),document.head.appendChild(a),s.push({el:a,created:!0})),Ut(a,t)};function Vt(e){var k,f,I;const t=Wt();if(t!==null)return t.push(e),()=>{};if(typeof document>"u")return()=>{};const o=[];let s;const a={},b={};if(e.title!==void 0){s=document.title;const $=e.titleTemplate,C=typeof $=="function"?$(e.title):typeof $=="string"?$.replace("%s",e.title):e.title;document.title=C}return(k=e.meta)==null||k.forEach($=>{nt("meta",$,$.name?`meta[name="${CSS.escape($.name)}"]`:$.property?`meta[property="${CSS.escape($.property)}"]`:$["http-equiv"]?`meta[http-equiv="${CSS.escape($["http-equiv"])}"]`:null,o)}),(f=e.link)==null||f.forEach($=>{nt("link",$,$.rel==="canonical"?'link[rel="canonical"]':$.rel&&$.href?`link[rel="${CSS.escape($.rel)}"][href="${CSS.escape($.href)}"]`:null,o)}),(I=e.script)==null||I.forEach($=>{const C=document.createElement("script");Object.entries($).forEach(([L,_])=>{L==="innerHTML"?C.textContent=String(_):_!=null&&_!==!1&&C.setAttribute(L,_===!0?"":String(_))}),document.head.appendChild(C),o.push({el:C,created:!0})}),e.htmlAttrs&&Object.entries(e.htmlAttrs).forEach(([$,C])=>{a[$]=document.documentElement.getAttribute($),document.documentElement.setAttribute($,C)}),e.bodyAttrs&&Object.entries(e.bodyAttrs).forEach(([$,C])=>{b[$]=document.body.getAttribute($),document.body.setAttribute($,C)}),function(){s!==void 0&&(document.title=s),o.forEach(({el:$,prevAttrs:C,created:L})=>{var _;L?(_=$.parentNode)==null||_.removeChild($):C&&qt($,C)}),Object.entries(a).forEach(([$,C])=>{C===null?document.documentElement.removeAttribute($):document.documentElement.setAttribute($,C)}),Object.entries(b).forEach(([$,C])=>{C===null?document.body.removeAttribute($):document.body.setAttribute($,C)})}}var je="data-courvux-ssr",Gt=e=>e?Promise.resolve().then(e):Promise.resolve();function rt(e,t){const o=e.trim();if(o.startsWith("{")){const s=o.replace(/[{}]/g,"").split(",").map(a=>a.trim()).filter(Boolean);return Object.fromEntries(s.map(a=>[a,t[a]]))}return{[o]:t}}var xe=e=>{if(e===null||typeof e!="object")return e;try{return structuredClone(e)}catch{return e}};async function ne(e,t,o){var x,S,n;const s={},{subscribe:a,createReactiveState:b,registerSetInterceptor:k,notifyAll:f}=Le();let I;if(typeof t.data=="function"?(t.loadingTemplate&&(e.innerHTML=t.loadingTemplate),I=await t.data()):I=t.data??{},t.templateUrl){const y=o.baseUrl?new URL(t.templateUrl,o.baseUrl).href:t.templateUrl,w=await fetch(y);if(!w.ok)throw new Error(`Failed to load template: ${y} (${w.status})`);e.innerHTML=await w.text()}else t.template&&(e.innerHTML=t.template);e.removeAttribute(je),(x=e.querySelector(`[${je}]`))==null||x.removeAttribute(je);const $={};if(t.inject&&o.provided){const y=Array.isArray(t.inject)?Object.fromEntries(t.inject.map(w=>[w,w])):t.inject;Object.entries(y).forEach(([w,A])=>{o.provided&&A in o.provided&&($[w]=o.provided[A])})}const C=b({...o.globalProperties??{},...I,...$,...t.methods,$refs:s,$el:e,...o.slots?{$slots:Object.fromEntries(Object.keys(o.slots).map(y=>[y,!0]))}:{},...o.store?{$store:o.store}:{},...o.currentRoute?{$route:o.currentRoute}:{},...o.router?{$router:o.router}:{}});C.$watch=(y,w,A)=>{const P=(A==null?void 0:A.deep)??!1,i=(A==null?void 0:A.immediate)??!1;let l=P?xe(C[y]):C[y];const r=a(y,()=>{const g=C[y];w.call(C,g,l),l=P?xe(g):g});return i&&w.call(C,C[y],void 0),r},C.$batch=St,C.$nextTick=y=>Gt(y),C.$dispatch=(y,w,A)=>{e.dispatchEvent(new CustomEvent(y,{bubbles:!0,composed:!0,...A??{},detail:w}))},o.magics&&Object.entries(o.magics).forEach(([y,w])=>{C[y]=w(C)}),C.$forceUpdate=()=>f();const L=[];C.$watchEffect=y=>{let w=[];const A=()=>{w.forEach(r=>r()),w=[];const i=He(()=>{try{y()}catch{}}),l=new Map;for(const{sub:r,key:g}of i)l.has(r)||l.set(r,new Set),!l.get(r).has(g)&&(l.get(r).add(g),w.push(r(g,A)))};A();const P=()=>{w.forEach(l=>l()),w=[];const i=L.indexOf(P);i>-1&&L.splice(i,1)};return L.push(P),P};const _=[];t.computed&&Object.entries(t.computed).forEach(([y,w])=>{const A=typeof w=="function"?w:w.get,P=typeof w!="function"?w.set:void 0;let i=[];const l=()=>{i.forEach(u=>u()),i=[];let r;const g=He(()=>{try{r=A.call(C)}catch(u){(t.debug??o.debug)&&console.warn("[courvux] computed error:",u)}});C[y]=r;const m=new Map;for(const{sub:u,key:h}of g)m.has(u)||m.set(u,new Set),!m.get(u).has(h)&&(m.get(u).add(h),i.push(u(h,l)))};l(),_.push(()=>i.forEach(r=>r())),P&&k(y,r=>P.call(C,r))});const M=[];t.watch&&Object.entries(t.watch).forEach(([y,w])=>{const A=typeof w=="object"&&w!==null&&"handler"in w,P=A?w.handler:w,i=A?w.immediate??!1:!1,l=A?w.deep??!1:!1;let r=l?xe(C[y]):C[y];const g=a(y,()=>{const m=C[y];P.call(C,m,r),r=l?xe(m):m});M.push(g),i&&P.call(C,C[y],void 0)});const z={...o.provided??{}};if(t.provide){const y=typeof t.provide=="function"?t.provide.call(C):t.provide;Object.assign(z,y)}const O={...o,provided:z,components:{...o.components,...t.components}};O.mountElement=Ce(O),O.createChildScope=(y,w)=>{const A=new Set(Object.keys(y)),P=new Set(Object.keys(w)),{subscribe:i,createReactiveState:l}=Le(),r=l(y);let g;return g=new Proxy({},{get(m,u){return typeof u!="string"?C[u]:A.has(u)?r[u]:P.has(u)?w[u].bind(g):C[u]},set(m,u,h){return typeof u!="string"?!1:A.has(u)?(r[u]=h,!0):(C[u]=h,!0)},has(m,u){return A.has(u)||P.has(u)||u in C},ownKeys(){return[...A,...P,...Object.keys(C)]},getOwnPropertyDescriptor(m,u){return A.has(u)||P.has(u)||u in C?{configurable:!0,enumerable:!0,writable:!0}:void 0}}),{state:g,subscribe:(m,u)=>A.has(m)?i(m,u):c(m,u),cleanup:()=>{}}},O.mountDynamic=async(y,w,A,P,i)=>{let l=null,r=null;const g=A.getAttribute("loading-template")??"",m=async()=>{var D,G,B;r==null||r(),r=null,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null);const u=W(w,P);if(!u)return;let h;if(typeof u=="function"){if(g){const H=document.createElement("div");H.innerHTML=g,(D=y.parentNode)==null||D.insertBefore(H,y.nextSibling),l=H}h=(await u()).default,l!=null&&l.parentNode&&(l.parentNode.removeChild(l),l=null)}else typeof u=="string"?h=(G=O.components)==null?void 0:G[u]:u&&typeof u=="object"&&(h=u);if(!h)return;const v=document.createElement("div"),T=H=>H.startsWith("@")||H.startsWith("cv:on:")||H.startsWith(":")||H.startsWith("cv-")||H.startsWith("v-slot");Array.from(A.attributes).forEach(H=>{T(H.name)||v.setAttribute(H.name,H.value)}),v.innerHTML=A.innerHTML;const F={},j={};Array.from(A.attributes).forEach(H=>{if(H.name.startsWith(":"))F[H.name.slice(1)]=W(H.value,P);else if(H.name.startsWith("@")||H.name.startsWith("cv:on:")){const K=H.value,V=H.name.startsWith("@")?H.name.slice(1):H.name.slice(6);j[V]=(...q)=>{typeof P[K]=="function"&&P[K].call(P,...q)}}});const U={...h,data:{...h.data,...F},methods:{...h.methods,$emit(H,...K){var V;gt(h,H,K),(V=j[H])==null||V.call(j,...K)}}},N={...O,components:{...O.components,...h.components}};N.mountElement=Ce(N),r=(await ne(v,U,N)).destroy,(B=y.parentNode)==null||B.insertBefore(v,y.nextSibling),l=v};J(w,i,m),await m()};const R=[];C.$addCleanup=y=>{R.push(y)};let E=!1;const c=(y,w)=>!t.onBeforeUpdate&&!t.onUpdated?a(y,w):a(y,()=>{var A;E||(E=!0,(A=t.onBeforeUpdate)==null||A.call(C),Promise.resolve().then(()=>{var P;E=!1,(P=t.onUpdated)==null||P.call(C)})),w()});try{(S=t.onBeforeMount)==null||S.call(C),await te(e,C,{subscribe:c,refs:s,...O,registerCleanup:y=>R.push(y)}),e.removeAttribute("cv-cloak"),(n=t.onMount)==null||n.call(C)}catch(y){if(t.onError)e.removeAttribute("cv-cloak"),t.onError.call(C,y);else if(o.errorHandler)e.removeAttribute("cv-cloak"),o.errorHandler(y,C,t.name??e.tagName.toLowerCase());else throw y}const d=typeof window<"u"?window.__COURVUX_DEVTOOLS__:void 0,p=d?Mt():0;if(d){const y=C,w=new Set,A={id:p,name:t.name??e.tagName.toLowerCase(),el:e,getState:()=>{const P={};for(const i of Object.keys(y))if(!(i.startsWith("$")||typeof y[i]=="function"))try{P[i]=y[i]}catch{}return P},setState:(P,i)=>{y[P]=i},subscribe:P=>(w.add(P),()=>w.delete(P)),children:[]};Object.keys(y).filter(P=>!P.startsWith("$")&&typeof y[P]!="function").forEach(P=>{a(P,()=>{d._emit("update",A),w.forEach(i=>i())})}),d._registerInstance(A),R.push(()=>d._unregisterInstance(p))}return{state:C,destroy:()=>{var y,w;(y=t.onBeforeUnmount)==null||y.call(C),_.forEach(A=>A()),M.forEach(A=>A()),L.forEach(A=>A()),R.forEach(A=>A()),(w=t.onDestroy)==null||w.call(C)},activate:()=>{var y;(y=t.onActivated)==null||y.call(C)},deactivate:()=>{var y;(y=t.onDeactivated)==null||y.call(C)},beforeLeave:t.onBeforeRouteLeave?(y,w)=>t.onBeforeRouteLeave.call(C,y,w):void 0,enter:t.onBeforeRouteEnter?y=>t.onBeforeRouteEnter.call(C,y):void 0}}function gt(e,t,o){if(!e.emits||Array.isArray(e.emits))return;const s=e.emits[t];typeof s=="function"&&!s(...o)&&console.warn(`[courvux] emit "${t}": validator returned false`)}function Ce(e){return async(t,o,s,a)=>{const b=e.components[o],k=t.getAttribute("cv-ref");k&&t.removeAttribute("cv-ref");const f={},I=[],$={};Array.from(t.attributes).filter(E=>E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:")).forEach(E=>{t.removeAttribute(E.name);const c=E.value,d=E.name.indexOf(":"),p=d>=0?E.name.slice(d+1).split(".")[0]:"modelValue",x=p==="modelValue"?"update:modelValue":`update:${p}`;f[p]=Oe(W(c,s)),I.push({propName:p,expr:c}),$[x]=S=>{pe(c,s,S)}});const C={};Array.from(t.attributes).forEach(E=>{const c=E.name.startsWith(":"),d=E.name.startsWith("@")||E.name.startsWith("cv:on:"),p=E.name==="cv-model"||E.name.startsWith("cv-model.")||E.name.startsWith("cv-model:"),x=E.name.startsWith("v-slot"),S=E.name==="slot";!c&&!d&&!p&&!x&&!S&&(C[E.name]=E.value)}),b.inheritAttrs===!1&&Object.keys(C).forEach(E=>t.removeAttribute(E)),Array.from(t.attributes).forEach(E=>{if(E.name.startsWith(":")){const c=E.name.slice(1),d=E.value;f[c]=Oe(W(d,s)),I.push({propName:c,expr:d})}else if(E.name.startsWith("@")||E.name.startsWith("cv:on:")){const c=E.name.startsWith("@")?E.name.slice(1):E.name.slice(6),d=E.value;$[c]=(...p)=>{typeof s[d]=="function"&&s[d].call(s,...p)}}});const L=t.getAttribute("v-slot")??t.getAttribute("v-slot:default");L&&(t.removeAttribute("v-slot"),t.removeAttribute("v-slot:default"));const _=new Map,M=[];Array.from(t.childNodes).forEach(E=>{const c=E.nodeType===1?E.getAttribute("slot"):null;if(c){if(!_.has(c)){const d=t.getAttribute(`v-slot:${c}`)??null;d&&t.removeAttribute(`v-slot:${c}`),_.set(c,{nodes:[],vSlot:d})}_.get(c).nodes.push(E.cloneNode(!0))}else M.push(E.cloneNode(!0))});const z={};M.some(E=>{var c;return E.nodeType===1||E.nodeType===3&&(((c=E.textContent)==null?void 0:c.trim())??"")!==""})&&(z.default=async E=>{const c=L?{...s,...rt(L,E)}:s,d=document.createDocumentFragment();return M.forEach(p=>d.appendChild(p.cloneNode(!0))),await te(d,c,a),Array.from(d.childNodes)});for(const[E,{nodes:c,vSlot:d}]of _)z[E]=async p=>{const x=d?{...s,...rt(d,p)}:s,S=document.createDocumentFragment();return c.forEach(n=>S.appendChild(n.cloneNode(!0))),await te(S,x,a),Array.from(S.childNodes)};const O={...e,components:{...e.components,...b.components},slots:z};O.mountElement=Ce(O);const{state:R}=await ne(t,{...b,data:{...b.data,...f,$attrs:C,$parent:s},methods:{...b.methods,$emit(E,...c){var d;gt(b,E,c),(d=$[E])==null||d.call($,...c)}}},O);R&&(I.forEach(({propName:E,expr:c})=>{ht(c,{...a,subscribe:a.subscribe},()=>{R[E]=Oe(W(c,s))})}),k&&a.refs&&(a.refs[k]=R))}}function Yt(e){Et();const t=typeof window<"u"?It():void 0,o=[],s={...e.directives},a={...e.components??{}},b=[],k=new Map,f={},I=new Map;if(e.debug&&t&&Ht(t),t&&e.store){const _=e.store,M=Object.keys(_).filter(z=>typeof _[z]!="function");t._registerStore({getState(){const z={};return M.forEach(O=>{try{z[O]=_[O]}catch{}}),z},setState(z,O){_[z]=O},subscribe(z){const O=M.map(R=>{try{return be(_,R,z)}catch{return()=>{}}});return()=>O.forEach(R=>R())}})}const $={router:e.router,use(_){return o.includes(_)||(o.push(_),_.install($)),$},directive(_,M){return s[_]=M,$},component(_,M){return a[_]=M,$},provide(_,M){return typeof _=="string"?f[_]=M:Object.assign(f,_),$},magic(_,M){return I.set(`$${_}`,M),$},mount:async _=>(await L(_),$),mountAll:async(_="[data-courvux]")=>{const M=Array.from(document.querySelectorAll(_));return await Promise.all(M.map(z=>C(z))),$},mountEl:async _=>C(_),unmount(_){if(!_)b.forEach(M=>M()),b.length=0,k.clear();else{const M=document.querySelector(_);if(M){const z=k.get(M);if(z){z(),k.delete(M);const O=b.indexOf(z);O>-1&&b.splice(O,1)}}}return $},destroy(){b.forEach(_=>_()),b.length=0,k.clear()}},C=async _=>{const M=new URL(".",document.baseURI).href,z={components:a,router:e.router,store:e.store,directives:s,baseUrl:M,provided:{...f},errorHandler:e.errorHandler,globalProperties:e.globalProperties,magics:I.size?Object.fromEntries(I):void 0};if(z.mountElement=Ce(z),e.router){const R=e.router;z.mountRouterView=async(E,c)=>{await new Promise(d=>{tt(E,R,async(p,x,S,n,y)=>{const w={...z,currentRoute:S};if(y){let A=null;const P={...w,mountRouterView:async(i,l)=>{A=tt(i,y,async(r,g,m,u)=>{const h={...w,currentRoute:m};if(u){let v=null;const T={...h,mountRouterView:async(j,U)=>{v=await ne(j,g,h)}},{destroy:F}=await ne(r,{template:u},T);return{destroy:()=>{v==null||v.destroy(),F()},activate:()=>v==null?void 0:v.activate(),deactivate:()=>v==null?void 0:v.deactivate()}}else return await ne(r,g,h)},l)}};if(n){let i=null;const l={...P,mountRouterView:async(g,m)=>{i=await ne(g,x,P)}},{destroy:r}=await ne(p,{template:n},l);return{destroy:()=>{A==null||A(),i==null||i.destroy(),r()},activate:()=>i==null?void 0:i.activate(),deactivate:()=>i==null?void 0:i.deactivate()}}else{const i=await ne(p,x,P);return{destroy:()=>{A==null||A(),i.destroy()},activate:()=>i.activate(),deactivate:()=>i.deactivate()}}}else if(n){let A=null;const P={...w,mountRouterView:async(l,r)=>{A=await ne(l,x,w)}},{destroy:i}=await ne(p,{template:n},P);return{destroy:()=>{A==null||A.destroy(),i()},activate:()=>A==null?void 0:A.activate(),deactivate:()=>A==null?void 0:A.deactivate()}}else return await ne(p,x,w)},c,d)})}}const O=await ne(_,e,z);return b.push(O.destroy),k.set(_,O.destroy),O.state},L=async _=>{const M=document.querySelector(_);if(M)return C(M)};return $}var at=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Xt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Pe={exports:{}},it;function Jt(){return it||(it=1,(function(e){var t=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
expect(w.text()).toBe('Alice');`,s_async:`it('waits for async data', async () => {
    ...
    `,onMount(){Z({title:"Testing",description:"Vitest-compatible test utility for Courvux. Mount components, drive state, query the DOM with happy-dom.",slug:"/testing"})}},wo={data:{s_manifest:`{
  "name":             "My App",
  "short_name":       "MyApp",
...
<button cv-if="pwa.installable && !pwa.installed" @click="pwa.prompt()">
    ...
    `,onMount(){Z({title:"Progressive Web App",description:"Make any Courvux app installable and offline-capable: manifest, vite-plugin-pwa, install prompt utility.",slug:"/pwa"})}},xo={data:{s_dir:`// Full definition
app.directive('focus', {
