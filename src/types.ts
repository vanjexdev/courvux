...
export type ScrollBehavior = (to: RouteMatch, from: RouteMatch | null) => { x?: number; y?: number } | void;
...
export interface Router {
    ...
    navigate(path: string, options?: { query?: Record<string, string> }): void;
    replace(path: string, options?: { query?: Record<string, string> }): void;
    back(): void;
    forward(): void;
}
